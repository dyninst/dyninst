...
PatchLoop::PatchLoop(PatchObject* obj, ParseAPI::Loop* loop)
: loop_(loop)
, parent(NULL)
{
    ...
    {
        backEdges.insert(obj->getEdge(*eit, obj->getBlock((*eit)->src()),
                                      obj->getBlock((*eit)->trg())));
    }
...
bool
PatchLoop::containsAddress(Address addr)
{
...
bool
PatchLoop::containsAddressInclusive(Address addr)
{
    vector<PatchBlock*> blks;
...
int
PatchLoop::getBackEdges(vector<PatchEdge*>& edges)
{
...
int
PatchLoop::getLoopEntries(vector<PatchBlock*>& e)
{
...
bool
PatchLoop::getLoopBasicBlocks(vector<PatchBlock*>& bbs)
{
...
bool
PatchLoop::getLoopBasicBlocksExclusive(vector<PatchBlock*>& bbs)
{
    ...
    {
        std::copy(contLoops[i]->basicBlocks.begin(), contLoops[i]->basicBlocks.end(),
...
bool
PatchLoop::hasBlock(PatchBlock* block)
{
    vector<PatchBlock*> blks;
    getLoopBasicBlocks(blks);
...
bool
PatchLoop::hasBlockExclusive(PatchBlock* block)
{
    vector<PatchBlock*> blks;
    getLoopBasicBlocksExclusive(blks);
...
PatchFunction*
PatchLoop::getFunction()
{
    return func;
}

std::string
PatchLoop::format() const
{
