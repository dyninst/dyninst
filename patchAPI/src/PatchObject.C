...
PatchObject*
PatchObject::create(ParseAPI::CodeObject* co, Address base, CFGMaker* cm,
                    PatchCallback* cb)
{
...
Address
PatchObject::codeOffsetToAddr(Address offset) const
{
...
bool
PatchObject::splitBlock(PatchBlock* /*orig*/, ParseAPI::Block* second)
{
...
bool
PatchObject::consistency(const AddrSpace* as) const
{
    if(!co_)
        return false;
    if(as != addr_space_)
