...
Point *PointMaker::createPoint(Location loc, Point::Type t) {
  switch (t) {
    case Point::PreInsn:
    case Point::PostInsn:
...
Point *PointMaker::mkFuncSitePoint(Point::Type t, PatchMgrPtr m,
                                   PatchFunction *f, PatchBlock *b) {
  return new Point(t, m, f, b);
}
Point *PointMaker::mkBlockPoint(Point::Type t, PatchMgrPtr m, PatchBlock *b,
                                PatchFunction *f) {
...
Point *PointMaker::mkEdgePoint(Point::Type t, PatchMgrPtr m, PatchEdge *e,
                               PatchFunction *f) {
