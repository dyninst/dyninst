...
bool
AddrSpace::write(PatchObject* /*obj*/, Address /*to*/, Address /*from*/, size_t /*size*/)
{
    return false;
}

Address
AddrSpace::malloc(PatchObject* /*obj*/, size_t /*size*/, Address /*near*/)
{
    return false;
}

bool
AddrSpace::realloc(PatchObject* /*obj*/, Address /*orig*/, size_t /*size*/)
{
    return false;
}
...
PatchObject*
AddrSpace::findObject(const ParseAPI::CodeObject* co) const
{
...
bool
AddrSpace::consistency(const PatchMgr* m) const
{
    if(mgr_.get() != m)
        return false;
    for(ObjMap::const_iterator iter = obj_map_.begin(); iter != obj_map_.end(); ++iter)
    {
