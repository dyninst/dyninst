...
This manual is structured as follows. Section~\ref{sec:abstractions} presents the core
abstractions in the public and plugin interface of
PatchAPI. Section~\ref{sec:examples} shows several examples in C++ to illustrate
...
Appendix~\ref{sec:dyninst-programmers} provides a quick tutorial of PatchAPI to those who are
