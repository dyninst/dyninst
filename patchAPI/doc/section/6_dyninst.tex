...
To access a PatchAPI class from a Dyninst class, use an explicit
...
\end{apient}
\apidesc { 
  These methods return a pair of iterators pointing to the start and
  end of the list of \texttt{Instance}s mapped to by
  the \texttt{BPatchSnippetHandle}. 
}
