...
\caption{\label{fig:object-ownership}Object Ownership}
\end{figure}
...
Figure~\ref{fig:object-ownership} shows the ownership hierarchy for PatchAPI's classes.
...
or a ``1:n'' relationship. In Figure~\ref{fig:object-ownership}, for example, each PatchMgr
...
\caption{\label{fig:inheritance-hierarchy}Inheritance Hierarchy}
\end{figure}
...
preceding finished \textbf{Commands}. Figure~\ref{fig:inheritance-hierarchy} illustrates the
