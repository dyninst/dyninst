...
Classes in PatchAPI use either the C++ raw pointer or the dyncompat shared pointer
(\emph{dyncompat::shared\_ptr<T>}) for memory management. A class uses a raw pointer
...
destroying. Classes that use a dyncompat shared pointer include a Snippet, PatchMgr,
