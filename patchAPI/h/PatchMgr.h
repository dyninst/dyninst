...
class PatchMgr : public dyn_detail::boost::enable_shared_from_this<PatchMgr> {
  ...
  typedef std::pair<PatchFunction *, PatchInsnLoc> InsnInstance;
  ...
  typedef std::vector<PatchCallSite> CallSites;
  typedef std::vector<PatchExitSite> ExitSites;
  typedef std::vector<PatchInsnLoc> Insns;
