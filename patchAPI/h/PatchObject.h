...
public:
    ...
    static PatchObject* clone(PatchObject* par_obj, Address base, CFGMaker* cm = NULL,
    ...
    // Edge
    PatchEdge* getEdge(ParseAPI::Edge*, PatchBlock* = NULL, PatchBlock* = NULL,
                       bool create = true);
...
protected:
    ...
    PatchObject(ParseAPI::CodeObject* o, Address a, CFGMaker* cm,
                PatchCallback* cb = NULL);
    PatchObject(const PatchObject* par_obj, Address a, CFGMaker* cm,
                PatchCallback* cb = NULL);
