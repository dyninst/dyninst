...
public:
    ...
    PatchEdge(ParseAPI::Edge* internalEdge, PatchBlock* source, PatchBlock* target);
    PatchEdge(const PatchEdge* parent, PatchBlock* child_src, PatchBlock* child_trg);
    virtual ~PatchEdge();
...
protected:
    ...
    /* Loop details*/
    bool _loop_analyzed;  // true if loops in the function have been found and stored in
                          // _loops
...
template <class OutputIterator>
void
PatchBlock::getFuncs(OutputIterator result)
{
