...
class COMMON_EXPORT MachSyscall {
 public:
  ...
  typedef unsigned long
      SyscallIDIndependent;  // e.g., Dyninst::Syscall::dyn_getpid
  typedef const char *SyscallName;

  // Factory methods
  // Allows ProcControlAPI to construct a MachSyscall for an event
  friend MachSyscall ProcControlAPI::makeFromEvent(
      const ProcControlAPI::EventSyscall *);
