...
const signed int BITS_512 = 0x00001000;
  ...
  DEF_REGISTER(         hw_reg_inst_dw1,  11 | BITS_32 |       HWR |Arch_amdgpu_gfx940, "amdgpu_gfx940");
  DEF_REGISTER(          hw_reg_ib_dbg0,  12 | BITS_32 |       HWR |Arch_amdgpu_gfx940, "amdgpu_gfx940");
