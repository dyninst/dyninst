...
#include "AMDGPU/gfx908/amdgpu_gfx908_sys_regs.h"
    ...
    namespace amdgpu_gfx90a{
        ...
        DEF_REGISTER(tid,                      Arch_amdgpu_gfx90a| SYSREG  | BITS_32 | 0 , "amdgpu_gfx90a");

        DEF_REGISTER(invalid,                  Arch_amdgpu_gfx90a| SYSREG  | BITS_32 | 1 , "amdgpu_gfx90a");
        DEF_REGISTER(pc_all,                   Arch_amdgpu_gfx90a| PC  | BITS_48 | 0 , "amdgpu_gfx90a");


        DEF_REGISTER(src_scc,                  Arch_amdgpu_gfx90a| HWR | BITS_32 | 0 , "amdgpu_gfx90a");


        DEF_REGISTER(src_vccz,                 Arch_amdgpu_gfx90a| HWR | BITS_1  | 1 , "amdgpu_gfx90a");
        DEF_REGISTER(vcc_lo,                   Arch_amdgpu_gfx90a| HWR | BITS_32 | 2 , "amdgpu_gfx90a");
        DEF_REGISTER(vcc_hi,                   Arch_amdgpu_gfx90a| HWR | BITS_32 | 3 , "amdgpu_gfx90a");
        DEF_REGISTER(vcc,                      Arch_amdgpu_gfx90a| HWR | BITS_64 | 2 , "amdgpu_gfx90a");



        DEF_REGISTER(src_execz,                Arch_amdgpu_gfx90a| HWR | BITS_1  | 4 , "amdgpu_gfx90a");
        DEF_REGISTER(exec_lo,                  Arch_amdgpu_gfx90a| HWR | BITS_32 | 5 , "amdgpu_gfx90a");
        DEF_REGISTER(exec_hi,                  Arch_amdgpu_gfx90a| HWR | BITS_32 | 6 , "amdgpu_gfx90a");
        DEF_REGISTER(exec,                     Arch_amdgpu_gfx90a| HWR | BITS_64 | 5 , "amdgpu_gfx90a");


        DEF_REGISTER(flat_scratch_lo,          Arch_amdgpu_gfx90a| HWR | BITS_64 | 7 , "amdgpu_gfx90a");
        DEF_REGISTER(flat_scratch_hi,          Arch_amdgpu_gfx90a| HWR | BITS_32 | 8 , "amdgpu_gfx90a");
        DEF_REGISTER(flat_scratch_all,         Arch_amdgpu_gfx90a| HWR | BITS_32 | 7 , "amdgpu_gfx90a");

        DEF_REGISTER(m0,                       Arch_amdgpu_gfx90a| HWR | BITS_32 | 10 , "amdgpu_gfx90a");

        DEF_REGISTER(src_literal,              Arch_amdgpu_gfx90a| HWR | BITS_32 | 11 , "amdgpu_gfx90a");// TODO
        DEF_REGISTER(src_pops_exiting_wave_id, Arch_amdgpu_gfx90a| HWR | BITS_32 | 12 , "amdgpu_gfx90a");// TODO

        DEF_REGISTER(src_private_base,         Arch_amdgpu_gfx90a| HWR | BITS_32 | 13 , "amdgpu_gfx90a");
        DEF_REGISTER(src_private_limit,        Arch_amdgpu_gfx90a| HWR | BITS_32 | 14 , "amdgpu_gfx90a");
        DEF_REGISTER(src_shared_base,          Arch_amdgpu_gfx90a| HWR | BITS_32 | 15 , "amdgpu_gfx90a");
        DEF_REGISTER(src_shared_limit,         Arch_amdgpu_gfx90a| HWR | BITS_32 | 16, "amdgpu_gfx90a");
        ...
        DEF_REGISTER(src_lds_direct,           Arch_amdgpu_gfx90a| HWR | BITS_32 | 19 , "amdgpu_gfx90a");
        DEF_REGISTER(vmcnt,                    Arch_amdgpu_gfx90a| HWR | BITS_32 | 20 , "amdgpu_gfx90a");
        DEF_REGISTER(expcnt,                   Arch_amdgpu_gfx90a| HWR | BITS_32 | 21 , "amdgpu_gfx90a");
        DEF_REGISTER(lgkmcnt,                  Arch_amdgpu_gfx90a| HWR | BITS_32 | 22 , "amdgpu_gfx90a");
        DEF_REGISTER(dsmem,                    Arch_amdgpu_gfx90a| HWR | BITS_32 | 23 , "amdgpu_gfx90a");


        DEF_REGISTER(ttmp0,                    Arch_amdgpu_gfx90a| TTMP_SGPR | BITS_32 | 0 , "amdgpu_gfx90a");
        DEF_REGISTER(ttmp1,                    Arch_amdgpu_gfx90a| TTMP_SGPR | BITS_32 | 1 , "amdgpu_gfx90a");
        DEF_REGISTER(ttmp2,                    Arch_amdgpu_gfx90a| TTMP_SGPR | BITS_32 | 2 , "amdgpu_gfx90a");
        DEF_REGISTER(ttmp3,                    Arch_amdgpu_gfx90a| TTMP_SGPR | BITS_32 | 3 , "amdgpu_gfx90a");
        DEF_REGISTER(ttmp4,                    Arch_amdgpu_gfx90a| TTMP_SGPR | BITS_32 | 4 , "amdgpu_gfx90a");
        DEF_REGISTER(ttmp5,                    Arch_amdgpu_gfx90a| TTMP_SGPR | BITS_32 | 5 , "amdgpu_gfx90a");
        DEF_REGISTER(ttmp6,                    Arch_amdgpu_gfx90a| TTMP_SGPR | BITS_32 | 6 , "amdgpu_gfx90a");
        DEF_REGISTER(ttmp7,                    Arch_amdgpu_gfx90a| TTMP_SGPR | BITS_32 | 7 , "amdgpu_gfx90a");
        DEF_REGISTER(ttmp8,                    Arch_amdgpu_gfx90a| TTMP_SGPR | BITS_32 | 8 , "amdgpu_gfx90a");
        DEF_REGISTER(ttmp9,                    Arch_amdgpu_gfx90a| TTMP_SGPR | BITS_32 | 9 , "amdgpu_gfx90a");
        DEF_REGISTER(ttmp10,                   Arch_amdgpu_gfx90a| TTMP_SGPR | BITS_32 | 10 , "amdgpu_gfx90a");
        DEF_REGISTER(ttmp11,                   Arch_amdgpu_gfx90a| TTMP_SGPR | BITS_32 | 11 , "amdgpu_gfx90a");
        DEF_REGISTER(ttmp12,                   Arch_amdgpu_gfx90a| TTMP_SGPR | BITS_32 | 12 , "amdgpu_gfx90a");
        DEF_REGISTER(ttmp13,                   Arch_amdgpu_gfx90a| TTMP_SGPR | BITS_32 | 13 , "amdgpu_gfx90a");
        DEF_REGISTER(ttmp14,                   Arch_amdgpu_gfx90a| TTMP_SGPR | BITS_32 | 14 , "amdgpu_gfx90a");
        DEF_REGISTER(ttmp15,                   Arch_amdgpu_gfx90a| TTMP_SGPR | BITS_32 | 15 , "amdgpu_gfx90a");



        DEF_REGISTER(mrt0,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 0 , "amdgpu_gfx90a");
        DEF_REGISTER(mrt1,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 1 , "amdgpu_gfx90a");
        DEF_REGISTER(mrt2,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 2 , "amdgpu_gfx90a");
        DEF_REGISTER(mrt3,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 3 , "amdgpu_gfx90a");
        DEF_REGISTER(mrt4,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 4 , "amdgpu_gfx90a");
        DEF_REGISTER(mrt5,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 5 , "amdgpu_gfx90a");
        DEF_REGISTER(mrt6,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 6 , "amdgpu_gfx90a");
        DEF_REGISTER(mrt7,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 7 , "amdgpu_gfx90a");
        DEF_REGISTER(mrtz,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 8 , "amdgpu_gfx90a");
        DEF_REGISTER(null,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 9 , "amdgpu_gfx90a");
        DEF_REGISTER(pos0,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 12 , "amdgpu_gfx90a");
        DEF_REGISTER(pos1,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 13 , "amdgpu_gfx90a");
        DEF_REGISTER(pos2,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 14 , "amdgpu_gfx90a");
        DEF_REGISTER(pos3,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 15 , "amdgpu_gfx90a");
        DEF_REGISTER(param0,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 32 , "amdgpu_gfx90a");
        DEF_REGISTER(param1,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 33 , "amdgpu_gfx90a");
        DEF_REGISTER(param2,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 34 , "amdgpu_gfx90a");
        DEF_REGISTER(param3,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 35 , "amdgpu_gfx90a");
        DEF_REGISTER(param4,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 36 , "amdgpu_gfx90a");
        DEF_REGISTER(param5,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 37 , "amdgpu_gfx90a");
        DEF_REGISTER(param6,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 38 , "amdgpu_gfx90a");
        DEF_REGISTER(param7,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 39 , "amdgpu_gfx90a");
        DEF_REGISTER(param8,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 40 , "amdgpu_gfx90a");
        DEF_REGISTER(param9,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 41 , "amdgpu_gfx90a");
        DEF_REGISTER(param10,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 42 , "amdgpu_gfx90a");
        DEF_REGISTER(param11,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 43 , "amdgpu_gfx90a");
        DEF_REGISTER(param12,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 44 , "amdgpu_gfx90a");
        DEF_REGISTER(param13,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 45 , "amdgpu_gfx90a");
        DEF_REGISTER(param14,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 46 , "amdgpu_gfx90a");
        DEF_REGISTER(param15,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 47 , "amdgpu_gfx90a");
        DEF_REGISTER(param16,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 48 , "amdgpu_gfx90a");
        DEF_REGISTER(param17,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 49 , "amdgpu_gfx90a");
        DEF_REGISTER(param18,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 50 , "amdgpu_gfx90a");
        DEF_REGISTER(param19,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 51 , "amdgpu_gfx90a");
        DEF_REGISTER(param20,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 52 , "amdgpu_gfx90a");
        DEF_REGISTER(param21,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 53 , "amdgpu_gfx90a");
        DEF_REGISTER(param22,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 54 , "amdgpu_gfx90a");
        DEF_REGISTER(param23,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 55 , "amdgpu_gfx90a");
        DEF_REGISTER(param24,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 56 , "amdgpu_gfx90a");
        DEF_REGISTER(param25,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 57 , "amdgpu_gfx90a");
        DEF_REGISTER(param26,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 58 , "amdgpu_gfx90a");
        DEF_REGISTER(param27,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 59 , "amdgpu_gfx90a");
        DEF_REGISTER(param28,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 60 , "amdgpu_gfx90a");
        DEF_REGISTER(param29,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 61 , "amdgpu_gfx90a");
        DEF_REGISTER(param30,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 62 , "amdgpu_gfx90a");
        DEF_REGISTER(param31,				Arch_amdgpu_gfx90a| TGT | BITS_32 | 63 , "amdgpu_gfx90a");

        DEF_REGISTER(attr0,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 0 , "amdgpu_gfx90a");
        DEF_REGISTER(attr1,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 1 , "amdgpu_gfx90a");
        DEF_REGISTER(attr2,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 2 , "amdgpu_gfx90a");
        DEF_REGISTER(attr3,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 3 , "amdgpu_gfx90a");
        DEF_REGISTER(attr4,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 4 , "amdgpu_gfx90a");
        DEF_REGISTER(attr5,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 5 , "amdgpu_gfx90a");
        DEF_REGISTER(attr6,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 6 , "amdgpu_gfx90a");
        DEF_REGISTER(attr7,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 7 , "amdgpu_gfx90a");
        DEF_REGISTER(attr8,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 8 , "amdgpu_gfx90a");
        DEF_REGISTER(attr9,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 9 , "amdgpu_gfx90a");
        DEF_REGISTER(attr10,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 10 , "amdgpu_gfx90a");
        DEF_REGISTER(attr11,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 11 , "amdgpu_gfx90a");
        DEF_REGISTER(attr12,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 12 , "amdgpu_gfx90a");
        DEF_REGISTER(attr13,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 13 , "amdgpu_gfx90a");
        DEF_REGISTER(attr14,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 14 , "amdgpu_gfx90a");
        DEF_REGISTER(attr15,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 15 , "amdgpu_gfx90a");
        DEF_REGISTER(attr16,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 16 , "amdgpu_gfx90a");
        DEF_REGISTER(attr17,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 17 , "amdgpu_gfx90a");
        DEF_REGISTER(attr18,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 18 , "amdgpu_gfx90a");
        DEF_REGISTER(attr19,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 19 , "amdgpu_gfx90a");
        DEF_REGISTER(attr20,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 20 , "amdgpu_gfx90a");
        DEF_REGISTER(attr21,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 21 , "amdgpu_gfx90a");
        DEF_REGISTER(attr22,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 22 , "amdgpu_gfx90a");
        DEF_REGISTER(attr23,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 23 , "amdgpu_gfx90a");
        DEF_REGISTER(attr24,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 24 , "amdgpu_gfx90a");
        DEF_REGISTER(attr25,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 25 , "amdgpu_gfx90a");
        DEF_REGISTER(attr26,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 26 , "amdgpu_gfx90a");
        DEF_REGISTER(attr27,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 27 , "amdgpu_gfx90a");
        DEF_REGISTER(attr28,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 28 , "amdgpu_gfx90a");
        DEF_REGISTER(attr29,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 29 , "amdgpu_gfx90a");
        DEF_REGISTER(attr30,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 30 , "amdgpu_gfx90a");
        DEF_REGISTER(attr31,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 31 , "amdgpu_gfx90a");
        DEF_REGISTER(attr32,				Arch_amdgpu_gfx90a| ATTR | BITS_32 | 32 , "amdgpu_gfx90a");
...
#include "AMDGPU/gfx940/amdgpu_gfx940_sys_regs.h"
    }
