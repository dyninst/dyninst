 ...
 */
    ...
    (__GLIBCXX__ < 20120920)
#error \
    "Using GCC 4.7.0 or 4.7.1 with Dyninst requires the -std:c++0x or -std:c++11 flag. Other versions do not."
#endif
#endif
...
COMMON_EXPORT bool wildcardEquiv(const std::string &us, const std::string &them,
