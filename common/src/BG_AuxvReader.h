...
/// properly.  User of this class is responsible for stopping/restarting the
/// process.
///
class BG_AuxvReader {
 private:
  ...
  DebuggerInterface::BG_Debugger_Msg
      ack_msg;  /// BG msg containing fetched auxv buffer.
 ...
 public:
  /// Construct a new reader for the specified process. PID is according to MPIR
  /// proctable.
