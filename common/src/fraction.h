...
class COMMON_EXPORT fraction {
 ...
 public:
  ...
  fraction()
      : numer(0), denom(0), interimMultOverflowPt(0), finalMultOverflowPt(0) {}
  ...
  int64_t getI() const { return numer / denom; }
  // returns a double representation of the fraction
  double getD() const { return (double)numer / (double)denom; }
  int64_t getInterimMultOverflowPt() const { return interimMultOverflowPt; }
  int64_t getFinalMultOverflowPt() const { return finalMultOverflowPt; }
  ...
  */
  ...
  fraction reciprocal() const { return fraction(denom, numer); }
...
// double   * fraction
inline double operator*(const double d, const fraction &a) { return a * d; }
...
// int64_t  * fraction
inline const fraction operator*(int64_t a, const fraction &b) { return b * a; }
