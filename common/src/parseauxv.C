...
AuxvParser::~AuxvParser() { pid_to_parser.erase(pid); }
...
Address AuxvParser::getInterpreterBase() { return interpreter_base; }

bool AuxvParser::parsedVsyscall() { return found_vsyscall; }

Address AuxvParser::getVsyscallBase() { return vsyscall_base; }

Address AuxvParser::getVsyscallText() { return vsyscall_text; }

Address AuxvParser::getVsyscallEnd() { return vsyscall_end; }

Address AuxvParser::getProgramBase() { return phdr; }

Address AuxvParser::getPageSize() { return page_size; }
