...
bool
Platform::operator==(const Platform& p) const
{
...
public:
    ...
    MachSyscall::SyscallIDPlatform findIDPlatform(Platform,
                                                  MachSyscall::SyscallIDIndependent);
...
SyscallInformation*
SyscallInformation::getInstance()
{
...
MachSyscall::SyscallName
SyscallInformation::findName(Platform plat, MachSyscall::SyscallIDPlatform id)
{
...
MachSyscall::SyscallIDPlatform
SyscallInformation::findIDPlatform(Platform plat, MachSyscall::SyscallIDIndependent id)
{
...
MachSyscall::SyscallName
MachSyscall::nameLookup(Platform plat, SyscallIDPlatform id)
{
    return SyscallInformation::getInstance()->findName(plat, id);
}

MachSyscall
MachSyscall::makeFromPlatform(Platform plat, SyscallIDIndependent id)
{
...
unsigned long
MachSyscall::num() const
{
    return _id;
}

MachSyscall::SyscallName
MachSyscall::name() const
{
    return _name;
}

bool
MachSyscall::operator==(const MachSyscall& m) const
{
