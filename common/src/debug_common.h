...
#define common_parsing_printf(...)                                                       \
    common_debug_printf(parsing, common_parsing, __VA_ARGS__)

COMMON_EXPORT int
dwarf_printf_int(const char* format, ...) DYNINST_PRINTF_ANNOTATION(1, 2);
COMMON_EXPORT int
translate_printf_int(const char* format, ...) DYNINST_PRINTF_ANNOTATION(1, 2);
COMMON_EXPORT int
lineinfo_printf_int(const char* format, ...) DYNINST_PRINTF_ANNOTATION(1, 2);
COMMON_EXPORT int
common_parsing_printf_int(const char* format, ...) DYNINST_PRINTF_ANNOTATION(1, 2);
