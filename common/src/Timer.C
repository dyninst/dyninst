...
// $Id: Timer.C,v 1.12 2002/02/11 22:02:01 tlmiller Exp $
...
#if !defined(rs6000_ibm_aix4_1) && !defined(i386_unknown_linux2_0) && !defined(alpha_dec_osf4_0) && !defined(mips_sgi_irix6_4) && !defined(ia64_unknown_linux2_4)
