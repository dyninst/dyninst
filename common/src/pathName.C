...
std::string
expand_tilde_pathname(const std::string& dir)
{
#ifdef os_windows
    // no-op on Windows
    return dir;
...
static std::string
concat_pathname_components_simple(const std::string& comp1, const std::string& comp2)
{
...
std::string
concat_pathname_components(const std::string& comp1, const std::string& comp2)
{
...
bool
extractNextPathElem(const char*& ptr, std::string& result)
{
...
bool
exists_executable(const std::string& fullpathname)
{
...
bool
executableFromArgv0AndPathAndCwd(std::string& result, const std::string& i_argv0,
...
std::string
extract_pathname_tail(const std::string& path)
{
...
std::string
resolve_file_path(std::string path)
{
