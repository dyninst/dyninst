...
AddressTranslate *AddressTranslate::createAddressTranslator(
    PID pid_, ProcessReader *, SymbolReaderFactory *, PROC_HANDLE phand,
    std::string exename, Address) {
  AddressTranslateStatic *new_translate =
      new AddressTranslateStatic(pid_, phand, exename);
  return new_translate;
}

AddressTranslate *AddressTranslate::createAddressTranslator(
    ProcessReader *, SymbolReaderFactory *, std::string exename, Address) {
  return createAddressTranslator(0, NULL, exename);
}

bool AddressTranslateStatic::init() { return true; }

bool AddressTranslateStatic::refresh() { return true; }
