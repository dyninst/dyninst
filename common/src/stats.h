...
class COMMON_EXPORT Statistic {
 ...
 protected:
  Statistic(StatContainer* c) : container_(c) {}
...
class COMMON_EXPORT CntStatistic : public Statistic {
 ...
 protected:
  ...
  CntStatistic(StatContainer* c) : Statistic(c), cnt_(0) {}

 public:
  CntStatistic() : Statistic(NULL), cnt_(0) {}
...
class COMMON_EXPORT TimeStatistic : public Statistic {
 ...
 protected:
  TimeStatistic(StatContainer* c) : Statistic(c) {}
...
typedef enum { CountStat, TimerStat } StatType;
...
class StatContainer {
 public:
  ...
  COMMON_EXPORT dyn_hash_map<std::string, Statistic*>& allStats() {
    return stats_;
  }
