...
unsigned
instruction::getTargetReg() const
{
    if(isBranchReg())
    {
...
unsigned
instruction::getBranchTargetReg() const
{
...
bool
instruction::isAtomicLoad() const
{
...
bool
instruction::isAtomicStore() const
{
