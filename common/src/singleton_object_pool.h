...
typename singleton_object_pool<T, Alloc>::pointer
singleton_object_pool<T, Alloc>::allocate(size_type n)
{
...
{
    inline void operator()(T* e) { singleton_object_pool<T>::destroy(e); }
};
