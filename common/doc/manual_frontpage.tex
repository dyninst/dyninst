%% article.cls sets the page counter to 1 both on entering and on leaving
%% titlepage, so the title page and the page after it are both page 1 and
%% hyperref emits a duplicate page.1 destination.  Give the title page no
%% page anchor; nothing links to it.
