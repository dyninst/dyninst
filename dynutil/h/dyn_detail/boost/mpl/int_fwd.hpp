...
#ifndef DYN_DETAIL_BOOST_MPL_INT_FWD_HPP_INCLUDED
#define DYN_DETAIL_BOOST_MPL_INT_FWD_HPP_INCLUDED
...
template< DYN_DETAIL_BOOST_MPL_AUX_NTTP_DECL(int, N) > struct int_;

DYN_DETAIL_BOOST_MPL_AUX_ADL_BARRIER_NAMESPACE_CLOSE
DYN_DETAIL_BOOST_MPL_AUX_ADL_BARRIER_DECL(int_)
}

#endif // DYN_DETAIL_BOOST_MPL_INT_FWD_HPP_INCLUDED
