...
class PARSER_EXPORT CodeRegion
: public Dyninst::InstructionSource
...
OS&
operator<<(OS& stream, const CodeRegion& cr)
{
...
class PARSER_EXPORT SymtabCodeSource
: public CodeSource
...
public:
    ...
    bool findCatchBlockByTryRange(Address /*given try address*/,
                                  std::set<Address>& /* catch start */) const;
...
inline bool
CodeRegion::contains(const Address addr) const
{
