...
class ParseCallback {
 ...
 protected:
  ...
  virtual bool absAddr(Address /*absolute*/, Address & /*loadAddr*/,
...
class ParseCallbackManager {
 public:
  ParseCallbackManager(ParseCallback *b) : inBatch_(false) {
    if (b) registerCallback(b);
  }
  ...
  void interproc_cf(Function *, Block *, Address,
                    ParseCallback::interproc_details *);
  void instruction_cb(Function *, Block *, Address,
                      ParseCallback::insn_details *);
  ...
  bool absAddr(Address /*absolute*/, Address & /*loadAddr*/,
               CodeObject *& /*containerObject*/);
 ...
 private:
  ...
  struct BlockMod {
    ...
    mod_t action;
    BlockMod(Block *b, Edge *e, ParseCallback::edge_type_t t, mod_t m)
        : block(b), edge(e), type(t), action(m){};
  };
