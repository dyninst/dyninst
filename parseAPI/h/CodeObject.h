...
public:
    ...
    PARSER_EXPORT int       findFuncsByBlock(CodeRegion* cr, Block* b,
                                             std::set<Function*>& funcs);
    PARSER_EXPORT int findFuncs(CodeRegion* cr, Address addr, std::set<Function*>& funcs);
    // Find functions overlapping the range [start,end)
    PARSER_EXPORT int findFuncs(CodeRegion* cr, Address start, Address end,
                                std::set<Function*>& funcs);
    PARSER_EXPORT int findCurrentFuncs(CodeRegion* cr, Address addr,
                                       std::set<Function*>& funcs);
    ...
    PARSER_EXPORT int findBlocks(CodeRegion* cr, Address addr, std::set<Block*>& blocks);
...
void
Block::getFuncs(OutputIterator result)
{
