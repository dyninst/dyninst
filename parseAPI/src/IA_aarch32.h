 ...
 */
#if !defined(IA_AARCH32__H)
#define IA_AARCH32__H
...
class IA_aarch32 : public IA_IAPI {
    public:
        IA_aarch32(Dyninst::InstructionAPI::InstructionDecoder dec_,
               Address start_, 
               Dyninst::ParseAPI::CodeObject* o,
               Dyninst::ParseAPI::CodeRegion* r,
               Dyninst::InstructionSource *isrc,
	       Dyninst::ParseAPI::Block * curBlk_);
	IA_aarch32(const IA_aarch32 &);
	virtual IA_aarch32* clone() const;
