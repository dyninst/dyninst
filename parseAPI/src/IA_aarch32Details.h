...
#if !defined(IA_AARCH32_DETAILS_H)
#define IA_AARCH32_DETAILS_H
...
class IA_aarch32Details : public IA_platformDetails
{
    friend IA_platformDetails* makePlatformDetails(Dyninst::Architecture Arch,
                                                   const IA_IAPI* cb);
  protected:
    IA_aarch32Details(const IA_IAPI* cb)
...
#endif //!defined(IA_AARCH32_DETAILS_H)
