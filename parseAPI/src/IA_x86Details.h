...
class IA_x86Details : public IA_platformDetails {
 ...
 protected:
  IA_x86Details(const IA_IAPI* cb) : IA_platformDetails(cb) {}
 ...
 private:
  ...
  boost::tuple<Dyninst::InstructionAPI::Instruction::Ptr,
               Dyninst::InstructionAPI::Instruction::Ptr, bool>
  findMaxSwitchInsn(Dyninst::ParseAPI::Block* start);
  void findThunkInBlock(Dyninst::ParseAPI::Block* curBlock);
  bool computeTableBounds(
      Dyninst::InstructionAPI::Instruction::Ptr maxSwitchInsn,
      Dyninst::InstructionAPI::Instruction::Ptr branchInsn,
      Dyninst::InstructionAPI::Instruction::Ptr tableInsn,
      bool foundJCCAlongTaken, unsigned& tableSize, unsigned& tableStride);
  bool fillTableEntries(
