...
public:
    ...
    dyn_hash_map<Assignment::Ptr, std::pair<AST::Ptr, AST::Ptr>,
    ...
    std::string  format();
    bool         isJumpTableFormat()
    {
        return jumpTableFormat && findIndex && findTableBase && memLoc;
    }
    ...
    void FindTOC();
    JumpTableFormatPred(ParseAPI::Function* f, ParseAPI::Block* b, ReachFact& r,
                        ThunkData& t, SymbolicExpression& sym);
