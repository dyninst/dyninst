...
bool
compute_gap(CodeRegion* cr, Address addr, set<Function*, Function::less> const& funcs,
            set<Function*, Function::less>::const_iterator& fit, Address& gapStart,
            Address& gapEnd)
{
    Function* cur     = NULL;
    Function* next    = NULL;
...
bool
compute_gap_new(CodeRegion* cr, Address addr, set<Function*, Function::less> const& funcs,
...
bool
gap_heuristic_GCC(CodeObject* co, CodeRegion* cr, Address addr)
{
    ...
    InstructionAdapter_t* ah  = InstructionAdapter_t::makePlatformIA_IAPI(
        co->cs()->getArch(), dec, addr, co, cr, cr, blk);
...
bool
gap_heuristic_MSVS(CodeObject* co, CodeRegion* cr, Address addr)
{
    using namespace Dyninst::InstructionAPI;
...
bool
gap_heuristics(CodeObject* co, CodeRegion* cr, Address addr)
{
    bool ret = false;
...
bool
IsNop(CodeObject* co, CodeRegion* cr, Address addr)
{
    using namespace Dyninst::InstructionAPI;
 ...
 */
void
Parser::parse_gap_heuristic(CodeRegion* cr)
{
...
bool
Parser::getGapRange(CodeRegion* cr, Address curAddr, Address& gapStart, Address& gapEnd)
{
    ...
    auto iter =
        func_range.upper_bound(make_pair(curAddr, std::numeric_limits<Address>::max()));
...
void
Parser::probabilistic_gap_parsing(CodeRegion* cr)
{
...
void
Parser::parse_gap_heuristic(CodeRegion*)
{}
void
Parser::probabilistic_gap_parsing(CodeRegion*)
{}
#endif
