...
class IA_aarch64Details : public IA_platformDetails {
  friend IA_platformDetails* makePlatformDetails(Dyninst::Architecture Arch,
                                                 const IA_IAPI* cb);

 protected:
  IA_aarch64Details(const IA_IAPI* cb)
 ...
 private:
  ...
  std::set<int> dfgregs;
  // std::map<Address,
  // Dyninst::InstructionAPI::Instruction::Ptr>::const_iterator patternIter;
