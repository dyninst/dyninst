...
{
class IA_amdgpu : public IA_IAPI
{
public:
    IA_amdgpu(Dyninst::InstructionAPI::InstructionDecoder dec_, Address start_,
    ...
    virtual bool       isTailCall(const ParseAPI::Function* context,
                                  ParseAPI::EdgeTypeEnum    type, unsigned int,
    ...
    virtual bool       isReturn(Dyninst::ParseAPI::Function* context,
