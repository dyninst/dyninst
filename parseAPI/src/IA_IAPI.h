...
public:
    ...
    static IA_IAPI*  makePlatformIA_IAPI(Dyninst::Architecture                       arch,
                                         ...
                                         Address start_, Dyninst::ParseAPI::CodeObject* o,
                                         Dyninst::ParseAPI::CodeRegion* r,
                                         Dyninst::InstructionSource*    isrc,
                                         Dyninst::ParseAPI::Block*      curBlk_);
    virtual IA_IAPI* clone() const = 0;
    virtual void reset(Dyninst::InstructionAPI::InstructionDecoder dec_, Address start,
    ...
    virtual bool isTailCall(const ParseAPI::Function*, Dyninst::ParseAPI::EdgeTypeEnum,
                            unsigned int, const std::set<Address>&) const = 0;
    ...
    virtual bool                     sliceReturn(ParseAPI::Block* bit, Address ret_addr,
                                                 ParseAPI::Function* func) const = 0;
...
protected:
    ...
    virtual void parseSyscall(
        std::vector<std::pair<Address, Dyninst::ParseAPI::EdgeTypeEnum>>& outEdges) const;
    virtual void parseSysEnter(
        std::vector<std::pair<Address, Dyninst::ParseAPI::EdgeTypeEnum>>& outEdges) const;
     ...
     */
public:
    typedef std::vector<std::pair<Address, Dyninst::InstructionAPI::Instruction>>
        allInsns_t;
