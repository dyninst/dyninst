...
std::string
ParseAPI::format(EdgeTypeEnum e)
{
    switch(e)
    {
        case CALL:
...
// ParseAPI call...
Function*
CFGFactory::_mkfunc(Address addr, FuncSource src, string name, CodeObject* obj,
                    CodeRegion* reg, Dyninst::InstructionSource* isrc)
{
...
Function*
CFGFactory::mkfunc(Address addr, FuncSource, string name, CodeObject* obj,
                   CodeRegion* reg, Dyninst::InstructionSource* isrc)
{
...
to_str(EdgeState e)
{
    switch(e)
    {
        case created:
            return "ok";
        case destroyed_noreturn:
            return "destroyed fallthrough from non-returning call/syscall";
        case destroyed_cb:
            return "destroyed from callback";
        case destroyed_all:
            return "destroyed during global cleanup";
        default:
