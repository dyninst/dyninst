...
AST::Ptr
StackTamperVisitor::visit(AST* a)
{
...
AST::Ptr
StackTamperVisitor::visit(BottomAST* b)
{
    tamper_ = TAMPER_NONZERO;
    return b->ptr();
}
...
AST::Ptr
StackTamperVisitor::visit(ConstantAST* c)
{
...
AST::Ptr
StackTamperVisitor::visit(VariableAST* v)
{
...
AST::Ptr
StackTamperVisitor::visit(StackAST* s)
{
...
AST::Ptr
StackTamperVisitor::visit(RoseAST* r)
{
...
StackTamper
StackTamperVisitor::tampersStack(AST::Ptr a, Address& newAddr)
{
    if(tamper_ != TAMPER_UNSET)
    {
        newAddr = modpc_;
