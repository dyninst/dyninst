...
G++ as follows: \code{g++ -std=c++0x -o code\_sample code\_sample.C -L<library
...
example, it can be built with G++ as follows: \code{g++ -std=c++0x -o example
  example.C -L<library install path> -I<headers install path>
