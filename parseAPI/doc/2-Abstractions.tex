...
{\item \textbf{block}: Nodes in the CFG represent \emph{basic blocks}:
...
{\item \textbf{edge}: Typed edges between the nodes in the CFG represent
...
{\item \textbf{loop}: The \emph{loop} represents code in the binary that may execute repeatedly,
