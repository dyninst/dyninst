...
\begin{apient}
void getImmediateDominates(Block *A, std::set<Block*> &imm) const;
\end{apient}
\apidesc{Fill \code{imm} with all the blocks immediate dominated by block \code{A}}

\begin{apient}
void getAllDominates(Block *A, std::set<Block*> &dom) const;
\end{apient}
...
\begin{apient}
void getImmediatePostDominates(Block *A, std::set<Block*> &imm) const;
\end{apient}
\apidesc{Fill \code{imm} with all the blocks immediate post-dominated by block \code{A}}

\begin{apient}
void getAllPostDominates(Block *A, std::set<Block*> &dom) const;
\end{apient}
