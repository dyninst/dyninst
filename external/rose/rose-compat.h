...
enum X86RegisterClass {
  ...
  x86_regclass_gpr,      // Numbers are X86GeneralPurposeRegister
...
enum X86PositionInRegister {
  ...
  x86_regpos_high_byte, /*!< 2nd byte of register (bits 8-15), only for
                           ax,bx,cx,dx */
  ...
  x86_regpos_all    /*!< the full register is used (default value), only value
                       allowed for segregs and st */
};
