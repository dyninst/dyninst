...
// DQ (10/11/2008): Started work to support PowerPC Instruction Set for BGL
// Performance Tool
...
enum PowerpcInstructionKind {
  ...
  powerpc_fctidz,  // Floating Convert to Integer Doubleword with Round Toward
                   // Zero
  powerpc_fctidz_record,  // Floating Convert to Integer Doubleword with Round
                          // Toward Zero
  ...
  powerpc_fprsqrte,  // FP2 Floating Parallel Reciprocal Square Root Estimate
                     // (BGL specific)
  powerpc_fpmr,
  powerpc_fpabs,
  powerpc_lfssx,
  ...
  powerpc_qvfxmadds,
  powerpc_qvfxxnpmadd,
  powerpc_qvfxxnpmadds,
  powerpc_qvfxxmadd,
  powerpc_qvfxxmadds,
  powerpc_qvfxxcpnmadd,
  powerpc_qvfxxcpnmadds,
  powerpc_qvfxmul,
  powerpc_qvfxmuls,
  powerpc_qvfrsp,
  powerpc_qvfctid,
  ...
  powerpc_frsqrte_record,  // Floating Reciprocal Square Root Estimate
                           // (optional)
  powerpc_frsqrtes,  // Floating Reciprocal Square Root Estimate (optional)
  powerpc_frsqrtes_record,  // Floating Reciprocal Square Root Estimate
                            // (optional)
...
enum PowerpcRegisterClass {
  ...
  powerpc_regclass_cr,     // Condition Register (only particular fields or bits
                           // may be used)
...
enum PowerpcSpecialPurposeRegister {  // These must match the processor's
                                      // numbers
  powerpc_spr_xer = 1,
  powerpc_spr_lr = 8,
  powerpc_spr_ctr = 9,
