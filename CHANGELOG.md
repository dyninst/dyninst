...
## [10.1.0](https://github.com/dyninst/dyninst/tree/10.1.0) (2019-07-30)
[Full Changelog](https://github.com/dyninst/dyninst/compare/v10.1.0...v10.2.0)

**Implemented enhancements:**

- Fix Variable location parsing ([781](https://github.com/dyninst/dyninst/issue/781))
- Fix proccontrol hangs in test_thread_X ([780](https://github.com/dyninst/dyninst/issue/780))
- proccontrol: Handle "ghost" threads ([742](https://github.com/dyninst/dyninst/issue/742))
- Elf extended numbering ([776](https://github.com/dyninst/dyninst/issue/776))
- Expand the list of non-returning functions in CodeSource.C. ([748](https://github.com/dyninst/dyninst/issue/748))
- Memory leak fixes ([758](https://github.com/dyninst/dyninst/issue/758))
- C++ cleanup ([610](https://github.com/dyninst/dyninst/issue/610))
- Libxul fixes ([755](https://github.com/dyninst/dyninst/issue/755))
- Potential fixes needed for relocating libraries ([754](https://github.com/dyninst/dyninst/issue/754))
- Add compiler-specific search directories in getResolvedLibraryPath ([732](https://github.com/dyninst/dyninst/issue/732))
- More parallel parsing optimization and fixes ([729](https://github.com/dyninst/dyninst/issue/729))
- Add search of libgcc.a to x86 and aarch64 ([731](https://github.com/dyninst/dyninst/issue/731))
- PIE/PIC aarch64 rewrite implementation ([698](https://github.com/dyninst/dyninst/issue/698))
- Fixes for AbsRegion and jump table index slicing involving global variable ([695](https://github.com/dyninst/dyninst/issue/695))
- Parallel DWARF parsing and improved parallel code parsing ([651](https://github.com/dyninst/dyninst/issue/651))
- Allow same address range to map to different source lines in DWARF ([643](https://github.com/dyninst/dyninst/issue/643))
- Parse dwarf variables with abstract origin attribute ([642](https://github.com/dyninst/dyninst/issue/642))
- Fix instrumentation regressions for libc-2.29 on ARM ([653](https://github.com/dyninst/dyninst/issue/653))
- Implement the check of ThreadDB at BPatch level ([667](https://github.com/dyninst/dyninst/issue/667))
- Use static AArch64 decoder tables. ([633](https://github.com/dyninst/dyninst/issue/633))
- Don't use software breakpoints when creating traps for springboards ([637](https://github.com/dyninst/dyninst/issue/637))
- ARMv8 initial work on rewriter ([612](https://github.com/dyninst/dyninst/issue/612))

**Fixed bugs:**

- Revert CUDA binaries openning to libdw ([787](https://github.com/dyninst/dyninst/issue/787))
- Updates for #780 ([783](https://github.com/dyninst/dyninst/issue/783))
- Improve detection of ghost threads ([784](https://github.com/dyninst/dyninst/issue/784))
- Remove Aggregate::setModule declaration ([779](https://github.com/dyninst/dyninst/issue/779))
- Remove examples ([764](https://github.com/dyninst/dyninst/issue/764))
- Improve logging in PCEventHandler::handleThreadCreate ([772](https://github.com/dyninst/dyninst/issue/772))
- Retain hint function from CodeSource even if we do not parse the code object. ([768](https://github.com/dyninst/dyninst/issue/768))
- remove unnecessary assertion for unknown phdr_type ([757](https://github.com/dyninst/dyninst/issue/757))
- Use register x30 (Link Register) to generate long branch ([720](https://github.com/dyninst/dyninst/issue/720))
- Do not use non-trivial types in varargs ([704](https://github.com/dyninst/dyninst/issue/704))
- Remove undefined behavior from Symtab::Type ([706](https://github.com/dyninst/dyninst/issue/706))
- Update Examples in dataflowAPI ([700](https://github.com/dyninst/dyninst/issue/700))
- Prevent corruption to rax during stack alignment on x86-64 ([670](https://github.com/dyninst/dyninst/issue/670))
- Ignore additional Eclipse file and spurious .gitignore ([681](https://github.com/dyninst/dyninst/issue/681))
- Add explicit ElfUtils dependency for ParseThat and examples ([678](https://github.com/dyninst/dyninst/issue/678))
- Add $INSTALL/lib/elfutils subdirectory to build paths ([680](https://github.com/dyninst/dyninst/issue/680))
- Allow sterile builds ([641](https://github.com/dyninst/dyninst/issue/641))
- Reorder includes to fix hidden build dependencies ([665](https://github.com/dyninst/dyninst/issue/665))
- Deprecate Blue Gene/Q support ([662](https://github.com/dyninst/dyninst/issue/662))
- Delete duplicate friend declaration of Parser in Block ([649](https://github.com/dyninst/dyninst/issue/649))
- Rename getType() -> getDataClass() in Section 8.1 of SymtabAPI docs ([661](https://github.com/dyninst/dyninst/issue/661))
- Fix spelling of getTypedefType in Section 8.1 of SymtabAPI docs ([660](https://github.com/dyninst/dyninst/issue/660))
- Update handling of TBB CMake file for clang ([654](https://github.com/dyninst/dyninst/issue/654))
- Fix typo in declaration of 'create' in Section 8.3 ([659](https://github.com/dyninst/dyninst/issue/659))
- Change dataTypeDefine -> DataTypedef in DataClass enum documentation ([650](https://github.com/dyninst/dyninst/issue/650))
- Use CMAKE_xx_COMPILER when building external dependencies ([636](https://github.com/dyninst/dyninst/issue/636))
- Allow CMake files for dependencies to be included multiple times ([639](https://github.com/dyninst/dyninst/issue/639))
- Fix overlapping bug of program header segments on fixPhdr. ([618](https://github.com/dyninst/dyninst/issue/618))
- Updates TLS descriptors values in .dynamic section (ARMv8, #614)
- Use private writable mmap when opening binaries and debug files ([624](https://github.com/dyninst/dyninst/issue/624))
- Convert snprintf with PRIx64 to std::to_string ([627](https://github.com/dyninst/dyninst/issue/627))
- Use PRIx64 macros for long long results for i686. ([517](https://github.com/dyninst/dyninst/issue/517))
