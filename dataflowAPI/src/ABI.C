...
std::map<MachRegister, int> *ABI::getIndexMap() { return index; }
...
bitArray ABI::getBitArray() { return bitArray(index->size()); }
#if defined(arch_x86) || defined(arch_x86_64)
...
void ABI::initialize64() {
  ...
  returnRead64_[machRegIndex_x86_64()[x86_64::rcx]] =
      true;  // Not correct, temporary
...
#if defined(arch_aarch64)
void ABI::initialize32() { assert(0); }

void ABI::initialize64() { assert(0); }
#endif
