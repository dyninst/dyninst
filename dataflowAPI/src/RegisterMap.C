...
machRegIndex_x86()
{
    ...
    if(mrmap == NULL)
    {
        ...
        *mrmap = { { x86::eax, 0 },
                   ...
                   { x86::xmm30, 137 },
                   { x86::xmm31, 138 },
                   { x86::mm0, 139 },  // mm0 to mm7 and st0 to st7
                                       // collapse to mm0
                   { x86::cr0, 140 },
                   { x86::cr1, 141 },
                   { x86::cr2, 142 },
...
machRegIndex_aarch64()
{
    ...
    {
        mrmap  = new RegisterMap();
        *mrmap = { { aarch64::x0, 0 },   { aarch64::x1, 1 },    { aarch64::x2, 2 },
                   { aarch64::x3, 3 },   { aarch64::x4, 4 },    { aarch64::x5, 5 },
                   { aarch64::x6, 6 },   { aarch64::x7, 7 },    { aarch64::x8, 8 },
                   { aarch64::x9, 9 },   { aarch64::x10, 10 },  { aarch64::x11, 11 },
                   { aarch64::x12, 12 }, { aarch64::x13, 13 },  { aarch64::x14, 14 },
                   { aarch64::x15, 15 }, { aarch64::x16, 16 },  { aarch64::x17, 17 },
                   { aarch64::x18, 18 }, { aarch64::x19, 19 },  { aarch64::x20, 20 },
                   { aarch64::x21, 21 }, { aarch64::x22, 22 },  { aarch64::x23, 23 },
                   { aarch64::x24, 24 }, { aarch64::x25, 25 },  { aarch64::x26, 26 },
                   { aarch64::x27, 27 }, { aarch64::x28, 28 },  { aarch64::x29, 29 },
                   { aarch64::x30, 30 }, { aarch64::w0, 0 },    { aarch64::w1, 1 },
                   { aarch64::w2, 2 },   { aarch64::w3, 3 },    { aarch64::w4, 4 },
                   { aarch64::w5, 5 },   { aarch64::w6, 6 },    { aarch64::w7, 7 },
                   { aarch64::w8, 8 },   { aarch64::w9, 9 },    { aarch64::w10, 10 },
                   { aarch64::w11, 11 }, { aarch64::w12, 12 },  { aarch64::w13, 13 },
                   { aarch64::w14, 14 }, { aarch64::w15, 15 },  { aarch64::w16, 16 },
                   { aarch64::w17, 17 }, { aarch64::w18, 18 },  { aarch64::w19, 19 },
                   { aarch64::w20, 20 }, { aarch64::w21, 21 },  { aarch64::w22, 22 },
                   { aarch64::w23, 23 }, { aarch64::w24, 24 },  { aarch64::w25, 25 },
                   { aarch64::w26, 26 }, { aarch64::w27, 27 },  { aarch64::w28, 28 },
                   { aarch64::w29, 29 }, { aarch64::w30, 30 },  { aarch64::q0, 31 },
                   { aarch64::q1, 32 },  { aarch64::q2, 33 },   { aarch64::q3, 34 },
                   { aarch64::q4, 35 },  { aarch64::q5, 36 },   { aarch64::q6, 37 },
                   { aarch64::q7, 38 },  { aarch64::q8, 39 },   { aarch64::q9, 40 },
                   { aarch64::q10, 41 }, { aarch64::q11, 42 },  { aarch64::q12, 43 },
                   { aarch64::q13, 44 }, { aarch64::q14, 45 },  { aarch64::q15, 46 },
                   { aarch64::q16, 47 }, { aarch64::q17, 48 },  { aarch64::q18, 49 },
                   { aarch64::q19, 50 }, { aarch64::q20, 51 },  { aarch64::q21, 52 },
                   { aarch64::q22, 53 }, { aarch64::q23, 54 },  { aarch64::q24, 55 },
                   { aarch64::q25, 56 }, { aarch64::q26, 57 },  { aarch64::q27, 58 },
                   { aarch64::q28, 59 }, { aarch64::q29, 60 },  { aarch64::q30, 61 },
                   { aarch64::q31, 62 }, { aarch64::fpcr, 63 }, { aarch64::fpsr, 64 },
                   { aarch64::pc, 65 },  { aarch64::sp, 66 },   { aarch64::pstate, 67 },
                   { aarch64::xzr, 68 } };
    }
    return *mrmap;
}
...
machRegIndex_x86()
{
    ...
    if(mrmap == NULL)
    {
        ...
        *mrmap = map_list_of(x86::eax, 0)(x86::ecx, 1)(x86::edx, 2)(x86::ebx, 3)(
            x86::esp, 4)(x86::ebp, 5)(x86::esi, 6)(x86::edi, 7)(x86::eip, 8)(x86::cf, 9)(
            x86::flag1, 10)(x86::pf, 11)(x86::flag3, 12)(x86::af, 13)(x86::flag5, 14)(
            x86::zf, 15)(x86::sf, 16)(x86::tf, 17)(x86::if_, 18)(x86::df, 19)(
            x86::of, 20)(x86::flagc, 21)(x86::flagd, 22)(x86::nt_, 23)(x86::flagf, 24)(
            x86::rf, 25)(x86::ds, 26)(x86::es, 27)(x86::fs, 28)(x86::gs, 29)(x86::cs, 30)(
            x86::ss, 31)(x86::oeax, 32)(x86::fsbase, 33)(x86::gsbase, 34)(x86::xmm0, 35)(
            x86::xmm1, 36)(x86::xmm2, 37)(x86::xmm3, 38)(x86::xmm4, 39)(x86::xmm5, 40)(
            x86::xmm6, 41)(x86::xmm7,
                           42)(x86::mm0, 43)  // mm0 to mm7 and st0 to st7 collapse to mm0
            (x86::cr0, 44)(x86::cr1, 45)(x86::cr2, 46)(x86::cr3, 47)(x86::cr4, 48)(
                x86::cr5, 49)(x86::cr6, 50)(x86::cr7, 51)(x86::dr0, 52)(x86::dr1, 53)(
                x86::dr2, 54)(x86::dr3, 55)(x86::dr4, 56)(x86::dr5, 57)(x86::dr6, 58)(
                x86::dr7, 59)(x86::tr0, 60)(x86::tr1, 61)(x86::tr2, 62)(x86::tr3, 63)(
                x86::tr4, 64)(x86::tr5, 65)(x86::tr6, 66)(x86::tr7, 67);
    }
    return *mrmap;
}
...
machRegIndex_x86_64()
{
    ...
    if(mrmap == NULL)
    {
        ...
        *mrmap = map_list_of(x86_64::rax, 0)(x86_64::rcx, 1)(x86_64::rdx, 2)(
            ...
            x86_64::zmm10, 55)(x86_64::zmm11, 56)(x86_64::zmm12, 57)(x86_64::zmm13, 58)(
            x86_64::zmm14, 59)(x86_64::zmm15, 60)(x86_64::zmm16, 61)(x86_64::zmm17, 62)(
            x86_64::zmm18, 63)(x86_64::zmm19, 64)(x86_64::zmm20, 65)(x86_64::zmm21, 66)(
            x86_64::zmm22, 67)(x86_64::zmm23, 68)(x86_64::zmm24, 69)(x86_64::zmm25, 70)(
            x86_64::zmm26, 71)(x86_64::zmm27, 72)(x86_64::zmm28, 73)(x86_64::zmm29, 74)(
            x86_64::zmm30, 75)(x86_64::zmm31, 75)(x86_64::ymm0, 76)(x86_64::ymm1, 77)(
            x86_64::ymm2, 78)(x86_64::ymm3, 79)(x86_64::ymm4, 80)(x86_64::ymm5, 81)(
            x86_64::ymm6, 82)(x86_64::ymm7, 83)(x86_64::ymm8, 84)(x86_64::ymm9, 85)(
            x86_64::ymm10, 86)(x86_64::ymm11, 87)(x86_64::ymm12, 88)(x86_64::ymm13, 89)(
            x86_64::ymm14, 90)(x86_64::ymm15, 91)(x86_64::ymm16, 92)(x86_64::ymm17, 93)(
            x86_64::ymm18, 94)(x86_64::ymm19, 95)(x86_64::ymm20, 96)(x86_64::ymm21, 97)(
            x86_64::ymm22, 98)(x86_64::ymm23, 99)(x86_64::ymm24, 100)(x86_64::ymm25, 101)(
            x86_64::ymm26, 102)(x86_64::ymm27, 103)(x86_64::ymm28, 104)(
            x86_64::ymm29, 105)(x86_64::ymm30, 106)(x86_64::ymm31, 107)(
            x86_64::xmm0, 108)(x86_64::xmm1, 109)(x86_64::xmm2, 110)(x86_64::xmm3, 111)(
            x86_64::xmm4, 112)(x86_64::xmm5, 113)(x86_64::xmm6, 114)(x86_64::xmm7, 115)(
            x86_64::xmm8, 116)(x86_64::xmm9, 117)(x86_64::xmm10, 118)(x86_64::xmm11, 119)(
            x86_64::xmm12, 120)(x86_64::xmm13, 121)(x86_64::xmm14, 122)(
            x86_64::xmm15, 123)(x86_64::xmm16, 124)(x86_64::xmm17, 125)(
            x86_64::xmm18, 126)(x86_64::xmm19, 127)(x86_64::xmm20, 128)(
            x86_64::xmm21, 129)(x86_64::xmm22, 130)(x86_64::xmm23, 131)(
            x86_64::xmm24, 132)(x86_64::xmm25, 133)(x86_64::xmm26, 134)(
            x86_64::xmm27, 135)(x86_64::xmm28, 136)(x86_64::xmm29, 137)(
            x86_64::xmm30, 138)(x86_64::xmm31, 139)(
            x86_64::mm0, 140)  // mm0 to mm7 and st0 to st7 collapse to mm0
            (x86_64::cr0, 141)(x86_64::cr1, 142)(x86_64::cr2, 143)(x86_64::cr3, 144)(
                x86_64::cr4, 145)(x86_64::cr5, 146)(x86_64::cr6, 147)(x86_64::cr7, 148)(
                x86_64::dr0, 149)(x86_64::dr1, 150)(x86_64::dr2, 151)(x86_64::dr3, 152)(
                x86_64::dr4, 153)(x86_64::dr5, 154)(x86_64::dr6, 155)(x86_64::dr7, 156)(
                x86_64::tr0, 157)(x86_64::tr1, 158)(x86_64::tr2, 159)(x86_64::tr3, 160)(
                x86_64::tr4, 161)(x86_64::tr5, 162)(x86_64::tr6, 163)(x86_64::tr7, 164);
    }
    return *mrmap;
}
...
machRegIndex_ppc()
{
    ...
    if(mrmap == NULL)
    {
        ...
        *mrmap = map_list_of(ppc32::r0, 0)(ppc32::r1, 1)(ppc32::r2, 2)(ppc32::r3, 3)(
            ...
            ppc32::r9, 9)(ppc32::r10, 10)(ppc32::r11, 11)(ppc32::r12, 12)(ppc32::r13, 13)(
            ppc32::r14, 14)(ppc32::r15, 15)(ppc32::r16, 16)(ppc32::r17, 17)(
            ppc32::r18, 18)(ppc32::r19, 19)(ppc32::r20, 20)(ppc32::r21, 21)(
            ppc32::r22, 22)(ppc32::r23, 23)(ppc32::r24, 24)(ppc32::r25, 25)(
            ppc32::r26, 26)(ppc32::r27, 27)(ppc32::r28, 28)(ppc32::r29, 29)(
            ppc32::r30, 30)(ppc32::r31, 31)(ppc32::fpr0, 32)(ppc32::fpr1, 33)(
            ppc32::fpr2, 34)(ppc32::fpr3, 35)(ppc32::fpr4, 36)(ppc32::fpr5, 37)(
            ppc32::fpr6, 38)(ppc32::fpr7, 39)(ppc32::fpr8, 40)(ppc32::fpr9, 41)(
            ppc32::fpr10, 42)(ppc32::fpr11, 43)(ppc32::fpr12, 44)(ppc32::fpr13, 45)(
            ppc32::fpr14, 46)(ppc32::fpr15, 47)(ppc32::fpr16, 48)(ppc32::fpr17, 49)(
            ppc32::fpr18, 50)(ppc32::fpr19, 51)(ppc32::fpr20, 52)(ppc32::fpr21, 53)(
            ppc32::fpr22, 54)(ppc32::fpr23, 55)(ppc32::fpr24, 56)(ppc32::fpr25, 57)(
            ppc32::fpr26, 58)(ppc32::fpr27, 59)(ppc32::fpr28, 60)(ppc32::fpr29, 61)(
            ppc32::fpr30, 62)(ppc32::fpr31, 63)(ppc32::fsr0, 64)(ppc32::fsr1, 65)(
            ppc32::fsr2, 66)(ppc32::fsr3, 67)(ppc32::fsr4, 68)(ppc32::fsr5, 69)(
            ppc32::fsr6, 70)(ppc32::fsr7, 71)(ppc32::fsr8, 72)(ppc32::fsr9, 73)(
            ppc32::fsr10, 74)(ppc32::fsr11, 75)(ppc32::fsr12, 76)(ppc32::fsr13, 77)(
            ppc32::fsr14, 78)(ppc32::fsr15, 79)(ppc32::fsr16, 80)(ppc32::fsr17, 81)(
            ppc32::fsr18, 82)(ppc32::fsr19, 83)(ppc32::fsr20, 84)(ppc32::fsr21, 85)(
            ppc32::fsr22, 86)(ppc32::fsr23, 87)(ppc32::fsr24, 88)(ppc32::fsr25, 89)(
            ppc32::fsr26, 90)(ppc32::fsr27, 91)(ppc32::fsr28, 92)(ppc32::fsr29, 93)(
            ppc32::fsr30, 94)(ppc32::fsr31, 95)(ppc32::mq, 96)(ppc32::xer, 97)(
            ppc32::lr, 98)(ppc32::ctr, 99)(ppc32::dsisr, 100)(ppc32::dar, 101)(
            ppc32::dec, 102)(ppc32::sdr1, 103)(ppc32::srr0, 104)(ppc32::srr1, 105)(
            ppc32::sprg0, 106)(ppc32::sprg1, 107)(ppc32::sprg2, 108)(ppc32::sprg3, 109)(
            ppc32::sprg3_ro, 109)(ppc32::ear, 110)(ppc32::tbl_wo, 111)(
            ppc32::tbl_ro, 111)(ppc32::tbu_wo, 112)(ppc32::tbu_ro, 112)(ppc32::pvr, 113)(
            ppc32::ibat0u, 114)(ppc32::ibat0l, 115)(ppc32::ibat1u, 116)(
            ppc32::ibat1l, 117)(ppc32::ibat2u, 118)(ppc32::ibat2l, 119)(
            ppc32::ibat3u, 120)(ppc32::ibat3l, 121)(ppc32::dbat0u, 122)(
            ppc32::dbat0l, 123)(ppc32::dbat1u, 124)(ppc32::dbat1l, 125)(
            ppc32::dbat2u, 126)(ppc32::dbat2l, 127)(ppc32::dbat3u, 128)(
            ppc32::dbat3l, 129)(ppc32::pc, 130)(ppc32::fpscw, 131)(ppc32::fpscw0, 132)(
            ppc32::fpscw1, 133)(ppc32::fpscw2, 134)(ppc32::fpscw3, 135)(
            ppc32::fpscw4, 136)(ppc32::fpscw5, 137)(ppc32::fpscw6, 138)(
            ppc32::fpscw7, 139)(ppc32::msr, 140)(ppc32::ivpr, 141)(ppc32::ivor8, 142)(
            ppc32::seg0, 143)(ppc32::seg1, 144)(ppc32::seg2, 145)(ppc32::seg3, 146)(
            ppc32::seg4, 147)(ppc32::seg5, 148)(ppc32::seg6, 149)(ppc32::seg7, 150)(
            ppc32::cr0, 151)(ppc32::cr1, 152)(ppc32::cr2, 153)(ppc32::cr3, 154)(
            ppc32::cr4, 155)(ppc32::cr5, 156)(ppc32::cr6, 157)(ppc32::cr7, 158)(
            ppc32::cr, 159)(ppc32::sprg4, 160)(ppc32::sprg4_ro, 160)(ppc32::sprg5, 161)(
...
machRegIndex_ppc_64()
{
    ...
    if(mrmap == NULL)
    {
        ...
        *mrmap = map_list_of(ppc64::r0, 0)(ppc64::r1, 1)(ppc64::r2, 2)(ppc64::r3, 3)(
            ...
            ppc64::r9, 9)(ppc64::r10, 10)(ppc64::r11, 11)(ppc64::r12, 12)(ppc64::r13, 13)(
            ppc64::r14, 14)(ppc64::r15, 15)(ppc64::r16, 16)(ppc64::r17, 17)(
            ppc64::r18, 18)(ppc64::r19, 19)(ppc64::r20, 20)(ppc64::r21, 21)(
            ppc64::r22, 22)(ppc64::r23, 23)(ppc64::r24, 24)(ppc64::r25, 25)(
            ppc64::r26, 26)(ppc64::r27, 27)(ppc64::r28, 28)(ppc64::r29, 29)(
            ppc64::r30, 30)(ppc64::r31, 31)(ppc64::fpr0, 32)(ppc64::fpr1, 33)(
            ppc64::fpr2, 34)(ppc64::fpr3, 35)(ppc64::fpr4, 36)(ppc64::fpr5, 37)(
            ppc64::fpr6, 38)(ppc64::fpr7, 39)(ppc64::fpr8, 40)(ppc64::fpr9, 41)(
            ppc64::fpr10, 42)(ppc64::fpr11, 43)(ppc64::fpr12, 44)(ppc64::fpr13, 45)(
            ppc64::fpr14, 46)(ppc64::fpr15, 47)(ppc64::fpr16, 48)(ppc64::fpr17, 49)(
            ppc64::fpr18, 50)(ppc64::fpr19, 51)(ppc64::fpr20, 52)(ppc64::fpr21, 53)(
            ppc64::fpr22, 54)(ppc64::fpr23, 55)(ppc64::fpr24, 56)(ppc64::fpr25, 57)(
            ppc64::fpr26, 58)(ppc64::fpr27, 59)(ppc64::fpr28, 60)(ppc64::fpr29, 61)(
            ppc64::fpr30, 62)(ppc64::fpr31, 63)(ppc64::fsr0, 64)(ppc64::fsr1, 65)(
            ppc64::fsr2, 66)(ppc64::fsr3, 67)(ppc64::fsr4, 68)(ppc64::fsr5, 69)(
            ppc64::fsr6, 70)(ppc64::fsr7, 71)(ppc64::fsr8, 72)(ppc64::fsr9, 73)(
            ppc64::fsr10, 74)(ppc64::fsr11, 75)(ppc64::fsr12, 76)(ppc64::fsr13, 77)(
            ppc64::fsr14, 78)(ppc64::fsr15, 79)(ppc64::fsr16, 80)(ppc64::fsr17, 81)(
            ppc64::fsr18, 82)(ppc64::fsr19, 83)(ppc64::fsr20, 84)(ppc64::fsr21, 85)(
            ppc64::fsr22, 86)(ppc64::fsr23, 87)(ppc64::fsr24, 88)(ppc64::fsr25, 89)(
            ppc64::fsr26, 90)(ppc64::fsr27, 91)(ppc64::fsr28, 92)(ppc64::fsr29, 93)(
            ppc64::fsr30, 94)(ppc64::fsr31, 95)(ppc64::mq, 96)(ppc64::xer, 97)(
            ppc64::lr, 98)(ppc64::ctr, 99)(ppc64::dsisr, 100)(ppc64::dar, 101)(
            ppc64::dec, 102)(ppc64::sdr1, 103)(ppc64::srr0, 104)(ppc64::srr1, 105)(
            ppc64::sprg0, 106)(ppc64::sprg1, 107)(ppc64::sprg2, 108)(ppc64::sprg3, 109)(
            ppc64::sprg3_ro, 109)(ppc64::ear, 110)(ppc64::tbl_wo, 111)(
            ppc64::tbl_ro, 111)(ppc64::tbu_wo, 112)(ppc64::tbu_ro, 112)(ppc64::pvr, 113)(
            ppc64::ibat0u, 114)(ppc64::ibat0l, 115)(ppc64::ibat1u, 116)(
            ppc64::ibat1l, 117)(ppc64::ibat2u, 118)(ppc64::ibat2l, 119)(
            ppc64::ibat3u, 120)(ppc64::ibat3l, 121)(ppc64::dbat0u, 122)(
            ppc64::dbat0l, 123)(ppc64::dbat1u, 124)(ppc64::dbat1l, 125)(
            ppc64::dbat2u, 126)(ppc64::dbat2l, 127)(ppc64::dbat3u, 128)(
            ppc64::dbat3l, 129)(ppc64::pc, 130)(ppc64::fpscw, 131)(ppc64::fpscw0, 132)(
            ppc64::fpscw1, 133)(ppc64::fpscw2, 134)(ppc64::fpscw3, 135)(
            ppc64::fpscw4, 136)(ppc64::fpscw5, 137)(ppc64::fpscw6, 138)(
            ppc64::fpscw7, 139)(ppc64::msr, 140)(ppc64::ivpr, 141)(ppc64::ivor8, 142)(
            ppc64::seg0, 143)(ppc64::seg1, 144)(ppc64::seg2, 145)(ppc64::seg3, 146)(
            ppc64::seg4, 147)(ppc64::seg5, 148)(ppc64::seg6, 149)(ppc64::seg7, 150)(
            ppc64::cr0, 151)(ppc64::cr1, 152)(ppc64::cr2, 153)(ppc64::cr3, 154)(
            ppc64::cr4, 155)(ppc64::cr5, 156)(ppc64::cr6, 157)(ppc64::cr7, 158)(
            ppc64::cr, 159)(ppc64::sprg4, 160)(ppc64::sprg4_ro, 160)(ppc64::sprg5, 161)(
...
machRegIndex_aarch64()
{
    ...
    if(mrmap == NULL)
    {
        mrmap = new RegisterMap();
        *mrmap =
            map_list_of(aarch64::x0, 0)(aarch64::x1, 1)(aarch64::x2, 2)(aarch64::x3, 3)(
                aarch64::x4, 4)(aarch64::x5, 5)(aarch64::x6, 6)(aarch64::x7, 7)(
                aarch64::x8, 8)(aarch64::x9, 9)(aarch64::x10, 10)(aarch64::x11, 11)(
                aarch64::x12, 12)(aarch64::x13, 13)(aarch64::x14, 14)(aarch64::x15, 15)(
                aarch64::x16, 16)(aarch64::x17, 17)(aarch64::x18, 18)(aarch64::x19, 19)(
                aarch64::x20, 20)(aarch64::x21, 21)(aarch64::x22, 22)(aarch64::x23, 23)(
                aarch64::x24, 24)(aarch64::x25, 25)(aarch64::x26, 26)(aarch64::x27, 27)(
                aarch64::x28, 28)(aarch64::x29, 29)(aarch64::x30, 30)(aarch64::w0, 0)(
                aarch64::w1, 1)(aarch64::w2, 2)(aarch64::w3, 3)(aarch64::w4, 4)(
                aarch64::w5, 5)(aarch64::w6, 6)(aarch64::w7, 7)(aarch64::w8, 8)(
                aarch64::w9, 9)(aarch64::w10, 10)(aarch64::w11, 11)(aarch64::w12, 12)(
                aarch64::w13, 13)(aarch64::w14, 14)(aarch64::w15, 15)(aarch64::w16, 16)(
                aarch64::w17, 17)(aarch64::w18, 18)(aarch64::w19, 19)(aarch64::w20, 20)(
                aarch64::w21, 21)(aarch64::w22, 22)(aarch64::w23, 23)(aarch64::w24, 24)(
                aarch64::w25, 25)(aarch64::w26, 26)(aarch64::w27, 27)(aarch64::w28, 28)(
                aarch64::w29, 29)(aarch64::w30, 30)(aarch64::q0, 31)(aarch64::q1, 32)(
                aarch64::q2, 33)(aarch64::q3, 34)(aarch64::q4, 35)(aarch64::q5, 36)(
                aarch64::q6, 37)(aarch64::q7, 38)(aarch64::q8, 39)(aarch64::q9, 40)(
                aarch64::q10, 41)(aarch64::q11, 42)(aarch64::q12, 43)(aarch64::q13, 44)(
                aarch64::q14, 45)(aarch64::q15, 46)(aarch64::q16, 47)(aarch64::q17, 48)(
                aarch64::q18, 49)(aarch64::q19, 50)(aarch64::q20, 51)(aarch64::q21, 52)(
                aarch64::q22, 53)(aarch64::q23, 54)(aarch64::q24, 55)(aarch64::q25, 56)(
                aarch64::q26, 57)(aarch64::q27, 58)(aarch64::q28, 59)(aarch64::q29, 60)(
                aarch64::q30, 61)(aarch64::q31, 62)(aarch64::fpcr, 63)(aarch64::fpsr, 64)(
                aarch64::pc, 65)(aarch64::sp, 66)(aarch64::pstate, 67)(aarch64::xzr, 68);
    }
