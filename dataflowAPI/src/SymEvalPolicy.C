...
SymEvalPolicy::SymEvalPolicy(Result_t& r, Address a, Dyninst::Architecture ac,
                             Instruction insn)
: res(r)
, arch(ac)
, addr(a)
...
, insn_(insn)
{
    ...
    for(Result_t::iterator iter = r.begin(); iter != r.end(); ++iter)
    {
...
void
SymEvalPolicy::startInstruction(SgAsmx86Instruction*)
{}

void
SymEvalPolicy::finishInstruction(SgAsmx86Instruction*)
{}
void
SymEvalPolicy::startInstruction(SgAsmPowerpcInstruction*)
{}

void
SymEvalPolicy::finishInstruction(SgAsmPowerpcInstruction*)
{}

Absloc
SymEvalPolicy::convert(PowerpcRegisterClass regtype, int regNum)
{
    switch(regtype)
    {
...
Absloc
SymEvalPolicy::convert(X86Flag f)
{
    switch(f)
    {
        case x86_flag_cf:
...
SymEvalPolicy_64::SymEvalPolicy_64(Result_t& r, Address a, Dyninst::Architecture ac,
                                   Instruction insn)
: res(r)
, arch(ac)
, addr(a)
...
void
SymEvalPolicy_64::undefinedInstruction(SgAsmx86Instruction*)
{
    undefinedInstructionCommon();
}

void
SymEvalPolicy_64::undefinedInstruction(SgAsmPowerpcInstruction*)
{
    // Log insn details here
...
void
SymEvalPolicy_64::undefinedInstructionCommon()
{
    for(std::map<Absloc, Assignment::Ptr>::iterator iter = aaMap.begin();
        iter != aaMap.end(); ++iter)
    {
...
void
SymEvalPolicy_64::startInstruction(SgAsmx86Instruction*)
{}

void
SymEvalPolicy_64::finishInstruction(SgAsmx86Instruction*)
{}
void
SymEvalPolicy_64::startInstruction(SgAsmPowerpcInstruction*)
{}

void
SymEvalPolicy_64::finishInstruction(SgAsmPowerpcInstruction*)
{}

Absloc
SymEvalPolicy_64::convert(PowerpcRegisterClass regtype, int regNum)
{
    // Fix this function when adding support for ppc64
    switch(regtype)
    {
            // PPC register classes (gpr/spr/whatever) are identical 32/64, and must
            // maintain this
...
Absloc
SymEvalPolicy_64::convert(X86GeneralPurposeRegister r)
{
    MachRegister mreg;
    switch(r)
    {
...
Absloc
SymEvalPolicy_64::convert(X86SegmentRegister r)
{
    MachRegister mreg;
    switch(r)
    {
...
std::ostream&
operator<<(std::ostream& os, const ROSEOperation& o)
{
    os << o.format();
    return os;
}
...
std::ostream&
operator<<(std::ostream& os, const Constant& o)
{
    os << o.format();
    return os;
}
