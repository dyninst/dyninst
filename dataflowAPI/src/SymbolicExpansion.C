...
bool
SymbolicExpansion::expandX86(SgAsmInstruction* rose_insn, SymEvalPolicy& policy)
{
...
bool
SymbolicExpansion::expandX86_64(SgAsmInstruction* rose_insn, SymEvalPolicy_64& policy)
{
    try
    {
        SgAsmx86Instruction* insn = static_cast<SgAsmx86Instruction*>(rose_insn);
                               ...
                               const std::string&              insn_dump)
{
    ...
    {
        //         fprintf(stderr, "Instruction processing threw exception for
        //         instruction: %s\n", insn_dump.c_str());
        //	 std::cerr << e << std::endl;
    }
