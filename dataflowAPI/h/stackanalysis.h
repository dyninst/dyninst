...
class StackAnalysis {
 public:
  ...
  class DATAFLOW_EXPORT Height {
   public:
    ...
    bool operator<(const Height &rhs) const { return (height_ < rhs.height_); }
 ...
 private:
  ...
  bool handleNormalCall(InstructionPtr insn, ParseAPI::Block *block, Offset off,
                        TransferFuncs &xferFuncs, TransferSet &funcSummary);
  bool handleThunkCall(InstructionPtr insn, TransferFuncs &xferFuncs);
  bool handleJump(InstructionPtr insn, ParseAPI::Block *block, Offset off,
                  TransferFuncs &xferFuncs, TransferSet &funcSummary);
  ...
  void handleMov(InstructionPtr insn, ParseAPI::Block *block, const Offset off,
                 TransferFuncs &xferFuncs);
