...
A \code{Variable} represents an abstract region at a particular
address.
...
A \code{Constant} object represents a constant value in code.
...
\subsection{Class ROSEOperation}
