...
\begin{apient}
void entryNodes(NodeIterator& begin, NodeIterator& end);
\end{apient}
\apidesc{The entry nodes (nodes without any incoming edges) of the graph.}

\begin{apient}
void exitNodes(NodeIterator& begin, NodeIterator& end);
\end{apient}
\apidesc{The exit nodes (nodes without any outgoing edges) of the graph.}

\begin{apient}
void allNodes(NodeIterator& begin, NodeIterator& end);
\end{apient}
...
void insertExitNode(NodePtr exit);
\end{apient}
\apidesc{Insert a node as an entry/exit node}

\begin{apient}
void markAsEntryNode(NodePtr entry);
void markAsExitNode(NodePtr exit);
\end{apient}
