...
\begin{apient}
bool widenAtPoint(AssignmentPtr) { return false; };
\end{apient}
\apidesc{The default behavior is to return \code{false}.}

\begin{apient}
bool endAtPoint(AssignmentPtr);
\end{apient}
...
bool followCall(ParseAPI::Function * callee,
                        CallStack_t & cs,
                        AbsRegion argument);
\end{apient}
...
\begin{apient}
bool addNodeCallback(AssignmentPtr assign,
