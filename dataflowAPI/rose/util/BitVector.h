...
public:
    ...
    dyncompat::uint64_t toInteger(const BitRange &range) const {
        checkRange(range);
    ...
    dyncompat::uint64_t toInteger() const {
        if (size() <= 64)
    ...
    BitVector& fromInteger(const BitRange &range, dyncompat::uint64_t value) {
        checkRange(range);
    ...
    BitVector& fromInteger(dyncompat::uint64_t value) {
