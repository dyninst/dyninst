...
// This file is the counterpart of <Sawyer/WarningsOff.h> and restores warnings
// to their state before WarningsOff was
// included. The WarningsRestore should be included once per WarningsOff -- they
