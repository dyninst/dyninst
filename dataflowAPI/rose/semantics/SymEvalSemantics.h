    ...
    namespace BinaryAnalysis {
        namespace InstructionSemantics2 {
            namespace SymEvalSemantics {
                ...
                typedef boost::shared_ptr<class RegisterStateAST_amdgpu_gfx950> RegisterStateAST_amdgpu_gfx950_Ptr;
		...
		private:
		    virtual Dyninst::Absloc convert(const RegisterDescriptor &reg);
                ...
                class RegisterStateAST_amdgpu_gfx908 : public RegisterStateAST {
                 ...
                 class RegisterStateAST_amdgpu_gfx950 : public RegisterStateAST {
                    public:
                        RegisterStateAST_amdgpu_gfx950(const BaseSemantics::SValuePtr &protoval,
                                const RegisterDictionary *regdict_) : RegisterStateAST(protoval, regdict_) { }

                        static RegisterStateAST_amdgpu_gfx950_Ptr instance(const BaseSemantics::SValuePtr &protoval,
                                const RegisterDictionary *regdict) {
                            return RegisterStateAST_amdgpu_gfx950_Ptr(new RegisterStateAST_amdgpu_gfx950(protoval, regdict));
                        }

                        static RegisterStateAST_amdgpu_gfx950_Ptr promote(const BaseSemantics::RegisterStatePtr &from) {
                            RegisterStateAST_amdgpu_gfx950_Ptr retval = boost::dynamic_pointer_cast<RegisterStateAST_amdgpu_gfx950>(from);
                            ASSERT_not_null(retval);
                            return retval;
                        }
