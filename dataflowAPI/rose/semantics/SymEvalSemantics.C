...
SymEvalSemantics::StateAST::readRegister(const RegisterDescriptor& desc,
                                         const BaseSemantics::SValuePtr& /*dflt*/,
                                         BaseSemantics::RiscOperators* /*ops*/)
{
    ASSERT_require(desc.is_valid());
    SymEvalSemantics::RegisterStateASTPtr registers =
        SymEvalSemantics::RegisterStateAST::promote(registerState());
    return registers->readRegister(desc, addr);
}

void
SymEvalSemantics::StateAST::writeRegister(const RegisterDescriptor&       reg,
...
BaseSemantics::SValuePtr
SymEvalSemantics::StateAST::readMemory(const BaseSemantics::SValuePtr& address,
                                       const BaseSemantics::SValuePtr& /*dflt*/,
                                       ...
                                       size_t readSize)
{
    ...
    SymEvalSemantics::MemoryStateASTPtr memory =
        SymEvalSemantics::MemoryStateAST::promote(memoryState());
    return memory->readMemory(address, readSize);
}

void
SymEvalSemantics::StateAST::writeMemory(const BaseSemantics::SValuePtr& addr,
                                        const BaseSemantics::SValuePtr& value,
                                        BaseSemantics::RiscOperators* /*addrOps*/,
                                        BaseSemantics::RiscOperators* /*valOps*/,
                                        size_t writeSize)
...
BaseSemantics::SValuePtr
SymEvalSemantics::RegisterStateAST::readRegister(const RegisterDescriptor& reg,
                                                 ...
                                                 BaseSemantics::RiscOperators* /*ops*/)
{
    ASSERT_always_forbid(
        "overridden RegisterState::readRegister() should never be called for AST, always "
        "use the non-virtual readRegister that takes Dyninst::Address as an argument.");
}

void
SymEvalSemantics::RegisterStateAST::writeRegister(
...
SymEvalSemantics::RegisterStateAST::writeRegister(
    ...
    BaseSemantics::RiscOperators* /*ops*/)
{
    ASSERT_always_forbid("overridden RegisterState::writeRegister() should never be "
                         "called for AST, always use the non-virtual writeRegister that "
                         "also takes additional parameters.");
}

Dyninst::Absloc
SymEvalSemantics::RegisterStateAST::convert(const RegisterDescriptor& reg)
{
    ASSERT_always_forbid("converting ROSE register to Dyninst register is platform "
...
SymEvalSemantics::RegisterStateASTARM64::convert(const RegisterDescriptor& reg)
{
    ...
    switch(major)
    {
        case armv8_regclass_gpr: {
            ...
            {
                mreg = Dyninst::MachRegister((size == 32) ? Dyninst::aarch64::wzr
                                                          : Dyninst::aarch64::xzr);
            }
            else
            {
                Dyninst::MachRegister base =
                    (size == 32) ? Dyninst::aarch64::w0 : Dyninst::aarch64::x0;
        ...
        case armv8_regclass_simd_fpr: {
            ...
            {
                case 8:
                    base = Dyninst::aarch64::b0;
                    break;
                case 16:
                    base = Dyninst::aarch64::h0;
                    break;
                case 32:
                    base = Dyninst::aarch64::s0;
                    break;
                case 64:
        ...
        case armv8_regclass_sp:
            mreg = Dyninst::MachRegister((size == 32) ? Dyninst::aarch64::wsp
                                                      : Dyninst::aarch64::sp);
            break;
        case armv8_regclass_pstate: {
            ...
            switch(offset)
            {
                ...
                default:
                    ASSERT_always_forbid(
                        "No part of the PSTATE register other than NZCV should be used.");
                    break;
            }
        }
        break;
...
Dyninst::Absloc
SymEvalSemantics::RegisterStateASTPPC32::convert(const RegisterDescriptor& reg)
{
    Dyninst::MachRegister mreg;
    ...
    switch(major)
    {
        case powerpc_regclass_gpr: {
            ...
            // For some reason, ROSE does not provide a enum representation for power
            // registers
            mreg = Dyninst::MachRegister(base.val() + minor);
        }
        break;
...
Dyninst::Absloc
SymEvalSemantics::RegisterStateASTPPC64::convert(const RegisterDescriptor& reg)
{
    Dyninst::MachRegister mreg;
...
BaseSemantics::SValuePtr
SymEvalSemantics::MemoryStateAST::readMemory(const BaseSemantics::SValuePtr& address,
                                             size_t                          readSize)
{
    SymEvalSemantics::SValuePtr addr = SymEvalSemantics::SValue::promote(address);
    return SymEvalSemantics::SValue::instance(Dyninst::DataflowAPI::RoseAST::create(
        Dyninst::DataflowAPI::ROSEOperation(Dyninst::DataflowAPI::ROSEOperation::derefOp,
                                            readSize),
        addr->get_expression(),
...
void
SymEvalSemantics::MemoryStateAST::writeMemory(
    const BaseSemantics::SValuePtr& address, const BaseSemantics::SValuePtr& value,
    Dyninst::DataflowAPI::Result_t&                      res,
    std::map<Dyninst::Absloc, Dyninst::Assignment::Ptr>& aaMap, size_t writeSize)
{
    std::map<Dyninst::Absloc, Dyninst::Assignment::Ptr>::iterator i =
...
void
SymEvalSemantics::MemoryStateAST::writeMemory(const BaseSemantics::SValuePtr& addr,
                                              const BaseSemantics::SValuePtr& value,
                                              BaseSemantics::RiscOperators* /*addrOps*/,
                                              BaseSemantics::RiscOperators* /*valOps*/)
{
    ASSERT_always_forbid(
        "overridden MemoryState::writeMemory() should never be called for AST, always "
        "use the non-virtual writeMemory that also takes additional parameters.");
}
...
BaseSemantics::SValuePtr
SymEvalSemantics::RiscOperatorsAST::and_(const BaseSemantics::SValuePtr& a_,
...
BaseSemantics::SValuePtr
SymEvalSemantics::RiscOperatorsAST::or_(const BaseSemantics::SValuePtr& a_,
                                        const BaseSemantics::SValuePtr& b_)
{
...
BaseSemantics::SValuePtr
SymEvalSemantics::RiscOperatorsAST::xor_(const BaseSemantics::SValuePtr& a_,
                                         const BaseSemantics::SValuePtr& b_)
{
...
BaseSemantics::SValuePtr
SymEvalSemantics::RiscOperatorsAST::invert(const BaseSemantics::SValuePtr& a_)
{
    return createUnaryAST(Dyninst::DataflowAPI::ROSEOperation::invertOp, a_);
}

BaseSemantics::SValuePtr
SymEvalSemantics::RiscOperatorsAST::extract(const BaseSemantics::SValuePtr& a_,
                                            uint64_t begin, uint64_t end)
{
    ...
    return createTernaryAST(Dyninst::DataflowAPI::ROSEOperation::extractOp, a_, begin_,
                            end_, end - begin);
}

BaseSemantics::SValuePtr
SymEvalSemantics::RiscOperatorsAST::ite(const BaseSemantics::SValuePtr& sel_,
...
BaseSemantics::SValuePtr
SymEvalSemantics::RiscOperatorsAST::concat(const BaseSemantics::SValuePtr& a_,
                                           const BaseSemantics::SValuePtr& b_)
{
...
BaseSemantics::SValuePtr
SymEvalSemantics::RiscOperatorsAST::leastSignificantSetBit(
    const BaseSemantics::SValuePtr& a_)
{
...
BaseSemantics::SValuePtr
SymEvalSemantics::RiscOperatorsAST::mostSignificantSetBit(
    const BaseSemantics::SValuePtr& a_)
{
...
BaseSemantics::SValuePtr
SymEvalSemantics::RiscOperatorsAST::rotateLeft(const BaseSemantics::SValuePtr& a_,
                                               const BaseSemantics::SValuePtr& b_)
{
...
BaseSemantics::SValuePtr
SymEvalSemantics::RiscOperatorsAST::rotateRight(const BaseSemantics::SValuePtr& a_,
                                                const BaseSemantics::SValuePtr& b_)
{
...
BaseSemantics::SValuePtr
SymEvalSemantics::RiscOperatorsAST::shiftLeft(const BaseSemantics::SValuePtr& a_,
                                              const BaseSemantics::SValuePtr& b_)
{
...
BaseSemantics::SValuePtr
SymEvalSemantics::RiscOperatorsAST::shiftRight(const BaseSemantics::SValuePtr& a_,
                                               const BaseSemantics::SValuePtr& b_)
{
...
BaseSemantics::SValuePtr
SymEvalSemantics::RiscOperatorsAST::shiftRightArithmetic(
...
BaseSemantics::SValuePtr
SymEvalSemantics::RiscOperatorsAST::equalToZero(const BaseSemantics::SValuePtr& a_)
{
    return createUnaryAST(Dyninst::DataflowAPI::ROSEOperation::equalToZeroOp, a_);
}

BaseSemantics::SValuePtr
SymEvalSemantics::RiscOperatorsAST::signExtend(const BaseSemantics::SValuePtr& a_,
                                               uint64_t                        newwidth)
{
...
BaseSemantics::SValuePtr
SymEvalSemantics::RiscOperatorsAST::add(const BaseSemantics::SValuePtr& a_,
                                        const BaseSemantics::SValuePtr& b_)
{
...
BaseSemantics::SValuePtr
SymEvalSemantics::RiscOperatorsAST::addWithCarries(const BaseSemantics::SValuePtr& a_,
                                                   const BaseSemantics::SValuePtr& b_,
...
BaseSemantics::SValuePtr
SymEvalSemantics::RiscOperatorsAST::negate(const BaseSemantics::SValuePtr& a_)
{
    return createUnaryAST(Dyninst::DataflowAPI::ROSEOperation::negateOp, a_);
}

BaseSemantics::SValuePtr
SymEvalSemantics::RiscOperatorsAST::signedDivide(const BaseSemantics::SValuePtr& a_,
                                                 const BaseSemantics::SValuePtr& b_)
{
...
BaseSemantics::SValuePtr
SymEvalSemantics::RiscOperatorsAST::signedModulo(const BaseSemantics::SValuePtr& a_,
                                                 const BaseSemantics::SValuePtr& b_)
{
...
BaseSemantics::SValuePtr
SymEvalSemantics::RiscOperatorsAST::signedMultiply(const BaseSemantics::SValuePtr& a_,
                                                   const BaseSemantics::SValuePtr& b_)
{
...
BaseSemantics::SValuePtr
SymEvalSemantics::RiscOperatorsAST::unsignedDivide(const BaseSemantics::SValuePtr& a_,
                                                   const BaseSemantics::SValuePtr& b_)
{
...
BaseSemantics::SValuePtr
SymEvalSemantics::RiscOperatorsAST::unsignedModulo(const BaseSemantics::SValuePtr& a_,
                                                   const BaseSemantics::SValuePtr& b_)
{
...
BaseSemantics::SValuePtr
SymEvalSemantics::RiscOperatorsAST::unsignedMultiply(const BaseSemantics::SValuePtr& a_,
                                                     const BaseSemantics::SValuePtr& b_)
{
...
BaseSemantics::SValuePtr
SymEvalSemantics::RiscOperatorsAST::readMemory(const RegisterDescriptor& /*segreg*/,
...
void
SymEvalSemantics::RiscOperatorsAST::writeMemory(const RegisterDescriptor& /*segreg*/,
                                                const BaseSemantics::SValuePtr& addr,
