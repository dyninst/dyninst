...
/** Shared-ownership pointer to an RISC-V instruction dispatcher. See @ref heap_object_shared_ownership. */
            ...
            protected:
                ...
                DispatcherRiscv64()
                        : BaseSemantics::Dispatcher(64, RegisterDictionary::dictionary_riscv64()) { }

                // Prototypical constructor
                DispatcherRiscv64(size_t addrWidth, const RegisterDictionary *regs/*=NULL*/)
                        : BaseSemantics::Dispatcher(addrWidth, regs ? regs : RegisterDictionary::dictionary_riscv64()) { }

                // Normal constructor
                DispatcherRiscv64(const BaseSemantics::RiscOperatorsPtr &ops, size_t addrWidth,
            ...
            public:
                ...
                static DispatcherRiscv64Ptr instance(size_t addrWidth, const RegisterDictionary *regs = NULL) {
                    return DispatcherRiscv64Ptr(new DispatcherRiscv64(addrWidth, regs));
                }

                /** Constructor. */
                static DispatcherRiscv64Ptr instance(const BaseSemantics::RiscOperatorsPtr &ops, size_t addrWidth,
			...
			//TODO
                ...
                static DispatcherRiscv64Ptr promote(const BaseSemantics::DispatcherPtr &d) {
                    DispatcherRiscv64Ptr retval = boost::dynamic_pointer_cast<DispatcherRiscv64>(d);
                    assert(retval != NULL);
                    return retval;
                }
