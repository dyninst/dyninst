...
class SgAsmOperandList : public SgAsmNode {
 ...
 public:
  ...
  // copy function required
  // and not required which is required to match the other aspects of the copy
  // mechanism code generation.
  // Specifically it is a problem to declare the copy function everywhere
  // because it is not implemented
  // for the SgSymbol IR nodes. I'm not clear why it is not implemented for
  // these IR nodes.
