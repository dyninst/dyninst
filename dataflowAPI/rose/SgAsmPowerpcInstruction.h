...
class SgAsmPowerpcInstruction : public SgAsmInstruction {
 public:
   ...
   */
  friend const SgAsmPowerpcInstruction* isSgAsmPowerpcInstruction(
      const SgNode* s);
 ...
 public:
  SgAsmPowerpcInstruction(
      rose_addr_t address = 0, std::string mnemonic = "",
      PowerpcInstructionKind kind = powerpc_unknown_instruction);
