...
.stabs "",36,0,0,.Lscope0-call35_2
	.align 4
.stabs "call35_1:F(0,1)",36,0,10,call35_1
.globl call35_1
	.type	 call35_1,@function
call35_1:
.stabn 68,0,10,.LM3-call35_1
.LM3:
	pushl %ebp
	movl %esp,%ebp
.ForceRelocation:
...
.LBB2:
	movl $1,-4(%ebp)
.stabn 68,0,12,.LM5-call35_1
.LM5:
	movl $1,-8(%ebp)
.stabn 68,0,13,.LM6-call35_1
.LM6:
	movl $0,-12(%ebp)
.stabn 68,0,14,.LM7-call35_1
.LM7:
	movl $2,-16(%ebp)
.stabn 68,0,16,.LM8-call35_1
.LM8:
	call call35_2
.stabn 68,0,18,.LM9-call35_1
.LM9:
	movl -4(%ebp),%eax
	imull -8(%ebp),%eax
	movl %eax,-12(%ebp)
.stabn 68,0,20,.LM10-call35_1
.LM10:
	call call35_2
.stabn 68,0,22,.LM11-call35_1
.LM11:
	call call35_2
.stabn 68,0,24,.LM12-call35_1
.LM12:
	movl -16(%ebp),%edx
	movl %edx,%eax
	jmp .L3
...
.stabn 68,0,25,.LM13-call35_1
.LM13:
.LBE2:
.stabn 68,0,25,.LM14-call35_1
.LM14:
	.align 4
.L3:
	leave
