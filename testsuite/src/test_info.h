...
test_data_t tests[] = {
   test_data_t("test1_1", "./test1_1.so", test1_mutatee, all_platforms, STOPPED, 1, 1, CREATE, ENABLED),
   test_data_t("test1_2", "./test1_2.so", test1_mutatee, all_platforms, STOPPED, 1, 2, CREATE, ENABLED),
   test_data_t("test1_3", "./test1_3.so", test1_mutatee, all_platforms, STOPPED, 1, 3, CREATE, ENABLED),
   test_data_t("test1_4", "./test1_4.so", test1_mutatee, all_platforms, STOPPED, 1, 4, CREATE, ENABLED),
   test_data_t("test1_5", "./test1_5.so", test1_mutatee, all_platforms, STOPPED, 1, 5, CREATE, ENABLED),
   test_data_t("test1_6", "./test1_6.so", test1_mutatee, all_platforms, STOPPED, 1, 6, CREATE, ENABLED),
   test_data_t("test1_7", "./test1_7.so", test1_mutatee, all_platforms, STOPPED, 1, 7, CREATE, ENABLED),
   test_data_t("test1_8", "./test1_8.so", test1_mutatee, all_platforms, STOPPED, 1, 8, CREATE, ENABLED),
   test_data_t("test1_9", "./test1_9.so", test1_mutatee, all_platforms, STOPPED, 1, 9, CREATE, ENABLED),
   test_data_t("test1_10", "./test1_10.so", test1_mutatee, all_platforms, STOPPED, 1, 10, CREATE, ENABLED),
   test_data_t("test1_11", "./test1_11.so", test1_mutatee, all_platforms, STOPPED, 1, 11, CREATE, ENABLED),
   test_data_t("test1_12", "./test1_12.so", test1_mutatee, all_platforms, STOPPED, 1, 12, CREATE, ENABLED),
   test_data_t("test1_13", "./test1_13.so", test1_mutatee, all_platforms, STOPPED, 1, 13, CREATE, ENABLED),
   test_data_t("test1_14", "./test1_14.so", test1_mutatee, all_platforms, STOPPED, 1, 14, CREATE, ENABLED),
   test_data_t("test1_15", "./test1_15.so", test1_mutatee, all_platforms, STOPPED, 1, 15, CREATE, ENABLED),
   test_data_t("test1_16", "./test1_16.so", test1_mutatee, all_platforms, STOPPED, 1, 16, CREATE, ENABLED),
   test_data_t("test1_17", "./test1_17.so", test1_mutatee, all_platforms, STOPPED, 1, 17, CREATE, ENABLED),
   test_data_t("test1_18", "./test1_18.so", test1_mutatee, all_platforms, STOPPED, 1, 18, CREATE, ENABLED),
   test_data_t("test1_19", "./test1_19.so", test1_mutatee, all_platforms, RUNNING, 1, 19, CREATE, ENABLED),
   test_data_t("test1_20", "./test1_20.so", test1_mutatee, all_platforms, STOPPED, 1, 20, CREATE, ENABLED),
   test_data_t("test1_21", "./test1_21.so", test1_mutatee, all_platforms, STOPPED, 1, 21, CREATE, ENABLED),
   test_data_t("test1_22", "./test1_22.so", test1_mutatee, all_platforms, STOPPED, 1, 22, CREATE, ENABLED),
   test_data_t("test1_23", "./test1_23.so", test1_mutatee, all_platforms, STOPPED, 1, 23, CREATE, ENABLED),
   test_data_t("test1_24", "./test1_24.so", test1_mutatee, all_platforms, STOPPED, 1, 24, CREATE, ENABLED),
   test_data_t("test1_25", "./test1_25.so", test1_mutatee, all_platforms, STOPPED, 1, 25, CREATE, ENABLED),
   test_data_t("test1_26", "./test1_26.so", test1_mutatee, all_platforms, STOPPED, 1, 26, CREATE, ENABLED),
   test_data_t("test1_27", "./test1_27.so", test1_mutatee, all_platforms, STOPPED, 1, 27, CREATE, ENABLED),
   test_data_t("test1_28", "./test1_28.so", test1_mutatee, all_platforms, STOPPED, 1, 28, CREATE, ENABLED),
   test_data_t("test1_29", "./test1_29.so", test1_mutatee, all_platforms, STOPPED, 1, 29, CREATE, ENABLED),
   test_data_t("test1_30", "./test1_30.so", test1_mutatee, all_platforms, STOPPED, 1, 30, CREATE, ENABLED),
   test_data_t("test1_31", "./test1_31.so", test1_mutatee, all_platforms, STOPPED, 1, 31, CREATE, ENABLED),
   test_data_t("test1_32", "./test1_32.so", test1_mutatee, all_platforms, STOPPED, 1, 32, CREATE, ENABLED),
   test_data_t("test1_33", "./test1_33.so", test1_mutatee, all_platforms, STOPPED, 1, 33, CREATE, ENABLED),
   test_data_t("test1_34", "./test1_34.so", test1_mutatee, all_platforms, STOPPED, 1, 34, CREATE, ENABLED),
   test_data_t("test1_35", "./test1_35.so", test1_mutatee, all_platforms, STOPPED, 1, 35, CREATE, ENABLED),
   test_data_t("test1_36", "./test1_36.so", test1_mutatee, all_platforms, STOPPED, 1, 36, CREATE, ENABLED),
   test_data_t("test1_37", "./test1_37.so", test1_mutatee, all_platforms, STOPPED, 1, 37, CREATE, ENABLED),
   test_data_t("test1_38", "./test1_38.so", test1_mutatee, all_platforms, STOPPED, 1, 38, CREATE, ENABLED),
   test_data_t("test1_39", "./test1_39.so", test1_mutatee, all_platforms, STOPPED, 1, 39, CREATE, ENABLED),
   test_data_t("test1_40", "./test1_40.so", test1_mutatee, all_platforms, STOPPED, 1, 40, CREATE, ENABLED),
   ...
   test_data_t("test2_5", "./test2_5.so", test2_mutatee, all_platforms, STOPPED, 2, 5, CREATE, ENABLED),
   test_data_t("test2_6", "./test2_6.so", test2_mutatee, all_platforms, STOPPED, 2, 6, CREATE, ENABLED),
   test_data_t("test2_7", "./test2_7.so", test2_mutatee, all_platforms, STOPPED, 2, 7, CREATE, ENABLED),
   test_data_t("test2_8", "./test2_8.so", test2_mutatee, all_platforms, STOPPED, 2, 8, CREATE, ENABLED),
   test_data_t("test2_9", "./test2_9.so", test2_mutatee, all_platforms, STOPPED, 2, 9, CREATE, ENABLED),
   test_data_t("test2_10", "./test2_10.so", test2_mutatee, all_platforms, STOPPED, 2, 10, CREATE, ENABLED),
   test_data_t("test2_11", "./test2_11.so", test2_mutatee, all_platforms, STOPPED, 2, 11, CREATE, ENABLED),
   test_data_t("test2_12", "./test2_12.so", test2_mutatee, all_platforms, STOPPED, 2, 12, CREATE, ENABLED),
   test_data_t("test2_13", "./test2_13.so", test2_mutatee, all_platforms, STOPPED, 2, 13, CREATE, ENABLED),
   test_data_t("test2_14", "./test2_14.so", test2_mutatee, all_platforms, STOPPED, 2, 14, CREATE, ENABLED),
