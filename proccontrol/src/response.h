...
class response : public dyncompat::enable_shared_from_this<response> {
   friend void dyncompat::checked_delete<response>(response *) CHECKED_DELETE_NOEXCEPT;
   friend void dyncompat::checked_delete<const response>(const response *) CHECKED_DELETE_NOEXCEPT;
...
class result_response : public response
{
   ...
   friend void dyncompat::checked_delete<result_response>(result_response *) CHECKED_DELETE_NOEXCEPT;
   friend void dyncompat::checked_delete<const result_response>(const result_response *) CHECKED_DELETE_NOEXCEPT;
  private:
   bool b;
   result_response();
...
{
   friend class linux_thread;
   friend void dyncompat::checked_delete<reg_response>(reg_response *) CHECKED_DELETE_NOEXCEPT;
   friend void dyncompat::checked_delete<const reg_response>(const reg_response *) CHECKED_DELETE_NOEXCEPT;
  private:
...
{
   friend void dyncompat::checked_delete<allreg_response>(allreg_response *) CHECKED_DELETE_NOEXCEPT;
   friend void dyncompat::checked_delete<const allreg_response>(const allreg_response *) CHECKED_DELETE_NOEXCEPT;
  private:
...
{
   friend void dyncompat::checked_delete<mem_response>(mem_response *) CHECKED_DELETE_NOEXCEPT;
   friend void dyncompat::checked_delete<const mem_response>(const mem_response *) CHECKED_DELETE_NOEXCEPT;
  private:
   char *buffer;
   unsigned size;
   bool buffer_set;
...
{
   friend void dyncompat::checked_delete<stack_response>(stack_response *) CHECKED_DELETE_NOEXCEPT;
   friend void dyncompat::checked_delete<const stack_response>(const stack_response *) CHECKED_DELETE_NOEXCEPT;
  private:
   void *data;
   int_thread *thr;
...
{
   friend void dyncompat::checked_delete<data_response>(data_response *) CHECKED_DELETE_NOEXCEPT;
   friend void dyncompat::checked_delete<const data_response>(const data_response *) CHECKED_DELETE_NOEXCEPT;
  private:
   void *data;
   data_response();
  public:
