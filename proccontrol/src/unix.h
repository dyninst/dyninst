...
public:
    ...
    virtual bool plat_decodeMemoryRights(Process::mem_perm& perm, unsigned long rights);
    virtual bool plat_encodeMemoryRights(Process::mem_perm perm, unsigned long& rights);
