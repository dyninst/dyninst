...
void
LibraryTracking::setDefaultTrackLibraries(bool b)
{
...
bool
LibraryTracking::getDefaultTrackLibraries()
{
    MTLock lock_this_func(MTLock::allow_init);
...
void
ThreadTracking::setDefaultTrackThreads(bool b)
{
    MTLock lock_this_func(MTLock::allow_init);
...
bool
ThreadTracking::getDefaultTrackThreads()
{
    MTLock lock_this_func(MTLock::allow_init);
...
void
LWPTracking::setDefaultTrackLWPs(bool b)
{
    MTLock lock_this_func(MTLock::allow_init);
...
bool
LWPTracking::getDefaultTrackLWPs()
{
    MTLock lock_this_func(MTLock::allow_init);
...
void
FollowFork::setDefaultFollowFork(FollowFork::follow_t f)
{
    MTLock lock_this_func(MTLock::allow_init);
...
FollowFork::follow_t
FollowFork::getDefaultFollowFork()
{
    MTLock lock_this_func(MTLock::allow_init);
...
bool
FollowFork::setFollowFork(FollowFork::follow_t f) const
{
    MTLock       lock_this_func;
    Process::ptr p = proc.lock();
...
void
MultiToolControl::setDefaultToolName(string name)
{
    MTLock lock_this_func(MTLock::allow_init);
...
void
MultiToolControl::setDefaultToolPriority(MultiToolControl::priority_t p)
{
    MTLock lock_this_func(MTLock::allow_init);
...
string
MultiToolControl::getDefaultToolName()
{
    MTLock lock_this_func(MTLock::allow_init);
    return default_tool_name;
}

MultiToolControl::priority_t
MultiToolControl::getDefaultToolPriority()
{
    MTLock lock_this_func(MTLock::allow_init);
...
bool
MemoryUsage::sharedUsed(unsigned long& used) const
{
    MTLock       lock_this_func;
    Process::ptr p = proc.lock();
...
bool
MemoryUsage::heapUsed(unsigned long& used) const
{
    MTLock       lock_this_func;
    Process::ptr p = proc.lock();
...
bool
MemoryUsage::stackUsed(unsigned long& used) const
{
    MTLock       lock_this_func;
    Process::ptr p = proc.lock();
...
bool
MemoryUsage::resident(unsigned long& resident) const
{
    MTLock       lock_this_func;
    Process::ptr p = proc.lock();
    ...
    MemUsageResp_t st_resp(&st, llproc), he_resp(&he, llproc), sh_resp(&sh, llproc),
        re_resp(&re, llproc);
...
void
SignalMask::setDefaultSigMask(dyn_sigset_t s)
{
    sigset_initialized = true;
    default_sigset     = s;
}
...
FileSet*
RemoteIO::getFileSet(string filename) const
{
    MTLock       lock_this_func;
    Process::ptr p = proc.lock();
...
FileSet*
RemoteIO::getFileSet(const set<string>& filenames) const
{
    MTLock       lock_this_func;
    Process::ptr p = proc.lock();
...
bool
RemoteIO::getFileNames(FileSet* fset) const
{
    MTLock       lock_this_func;
    Process::ptr p = proc.lock();
...
bool
RemoteIO::readFileContents(const FileSet* fset)
{
    MTLock       lock_this_func;
    Process::ptr p = proc.lock();
    PTR_EXIT_TEST(p, "getStatData", false);
...
FileSet*
RemoteIOSet::getFileSet(string filename)
{
...
FileSet*
RemoteIOSet::getFileSet(const set<string>& filenames)
{
    ProcessSet::ptr procs = pset.lock();
    if(!procs || procs->empty())
    {
...
bool
RemoteIOSet::addToFileSet(string filename, FileSet* fs)
{
    ProcessSet::ptr procs = pset.lock();
    if(!procs || procs->empty())
    {
...
bool
int_LWPTracking::lwp_setTracking(bool b)
{
...
bool
int_LWPTracking::plat_lwpChangeTracking(bool)
{
    return true;
}

bool
int_LWPTracking::lwp_getTracking()
{
    return lwp_tracking;
}

bool
int_LWPTracking::lwp_refresh()
{
...
bool
int_LWPTracking::lwp_refreshPost(result_response::ptr& resp)
{
...
bool
int_LWPTracking::lwp_refreshCheck(bool& change)
{
...
bool
int_LWPTracking::plat_lwpRefreshNoteNewThread(int_thread*)
{
    return true;
}
...
bool
int_remoteIO::getFileNames(FileSet* fset)
{
    if(!fset)
    {
...
bool
int_remoteIO::getFileStatData(FileSet& files)
{
...
bool
int_remoteIO::getFileDataAsync(const FileSet& files)
{
