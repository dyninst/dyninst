...
#else
/**
 * Note.  The following contents of this file come from glibc proc_service.h.  They probably
 * should have distributed this file, but didn't.  Since we're all LGPL this is just a little
 * friendly sharing.
 **/
