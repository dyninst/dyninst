...
#else
/**
 * Note.  The following contents of this file come from glibc proc_service.h.
 *They probably
 * should have distributed this file, but didn't.  Since we're all LGPL this is
 *just a little
 * friendly sharing.
 **/
...
extern PC_EXPORT ps_err_e ps_pdread(struct ps_prochandle *, psaddr_t, void *,
                                    size_t);
extern PC_EXPORT ps_err_e ps_pdwrite(struct ps_prochandle *, psaddr_t,
                                     const void *, size_t);
extern PC_EXPORT ps_err_e ps_ptread(struct ps_prochandle *, psaddr_t, void *,
                                    size_t);
extern PC_EXPORT ps_err_e ps_ptwrite(struct ps_prochandle *, psaddr_t,
                                     const void *, size_t);

/* Get and set the given LWP's general or FPU register set.  */
extern PC_EXPORT ps_err_e ps_lgetregs(struct ps_prochandle *, lwpid_t,
                                      prgregset_t);
extern PC_EXPORT ps_err_e ps_lsetregs(struct ps_prochandle *, lwpid_t,
                                      const prgregset_t);
extern PC_EXPORT ps_err_e ps_lgetfpregs(struct ps_prochandle *, lwpid_t,
                                        prfpregset_t *);
extern PC_EXPORT ps_err_e ps_lsetfpregs(struct ps_prochandle *, lwpid_t,
                                        const prfpregset_t *);
