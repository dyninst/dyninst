...
static const unsigned int linux_x86_64_call_mmap_size =
    sizeof(linux_x86_64_call_mmap);
...
static const unsigned int linux_x86_64_call_munmap_size =
    sizeof(linux_x86_64_call_munmap);
...
static const unsigned int linux_x86_call_mmap_size =
    sizeof(linux_x86_call_mmap);
...
static const unsigned int linux_x86_call_munmap_size =
    sizeof(linux_x86_call_munmap);
...
static const unsigned int linux_ppc32_call_mmap_size =
    sizeof(linux_ppc32_call_mmap);
...
static const unsigned int linux_ppc32_call_munmap_size =
    sizeof(linux_ppc32_call_munmap);
...
static const unsigned int linux_ppc64_call_mmap_size =
    sizeof(linux_ppc64_call_mmap);
...
static const unsigned int linux_ppc64_call_munmap_size =
    sizeof(linux_ppc64_call_munmap);
...
static const unsigned int linux_aarch64_mmap_size_position =
    linux_aarch64_mmap_addr_position + 16;
static const unsigned int linux_aarch64_mmap_flags_position =
    linux_aarch64_mmap_size_position + 16;
static const unsigned char linux_aarch64_call_mmap[] = {
    // _NR_mmap 1058
    0xd5, 0x03, 0x20,
    0x1f,  // nop              ;mmap(void *addr, size_t size, int _prot,
...
static const unsigned int linux_aarch64_call_mmap_size =
    sizeof(linux_aarch64_call_mmap);
...
static const unsigned int linux_aarch64_munmap_size_position =
    linux_aarch64_munmap_addr_position + 16;
...
static const unsigned int linux_aarch64_call_munmap_size =
    sizeof(linux_aarch64_call_munmap);
...
static const unsigned char freebsd_x86_64_call_mmap[] = {
    ...
    0x00, 0x00,  // mov    $0x0,%r9 (offset)
    0x49, 0xc7, 0xc0, 0xff, 0xff,
    0xff, 0xff,  // mov    $0xffffffffffffffff,%r8 (fd)
    0x49, 0xc7, 0xc2, 0x12, 0x10,
    0x00, 0x00,  // mov    $0x1012,%r10 (flags)
    0x48, 0xc7, 0xc2, 0x07, 0x00,
    0x00, 0x00,  // mov    $0x7,%rdx (perms)
    0x48, 0xbe, 0x00, 0x00, 0x00,
    0x00, 0x00,        // mov    $0x0000000000000000,%rsi (size)
    0x00, 0x00, 0x00,  //
    0x48, 0xbf, 0x00, 0x00, 0x00,
    0x00, 0x00,                    // mov    $0x0000000000000000,%rdi (addr)
    0x00, 0x00, 0x00,              //
...
static const unsigned int freebsd_x86_64_call_mmap_size =
    sizeof(freebsd_x86_64_call_mmap);
...
static const unsigned int freebsd_x86_64_call_munmap_size =
    sizeof(freebsd_x86_64_call_munmap);
...
static const unsigned int freebsd_x86_call_mmap_size =
    sizeof(freebsd_x86_call_mmap);
...
static const unsigned int freebsd_x86_call_munmap_size =
    sizeof(freebsd_x86_call_munmap);

mmap_alloc_process::mmap_alloc_process(Dyninst::PID p, std::string e,
...
bool mmap_alloc_process::plat_collectAllocationResult(int_thread *thr,
...
bool mmap_alloc_process::plat_createAllocationSnippet(
  ...
  if (getTargetArch() == Arch_x86_64 || getTargetArch() == Arch_x86) {
    ...
    *((unsigned int *)(((char *)buffer) + flags_pos)) = flags;
    ...
    bool use_linux =
        (getOS() == Linux || getOS() == BlueGeneP || getOS() == BlueGeneL);
    ...
    *((uint16_t *)(((char *)buffer) + size_hi_position)) =
        (uint16_t)(size >> 16);
    *((uint16_t *)(((char *)buffer) + size_lo_position)) = (uint16_t)size;
    *((uint16_t *)(((char *)buffer) + flags_hi_position)) =
        (uint16_t)(flags >> 16);
    *((uint16_t *)(((char *)buffer) + flags_lo_position)) = (uint16_t)flags;
    *((uint16_t *)(((char *)buffer) + addr_hi_position)) =
        (uint16_t)(addr >> 16);
    *((uint16_t *)(((char *)buffer) + addr_lo_position)) = (uint16_t)addr;
    ...
    pwords[size_highest_position] |=
        (uint32_t)(((uint64_t)size >> 48) & 0x0000ffff);
    pwords[size_higher_position] |=
        (uint32_t)(((uint64_t)size >> 32) & 0x0000ffff);
    ...
    pwords[flags_hi_position] |=
        (uint32_t)(((uint64_t)flags >> 16) & 0x0000ffff);
    pwords[flags_lo_position] |= (uint32_t)((uint64_t)flags & 0x0000ffff);
    pwords[addr_highest_position] |=
        (uint32_t)(((uint64_t)addr >> 48) & 0x0000ffff);
    pwords[addr_higher_position] |=
        (uint32_t)(((uint64_t)addr >> 32) & 0x0000ffff);
...
bool mmap_alloc_process::plat_createDeallocationSnippet(
