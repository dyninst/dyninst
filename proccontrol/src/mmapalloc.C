...
bool
mmap_alloc_process::plat_collectAllocationResult(int_thread* thr, reg_response::ptr resp)
{
...
bool
mmap_alloc_process::plat_createAllocationSnippet(Dyninst::Address addr, bool use_addr,
...
bool
mmap_alloc_process::plat_createDeallocationSnippet(Dyninst::Address addr,
                                                   unsigned long size, void*& buffer,
                                                   unsigned long& buffer_size,
                                                   unsigned long& start_offset)
{
