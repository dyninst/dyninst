...
class thread_db_process : public int_threadTracking {
  ...
  friend ps_err_e ps_pwrite(struct ps_prochandle *, psaddr_t, const void *,
                            size_t);
 ...
 public:
  ...
  virtual bool setTrackThreads(
      bool b, std::set<std::pair<int_breakpoint *, Address> > &bps,
      bool &add_bp);
  virtual bool isTrackingThreads();
  virtual bool refreshThreads();
  virtual int threaddb_getPid();

  async_ret_t plat_calcTLSAddress(int_thread *thread, int_library *lib,
  ...
  typedef td_err_e (*td_ta_event_addr_t)(const td_thragent_t *, td_event_e,
                                         td_notify_t *);
  typedef td_err_e (*td_ta_set_event_t)(const td_thragent_t *,
                                        td_thr_events_t *);
  typedef td_err_e (*td_ta_event_getmsg_t)(const td_thragent_t *,
                                           td_event_msg_t *);
  typedef td_err_e (*td_ta_map_lwp2thr_t)(const td_thragent_t *, lwpid_t,
                                          td_thrhandle_t *);
  ...
  typedef td_err_e (*td_thr_set_event_t)(const td_thrhandle_t *,
                                         td_thr_events_t *);
  typedef td_err_e (*td_thr_event_getmsg_t)(const td_thrhandle_t *,
                                            td_event_msg_t *);
  typedef td_err_e (*td_thr_dbsuspend_t)(const td_thrhandle_t *);
  typedef td_err_e (*td_thr_dbresume_t)(const td_thrhandle_t *);
  typedef td_err_e (*td_thr_tls_get_addr_t)(const td_thrhandle_t *,
                                            void *map_address, size_t offset,
                                            void **address);
  typedef td_err_e (*td_thr_tlsbase_t)(const td_thrhandle_t *,
                                       unsigned long modid, void **address);
 ...
 protected:
  ...
  std::map<Dyninst::Address, std::pair<int_breakpoint *, EventType> >
      addr2Event;
...
class thread_db_thread : virtual public int_thread {
 public:
  ...
  virtual bool plat_convertToSystemRegs(const int_registerPool &,
                                        unsigned char *, bool);
};
...
class thread_db_process : virtual public int_process {
 public:
  ...
  bool threaddb_setTrackThreads(
      bool, std::set<std::pair<int_breakpoint *, Address> > &, bool &);
