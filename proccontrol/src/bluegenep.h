...
class bgp_process : public sysv_process,
                    public thread_db_process,
                    public ppc_process,
                    public unified_lwp_control_process,
...
class bgp_thread : public thread_db_thread {
 public:
  ...
  bool plat_setAllRegistersAsync(int_registerPool &pool,
                                 result_response::ptr result);
...
class DecoderBlueGene : public Decoder {
 public:
  ...
  virtual bool getProcAndThread(ArchEventBlueGene *archbg, bgp_process *&p,
                                bgp_thread *&t);
  ...
  // the appropriate ACK event, and turn the ACK event into the original
  // ArchEvent
