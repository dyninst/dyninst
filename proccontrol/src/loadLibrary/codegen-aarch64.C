...
bool
Codegen::generatePreambleAARCH64()
{
...
bool
Codegen::generateCallAARCH64(Address addr, const std::vector<Address>& args)
{
    if(args.size() > 6)
        return false;
    ...
    */
    ...
    for(std::vector<Address>::const_iterator itA = args.begin(); itA != args.end(); itA++)
    {
