...
bool
Codegen::generateCallIA32(Address addr, const std::vector<Address>& args)
{
...
bool
Codegen::generateCallAMD64(Address addr, const std::vector<Address>& args)
{
    if(args.size() >= 1)
    {
        copyByte(0x48);
...
bool
Codegen::generatePreambleIA32()
{
    return true;
}

bool
Codegen::generatePreambleAMD64()
{
