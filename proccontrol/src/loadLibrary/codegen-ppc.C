...
bool
Codegen::generateCallPPC32(Address addr, const std::vector<Address>& args)
{
...
bool
Codegen::generateCallPPC64(Address addr, const std::vector<Address>& args)
{
...
void
Codegen::generatePPC32(Address val, unsigned reg)
{
    instruction insn;
    insn.clear();
...
void
Codegen::generatePPC64(Address val, unsigned reg)
{
