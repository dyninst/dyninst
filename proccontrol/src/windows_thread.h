...
class windows_thread : public int_thread {
 public:
  ...
  virtual bool plat_needsEmulatedSingleStep(
  ...
  void setLWP(Dyninst::LWP L) { lwp = L; }
  ...
  void *plat_getHandle() const { return hthread; }
 ...
 private:
  ...
  typedef enum { notRPCThread, RPCpreCreate, RPCrunning } dummyRPC_t;
