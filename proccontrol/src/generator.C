...
void
Generator::registerNewEventCB(void (*func)())
{
    if(!cb_lock)
        cb_lock = new Mutex<>();
...
void
Generator::removeNewEventCB(void (*func)())
{
    if(!cb_lock)
        cb_lock = new Mutex<>();
    Generator::cb_lock->lock();
...
const char*
Generator::generatorStateStr(Generator::state_t s)
{
    switch(s)
    {
        STR_CASE(none);
...
void
Generator::setState(Generator::state_t new_state)
{
...
ArchEvent*
Generator::getCachedEvent()
{
    return m_Event;
}

void
Generator::setCachedEvent(ArchEvent* ae)
{
    m_Event = ae;
}

bool
Generator::getMultiEvent(bool block, vector<ArchEvent*>& events)
{
...
bool
Generator::getAndQueueEventInt(bool block)
{
    bool result = true;
...
bool
Generator::plat_skipGeneratorBlock()
{
...
void
GeneratorInternalJoin(GeneratorMTInternals* gen_int)
{
    gen_int->thrd.join();
}
...
bool
GeneratorMT::processWait(bool block)
{
...
bool
GeneratorMT::getAndQueueEvent(bool)
{
