...
err_t
Dyninst::ProcControlAPI::getLastError()
{
    return last_error;
}
...
const char*
Dyninst::ProcControlAPI::getLastErrorMsg()
{
    return last_error_msg;
}

void
Dyninst::ProcControlAPI::globalSetLastError(err_t err, const char* msg)
{
    last_error     = err;
    last_error_msg = msg;
}
...
void
Dyninst::ProcControlAPI::setDebugChannel(FILE* f)
{
    pctrl_err_out = f;
}

void
Dyninst::ProcControlAPI::setDebug(bool enable)
{
...
#define STR_RET(C, S)                                                                    \
    case C:                                                                              \
        return S
const char*
Dyninst::ProcControlAPI::getGenericErrorMsg(err_t e)
{
    switch(e)
    {
