...
Table~\ref{tab:event-subclass} shows the Event subclass that is used for each EventType. Not all
...
\begin{table}[!ht]
  ...
  \end{tabular}
  \caption{Event subclass used for each EventType}
  \label{tab:event-subclass}
\end{table}
