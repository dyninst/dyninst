...
As an example, consider the code in Listing~\ref{lst:thread-create} that creates a target process and
...
\lstinputlisting[label=lst:thread-create, caption={Printing a message when the target process creates a thread}]{examples/ThreadCreate.C}
