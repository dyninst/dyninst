...
const_iterator lower_bound(Dyninst::Address addr) const;
\end{apient}
...
const_iterator upper_bound(Dyninst::Address addr) const;
\end{apient}
...
\begin{apient}
AddressSet::ptr set_union(AddressSet::const_ptr aset) const;
\end{apient}
...
\begin{apient}
AddressSet::ptr set_intersection(AddressSet::const_ptr aset) const;
\end{apient}
...
\begin{apient}
AddressSet::ptr set_difference(AddressSet::const_ptr aset) const;
\end{apient}
