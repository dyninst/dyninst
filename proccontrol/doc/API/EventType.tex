...
EventTypes. All EventTypes have an associate code---an
integral value that identifies the EventType. Some EventTypes also have a
time associated with them (Pre, Post, or None)---describing
...
More details on Events and EventTypes can be found in Section~\ref{bkm:Ref273435580}.
...
These constants describe possible values for an EventType's
