...
\begin{apient}
  static ProcessSet::ptr newProcessSet(AddressSet::const_iterator ab, AddressSet::const_iterator ae);
\end{apient}
...
\begin{apient}
  bool readMemory(std::multimap<Process::const_ptr, read_t> &addr) const;
\end{apient}
...
\begin{apient}
  bool writeMemory(AddressSet::ptr addrs, const void* buffer, size_t sz) const;
\end{apient}
