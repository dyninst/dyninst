...
public:
    ...
    // These aren't completely real events.  They can have callbacks registered, but won't
    // be delivered.
    // Instead, a real event will be delivered to their callback.  E.g, a callback
    // registered for Terminate will actually get Exit or Crash events.
