...
bool EmitterAARCH32::clobberAllFuncCall( registerSpace *rs,
...
Register EmitterAARCH32::emitCallReplacement(opCode ocode,
                                           codeGen &gen,
                                           bool /* noCost */,
                                           func_instance *callee)
{
...
Register EmitterAARCH32::emitCall(opCode ocode,
                                  codeGen &gen,
...
//
// I don't know how to compute cycles for AARCH32 instructions due to
...
void registerSpace::saveClobberInfo(const instPoint *location)
{
    ...
    if (location == NULL)
        return;
    if (location->actualGPRLiveSet_ != NULL &&
        location->actualFPRLiveSet_ != NULL)
    {
...
bool EmitterAARCH32::emitCallRelative(Register dest, Address offset, Register base, codeGen &gen)
{
    assert(0); //Not implemented
    return true;
}

bool EmitterAARCH32::emitLoadRelative(Register dest, Address offset, Register base, int size, codeGen &gen)
{
    assert(0); //Not implemented
    return true;
}

void EmitterAARCH32::emitStoreRelative(Register source, Address offset, Register base, int size, codeGen &gen)
{
    //return true;
    assert(0); //Not implemented
}

bool EmitterAARCH32::emitMoveRegToReg(registerSlot *src,
                                    registerSlot *dest,
                                    codeGen &gen)
{
    assert(0); //Not implemented
...
/*
bool EmitterAARCH3232Stat::emitPIC(codeGen& gen, Address origAddr, Address relocAddr)
{
...
bool EmitterAARCH32Stat::emitPIC(codeGen& gen, Address origAddr, Address relocAddr)
{
    assert(0);
    return false;
}

bool EmitterAARCH32Dyn::emitPIC(codeGen &gen, Address origAddr, Address relocAddr)
{
...
bool EmitterAARCH32Stat::emitPLTCommon(func_instance *callee, bool call, codeGen &gen)
{
    assert(0); //Not implemented
    return true;
}
...
bool EmitterAARCH32Dyn::emitTOCCommon(block_instance *block, bool call, codeGen &gen)
{
    assert(0); //Not implemented
    return true;
}
...
// TODO 32/64-bit?
bool EmitterAARCH32Stat::emitPLTCall(func_instance *callee, codeGen &gen)
{
    assert(0); //Not implemented
    return emitPLTCommon(callee, true, gen);
}

bool EmitterAARCH32Stat::emitPLTJump(func_instance *callee, codeGen &gen)
{
    assert(0); //Not implemented
    return emitPLTCommon(callee, false, gen);
}

bool EmitterAARCH32Stat::emitTOCCall(block_instance *block, codeGen &gen)
{
    assert(0); //Not implemented
    return emitTOCCommon(block, true, gen);
}

bool EmitterAARCH32Stat::emitTOCJump(block_instance *block, codeGen &gen)
{
    assert(0); //Not implemented
    return emitTOCCommon(block, false, gen);
}

bool EmitterAARCH32Stat::emitTOCCommon(block_instance *block, bool call, codeGen &gen)
{
    assert(0); //Not implemented
    return false;
}

bool EmitterAARCH32Stat::emitCallInstruction(codeGen &gen,
                                             func_instance *callee,
                                             bool setTOC, Address)
{
    assert(0); //Not implemented
...
// Generates call instruction sequence for all AARCH32-based systems
...
bool EmitterAARCH32::emitCallInstruction(codeGen &gen, func_instance *callee, bool setTOC, Address toc_anchor)
{
    assert(0); //Not implemented
    return true;
}

void EmitterAARCH32::emitLoadShared(opCode op, Register dest, const image_variable* var, bool is_local, int size, codeGen &gen, Address offset)
{
    assert(0); //Not implemented
    return;
}

void EmitterAARCH32::emitStoreShared(Register source, const image_variable * var, bool is_local, int size, codeGen & gen)
{
    assert(0); //Not implemented
    return;
}
...
Address EmitterAARCH32::emitMovePCToReg(Register dest, codeGen &gen)
{
    assert(0); //Not implemented
