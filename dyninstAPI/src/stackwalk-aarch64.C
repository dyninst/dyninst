...
bool
PCProcess::createStackwalkerSteppers()
{
...
bool
StackwalkInstrumentationHelper::isInstrumentation(Dyninst::Address ra,
...
DynFrameHelper::allocatesFrame(Address addr)
{
...
bool
DynWandererHelper::isPrevInstrACall(Address /*addr*/, Address& /*target*/)
{
    // NOT IMPLEMENTED
    assert(0);
    return false;
...
bool
DynWandererHelper::requireExactMatch()
{
    // NOT IMPLEMENTED
    assert(0);
    return false;
