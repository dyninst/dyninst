...
void cleanUpAndExit(int status) { exit(status); }

extern "C" {

void __uninitialized_copy_aux__H2ZPCt6vector2ZUiZt9allocator1ZUiZPt6vector2ZUiZt9allocator1ZUi_X01X01X11G12__false_type_X11() {
  abort();
}
...
void fill__H2ZPP19BPatch_variableExprZP19BPatch_variableExpr_X01X01RCX11_v() {
  abort();
}

void fill__H2ZPP19BPatch_variableExprZP19BPatch_variableExpr_X01T0RCX11_v() {
  abort();
}
