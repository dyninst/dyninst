...
class codeGen {
 ...
 public:
  ...
  std::map<block_instance *, Extent> &getDefensivePads() {
    return defensivePads_;
  }
  ...
  std::map<baseTramp *, Address> &getInstrumentation() {
    return instrumentation_;
  }

  void registerRemovedInstrumentation(baseTramp *bt, Address loc) {
    removedInstrumentation_[bt] = loc;
  }
  std::map<baseTramp *, Address> &getRemovedInstrumentation() {
