...
BPatch_function*
BPatch_addressSpace::findOrCreateBPFunc(Dyninst::PatchAPI::PatchFunction* ifunc,
                                        BPatch_module*                    bpmod)
{
...
BPatch_point*
BPatch_addressSpace::findOrCreateBPPoint(BPatch_function*          bpfunc,
                                         ...
                                         BPatch_procedureLocation  pointType)
{
    ...
    if(!fi)
        return NULL;  // PatchAPI can create function-less points, but we can't represent
                      // them as BPatch_points
    ...
    BPatch_point* pt   = new BPatch_point(this, bpfunc, pointsToUse.first,
                                        pointsToUse.second, pointType, lladdrSpace);
    mod->instp_map[ip] = pt;
...
BPatch_variableExpr*
BPatch_addressSpace::findOrCreateVariable(int_variable* v, BPatch_type* type)
{
...
BPatch_function*
BPatch_addressSpace::createBPFuncCB(AddressSpace* a, Dyninst::PatchAPI::PatchFunction* f)
{
...
BPatch_point*
BPatch_addressSpace::createBPPointCB(AddressSpace*                     a,
...
BPatchSnippetHandle::thread_iter
BPatchSnippetHandle::getCatchupThreads_end()
{
...
BPatch_addressSpace::replaceFunctionCall(BPatch_point& point, BPatch_function& newFunc)
{
    ...
    DynModifyCallCommand* rep_call   = DynModifyCallCommand::create(
        addr_space, point.point->block(), newFunc.lowlevel_func(), point.point->func());
...
bool
BPatch_addressSpace::wrapFunction(BPatch_function* original, BPatch_function* wrapper,
...
bool
BPatch_addressSpace::revertWrapFunction(BPatch_function* original)
{
...
bool
BPatch_addressSpace::getAddressRanges(const char* fileName, unsigned int lineNo,
...
bool
BPatch_addressSpace::getSourceLines(unsigned long                    addr,
...
BPatch_variableExpr*
BPatch_addressSpace::malloc(const BPatch_type& type, std::string name)
{
    std::vector<AddressSpace*> as;
    assert(BPatch::bpatch != NULL);
    getAS(as);
...
BPatch_variableExpr*
BPatch_addressSpace::createVariable(std::string name, Dyninst::Address addr,
                                    BPatch_type* type)
{
    assert(BPatch::bpatch != NULL);
    std::vector<AddressSpace*> as;
    ...
    BPatch_variableExpr* varExpr =
        BPatch_variableExpr::makeVariableExpr(this, as[0], name, (void*) addr, type);
 ...
 */
BPatch_function*
BPatch_addressSpace::findFunctionByEntry(Address entry)
{
...
bool
BPatch_addressSpace::findFuncsByRange(Address startAddr, Address endAddr,
 ...
 */
bool
BPatch_addressSpace::findFunctionsByAddr(Address                        addr,
 ...
 */
BPatch_module*
BPatch_addressSpace::findModuleByAddr(Address addr)
{
    std::vector<AddressSpace*> as;
    getAS(as);
    assert(as.size());
...
BPatchSnippetHandle*
BPatch_addressSpace::insertSnippet(const BPatch_snippet& expr, BPatch_point& point,
...
extern bool
BPatchToInternalArgs(BPatch_point* point, BPatch_callWhen when, BPatch_snippetOrder order,
...
BPatchSnippetHandle*
BPatch_addressSpace::insertSnippet(const BPatch_snippet&               expr,
 ...
 *
 * Returns true if the underlying image represents a statically-linked executable, false
 * otherwise.
 */
bool
BPatch_addressSpace::isStaticExecutable()
...
void
BPatch_addressSpace::init_registers()
{
    if(registers_.size())
        return;
    std::vector<AddressSpace*> as;
...
BPatch_addressSpace::register_iter
BPatch_addressSpace::getRegisters_end()
{
    init_registers();
...
{}
bool
BPatch_addressSpace::getRegisters(std::vector<BPatch_register>&)
{
...
#else
bool
BPatch_addressSpace::createRegister_NP(std::string, BPatch_register&)
{
    return false;
}
#endif
...
BPatch_variableExpr*
BPatch_addressSpace::createVariable(Dyninst::Address at_addr, BPatch_type* type,
                                    std::string var_name, BPatch_module* in_module)
{
...
Dyninst::PatchAPI::convert(const BPatch_addressSpace* a)
{
