...
public:
    ...
    std::map<Address, StackAccess*>* getDefinitionMap() { return _definitionMap; }
...
private:
    ...
    bool createOffsetVector_Analysis(ParseAPI::Function* func, ParseAPI::Block* block,
    ...
    bool addToOffsetVector(StackAnalysis::Height off, int size,
                           ...
                           ValidPCRange* valid, MachRegister reg = MachRegister());
...
template <class OutputIterator>
void
func_instance::getCallerBlocks(OutputIterator result)
{
    ...
    */
    ...
    for(PatchBlock::edgelist::const_iterator iter = ins.begin(); iter != ins.end();
        ++iter)
    {
...
template <class OutputIterator>
void
func_instance::getCallerFuncs(OutputIterator result)
{
