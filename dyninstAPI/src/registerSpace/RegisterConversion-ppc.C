...
map<MachRegister, Register> reverseRegisterMap = map_list_of
  (ppc64::r0, registerSpace::r0)
  (ppc64::r1, registerSpace::r1)
  (ppc64::r2, registerSpace::r2)
  (ppc64::r3, registerSpace::r3)
  (ppc64::r4, registerSpace::r4)
  (ppc64::r5, registerSpace::r5)
  (ppc64::r6, registerSpace::r6)
  (ppc64::r7, registerSpace::r7)
  (ppc64::r8, registerSpace::r8)
  (ppc64::r9, registerSpace::r9)
  (ppc64::r10, registerSpace::r10)
  (ppc64::r11, registerSpace::r11)
  (ppc64::r12, registerSpace::r12)
  (ppc64::r13, registerSpace::r13)
  (ppc64::r14, registerSpace::r14)
  (ppc64::r15, registerSpace::r15)
  (ppc64::r16, registerSpace::r16)
  (ppc64::r17, registerSpace::r17)
  (ppc64::r18, registerSpace::r18)
  (ppc64::r19, registerSpace::r19)
  (ppc64::r20, registerSpace::r20)
  (ppc64::r21, registerSpace::r21)
  (ppc64::r22, registerSpace::r22)
  (ppc64::r23, registerSpace::r23)
  (ppc64::r24, registerSpace::r24)
  (ppc64::r25, registerSpace::r25)
  (ppc64::r26, registerSpace::r26)
  (ppc64::r27, registerSpace::r27)
  (ppc64::r28, registerSpace::r28)
  (ppc64::r29, registerSpace::r29)
  (ppc64::r30, registerSpace::r30)
  (ppc64::r31, registerSpace::r31)
  (ppc64::fpr0, registerSpace::fpr0)
  (ppc64::fpr1, registerSpace::fpr1)
  (ppc64::fpr2, registerSpace::fpr2)
  (ppc64::fpr3, registerSpace::fpr3)
  (ppc64::fpr4, registerSpace::fpr4)
  (ppc64::fpr5, registerSpace::fpr5)
  (ppc64::fpr6, registerSpace::fpr6)
  (ppc64::fpr7, registerSpace::fpr7)
  (ppc64::fpr8, registerSpace::fpr8)
  (ppc64::fpr9, registerSpace::fpr9)
  (ppc64::fpr10, registerSpace::fpr10)
  (ppc64::fpr11, registerSpace::fpr11)
  (ppc64::fpr12, registerSpace::fpr12)
  (ppc64::fpr13, registerSpace::fpr13)
  (ppc64::fpr14, registerSpace::fpr14)
  (ppc64::fpr15, registerSpace::fpr15)
  (ppc64::fpr16, registerSpace::fpr16)
  (ppc64::fpr17, registerSpace::fpr17)
  (ppc64::fpr18, registerSpace::fpr18)
  (ppc64::fpr19, registerSpace::fpr19)
  (ppc64::fpr20, registerSpace::fpr20)
  (ppc64::fpr21, registerSpace::fpr21)
  (ppc64::fpr22, registerSpace::fpr22)
  (ppc64::fpr23, registerSpace::fpr23)
  (ppc64::fpr24, registerSpace::fpr24)
  (ppc64::fpr25, registerSpace::fpr25)
  (ppc64::fpr26, registerSpace::fpr26)
  (ppc64::fpr27, registerSpace::fpr27)
  (ppc64::fpr28, registerSpace::fpr28)
  (ppc64::fpr29, registerSpace::fpr29)
  (ppc64::fpr30, registerSpace::fpr30)
  (ppc64::fpr31, registerSpace::fpr31)
  (ppc64::xer, registerSpace::xer)
  (ppc64::lr, registerSpace::lr)
  (ppc64::ctr, registerSpace::ctr)
  (ppc64::mq, registerSpace::mq)
  (ppc64::cr, registerSpace::cr);

Register convertRegID(MachRegister reg) {

    MachRegister baseReg = MachRegister((reg.getBaseRegister().val() & ~reg.getArchitecture()) | Arch_ppc64);
