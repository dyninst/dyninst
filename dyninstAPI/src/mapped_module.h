...
class mapped_module {
 public:
  static mapped_module *createMappedModule(mapped_object *obj, pdmodule *pdmod);
  ...
  bool getAddrFromLine(unsigned lineNum, pdvector<Address> &addresses,
                       bool exactMatch);
 ...
 private:
  ...
  mapped_module();
  mapped_module(mapped_object *obj, pdmodule *pdmod);
