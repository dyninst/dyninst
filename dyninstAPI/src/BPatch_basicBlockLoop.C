...
int
BPatch_basicBlockLoop::getBackEdges(BPatch_Vector<BPatch_edge*>& edges)
{
...
void
BPatch_basicBlockLoop::addBackEdges(std::vector<BPatch_edge*>& newEdges)
{
...
bool
BPatch_basicBlockLoop::getLoopBasicBlocks(BPatch_Vector<BPatch_basicBlock*>& bbs)
{
...
bool
BPatch_basicBlockLoop::getLoopBasicBlocksExclusive(BPatch_Vector<BPatch_basicBlock*>& bbs)
{
...
bool
BPatch_basicBlockLoop::hasBlock(BPatch_basicBlock* block)
{
    BPatch_Vector<BPatch_basicBlock*> blks;
    getLoopBasicBlocks(blks);
...
bool
BPatch_basicBlockLoop::hasBlockExclusive(BPatch_basicBlock* block)
{
    BPatch_Vector<BPatch_basicBlock*> blks;
    getLoopBasicBlocksExclusive(blks);
