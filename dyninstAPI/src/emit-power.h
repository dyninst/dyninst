...
public:
    ...
    virtual void emitOpImm(unsigned, unsigned, Register, Register, RegValue, codeGen&)
    {
        assert(0);
    }
    ...
    virtual void emitStoreFrameRelative(Address, Register, Register, int, codeGen&)
    {
        assert(0);
    }
    ...
    virtual Register emitCall(opCode, codeGen&, const std::vector<AstNodePtr>&, bool,
                              func_instance*);
    ...
    virtual Register emitCallReplacement(opCode, codeGen&, bool, func_instance*);
    void emitCallWithSaves(codeGen& gen, Address dest, bool saveToc, bool saveLR,
                           bool saveR12);
