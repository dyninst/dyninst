...
Frame::Frame(const Dyninst::Stackwalker::Frame& swf, PCProcess* proc, PCThread* thread,
             bool uppermost)
:
...
bool
int_stackwalk::isValid()
{
    return isValid_;
}

bool
int_stackwalk::setStackwalk(std::vector<Frame>& new_stack)
{
