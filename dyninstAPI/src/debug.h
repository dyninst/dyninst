...
extern void
            statusLine(const char* line, bool force = false);
extern char errorLine[];
extern int
bpfatal(const char* format, ...) DYNINST_PRINTF_ANNOTATION(1, 2);
extern int
bperr(const char* format, ...) DYNINST_PRINTF_ANNOTATION(1, 2);
extern int
bpwarn(const char* format, ...) DYNINST_PRINTF_ANNOTATION(1, 2);
extern int
bpinfo(const char* format, ...) DYNINST_PRINTF_ANNOTATION(1, 2);
...
// C++ prototypes
#define debug_sys_cerr(debug_sys)                                                        \
    if(dyn_debug_##debug_sys)                                                            \
    cerr
...
#define DECLARE_PRINTF_FUNC(f)                                                           \
    extern int f(const char* format, ...) DYNINST_PRINTF_ANNOTATION(1, 2)
...
#define debug_sys_printf(debug_sys, ...)                                                 \
    do                                                                                   \
    {                                                                                    \
        if(dyn_debug_##debug_sys)                                                        \
