...
//  we really do not want to have this defined, but I'm defining it for the moment to get
//  thru paradyn seperation
...
class mapped_object
: public codeRange
, public Dyninst::PatchAPI::DynObject
{
...
public:
    ...
    static mapped_object* createMappedObject(fileDescriptor& desc, AddressSpace* p,
...
public:
    ...
    const std::vector<func_instance*>* findFuncVectorByPretty(
        const std::string& funcname);
    const std::vector<func_instance*>* findFuncVectorByMangled(
        const std::string& funcname);
...
{
public:
    mappedObjData(mapped_object* obj_)
    : obj(obj_)
    {}
