...
syscallNotification::syscallNotification(syscallNotification* parentSN, PCProcess* child)
: preForkInst(NULL)
, postForkInst(NULL)
, preExecInst(NULL)
, postExecInst(NULL)
...
syscallNotification::installPreFork()
{
    ...
    preForkInst = new instMapping(getForkFuncName(), "DYNINST_instForkEntry", FUNC_ENTRY);
