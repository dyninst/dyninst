...
codeBufIndex_t EmitterAMDGPU::emitIf(
...
void EmitterAMDGPU::emitLoadConst(Register dest, Address imm, codeGen &gen)
{
    insnCodeGen::loadImmIntoReg(gen, dest, imm);
}


void EmitterAMDGPU::emitLoad(Register dest, Address addr, int size, codeGen &gen)
{
...
void EmitterAMDGPU::emitStore(Address addr, Register src, int size, codeGen &gen)
{
    Register scratch = gen.rs()->getScratchRegister(gen);
...
void EmitterAMDGPU::emitGetParam(
...
void EmitterAMDGPU::emitRelOpImm(
...
void EmitterAMDGPU::emitLoadIndir(Register dest, Register addr_src, int size, codeGen &gen)
{
    insnCodeGen::generateMemAccess(gen, insnCodeGen::Load, dest,
...
void EmitterAMDGPU::emitStoreIndir(Register addr_reg, Register src, int size, codeGen &gen)
{
    insnCodeGen::generateMemAccess(gen, insnCodeGen::Store, src,
...
void EmitterAMDGPU::emitLoadOrigRegRelative(
...
void EmitterAMDGPU::emitLoadOrigRegister(Address register_num, Register destination, codeGen &gen)
{
