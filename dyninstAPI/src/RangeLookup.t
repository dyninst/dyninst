...
template< class Value, class ValueRange > 
bool RangeLookup< Value, ValueRange >::addAddressRange( Address lowInclusiveAddr, 
                                                        Address highExclusiveAddr, 
                                                        Value v ) 
{
...
*/	   
template< class Value, class ValueRange > 
bool RangeLookup< Value, ValueRange >::getValues( Address addressInRange, 
...
bool RangeLookupImpl::AddressRangeLess::operator()(const AddressRange &lhs,
