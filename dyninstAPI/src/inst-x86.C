...
registerSpace::initialize32()
{
    ...
    // When we use
    registerSlot* eax =
        new registerSlot(REGNUM_EAX, "eax",
                         false,  // Off-limits due to our "stack slot" register mechanism
                         registerSlot::liveAlways, registerSlot::realReg);
    registerSlot* ecx = new registerSlot(REGNUM_ECX, "ecx", false,
                                         registerSlot::liveAlways, registerSlot::realReg);
    registerSlot* edx = new registerSlot(REGNUM_EDX, "edx", false,
                                         registerSlot::liveAlways, registerSlot::realReg);
    registerSlot* ebx = new registerSlot(REGNUM_EBX, "ebx", false,
                                         registerSlot::liveAlways, registerSlot::realReg);
    ...
    registerSlot* ebp = new registerSlot(REGNUM_EBP, "ebp", true,
                                         registerSlot::liveAlways, registerSlot::realReg);
    registerSlot* esi = new registerSlot(REGNUM_ESI, "esi", false,
                                         registerSlot::liveAlways, registerSlot::realReg);
    registerSlot* edi = new registerSlot(REGNUM_EDI, "edi", false,
                                         registerSlot::liveAlways, registerSlot::realReg);
    ...
    // SPRs...
    registerSlot* gs = new registerSlot(REGNUM_GS, "gs", false, registerSlot::liveAlways,
                                        registerSlot::SPR);
    ...
    for(unsigned i = 1; i <= NUM_VIRTUAL_REGISTERS; i++)
    {
        ...
        registerSlot* virt =
            new registerSlot(i, buf, false, registerSlot::deadAlways, registerSlot::GPR);
    ...
    registerSlot* fpr = new registerSlot(
        ...
        true,                      // off-limits...
        registerSlot::liveAlways,  // because we check this via overapproximation and not
                                   // the
    ...
    registers.push_back(new registerSlot(IA32_FLAG_VIRTUAL_REGISTER, "virtFlags", true,
...
registerSpace::initialize64()
{
    ...
    registerSlot* rax = new registerSlot(REGNUM_RAX, "rax",
                                         // TODO FIXME but I need it...
                                         false,  // We use it implicitly _everywhere_
                                         registerSlot::deadABI, registerSlot::GPR);
    registerSlot* rcx = new registerSlot(REGNUM_RCX, "rcx", false,
                                         registerSlot::liveAlways, registerSlot::GPR);
    registerSlot* rdx = new registerSlot(REGNUM_RDX, "rdx", false,
                                         registerSlot::liveAlways, registerSlot::GPR);
    registerSlot* rbx = new registerSlot(REGNUM_RBX, "rbx", false,
                                         registerSlot::liveAlways, registerSlot::GPR);
    registerSlot* rsp = new registerSlot(REGNUM_RSP, "rsp",
                                         true,  // Off-limits...
                                         registerSlot::liveAlways, registerSlot::GPR);
    registerSlot* rbp = new registerSlot(REGNUM_RBP, "rbp", true,
                                         registerSlot::liveAlways, registerSlot::GPR);
    registerSlot* rsi = new registerSlot(REGNUM_RSI, "rsi", false,
                                         registerSlot::liveAlways, registerSlot::GPR);
    registerSlot* rdi = new registerSlot(REGNUM_RDI, "rdi", false,
                                         registerSlot::liveAlways, registerSlot::GPR);
    registerSlot* r8  = new registerSlot(REGNUM_R8, "r8", false, registerSlot::liveAlways,
                                        registerSlot::GPR);
    registerSlot* r9  = new registerSlot(REGNUM_R9, "r9", false, registerSlot::liveAlways,
                                        registerSlot::GPR);
    registerSlot* r10 = new registerSlot(REGNUM_R10, "r10", false, registerSlot::deadABI,
                                         registerSlot::GPR);
    registerSlot* r11 = new registerSlot(REGNUM_R11, "r11", false, registerSlot::deadABI,
                                         registerSlot::GPR);
    registerSlot* r12 = new registerSlot(REGNUM_R12, "r12", false,
                                         registerSlot::liveAlways, registerSlot::GPR);
    registerSlot* r13 = new registerSlot(REGNUM_R13, "r13", false,
                                         registerSlot::liveAlways, registerSlot::GPR);
    registerSlot* r14 = new registerSlot(REGNUM_R14, "r14", false,
                                         registerSlot::liveAlways, registerSlot::GPR);
    registerSlot* r15 = new registerSlot(REGNUM_R15, "r15", false,
                                         registerSlot::liveAlways, registerSlot::GPR);
    ...
    registers.push_back(new registerSlot(REGNUM_OF, "of", true, registerSlot::liveAlways,
                                         registerSlot::SPR));
    registers.push_back(new registerSlot(REGNUM_SF, "sf", true, registerSlot::liveAlways,
                                         registerSlot::SPR));
    registers.push_back(new registerSlot(REGNUM_ZF, "zf", true, registerSlot::liveAlways,
                                         registerSlot::SPR));
    registers.push_back(new registerSlot(REGNUM_AF, "af", true, registerSlot::liveAlways,
                                         registerSlot::SPR));
    registers.push_back(new registerSlot(REGNUM_PF, "pf", true, registerSlot::liveAlways,
                                         registerSlot::SPR));
    registers.push_back(new registerSlot(REGNUM_CF, "cf", true, registerSlot::liveAlways,
                                         registerSlot::SPR));
    registers.push_back(new registerSlot(REGNUM_TF, "tf", true, registerSlot::liveAlways,
                                         registerSlot::SPR));
    registers.push_back(new registerSlot(REGNUM_IF, "if", true, registerSlot::liveAlways,
                                         registerSlot::SPR));
    registers.push_back(new registerSlot(REGNUM_DF, "df", true, registerSlot::liveAlways,
                                         registerSlot::SPR));
    registers.push_back(new registerSlot(REGNUM_NT, "nt", true, registerSlot::liveAlways,
                                         registerSlot::SPR));
    registers.push_back(new registerSlot(REGNUM_RF, "rf", true, registerSlot::liveAlways,
                                         registerSlot::SPR));
    ...
    registers.push_back(new registerSlot(REGNUM_MM7, "MM7/ST(7)", true,
                                         registerSlot::liveAlways, registerSlot::FPR));
    registers.push_back(new registerSlot(REGNUM_XMM0, "XMM0", true,
                                         registerSlot::liveAlways, registerSlot::FPR));
    registers.push_back(new registerSlot(REGNUM_XMM1, "XMM1", true,
                                         registerSlot::liveAlways, registerSlot::FPR));
    registers.push_back(new registerSlot(REGNUM_XMM2, "XMM2", true,
                                         registerSlot::liveAlways, registerSlot::FPR));
    registers.push_back(new registerSlot(REGNUM_XMM3, "XMM3", true,
                                         registerSlot::liveAlways, registerSlot::FPR));
    registers.push_back(new registerSlot(REGNUM_XMM4, "XMM4", true,
                                         registerSlot::liveAlways, registerSlot::FPR));
    registers.push_back(new registerSlot(REGNUM_XMM5, "XMM5", true,
                                         registerSlot::liveAlways, registerSlot::FPR));
    registers.push_back(new registerSlot(REGNUM_XMM6, "XMM6", true,
                                         registerSlot::liveAlways, registerSlot::FPR));
    registers.push_back(new registerSlot(REGNUM_XMM7, "XMM7", true,
                                         registerSlot::liveAlways, registerSlot::FPR));
    registers.push_back(new registerSlot(REGNUM_XMM8, "XMM8", true,
                                         registerSlot::liveAlways, registerSlot::FPR));
    registers.push_back(new registerSlot(REGNUM_XMM9, "XMM9", true,
                                         registerSlot::liveAlways, registerSlot::FPR));
    ...
    registers.push_back(new registerSlot(REGNUM_FS, "FS", false, registerSlot::liveAlways,
                                         registerSlot::SPR));
...
bool
baseTramp::generateSaves(codeGen& gen, registerSpace*)
{
    return gen.codeEmitter()->emitBTSaves(this, gen);
}

bool
baseTramp::generateRestores(codeGen& gen, registerSpace*)
{
...
void
emitJccR8(int condition_code, char jump_offset, codeGen& gen)
{
    GET_PTR(insn, gen);
...
void
emitJcc(int condition, int offset, codeGen& gen, bool willRegen) /* = true */
{
    ...
    if(!willRegen && (offset >= -128 && offset <= 127))
    {  // jcc rel8
...
int tramp_pre_frame_size_64 =
    8 + 16 * 8 + AMD64_RED_ZONE;  // stack space allocated by pushing flags and 16 GPRs
                                  // and skipping the 128-byte red zone

bool
can_do_relocation(PCProcess* proc, const std::vector<std::vector<Frame>>& stackWalks,
                  func_instance* instrumented_func)
{
    ...
    {
        std::vector<func_instance*> stack_funcs = proc->pcsToFuncs(stackWalks[walk_itr]);
...
makeModRMbyte(unsigned Mod, unsigned Reg, unsigned RM)
{
...
static inline unsigned char
makeSIBbyte(unsigned Scale, unsigned Index, unsigned Base)
{
    return static_cast<unsigned char>(((Scale & 0x3) << 6) + ((Index & 0x7) << 3) +
                                      (Base & 0x7));
}
...
*/
void
emitAddressingMode(unsigned base, RegValue disp, unsigned reg_opcode, codeGen& gen)
{
    // MT linux uses ESP+4
                   ...
                   int reg_opcode, codeGen& gen)
{
    ...
    if(base == Null_Register)
    {  // we have to emit [index<<scale+disp32]
    ...
    {  // EBP must have 0 disp8; emit [base+index<<scale]
        *insn++ = makeModRMbyte(0, reg_opcode, 4);
        *insn++ = makeSIBbyte(scale, index, base);
    }
    else if(disp >= -128 && disp <= 127)
    {  // emit [base+index<<scale+disp8]
        *insn++           = makeModRMbyte(1, reg_opcode, 4);
        *insn++           = makeSIBbyte(scale, index, base);
        *((char*) insn++) = (char) disp;
    }
    else
    {  // emit [base+index<<scale+disp32]
...
void
emitSimpleInsn(unsigned op, codeGen& gen)
{
    GET_PTR(insn, gen);
...
void
emitOpRegReg(unsigned opcode, RealRegister dest, RealRegister src, codeGen& gen)
{
    GET_PTR(insn, gen);
    if(opcode <= 0xFF)
...
void
emitOpRegImm(int opcode, RealRegister dest, int imm, codeGen& gen)
{
    GET_PTR(insn, gen);
    *insn++        = 0x81;
...
void
emitOpSegRMReg(unsigned opcode, RealRegister dest, RealRegister, int disp, codeGen& gen)
{
    GET_PTR(insn, gen);
    *insn++        = opcode;
...
// emit OP reg, r/m
void
emitOpRegRM(unsigned opcode, RealRegister dest, RealRegister base, int disp, codeGen& gen)
{
    GET_PTR(insn, gen);
    if(opcode <= 0xff)
    {
...
// emit OP r/m, reg
void
emitOpRMReg(unsigned opcode, RealRegister base, int disp, RealRegister src, codeGen& gen)
{
    GET_PTR(insn, gen);
    *insn++ = static_cast<unsigned char>(opcode);
    SET_PTR(insn, gen);
...
// emit OP reg, imm32
void
emitOpExtRegImm(int opcode, int ext, RealRegister dest, int imm, codeGen& gen)
{
    GET_PTR(insn, gen);
    *insn++        = opcode;
...
void
emitOpExtRegImm8(int opcode, char ext, RealRegister dest, unsigned char imm, codeGen& gen)
{
    GET_PTR(insn, gen);
    *insn++                  = opcode;
...
void
emitOpExtReg(unsigned opcode, unsigned char ext, RealRegister reg, codeGen& gen)
{
    GET_PTR(insn, gen);
    *insn++ = opcode;
...
void
emitOpRegRegImm(unsigned opcode, RealRegister dest, RealRegister src, unsigned imm,
                codeGen& gen)
{
    GET_PTR(insn, gen);
    *insn++        = opcode;
...
void
emitLEA(RealRegister base, unsigned displacement, RealRegister dest, codeGen& gen)
{
    gen.markRegDefined(dest.reg());
    GET_PTR(insn, gen);
    *insn++             = 0x8D;
...
void
emitMovPCRMToReg(RealRegister dest, int offset, codeGen& gen, bool deref_result)
{
    ...
    if(gen.getPCRelUseCount() > 1 && gen.rs()->pc_rel_use_count == gen.getPCRelUseCount())
    {
...
// emit MOV m, reg
void
emitMovRegToMB(int disp, RealRegister src, codeGen& gen)
{
    GET_PTR(insn, gen);
    *insn++        = 0x88;
...
// emit MOV m, reg
void
emitMovRegToMW(int disp, RealRegister src, codeGen& gen)
{
    GET_PTR(insn, gen);
    *insn++        = 0x66;
    *insn++        = 0x88;
...
void
emitAddMemImm32(Address addr, int imm, codeGen& gen)
{
    GET_PTR(insn, gen);
    *insn++             = 0x81;
    *insn++             = 0x05;
...
// emit Add reg, imm32
void
emitAddRegImm32(RealRegister reg, int imm, codeGen& gen)
{
    GET_PTR(insn, gen);
    if(imm >= -128 && imm <= 127)
    {
...
// emit Sub reg, reg
void
emitSubRegReg(RealRegister dest, RealRegister src, codeGen& gen)
{
    gen.markRegDefined(dest.reg());
    GET_PTR(insn, gen);
    *insn++ = 0x2B;
...
unsigned char
cmovOpcodeFromRelOp(unsigned op, bool s)
{
    switch(op)
    {
        case eqOp:
...
unsigned char
jccOpcodeFromRelOp(unsigned op, bool s)
{
    switch(op)
    {
        case eqOp:
...
Register
emitFuncCall(opCode, codeGen&, std::vector<AstNodePtr>&, bool, Address)
{
    assert(0);
    return 0;
}
...
Register
emitFuncCall(opCode op, codeGen& gen, std::vector<AstNodePtr>& operands, bool noCost,
...
bool
EmitterIA32::clobberAllFuncCall(registerSpace* rs, func_instance* callee)
...
void
EmitterIA32::setFPSaveOrNot(const int* liveFPReg, bool saveOrNot)
{
    if(liveFPReg != NULL)
    {
...
Register
EmitterIA32::emitCall(opCode op, codeGen& gen, const std::vector<AstNodePtr>& operands,
...
codeBufIndex_t
emitA(opCode op, Register src1, Register /*src2*/, long dest, codeGen& gen, RegControl rc,
      bool /*noCost*/)
{
...
Register
emitR(opCode op, Register src1, Register src2, Register dest, codeGen& gen, bool noCost,
      const instPoint* location, bool /*for_multithreaded*/)
{
    ...
    switch(op)
    {
        ...
        case getParamAtEntryOp:
            ...
            // dest is a register where we can store the value
            gen.codeEmitter()->emitGetParam(dest, src1, location->type(), op, get_addr_of,
                                            gen);
            if(!get_addr_of)
                return dest;
            break;
...
emitSHL(RealRegister dest, unsigned char pos, codeGen& gen)
{
    ...
    GET_PTR(insn, gen);
    *insn++ = 0xC1;
    *insn++ = makeModRMbyte(3 /* rm gives register */, 4 /* opcode ext. */, dest.reg());
    *insn++ = pos;
    SET_PTR(insn, gen);
}

void
EmitterIA32::emitPushFlags(codeGen& gen)
{
...
void
EmitterIA32::emitRestoreFlags(codeGen&, unsigned)
{
...
void
EmitterIA32::emitRestoreFlagsFromStackSlot(codeGen& gen)
{
...
stackItemLocation
getHeightOf(stackItem sitem, codeGen& gen)
{
    int          offset = 0;
    RealRegister reg;
...
Register
restoreGPRtoReg(RealRegister reg, codeGen& gen, RealRegister* dest_to_use)
{
    ...
    if(r->spilledState == registerSlot::unspilled || !gen.isRegDefined(reg.reg()))
    {
...
void
restoreGPRtoGPR(RealRegister src, RealRegister dest, codeGen& gen)
{
...
void
emitASload(const BPatch_addrSpec_NP* as, Register dest, int stackShift, codeGen& gen,
           bool /* noCost */)
{
...
void
EmitterIA32::emitASload(int ra, int rb, int sc, long imm, Register dest, int stackOffset,
                        codeGen& gen)
{
...
void
emitCSload(const BPatch_countSpec_NP* as, Register dest, codeGen& gen, bool /* noCost */)
{
...
void
EmitterIA32::emitCSload(int ra, int rb, int sc, long imm, Register dest, codeGen& gen)
{
...
void
emitVload(opCode op, Address src1, Register src2, Register dest, codeGen& gen,
...
void
emitVstore(opCode op, Register src1, Register src2, Address dest, codeGen& gen,
           bool /*noCost*/, registerSpace* /*rs*/, int size,
           const instPoint* /* location */, AddressSpace* /* proc */)
{
    if(op == storeOp)
...
void
emitV(opCode op, Register src1, Register src2, Register dest, codeGen& gen,
      bool /*noCost*/, registerSpace* /*rs*/, int size, const instPoint* /* location */,
...
void
emitImm(opCode op, Register src1, RegValue src2imm, Register dest, codeGen& gen, bool,
        registerSpace*, bool s)
{
    if(op == storeOp)
    {
...
getInsnCost(opCode op)
{
    ...
    {  // VG(8/15/02): No clue if this is right or not
        return (1 + 2 + 1);
    }
    else if(op == whileOp)
    {
...
bool
EmitterIA32::emitPush(codeGen& gen, Register reg)
{
...
bool
EmitterIA32::emitPop(codeGen& gen, Register reg)
{
    RealRegister real_reg = gen.rs()->loadVirtual(reg, gen);
...
bool
emitPop(RealRegister reg, codeGen& gen)
{
    GET_PTR(insn, gen);
    int r = reg.reg();
    assert(r < 8);
...
bool
EmitterIA32::emitAdjustStackPointer(int index, codeGen& gen)
{
...
void
emitLoadPreviousStackFrameRegister(Address register_num, Register dest, codeGen& gen, int,
                                   bool)
{
...
void
emitStorePreviousStackFrameRegister(Address register_num, Register src, codeGen& gen, int,
                                    bool)
{
...
bool
AddressSpace::getDynamicCallSiteArgs(InstructionAPI::Instruction insn, Address addr,
...
bool
func_instance::setReturnValue(int val)
{
    codeGen gen(16);
...
unsigned
saveRestoreRegistersInBaseTramp(AddressSpace* /*proc*/, baseTramp* /*bt*/,
                                registerSpace* /*rs*/)
{
    return 0;
}
 ...
 **/
bool
writeFunctionPtr(AddressSpace* p, Address addr, func_instance* f)
{
...
bool
emitStoreConst(Address addr, int imm, codeGen& gen, bool noCost)
{
...
bool
emitAddSignedImm(Address addr, long int imm, codeGen& gen, bool noCost)
{
...
bool
emitSubSignedImm(Address addr, long int imm, codeGen& gen, bool noCost)
{
...
void
registerSpace::initRealRegSpace()
{
...
void
registerSpace::movRegToReg(RealRegister dest, RealRegister src, codeGen& gen)
{
    gen.markRegDefined(dest.reg());
...
void
registerSpace::spillToVReg(RealRegister reg, registerSlot* v_reg, codeGen& gen)
{
...
void
registerSpace::movVRegToReal(registerSlot* v_reg, RealRegister r, codeGen& gen)
{
    stackItemLocation loc = getHeightOf(stackItem::framebase, gen);
    loc.offset += -4 * v_reg->encoding();
...
void
emitBTRegRestores32(baseTramp* bt, codeGen& gen)
{
...
void
emitJump(unsigned disp32, codeGen& gen)
{
    GET_PTR(insn, gen);
    *insn++        = 0xE9;
    *((int*) insn) = disp32;
...
int
EmitterIA32::emitCallParams(codeGen& gen, const std::vector<AstNodePtr>& operands,
...
bool
EmitterIA32::emitCallCleanup(codeGen& gen, func_instance* /*target*/, int frame_size,
