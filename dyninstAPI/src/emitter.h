...
public:
    virtual ~Emitter() {}
    virtual codeBufIndex_t emitIf(Register expr_reg, Register target, RegControl rc,
                                  codeGen& gen)                                = 0;
    virtual void emitOp(unsigned opcode, Register dest, Register src1, Register src2,
                        codeGen& gen)                                          = 0;
    virtual void emitOpImm(unsigned opcode1, unsigned opcode2, Register dest,
                           Register src1, RegValue src2imm, codeGen& gen)      = 0;
    virtual void emitRelOp(unsigned op, Register dest, Register src1, Register src2,
                           codeGen& gen, bool s)                               = 0;
    virtual void emitRelOpImm(unsigned op, Register dest, Register src1, RegValue src2imm,
                              codeGen& gen, bool s)                            = 0;
    ...
    virtual void emitTimesImm(Register dest, Register src1, RegValue src2imm,
                              codeGen& gen)                                    = 0;
    virtual void emitDivImm(Register dest, Register src1, RegValue src2imm, codeGen& gen,
                            bool s)                                            = 0;
    ...
    virtual bool emitLoadRelative(Register dest, Address offset, Register base, int size,
                                  codeGen& gen)                                = 0;
    virtual void emitLoadShared(opCode op, Register dest, const image_variable* var,
    ...
    virtual void emitLoadOrigFrameRelative(Register dest, Address offset,
                                           codeGen& gen)           = 0;
    virtual void emitLoadOrigRegRelative(Register dest, Address offset, Register base,
                                         codeGen& gen, bool store) = 0;
    ...
    virtual void emitStoreIndir(Register addr_reg, Register src, int size,
                                codeGen& gen)                                  = 0;
    virtual void emitStoreFrameRelative(Address offset, Register src, Register scratch,
    ...
    virtual void emitGetParam(Register dest, Register param_num, instPoint::Type pt_type,
                              opCode op, bool addr_of, codeGen& gen)      = 0;
    ...
    virtual bool emitPLTCall(func_instance*, codeGen&)
    {
        assert(0);
        return false;
    }
    virtual bool emitPLTJump(func_instance*, codeGen&)
    {
        assert(0);
        return false;
    }
