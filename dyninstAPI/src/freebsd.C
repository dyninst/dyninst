...
bool BinaryEdit::getResolvedLibraryPath(const std::string &filename,
...
bool PCProcess::skipHeap(const heapDescriptor &) { return false; }

bool AddressSpace::usesDataLoadAddress() const { return false; }

bool PCProcess::copyDanglingMemory(PCProcess *) { return true; }
...
void initPrimitiveCost() { assert(!FREEBSD_NOT_IMPLEMENTED); }
...
bool PCProcess::bindPLTEntry(Dyninst::SymtabAPI::relocationEntry const &,
                             Address, func_instance *, Address) {
  return false;
}
