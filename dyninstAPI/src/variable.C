...
Address image_variable::getOffset() const { return var_->getOffset(); }
...
int_variable::int_variable(image_variable *var, Address base,
                           mapped_module *mod)
    : addr_(base + var->getOffset()), size_(0), ivar_(var), mod_(mod) {}
...
string int_variable::symTabName() const { return ivar_->symTabName(); }
