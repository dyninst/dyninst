...
/* $Id: process.h,v 1.383 2006/06/06 20:43:15 bernat Exp $
...
class process {
 ...
 public:
  ...
  // states)
  void set_status(processState st, bool overrideState = false);
...
// garbage collect instrumentation
  ...
  bool writeThreadStruct(Address baseAddr, dyninst_thread_t &struc);
};
