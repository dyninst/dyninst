...
getAccesses(ParseAPI::Function* func, ParseAPI::Block* block, Address addr,
            ...
            std::set<Address>& defPointsToMod, bool analyzeDefinition = false);

bool
getMemoryOffset(ParseAPI::Function* func, ParseAPI::Block* block,
                InstructionAPI::Instruction insn, Address addr, const MachRegister& reg,
                const StackAnalysis::Height& height, const StackAnalysis::Definition& def,
                StackAccess*& ret, Architecture arch, bool analyzeDefintion = false);
