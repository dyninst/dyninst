...
#ifndef _EMITTER_AARCH32_H
#define _EMITTER_AARCH32_H
...
class EmitterAARCH32 : public Emitter {

 public:
    virtual ~EmitterAARCH32() {};
...
class EmitterAARCH32Dyn : public EmitterAARCH32
{
  public:
  ...
  virtual bool emitTOCJump(block_instance *dest, codeGen &gen) { return emitTOCCommon(dest, false, gen); }
    virtual ~EmitterAARCH32Dyn() {}
 private:
    bool emitTOCCommon(block_instance *dest, bool call, codeGen &gen);

};

class EmitterAARCH32Stat : public EmitterAARCH32 {
  public:
    virtual ~EmitterAARCH32Stat() {}
