...
inline unsigned uiHash(const unsigned &val) { return val; }

inline unsigned CThash(const unsigned &val) { return val % 1048573; }

unsigned ptrHash4(void *ptr);
unsigned ptrHash16(void *ptr);

inline unsigned intHash(const int &val) { return val; }
