...
void
ASTFactory::visit(BinaryFunction* b)
{
    ...
    if(b->isAdd())
    {
        m_stack.push_back(AstNode::operatorNode(plusOp, lhs, rhs));
    }
    else if(b->isMultiply())
    {
        m_stack.push_back(AstNode::operatorNode(timesOp, lhs, rhs));
    }
    else
    {
        assert(0);
...
void
ASTFactory::visit(RegisterAST* r)
{
#if defined(arch_x86) || defined(arch_x86_64)
    bool unused;
    ...
    m_stack.push_back(AstNode::operandNode(AstNode::origRegister, (void*) (astreg)));
#endif
}
