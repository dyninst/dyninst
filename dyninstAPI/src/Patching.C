...
void
DynPatchCallback::split_block_cb(PatchBlock* first, PatchBlock* second)
{
...
void
DynPatchCallback::add_block_cb(PatchFunction* func, PatchBlock* block)
{
    SCAST_FI(func)->add_block_cb(SCAST_BI(block));
}

void
DynPatchCallback::remove_block_cb(PatchFunction* f, PatchBlock* b)
{
    SCAST_FI(f)->removeBlock(SCAST_BI(b));
}

void
DynPatchCallback::destroy_cb(Point* p)
{
    static_cast<instPoint*>(p)->func()->obj()->remove(static_cast<instPoint*>(p));
}

void
DynPatchCallback::destroy_cb(PatchAPI::PatchBlock* b)
{
    SCAST_MO(b->obj())->destroy(SCAST_BI(b));
}
void
DynPatchCallback::destroy_cb(PatchEdge*, PatchObject*)
{
    // nothing to do
}
void
DynPatchCallback::destroy_cb(PatchAPI::PatchFunction* f)
{
    SCAST_MO(f->obj())->destroy(SCAST_FI(f));
}
void
DynPatchCallback::destroy_cb(PatchAPI::PatchObject*)
{
