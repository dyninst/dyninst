...
void EmitterAMD64::emitLoadShared(opCode op, Register dest, const image_variable *var, int size, codeGen &gen)
{
    // create or retrieve jump slot
...
void EmitterAMD64::emitStoreShared(opCode op, Register source, const image_variable *var, int size, codeGen &gen)
{
    // create or retrieve jump slot
    Address addr = getInterModuleVarAddr(var, gen);
...
void EmitterIA32::emitStoreShared(opCode op, Register source, const image_variable *var, bool is_local, int size, codeGen &gen)
{
    // create or retrieve jump slot
    //Address addr = getInterModuleVarAddr(var, gen);
  Address addr;
