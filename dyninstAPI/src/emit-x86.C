...
static void
emitSegPrefix(Register segReg, codeGen& gen)
{
    switch(segReg)
    {
        case REGNUM_FS:
...
bool
EmitterIA32::emitMoveRegToReg(Register src, Register dest, codeGen& gen)
{
...
void
EmitterIA32::emitLEA(Register base, Register index, unsigned int scale, int disp,
...
void
EmitterIA32::emitOp(unsigned opcode, Register dest, Register src1, Register src2,
                    codeGen& gen)
{
...
void
EmitterIA32::emitRelOp(unsigned op, Register dest, Register src1, Register src2,
                       codeGen& gen, bool s)
{
    RealRegister src1_r    = gen.rs()->loadVirtual(src1, gen);
    RealRegister src2_r    = gen.rs()->loadVirtual(src2, gen);
...
void
EmitterIA32::emitDiv(Register dest, Register src1, Register src2, codeGen& gen, bool s)
{
    Register scratch = gen.rs()->allocateRegister(gen, true);
...
void
EmitterIA32::emitOpImm(unsigned opcode1, unsigned opcode2, Register dest, Register src1,
...
void
EmitterIA32::emitRelOpImm(unsigned op, Register dest, Register src1, RegValue src2imm,
                          codeGen& gen, bool s)
{
...
void
EmitterIA32::emitTimesImm(Register dest, Register src1, RegValue src2imm, codeGen& gen)
{
    int result;
...
void
EmitterIA32::emitDivImm(Register dest, Register src1, RegValue src2imm, codeGen& gen,
                        bool s)
{
    int result;
    if(src2imm == 1)
...
void
EmitterIA32::emitLoad(Register dest, Address addr, int size, codeGen& gen)
{
...
void
EmitterIA32::emitLoadConst(Register dest, Address imm, codeGen& gen)
{
    RealRegister r = gen.rs()->loadVirtualForWrite(dest, gen);
...
void
EmitterIA32::emitLoadIndir(Register dest, Register addr_reg, int /*size*/, codeGen& gen)
{
...
void
EmitterIA32::emitLoadOrigFrameRelative(Register dest, Address offset, codeGen& gen)
{
...
bool
EmitterIA32::emitLoadRelative(Register /*dest*/, Address /*offset*/, Register /*base*/,
...
bool
EmitterIA32::emitLoadRelativeSegReg(Register /*dest*/, Address offset, Register base,
                                    int /*size*/, codeGen& gen)
{
...
void
EmitterIA32::emitStoreRelative(Register /*src*/, Address /*offset*/, Register /*base*/,
                               int /*size*/, codeGen& /*gen*/)
{
    assert(0);
    return;
...
void
EmitterIA32::emitLoadOrigRegRelative(Register dest, Address offset, Register base,
...
void
EmitterIA32::emitLoadFrameAddr(Register dest, Address offset, codeGen& gen)
{
    RealRegister dest_r = gen.rs()->loadVirtualForWrite(dest, gen);
...
void
EmitterIA32::emitLoadOrigRegister(Address register_num, Register dest, codeGen& gen)
{
    RealRegister dest_r = gen.rs()->loadVirtualForWrite(dest, gen);
...
void
EmitterIA32::emitStoreOrigRegister(Address register_num, Register src, codeGen& gen)
{
    assert(0);  // MATT TODO
    ...
    emitMovRMToReg(RealRegister(REGNUM_EAX), RealRegister(REGNUM_EBP), -1 * (src * 4),
                   gen);
...
void
EmitterIA32::emitStore(Address addr, Register src, int size, codeGen& gen)
{
...
void
EmitterIA32::emitStoreIndir(Register addr_reg, Register src, int /*size*/, codeGen& gen)
{
    RealRegister src_r  = gen.rs()->loadVirtual(src, gen);
...
void
EmitterIA32::emitStoreFrameRelative(Address offset, Register src, Register scratch,
                                    int /*size*/, codeGen& gen)
{
    if(gen.bt()->createdFrame)
    {
...
void
EmitterIA32::emitGetRetVal(Register dest, bool addr_of, codeGen& gen)
{
    RealRegister dest_r = gen.rs()->loadVirtualForWrite(dest, gen);
    if(!addr_of)
    {
...
void
EmitterIA32::emitGetRetAddr(Register dest, codeGen& gen)
{
...
void
EmitterIA32::emitGetParam(Register dest, Register param_num, instPoint::Type pt_type,
...
void
EmitterIA32::emitStackAlign(int offset, codeGen& gen)
{
...
bool
EmitterIA32::emitBTSaves(baseTramp* bt, codeGen& gen)
{
...
bool
EmitterIA32::emitBTRestores(baseTramp* bt, codeGen& gen)
{
    bool useFPRs;
    bool createFrame;
    bool saveOrigAddr;
    ...
    if(useFPRs)
    {
        if(gen.rs()->hasXMM)
        {
            ...
            *insn++ = 0x24;
            ...
            emitOpRegRM(FRSTOR, RealRegister(FRSTOR_OP), RealRegister(REGNUM_ESP), 0,
                        gen);
    }
...
static void
emitRex(bool is_64, Register* r, Register* x, Register* b, codeGen& gen)
{
...
void
EmitterIA32::emitStoreImm(Address addr, int imm, codeGen& gen, bool /*noCost*/)
{
    emitMovImmToMem(addr, imm, gen);
}

void
emitAddMem(Address addr, int imm, codeGen& gen)
{
...
void
EmitterIA32::emitAddSignedImm(Address addr, int imm, codeGen& gen, bool /*noCost*/)
{
...
bool
isImm64bit(Address imm)
{
    return (imm >> 32);
}

void
emitMovRegToReg64(Register dest, Register src, bool is_64, codeGen& gen)
{
    if(dest == src)
        return;
...
static void
emitMovRMToReg64(Register dest, Register base, int disp, int size, codeGen& gen)
{
    Register tmp_dest = dest;
    Register tmp_base = base;
...
static void
emitMovSegRMToReg64(Register dest, Register base, int disp, codeGen& gen)
{
    Register tmp_dest = dest;
    Register tmp_base = base;
    ...
    emitSegPrefix(base, gen);
    emitRex(true, &tmp_dest, NULL, &tmp_base, gen);
    emitOpSegRMReg(MOV_RM32_TO_R32, RealRegister(tmp_dest), RealRegister(tmp_base), disp,
                   gen);
}

static void
emitMovRegToRM64(Register base, int disp, Register src, int size, codeGen& gen)
{
    Register tmp_base = base;
    Register tmp_src  = src;
...
static void
emitOpRegReg64(unsigned opcode, Register dest, Register src, bool is_64, codeGen& gen)
{
    Register tmp_dest = dest;
    Register tmp_src  = src;
    emitRex(is_64, &tmp_dest, NULL, &tmp_src, gen);
...
static void
emitOpRegRM64(unsigned opcode, Register dest, Register base, int disp, bool is_64,
              codeGen& gen)
{
    Register tmp_dest = dest;
    Register tmp_base = base;
...
void
emitOpRegImm64(unsigned opcode, unsigned opcode_ext, Register rm_reg, int imm, bool is_64,
               codeGen& gen)
{
...
static void
emitOpMemImm64(unsigned opcode, unsigned opcode_ext, Register base, int imm, bool is_64,
               codeGen& gen)
{
    Register tmp_base = base;
...
static void
emitOpRegRegImm64(unsigned opcode, Register dest, Register src1, int imm, bool is_64,
                  codeGen& gen)
{
...
static void
emitOpRegImm8_64(unsigned opcode, unsigned opcode_ext, Register dest, char imm,
...
void
emitPushReg64(Register src, codeGen& gen)
{
...
void
emitPopReg64(Register dest, codeGen& gen)
{
...
bool
EmitterAMD64::emitMoveRegToReg(Register src, Register dest, codeGen& gen)
{
...
bool
EmitterAMD64::emitMoveRegToReg(registerSlot* source, registerSlot* dest, codeGen& gen)
{
...
void
EmitterAMD64::emitLEA(Register base, Register index, unsigned int scale, int disp,
                      Register dest, codeGen& gen)
{
    Register tmp_base  = base;
    Register tmp_index = index;
    Register tmp_dest  = dest;
    emitRex(/*is_64*/ true, &tmp_dest, tmp_index == Null_Register ? NULL : &tmp_index,
...
codeBufIndex_t
EmitterAMD64::emitIf(Register expr_reg, Register target, RegControl, codeGen& gen)
{
    // test %expr, %expr
...
void
EmitterAMD64::emitOp(unsigned opcode, Register dest, Register src1, Register src2,
                     codeGen& gen)
{
...
void
EmitterAMD64::emitOpImm(unsigned opcode1, unsigned opcode2, Register dest, Register src1,
                        RegValue src2imm, codeGen& gen)
{
    if(src1 != dest)
    {
...
void
EmitterAMD64::emitRelOp(unsigned op, Register dest, Register src1, Register src2,
                        codeGen& gen, bool s)
{
    // cmp %src2, %src1
...
void
EmitterAMD64::emitDiv(Register dest, Register src1, Register src2, codeGen& gen, bool s)
{
...
void
EmitterAMD64::emitTimesImm(Register dest, Register src1, RegValue src2imm, codeGen& gen)
{
    int result = -1;
...
void
EmitterAMD64::emitDivImm(Register dest, Register src1, RegValue src2imm, codeGen& gen,
                         bool s)
{
    int result = -1;
    gen.markRegDefined(dest);
...
void
EmitterAMD64::emitLoad(Register dest, Address addr, int size, codeGen& gen)
{
...
void
EmitterAMD64::emitLoadConst(Register dest, Address imm, codeGen& gen)
{
...
void
EmitterAMD64::emitLoadIndir(Register dest, Register addr_src, int size, codeGen& gen)
{
...
void
EmitterAMD64::emitLoadOrigFrameRelative(Register dest, Address offset, codeGen& gen)
{
    if(gen.bt()->createdFrame)
    {
        Register scratch = gen.rs()->getScratchRegister(gen);
...
bool
EmitterAMD64::emitLoadRelative(Register dest, Address offset, Register base,
                               int /* size */, codeGen& gen)
{
    // mov offset(%base), %dest
    emitMovRMToReg64(dest, base, offset, gen.addrSpace()->getAddressWidth(), gen);
    gen.markRegDefined(dest);
    return true;
}

bool
EmitterAMD64::emitLoadRelativeSegReg(Register dest, Address offset, Register base,
                                     int /* size */, codeGen& gen)
{
...
void
EmitterAMD64::emitLoadFrameAddr(Register dest, Address offset, codeGen& gen)
{
    // mov (%rbp), %dest
    if(gen.bt()->createdFrame)
    {
...
void
EmitterAMD64::emitLoadOrigRegRelative(Register dest, Address offset, Register base,
                                      codeGen& gen, bool store)
{
    Register scratch = gen.rs()->getScratchRegister(gen);
...
void
EmitterAMD64::emitLoadOrigRegister(Address register_num, Register destination,
                                   codeGen& gen)
{
...
void
EmitterAMD64::emitStoreOrigRegister(Address register_num, Register src, codeGen& gen)
{
...
void
EmitterAMD64::emitStore(Address addr, Register src, int size, codeGen& gen)
{
    Register scratch = gen.rs()->getScratchRegister(gen);
    gen.markRegDefined(scratch);
...
void
EmitterAMD64::emitStoreIndir(Register addr_reg, Register src, int size, codeGen& gen)
{
    emitMovRegToRM64(addr_reg, 0, src, size, gen);
}

void
EmitterAMD64::emitStoreFrameRelative(Address offset, Register src, Register /*scratch*/,
                                     int size, codeGen& gen)
{
    if(gen.bt()->createdFrame)
    {
...
void
EmitterAMD64::emitStoreRelative(Register src, Address offset, Register base,
                                int /* size */, codeGen& gen)
{
    emitMovRegToRM64(base, offset, src, gen.addrSpace()->getAddressWidth(), gen);
}

void
EmitterAMD64::setFPSaveOrNot(const int* liveFPReg, bool saveOrNot)
{
    if(liveFPReg != NULL)
    {
...
bool
EmitterAMD64::clobberAllFuncCall(registerSpace* rs, func_instance* callee)
...
Register
EmitterAMD64::emitCall(opCode op, codeGen& gen, const std::vector<AstNodePtr>& operands,
                       bool noCost, func_instance* callee)
{
    ...
    if(inInstrumentation)
    {
        ...
        for(int i = 0; i < gen.rs()->numGPRs(); i++)
        {
            ...
            bool                    callerSave = regsClobberedByCall.test(
                live.getIndex(regToMachReg64.equal_range(r).first->second));
            if(!callerSave)
            {
                // We don't care!
            ...
            regalloc_printf(
                "%s[%d]: pre-call, register %u has refcount %d, keptValue %d, liveState "
                "%s\n",
                FILE__, __LINE__, reg->number, reg->refCount, reg->keptValue,
            ...
            {
                // mapping from Register to MachRegister, then to index in liveness
                // bitArray
                if(regsClobberedByCall.test(
                       live.getIndex(regToMachReg64.equal_range(r).first->second)))
                {
    ...
    for(int u = operands.size() - 1; u >= 0; u--)
    {
        ...
        else
        {
            ...
            {
                cerr << "Error: tried to allocate register " << amd64_arg_regs[u]
                     << " and failed!" << endl;
                assert(0);
            }
    ...
    if(frame_size)
    {
        ...
        // emitOpRegImm64(0x81, EXTENDED_0x81_ADD, REGNUM_RSP, frame_size * 8, gen); //
        // add esp, frame_size
    }
...
bool
EmitterAMD64Dyn::emitCallInstruction(codeGen& gen, func_instance* callee, Register)
{
...
bool
EmitterAMD64Stat::emitCallInstruction(codeGen& gen, func_instance* callee, Register)
{
...
void
EmitterAMD64::emitGetRetVal(Register dest, bool addr_of, codeGen& gen)
{
    if(!addr_of)
    {
...
void
EmitterAMD64::emitASload(int ra, int rb, int sc, long imm, Register dest, int stackShift,
                         codeGen& gen)
{
...
void
EmitterAMD64::emitCSload(int ra, int rb, int sc, long imm, Register dest, codeGen& gen)
{
...
// (1 qword for our false return address, 16 for the saved registers, 1 more for the
// flags)
#    define SAVED_RFLAGS_OFFSET 18

void
EmitterAMD64::emitRestoreFlags(codeGen& gen, unsigned offset)
{
    if(offset)
        emitOpRMReg(PUSH_RM_OPC1, RealRegister(REGNUM_EBP), offset * 8,
                    RealRegister(PUSH_RM_OPC2), gen);
    emitSimpleInsn(0x9D, gen);
}

void
EmitterAMD64::emitPushFlags(codeGen& gen)
{
    // save flags (PUSHFQ)
...
void
EmitterAMD64::emitStackAlign(int offset, codeGen& gen)
{
    ...
    emitOpRegImm8_64(0x83, EXTENDED_0x83_AND, REGNUM_RSP, -AMD64_STACK_ALIGNMENT, true,
                     gen);
...
bool
EmitterAMD64::emitBTSaves(baseTramp* bt, codeGen& gen)
{
    gen.setInInstrumentation(true);
    ...
    if(useFPRs)
    {
        ...
        for(auto curReg = gen.rs()->FPRs().begin(); curReg != gen.rs()->FPRs().end();
            ++curReg)
        {
...
bool
EmitterAMD64::emitBTRestores(baseTramp* bt, codeGen& gen)
{
    bool useFPRs        = false;
...
void
EmitterAMD64::emitStoreImm(Address addr, int imm, codeGen& gen, bool noCost)
{
...
void
EmitterAMD64::emitAddSignedImm(Address addr, int imm, codeGen& gen, bool noCost)
{
    if(!isImm64bit(addr) && !isImm64bit(imm))
    {
        emitAddMem(addr, imm, gen);
...
bool
EmitterAMD64::emitPush(codeGen& gen, Register reg)
{
    emitPushReg64(reg, gen);
    return true;
}
...
bool
EmitterAMD64::emitPop(codeGen& gen, Register reg)
{
...
bool
EmitterAMD64::emitAdjustStackPointer(int index, codeGen& gen)
{
...
bool
EmitterIA32Dyn::emitCallInstruction(codeGen& gen, func_instance* callee, Register ret)
{
    // make the call
...
bool
EmitterIA32Stat::emitCallInstruction(codeGen& gen, func_instance* callee, Register ret)
{
    AddressSpace* addrSpace = gen.addrSpace();
    Address       dest;
...
bool
EmitterIA32Stat::emitPLTCall(func_instance* callee, codeGen& gen)
{
    // create or retrieve jump slot
    Address dest = getInterModuleFuncAddr(callee, gen);
...
bool
EmitterIA32Stat::emitPLTJump(func_instance* callee, codeGen& gen)
{
    // create or retrieve jump slot
    Address dest = getInterModuleFuncAddr(callee, gen);
    // load register with address from jump slot
...
void
EmitterIA32::emitLoadShared(opCode op, Register dest, const image_variable* var,
...
void
EmitterIA32::emitStoreShared(Register source, const image_variable* var, bool is_local,
                             int /*size*/, codeGen& gen)
{
    // create or retrieve jump slot
...
bool
EmitterIA32::emitXorRegRM(Register dest, Register base, int disp, codeGen& gen)
{
    RealRegister dest_r = gen.rs()->loadVirtualForWrite(dest, gen);
...
bool
EmitterIA32::emitXorRegReg(Register dest, Register base, codeGen& gen)
{
    RealRegister dest_r = gen.rs()->loadVirtualForWrite(dest, gen);
...
bool
EmitterIA32::emitXorRegImm(Register dest, int imm, codeGen& gen)
{
    RealRegister dest_r = gen.rs()->loadVirtualForWrite(dest, gen);
...
bool
EmitterIA32::emitXorRegSegReg(Register /*dest*/, Register base, int disp, codeGen& gen)
{
...
#if defined(arch_x86_64)
void
EmitterAMD64::emitLoadShared(opCode op, Register dest, const image_variable* var,
                             bool is_local, int size, codeGen& gen, Address offset)
{
    Address addr;
    gen.markRegDefined(dest);
    ...
    if(op == loadConstOp)
    {
        ...
        // Brutal hack for IP-relative: displacement operand on 32-bit = IP-relative on
        // 64-bit.
        if(is_local || !var)
...
void
EmitterAMD64::emitStoreShared(Register source, const image_variable* var, bool is_local,
                              int size, codeGen& gen)
{
    Address addr;
...
bool
EmitterAMD64::emitXorRegRM(Register dest, Register base, int disp, codeGen& gen)
{
...
bool
EmitterAMD64::emitXorRegReg(Register dest, Register base, codeGen& gen)
{
...
bool
EmitterAMD64::emitXorRegImm(Register dest, int imm, codeGen& gen)
{
...
bool
EmitterAMD64::emitXorRegSegReg(Register dest, Register base, int disp, codeGen& gen)
{
    Register tmp_dest = dest;
    Register tmp_base = base;
    ...
    emitSegPrefix(base, gen);
    emitRex(true, &tmp_dest, NULL, &tmp_base, gen);
    emitOpSegRMReg(XOR_R32_RM32, RealRegister(tmp_dest), RealRegister(tmp_base), disp,
                   gen);
    gen.markRegDefined(dest);
    return true;
}
