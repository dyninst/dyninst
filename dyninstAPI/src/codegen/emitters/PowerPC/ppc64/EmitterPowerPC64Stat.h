...
#ifndef DYNINST_DYNINSTAPI_CODEGEN_EMITTERS_PPC64_EMITTERPPC64STAT_H
#define DYNINST_DYNINSTAPI_CODEGEN_EMITTERS_PPC64_EMITTERPPC64STAT_H

#include "codegen/emitters/PowerPC/EmitterPowerPC.h"

/*
 *  Instruction emitter for static instrumentation on 64-bit PowerPC
 */

namespace Dyninst { namespace DyninstAPI {

  class EmitterPowerPC64Stat : public Dyninst::DyninstAPI::EmitterPowerPC {
  public:
    ~EmitterPowerPC64Stat() = default;
