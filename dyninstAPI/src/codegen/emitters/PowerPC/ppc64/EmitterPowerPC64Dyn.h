...
#ifndef DYNINST_DYNINSTAPI_CODEGEN_EMITTERS_PPC64_EMITTERPPC64DYN_H
#define DYNINST_DYNINSTAPI_CODEGEN_EMITTERS_PPC64_EMITTERPPC64DYN_H

#include "codegen/emitters/PowerPC/EmitterPowerPC.h"

/*
 *  Instruction emitter for dynamic instrumentation on 64-bit PowerPC
 */

namespace Dyninst { namespace DyninstAPI {

  class EmitterPowerPC64Dyn : public EmitterPowerPC {
  public:
