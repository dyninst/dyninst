...
#ifndef DYNINST_DYNINSTAPI_CODEGEN_EMITTERS_X86_IA32_EMITTERIA32STAT_H
#define DYNINST_DYNINSTAPI_CODEGEN_EMITTERS_X86_IA32_EMITTERIA32STAT_H

/*
 *  Instruction emitter for static instrumentation on IA32
 */
...
namespace Dyninst { namespace DyninstAPI {
  ...
  class EmitterIA32Stat final : public EmitterIA32 {
  public:
