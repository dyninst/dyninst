...
class instPoint : public Dyninst::PatchAPI::Point {
 ...
 private:
  ...
  // Insn
  instPoint(Type, PatchMgrPtr, block_instance *, Address,
            InstructionAPI::Instruction::Ptr, func_instance *);
 ...
 public:
  ...
  virtual Dyninst::PatchAPI::InstancePtr pushBack(
      Dyninst::PatchAPI::SnippetPtr);
  virtual Dyninst::PatchAPI::InstancePtr pushFront(
      Dyninst::PatchAPI::SnippetPtr);
 ...
 private:
  ...
  static bool checkInsn(block_instance *,
                        InstructionAPI::Instruction::Ptr &insn, Address a);
