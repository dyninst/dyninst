...
public:
    ...
    static instPoint* preInsn(func_instance*, block_instance*, Address,
                              InstructionAPI::Instruction = InstructionAPI::Instruction(),
                              bool trusted                = false);
    static instPoint* postInsn(
        func_instance*, block_instance*, Address,
        InstructionAPI::Instruction = InstructionAPI::Instruction(),
        bool trusted                = false);
    static instPoint* preCall(func_instance*, block_instance*);
    static instPoint* postCall(func_instance*, block_instance*);
...
private:
    ...
    // Insn
    instPoint(Type, PatchMgrPtr, block_instance*, Address, InstructionAPI::Instruction,
              func_instance*);
...
private:
    ...
    static bool checkInsn(block_instance*, InstructionAPI::Instruction& insn, Address a);
