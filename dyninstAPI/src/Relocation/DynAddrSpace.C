...
bool
DynAddrSpace::loadLibrary(DynObject* obj)
{
    if(obj)
    {
        loadObject(obj);
...
bool
DynAddrSpace::removeAddrSpace(AddressSpace* as)
{
    as_set_.erase(as);
    return true;
}
...
bool
DynAddrSpace::write(PatchObject* obj, Address to, Address from, size_t size)
{
...
Address
DynAddrSpace::malloc(PatchObject* obj, size_t size, Address /*near*/)
{
    DynObject* dobj = dynamic_cast<DynObject*>(obj);
...
bool
DynAddrSpace::realloc(PatchObject* obj, Address orig, size_t size)
{
    DynObject* dobj = dynamic_cast<DynObject*>(obj);
...
bool
DynAddrSpace::free(PatchObject* obj, Address orig)
{
    DynObject* dobj = dynamic_cast<DynObject*>(obj);
