...
class DynInsertSnipCommand : public Command {
 public:
  DynInsertSnipCommand(instPoint* pt, callOrder order, AstNodePtr ast,
                       bool recursive);
...
class DynModifyCallCommand : public Command {
 public:
  DynModifyCallCommand(AddressSpace* as, block_instance* block,
...
class DynRemoveCallCommand : public Command {
 public:
  DynRemoveCallCommand(AddressSpace* as, block_instance* block,
                       func_instance* context);
