...
PatchFunction*
DynCFGMaker::makeFunction(Function* f, PatchObject* obj)
{
...
PatchFunction*
DynCFGMaker::copyFunction(PatchFunction* f, PatchObject* o)
{
...
PatchBlock*
DynCFGMaker::makeBlock(ParseAPI::Block* b, PatchObject* obj)
{
...
PatchBlock*
DynCFGMaker::copyBlock(PatchBlock* b, PatchObject* o)
{
...
PatchEdge*
DynCFGMaker::makeEdge(ParseAPI::Edge* e, PatchBlock* s, PatchBlock* t, PatchObject* o)
{
    ...
    edge_instance* inst = new edge_instance(e, s ? SCAST_BI(s) : moS->findBlock(e->src()),
                                            t ? SCAST_BI(t) : moT->findBlock(e->trg()));

#else  // doesn't allow inter-object edges
    mapped_object* mo   = t ? t->obj() : NULL;
    edge_instance* inst = new edge_instance(e, s ? SCAST_BI(s) : mo->findBlock(e->src()),
...
PatchEdge*
DynCFGMaker::copyEdge(PatchEdge* e, PatchObject* o)
{
