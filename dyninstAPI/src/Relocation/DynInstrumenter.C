...
DynInsertSnipCommand::DynInsertSnipCommand(instPoint* pt, callOrder order,
  ...
  if (inst_ && recursive) inst_->disableRecursiveGuard();
}

DynInsertSnipCommand* DynInsertSnipCommand::create(instPoint* pt,
                                                   callOrder order,
                                                   AstNodePtr ast,
                                                   bool recursive) {
...
bool DynInsertSnipCommand::run() { return true; }
...
DynRemoveSnipCommand::DynRemoveSnipCommand(
    Dyninst::PatchAPI::Instance::Ptr inst)
    : inst_(inst) {}

DynRemoveSnipCommand* DynRemoveSnipCommand::create(
    Dyninst::PatchAPI::Instance::Ptr inst) {
