...
public:
    ...
    static Ptr create(InstructionAPI::Instruction insn, Address addr, signed long newDisp,
                      Architecture arch);
...
private:
    StackModWidget(InstructionAPI::Instruction insn, Address addr, signed long newDisp,
                   Architecture arch)
    : insn_(insn)
    , addr_(addr)
    , newDisp_(newDisp)
...
{
    StackModPatch(InstructionAPI::Instruction a, signed long d, Architecture ar,
                  Address ad)
    : orig_insn(a)
    , newDisp(d)
    , arch(ar)
