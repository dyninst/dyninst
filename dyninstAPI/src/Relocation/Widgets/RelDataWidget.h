...
public:
    ...
    static Ptr create(InstructionAPI::Instruction insn, Address addr, Address target);
...
private:
    RelDataWidget(InstructionAPI::Instruction insn, Address addr, Address target)
    : insn_(insn)
    , addr_(addr)
    , target_(target)
    {}
