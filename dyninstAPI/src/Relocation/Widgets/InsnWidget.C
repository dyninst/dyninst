...
bool InsnWidget::generate(const codeGen &, const RelocBlock *t,
                          CodeBuffer &buffer) {
...
InsnWidget::Ptr InsnWidget::create(Instruction::Ptr insn, Address addr) {
...
unsigned InsnWidget::size() const { return insn_->size(); }
