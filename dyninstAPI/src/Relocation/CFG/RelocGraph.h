...
class RelocGraph {
 public:
  ...
  typedef std::map<std::pair<block_instance *, func_instance *>, RelocBlock *>
      Map;
  ...
  bool setSpringboard(block_instance *from, func_instance *func,
                      RelocBlock *to);
...
template <class Predicate>
void RelocGraph::applyPredicate(Predicate &p, RelocEdges *e,
                                RelocEdges &results) {
...
template <class Predicate>
bool RelocGraph::changeType(Predicate &p, RelocEdges *e,
