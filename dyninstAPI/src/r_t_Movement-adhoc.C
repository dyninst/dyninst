...
bool adhocMovementTransformer::processBlock(BlockList::iterator &b_iter) {
...
bool adhocMovementTransformer::isPCRelData(Element::Ptr ptr,
				   Address &target) {
  target = 0;
