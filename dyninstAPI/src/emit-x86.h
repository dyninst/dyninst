...
public:
    ...
    virtual bool emitLoadRelativeSegReg(Register dest, Address offset, Register base,
    ...
    virtual void emitLEA(Register base, Register index, unsigned int scale, int disp,
                         Register dest, codeGen& gen) = 0;
...
public:
    ...
    int  emitCallParams(codeGen& gen, const std::vector<AstNodePtr>& operands,
    ...
    void emitLoadEffectiveAddress(Register base, Register index, unsigned int scale,
...
void
emitMovPCRMToReg64(Register dest, int offset, int size, codeGen& gen);
void
...
void
emitMovImmToRM64(Register base, int disp, int imm, codeGen& gen);
void
emitAddMem64(Address addr, int imm, codeGen& gen);
void
emitAddRM64(Address addr, int imm, codeGen& gen);
void
