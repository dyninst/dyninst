...
#ifdef IBM_BPATCH_COMPAT
  virtual bool getAddressRange(void *& /*_startAddress*/,
                               void *& /*_endAddress*/) {
    return false;
  }
  virtual bool getLineNumbers(unsigned int & /*_startLine*/,
                              unsigned int & /*_endLine*/) {
    return false;
  }
  virtual void getIncPoints(BPatch_Vector<BPatch_point *> & /*vect*/) {
    return;
  }
  virtual void getExcPoints(BPatch_Vector<BPatch_point *> & /*vect*/) {
    return;
  }
#endif
 protected:
  ...
  const char *strLanguage(BPatch_language l) {
    switch (l) {
      ...
      case BPatch_cPlusPlus:
        return "BPatch_cPlusPlus";
      case BPatch_fortran:
        return "BPatch_fortran";
      case BPatch_fortran77:
        return "BPatch_fortran77";
      case BPatch_fortran90:
        return "BPatch_fortran90";
      case BPatch_f90_demangled_stabstr:
        return "BPatch_fortran90_demangled_stabstr";
      case BPatch_fortran95:
        return "BPatch_fortran95";
      case BPatch_assembly:
        return "BPatch_assembly";
      case BPatch_mixed:
        return "BPatch_mixed";
      case BPatch_hpf:
        return "BPatch_hpf";
      case BPatch_java:
        return "BPatch_java";
      case BPatch_unknownLanguage:
        return "BPatch_unknownLanguage";
      default:
