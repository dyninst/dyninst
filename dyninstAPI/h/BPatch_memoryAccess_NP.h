...
class BPATCH_DLL_EXPORT BPatch_memoryAccess : public BPatch_instruction {
 ...
 protected:
  ...
  void set1st(bool _isLoad, bool _isStore, long _imm_s, int _ra_s, int _rb_s,
              ...
              unsigned int _scale_s = 0, int _preFcn = -1, int _cond = -1,
              bool _nt = false);
 ...
 public:
  ...
  BPatch_memoryAccess(internal_instruction *, long unsigned int _addr,
  ...
  BPatch_memoryAccess(internal_instruction *insn, long unsigned int _addr,
                      bool _isinternal_Load, bool _isStore, long _imm_s,
                      int _ra_s, int _rb_s, unsigned int _scale_s, long _imm_c,
                      int _ra_c, int _rb_c, unsigned int _scale_c, int _cond,
                      bool _nt, int _preFcn = -1);
  ...
  BPatch_memoryAccess(internal_instruction *insn, long unsigned int _addr,
                      ...
                      int _rb_c, unsigned short _preFcn);

  // initializes only the first access; #bytes is an expression & not a prefetch
  BPatch_memoryAccess(internal_instruction *insn, long unsigned int _addr,
                      bool _isLoad, bool _isStore, long _imm_s, int _ra_s,
                      int _rb_s, long _imm_c, int _ra_c, int _rb_c);

  // sets 2nd access; #bytes is constant
  void set2nd(bool _isLoad, bool _isStore, unsigned int _bytes, long _imm,
              int _ra, int _rb, unsigned int _scale = 0);
  ...
  BPatch_memoryAccess(internal_instruction *insn, long unsigned int _addr,
                      ...
                      int _rb_c, unsigned int _scale_c, bool _isLoad2,
                      bool _isStore2, long _imm2_s, int _ra2_s, int _rb2_s,
                      unsigned int _scale2_s, long _imm2_c, int _ra2_c,
                      int _rb2_c, unsigned int _scale2_c);
