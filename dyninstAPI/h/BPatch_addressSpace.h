...
BPATCH_DLL_EXPORT PatchMgrPtr
convert(const BPatch_addressSpace*);
}  // namespace PatchAPI
namespace SymtabAPI
{
class Symbol;
...
public:
    ...
    BPatch_variableExpr* findOrCreateVariable(int_variable* v, BPatch_type* type = NULL);
...
public:
    ...
    bool findFunctionsByAddr(Dyninst::Address addr, std::vector<BPatch_function*>& funcs);
    ...
    BPatch_variableExpr* createVariable(Dyninst::Address at_addr, BPatch_type* type,
