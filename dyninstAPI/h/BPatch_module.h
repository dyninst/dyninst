...
class Module;
struct AddressRange;
BPATCH_DLL_EXPORT Module*
                  convert(const BPatch_module*);
}  // namespace SymtabAPI
namespace PatchAPI
{
class PatchFunction;
...
class BPATCH_DLL_EXPORT BPatch_module : public BPatch_sourceObj
{
    ...
    typedef std::map<Dyninst::PatchAPI::PatchFunction*, BPatch_function*> BPatch_funcMap;
...
public:
    ...
    BPatch_Vector<BPatch_function*>* findFunctionByAddress(
        void* addr, BPatch_Vector<BPatch_function*>& funcs, bool notify_on_failure = true,
        bool incUninstrumentable = false);
