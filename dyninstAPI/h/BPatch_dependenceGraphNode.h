...
class BPATCH_DLL_EXPORT BPatch_dependenceGraphNode : public BPatch_eventLock {
 ...
 public:
  ...
  API_EXPORT_CTOR(Int, (inst), BPatch_dependenceGraphNode,
                  (BPatch_instruction * inst));

  API_EXPORT_CTOR(Int, (inst, incList, outList), BPatch_dependenceGraphNode,
                  (BPatch_instruction * inst,
                   BPatch_Vector<BPatch_dependenceGraphEdge*>* incList,
                   BPatch_Vector<BPatch_dependenceGraphEdge*>* outList));

  API_EXPORT_V(Int, (out), void, getOutgoingEdges,
               (BPatch_Vector<BPatch_dependenceGraphEdge*> & out))

  API_EXPORT_V(Int, (inc), void, getIncomingEdges,
               (BPatch_Vector<BPatch_dependenceGraphEdge*> & inc))

  API_EXPORT(Int, (other_node), bool, isImmediateSuccessor,
             (BPatch_instruction * other_node));

  API_EXPORT(Int, (other_node), bool, isImmediatePredecessor,
             (BPatch_instruction * other_node));

  API_EXPORT(Int, (), BPatch_instruction*, getBPInstruction, ());
