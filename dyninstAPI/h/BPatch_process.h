...
public:
    OneTimeCodeInfo(bool _synchronous, void* _userData, BPatchOneTimeCodeCallback _cb,
                    unsigned _thrID)
...
private:
    ...
    static int oneTimeCodeCallbackDispatch(PCProcess* theProc, unsigned /* rpcid */,
...
public:
    ...
    bool triggerCodeOverwriteCB(instPoint* faultPoint, Dyninst::Address faultTarget);
    ...
    bool finalizeInsertionSetWithCatchup(
        bool atomic, bool* modified, BPatch_Vector<BPatch_catchupInfo>& catchup_handles);
