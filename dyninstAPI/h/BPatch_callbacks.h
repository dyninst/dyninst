...
typedef enum { NoExit, ExitedNormally, ExitedViaSignal } BPatch_exitType;
...
typedef void (*BPatchAsyncThreadEventCallback)(BPatch_process *proc,
                                               BPatch_thread *thr);
...
// This callback is invoked whenever previously un-analyzed code is discovered
// through runtime
// analysis, and delivers a vector of  functions whose analysis has been
// modified and a vector
