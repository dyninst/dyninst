...
{
class CodeObject;
BPATCH_DLL_EXPORT CodeObject*
                  convert(const BPatch_object*);
}  // namespace ParseAPI
namespace PatchAPI
{
class PatchObject;
BPATCH_DLL_EXPORT PatchObject*
                  convert(const BPatch_object*);
}  // namespace PatchAPI
namespace SymtabAPI
{
class Symtab;
BPATCH_DLL_EXPORT Symtab*
                  convert(const BPatch_object*);
}  // namespace SymtabAPI
}  // namespace Dyninst
...
public:
    ...
    // object.
    // By design, shared libraries contain a single module; executable files contain one
    // or more.
