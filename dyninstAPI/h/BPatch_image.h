...
public:
    ...
    void getNewCodeRegions(std::vector<BPatch_function*>& newFuncs,
    ...
    BPatch_Vector<BPatch_parRegion*>* getParRegions(bool incUninstrumentable = false);
    ...
    bool findFunction(Dyninst::Address addr, BPatch_Vector<BPatch_function*>& funcs);
    ...
    bool readString(Dyninst::Address addr, std::string& str, unsigned size_limit = 0);

    bool readString(BPatch_variableExpr* expr, std::string& str, unsigned size_limit = 0);
...
#    pragma warning(pop)
    ...
    void findFunctionInImage(const char* name, image* img,
                             BPatch_Vector<BPatch_function*>* funcs,
                             bool incUninstrumentable = false);
    void sieveFunctionsInImage(image* img, BPatch_Vector<BPatch_function*>* funcs,
