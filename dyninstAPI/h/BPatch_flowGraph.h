...
class BPATCH_DLL_EXPORT BPatch_flowGraph : public Dyninst::AnnotatableSparse {
  friend class BPatch_basicBlock;
  friend class BPatch_edge;
  friend class BPatch_function;
  friend class dominatorCFG;
  friend class func_instance;  // This is illegal here... keeps us from having
                               // to
                               // have a public constructor...  PDSEP
  friend std::ostream &operator<<(std::ostream &, BPatch_flowGraph &);
  friend void dfsCreateLoopHierarchy(
      BPatch_loopTreeNode *parent,
      BPatch_Vector<BPatch_basicBlockLoop *> &loops, std::string level);
  ...
  */
  ...
  BPatch_Vector<BPatch_point *> *findLoopInstPoints(
 ...
 private:
  ...
  static void findBBForBackEdge(BPatch_edge *, std::set<BPatch_basicBlock *> &);
