...
class BPATCH_DLL_EXPORT BPatch_function : public BPatch_sourceObj,
  ...
  friend BPatch_Vector<BPatch_point *> *findPoint(
      const BPatch_Set<BPatch_opCode> &ops, InstrucIter &ii,
      BPatch_process *proc, BPatch_function *bpf);
  friend Dyninst::ParseAPI::Function *Dyninst::ParseAPI::convert(
      const BPatch_function *);
  friend Dyninst::PatchAPI::PatchFunction *Dyninst::PatchAPI::convert(
      const BPatch_function *);
...
#pragma warning(pop)
 ...
 public:
  ...
  void setModule(BPatch_module *module) {
    if (this->mod == NULL) this->mod = module;
  }
  void removeCFG() { cfg = NULL; }
  void getUnresolvedControlTransfers(
  ...
  //  Returns a vector of BPatch_localVar, representing this function's
  //  parameters
  ...
  //  Returns a vector of inst points, corresponding to the given
  //  BPatch_procedureLocation

  BPatch_Vector<BPatch_point *> *findPoint(const BPatch_procedureLocation loc);

  //  BPatch_function::findPoint
  //  Returns a vector of inst points, corresponding to the given set of op
  //  codes
  ...
  //  BPatch_function::findPoint
  //
  //  Returns a BPatch_point that corresponds with the provided address. Returns
  //  NULL
  ...
  bool findVariable(const char *name,
  ...
  const char *addName(const char *name, bool isPrimary = true,
