...
BPATCH_DLL_EXPORT                   Point*
                                    convert(const BPatch_point*, BPatch_callWhen);
}  // namespace PatchAPI
}  // namespace Dyninst
...
class BPATCH_DLL_EXPORT BPatch_point
{
    ...
    friend Dyninst::PatchAPI::Point* Dyninst::PatchAPI::convert(const BPatch_point*,
                                                                BPatch_callWhen);
...
private:
    ...
    void recordSnippet(BPatch_callWhen, BPatch_snippetOrder, BPatchSnippetHandle*);
