...
class BPATCH_DLL_EXPORT BPatch_basicBlockLoop : public Dyninst::AnnotatableSparse
{
...
private:
    ...
    bool getLoops(BPatch_Vector<BPatch_basicBlockLoop*>&, bool outerMostOnly) const;
};
