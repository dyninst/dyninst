...
\apidesc{
  ...
  the new convert interface described in Section~\ref{sec:conversions}.
}
...
\apidesc{
  ...
  information on accessing PatchAPI abstractions from DyninstAPI abstractions, see Section~\ref{sec:conversions}.
}
