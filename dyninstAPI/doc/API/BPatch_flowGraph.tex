...
\begin{apient}
  bool getAllBasicBlocks(std::set<BPatch_basicBlock*>&);
\end{apient}
...
\begin{apient}
  bool getEntryBasicBlock(std::vector<BPatch_basicBlock*>&);
\end{apient}
...
\begin{apient}
  bool getExitBasicBlock(std::vector<BPatch_basicBlock*>&);
\end{apient}
...
\begin{apient}
  bool getLoops(std::vector<BPatch_basicBlockLoop*>&);
\end{apient}
