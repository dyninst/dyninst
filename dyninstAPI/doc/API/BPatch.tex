...
\apidesc{
Create a new type, named name, which points to objects of type ptr. The size of
the pointer is the value passed in the size parameter; left out, it is
sizeof(void*) on the target platform where the muta\-tee is running.
}
