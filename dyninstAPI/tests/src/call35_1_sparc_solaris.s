...
.stabs "call35_1.c",100,0,0,.LLtext0
.section	".text"
.LLtext0:
...
.stabs "",36,0,0,.LLscope0-call35_2
	.global .umul
	.align 4
.stabs "call35_1:F(0,1)",36,0,5,call35_1
	.global call35_1
	.type	 call35_1,#function
	.proc	04
call35_1:
.stabn 68,0,5,.LLM3-call35_1
.LLM3:
	!#PROLOGUE# 0
	save	%sp, -128, %sp
	!#PROLOGUE# 1
.stabn 68,0,6,.LLM4-call35_1
.LLM4:
.LLBB2:
	mov	1, %o0
	st	%o0, [%fp-20]
.stabn 68,0,7,.LLM5-call35_1
.LLM5:
	mov	1, %o0
	st	%o0, [%fp-24]
.stabn 68,0,8,.LLM6-call35_1
.LLM6:
	st	%g0, [%fp-28]
.stabn 68,0,9,.LLM7-call35_1
.LLM7:
	mov	2, %o0
	st	%o0, [%fp-32]
.stabn 68,0,11,.LLM8-call35_1
.LLM8:
	call	call35_2, 0
	 nop
.stabn 68,0,13,.LLM9-call35_1
.LLM9:
	ld	[%fp-20], %o0
	ld	[%fp-24], %o1
	call	.umul, 0
	 nop
	st	%o0, [%fp-28]
.stabn 68,0,15,.LLM10-call35_1
.LLM10:
	call	call35_2, 0
	 nop
.stabn 68,0,17,.LLM11-call35_1
.LLM11:
	call	call35_2, 0
	 nop
.stabn 68,0,19,.LLM12-call35_1
.LLM12:
	ld	[%fp-32], %o0
	mov	%o0, %i0
	b	.LL3
	 nop
.stabn 68,0,20,.LLM13-call35_1
.LLM13:
.LLBE2:
.stabn 68,0,20,.LLM14-call35_1
.LLM14:
.LL3:
...
.stabn 192,0,0,.LLBB2-call35_1
.stabn 224,0,0,.LLBE2-call35_1
.LLscope1:
.stabs "",36,0,0,.LLscope1-call35_1
	.text
