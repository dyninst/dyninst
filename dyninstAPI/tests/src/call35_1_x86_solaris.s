...
.LM7:
	movl $2,-16(%ebp)
.stabn 68,0,11,.LM8-call35_1
.LM8:
	call call35_2
.stabn 68,0,13,.LM9-call35_1
.LM9:
	movl -4(%ebp),%eax
	imull -8(%ebp),%eax
	movl %eax,-12(%ebp)
.stabn 68,0,15,.LM10-call35_1
.LM10:
	call call35_2
.stabn 68,0,17,.LM11-call35_1
.LM11:
	call call35_2
.stabn 68,0,19,.LM12-call35_1
.LM12:
	movl -16(%ebp),%edx
	movl %edx,%eax
	jmp .L3
...
.stabn 68,0,20,.LM13-call35_1
.LM13:
.LBE2:
.stabn 68,0,20,.LM14-call35_1
.LM14:
	.align 4
.L3:
	leave
...
.stabs "localVariable35_1:(0,1)",128,0,6,-4
.stabs "localVariable35_2:(0,1)",128,0,7,-8
.stabs "total35_1:(0,1)",128,0,8,-12
.stabs "total35_2:(0,1)",128,0,9,-16
