...
enum RunMode { SINGLE_BINARY, BATCH_DIRECTORY, BATCH_FILE };
...
enum ParseLevel { PARSE_MODULE, PARSE_FUNC, PARSE_CFG, PARSE_MAX };
...
enum InstType { USER_FUNC, DEFAULT };

enum RunState { NORMAL, SIGCHLD_WAIT, TIME_EXPIRED, CHILD_EXITED, DETACHED };
