...
set(_known_arches "ppc64le" "aarch64" "loongarch64" "riscv64" ${_32bit_x86_arches} ${_64bit_x86_arches}
                  ${_amdgpu_arches})
...
elseif(${_host_arch} STREQUAL "loongarch64")
  set(DYNINST_HOST_ARCH_LOONGARCH64 TRUE)
...
elseif(${_codegen_arch} STREQUAL "riscv64")
  set(DYNINST_CODEGEN_ARCH_RISCV64 TRUE)
  set(DYNINST_ENABLE_CAPSTONE ON)
elseif(${_codegen_arch} STREQUAL "loongarch64")
  set(DYNINST_CODEGEN_ARCH_LOONGARCH64 TRUE)
...
if(${_host_os} STREQUAL "Linux")
  if(NOT _is64bit)
    ...
    elseif(${_host_arch} STREQUAL "loongarch64")
      set(DYNINST_PLATFORM loongarch64-unknown-linux)
    else()
