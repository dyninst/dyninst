...
function(DYNINST_MESSAGE TYPE)
    if("${TYPE}" MATCHES "ERROR|WARNING" OR NOT DYNINST_QUIET_CONFIG)
...
function(DYNINST_ADD_INTERFACE_LIBRARY _TARGET)
    ...
    if(NOT TARGET ${PROJECT_NAME}::${_TARGET})
    ...
    dyninst_append_property_list(DYNINST_INTERFACE_TARGETS ${_TARGET})
    ...
    install(
        ...
        DESTINATION ${INSTALL_CMAKE_DIR}/interface)
    # build tree
    export(
        TARGETS ${_TARGET}
        NAMESPACE ${PROJECT_NAME}::
        FILE ${PROJECT_BINARY_DIR}/build-tree/interface/${_TARGET}Targets.cmake
