...
if(${CMAKE_CXX_COMPILER_ID} IN_LIST _linux_compilers)
  ...
  set(CMAKE_C_FLAGS_RELEASE "/MP /O2 /MD")
  set(CMAKE_CXX_FLAGS_RELEASE "/MP /O2 /MD")

  set(CMAKE_C_FLAGS_RELWITHDEBINFO "/MP /O2 /Zi /MD")
  set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "/MP /O2 /Zi /MD")

  set(CMAKE_C_FLAGS_MINSIZEREL "/MP /O1 /MD")
  set(CMAKE_CXX_FLAGS_MINSIZEREL "/MP /O1 /MD")
