...
elseif(DYNINST_HOST_ARCH_RISCV64)
  set(ARCH_DEFINES_TESTSUITE -Darch_riscv64 -Darch_64bit)
elseif(DYNINST_HOST_ARCH_LOONGARCH64)
  set(ARCH_DEFINES_TESTSUITE -Darch_loongarch64 -Darch_64bit)
endif()
...
elseif(DYNINST_CODEGEN_ARCH_RISCV64)
  ...
  set(CAP_DEFINES ${CAP_DEFINES} -Dcap_registers)
elseif(DYNINST_CODEGEN_ARCH_LOONGARCH64)
  set(ARCH_DEFINES_CODEGEN -Darch_loongarch64 -Darch_64bit)
  set(CAP_DEFINES ${CAP_DEFINES} -Dcap_registers)
...
if(DYNINST_OS_Linux)
  ...
  elseif(DYNINST_HOST_ARCH_LOONGARCH64)
    set(OLD_DEFINES -Dloongarch64_unknown_linux)
  endif()
