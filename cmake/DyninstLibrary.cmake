...
function(dyninst_library TARG_NAME)
    ...
    foreach(_target ${ADDED_TARGETS})
        ...
        target_link_libraries(${_target} PUBLIC Dyninst::LanguageFeatures)
        ...
        set_target_properties(
            ...
            PROPERTIES OUTPUT_NAME ${TARG_NAME}
                       ...
                       INSTALL_RPATH "${DYNINST_LIBRARY_INSTALL_RPATH}"
    ...
    dyninst_append_property_list(DYNINST_BUILD_TARGETS ${TARG_NAME})
endfunction()
