...
if(CMAKE_C_COMPILER_ID MATCHES "^(GNU|Clang)$")
    ...
    foreach(f IN LISTS REQUESTED_WARNING_FLAGS)
        ...
        # with a warning message output: check_c_compiler_flag("-${f}"
        # "${v}")
        if(${v})
...
# compiler version and build type for the following two files:
#
# instructionAPI/src/InstructionDecoder-power.C (includes
# instructionAPI/src/InstructionDecoder-power.C) common/src/MachSyscall.C (includes
