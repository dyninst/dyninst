...
#define yyparse mrnparse
#define yylex mrnlex
#define yyerror mrnerror
#define yylval mrnlval
#define yychar mrnchar
#define yydebug mrndebug
#define yynerrs mrnnerrs
#define	PORT	257
#define	HOSTNAME	258
#define	COLON	259
#define	SEMI	260
