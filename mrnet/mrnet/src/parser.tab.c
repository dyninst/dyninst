...
#define yyparse mrn_yyparse
#define yylex mrn_yylex
#define yyerror mrn_yyerror
#define yylval mrn_yylval
#define yychar mrn_yychar
#define yydebug mrn_yydebug
#define yynerrs mrn_yynerrs
#define	PORT	257
#define	HOSTNAME	258
#define	COLON	259
#define	SEMI	260
