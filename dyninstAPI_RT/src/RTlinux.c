...
#if defined(host_arch_power) && defined(host_arch_64bit) && defined(os_linux)
...
// Register numbers experimentally verified
  ...
  #endif // amd-64
#elif defined(host_arch_power)
  #if defined(host_arch_64bit)
...
#if !defined(host_arch_x86_64) || defined(MUTATEE_32)
