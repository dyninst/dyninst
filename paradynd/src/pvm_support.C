 ...
 * Removed compiler warnings.
 *
 * Revision 1.9  1994/06/16  15:22:20  markc
 * Renamed structures to match new pvm names.
 *
 * Revision 1.8  1994/06/02  23:30:59  markc
 * Modifications to support new interfaces for libutil calls.
 *
 * Revision 1.7  1994/05/03  05:27:09  markc
 * Added hoster and tasker functions.
 * */
