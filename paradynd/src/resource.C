 ...
 *
 * $Log: resource.C,v $
 * Revision 1.34  2002/04/05 19:39:22  schendel
 * reorganize what was previously the metricDefinitionNode graph (which
 * also unifies the MT and non-MT aspects of this graph);
 * much associated code clean-up and reorganization  - - - - - - - - - - - -
 * use non-system specific type maximum macro
 *
