...
class resource {
 public:
   ...
   static resourceHandle createResource_ncb(pdvector<string>& resource_name, 
                                            string& abstr, unsigned type,
   ...
   const pdvector<string>& getParts() const {return fullName;}
   static bool get_lib_constraints(pdvector<string>&, pdvector<unsigned>&);
   static bool get_func_constraints(pdvector< pdvector<string> >&, pdvector<unsigned>&);
   ...
   static string DMcreateRLname(const pdvector<resourceHandle> &res);
 ...
 protected:
   ...
   resource(resourceHandle p_handle,
            ...
            pdvector<string>& resource_name, string& r_name,
            string& abstr, unsigned type);
   resource(resourceHandle p_handle,
            pdvector<string>& resource_name, string& r_name,
            string& abstr, unsigned type);
 ...
 private:
   ...
   static pdvector< pdvector<string> > func_constraints;
...
class resourceList {
 ...
 public:
   ...
   resourceList(const pdvector<string> &names); 
   ...
   bool convertToStringList(pdvector< pdvector<string> >& fs);
