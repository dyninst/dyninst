...
// $Id: DMresource.h,v 1.47 2002/11/25 23:52:23 schendel Exp $
...
class resource {
 public:
   ...
   static resourceHandle createResource_ncb(vector<string>& resource_name, 
                                            string& abstr, unsigned type,
                                            resourceHandle &p_handle, 
                                            bool &exist);

   vector<resourceHandle> *getChildren(bool dontGetRetiredChildren = false);
   ...
   static string DMcreateRLname(const vector<resourceHandle> &res);
 ...
 protected:
   ...
   resource(resourceHandle p_handle,
            ...
            vector<string>& resource_name, string& r_name,
            string& abstr, unsigned type);
   resource(resourceHandle p_handle,
            vector<string>& resource_name, string& r_name,
            string& abstr, unsigned type);
