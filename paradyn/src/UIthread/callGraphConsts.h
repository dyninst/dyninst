...
// $Id: callGraphConsts.h,v 1.5 2004/03/23 01:12:29 eli Exp $
...
//callGraphConsts: constants needed for the callGraph Display, similar to
//shgConsts
...
struct callGraphConsts {
  ...
  callGraphConsts(Tcl_Interp *interp, Tk_Window theTkWindow);
  ~callGraphConsts();
};
