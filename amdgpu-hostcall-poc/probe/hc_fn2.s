...
.LBB0_93:
	s_or_b64 exec, exec, s[6:7]
	v_mov_b32_e32 v3, 0
	buffer_store_dword v3, off, s[0:3], s32 offset:24 ; 4-byte Folded Spill
	v_mov_b32_e32 v3, 0
	buffer_store_dword v3, off, s[0:3], s32 ; 4-byte Folded Spill
	s_and_saveexec_b64 s[6:7], vcc
...
.LBB0_97:
	s_or_b64 exec, exec, s[6:7]
	v_mov_b32_e32 v3, 0
	buffer_store_dword v3, off, s[0:3], s32 offset:36 ; 4-byte Folded Spill
	v_mov_b32_e32 v3, 0
	buffer_store_dword v3, off, s[0:3], s32 offset:8 ; 4-byte Folded Spill
	s_and_saveexec_b64 s[6:7], vcc
...
.LBB0_101:
	s_or_b64 exec, exec, s[6:7]
	v_mov_b32_e32 v3, 0
	buffer_store_dword v3, off, s[0:3], s32 offset:4 ; 4-byte Folded Spill
	v_mov_b32_e32 v3, 0
	buffer_store_dword v3, off, s[0:3], s32 offset:28 ; 4-byte Folded Spill
	s_and_saveexec_b64 s[6:7], vcc
...
.LBB0_105:
	s_or_b64 exec, exec, s[6:7]
	v_mov_b32_e32 v3, 0
	buffer_store_dword v3, off, s[0:3], s32 offset:12 ; 4-byte Folded Spill
	v_mov_b32_e32 v3, 0
	buffer_store_dword v3, off, s[0:3], s32 offset:40 ; 4-byte Folded Spill
	s_and_saveexec_b64 s[6:7], vcc
...
.LBB0_109:
	s_or_b64 exec, exec, s[6:7]
	v_mov_b32_e32 v3, 0
	buffer_store_dword v3, off, s[0:3], s32 offset:16 ; 4-byte Folded Spill
	v_mov_b32_e32 v3, 0
	buffer_store_dword v3, off, s[0:3], s32 offset:56 ; 4-byte Folded Spill
	s_and_saveexec_b64 s[6:7], vcc
...
.LBB0_113:
	...
	v_mov_b32_e32 v3, 0
	v_mov_b32_e32 v11, 0
	buffer_store_dword v3, off, s[0:3], s32 offset:48 ; 4-byte Folded Spill
	s_and_saveexec_b64 s[6:7], vcc
...
.LBB0_117:
	...
	v_mov_b32_e32 v3, 0
	buffer_store_dword v3, off, s[0:3], s32 offset:20 ; 4-byte Folded Spill
	s_and_saveexec_b64 s[6:7], vcc
...
.LBB0_121:
	...
	v_mov_b32_e32 v3, 0
	buffer_store_dword v3, off, s[0:3], s32 offset:32 ; 4-byte Folded Spill
	s_and_saveexec_b64 s[6:7], vcc
...
.LBB0_125:
	...
	v_mov_b32_e32 v10, 0
	v_mov_b32_e32 v3, 0
	buffer_store_dword v3, off, s[0:3], s32 offset:52 ; 4-byte Folded Spill
	s_and_saveexec_b64 s[6:7], vcc
...
.LBB0_129:
	s_or_b64 exec, exec, s[6:7]
	v_mov_b32_e32 v3, 0
	buffer_store_dword v3, off, s[0:3], s32 offset:44 ; 4-byte Folded Spill
	v_mov_b32_e32 v3, 0
...
.LBB0_257:
	...
	buffer_load_dword v1, off, s[0:3], s32 offset:36 ; 4-byte Folded Reload
	...
	buffer_load_dword v10, off, s[0:3], s32 offset:24 ; 4-byte Folded Reload
	v_accvgpr_read_b32 v11, a59             ;  Reload Reuse
	buffer_load_dword v12, off, s[0:3], s32 offset:56 ; 4-byte Folded Reload
	...
	buffer_load_dword v2, off, s[0:3], s32 offset:40 ; 4-byte Folded Reload
	v_accvgpr_read_b32 v5, a48              ;  Reload Reuse
	global_store_dwordx4 v0, v[9:12], s[6:7] offset:32
	...
	v_or_b32_sdwa v1, v2, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
	buffer_load_dword v2, off, s[0:3], s32 offset:48 ; 4-byte Folded Reload
	buffer_load_dword v5, off, s[0:3], s32 offset:28 ; 4-byte Folded Reload
	s_waitcnt vmcnt(1)
	v_lshlrev_b16_e32 v2, 8, v2
	s_waitcnt vmcnt(0)
	v_or_b32_sdwa v2, v5, v2 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
	v_accvgpr_read_b32 v5, a32              ;  Reload Reuse
	global_store_dwordx4 v0, v[8:11], s[6:7] offset:48
	v_lshlrev_b16_e32 v5, 8, v5
	...
	global_store_dwordx4 v0, v[8:11], s[6:7] offset:64
	...
	global_store_dwordx4 v0, v[5:8], s[6:7] offset:80
	buffer_load_dword v6, off, s[0:3], s32 offset:52 ; 4-byte Folded Reload
	v_or_b32_sdwa v5, v1, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
	...
	buffer_load_dword v1, off, s[0:3], s32 offset:16 ; 4-byte Folded Reload
	buffer_load_dword v2, off, s[0:3], s32 offset:8 ; 4-byte Folded Reload
	s_waitcnt vmcnt(1)
	v_lshlrev_b16_e32 v1, 8, v1
	s_waitcnt vmcnt(0)
	v_or_b32_sdwa v1, v2, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
	...
	global_store_dwordx4 v0, v[2:5], s[6:7] offset:96
	...
	buffer_load_dword v2, off, s[0:3], s32 offset:32 ; 4-byte Folded Reload
	buffer_load_dword v6, off, s[0:3], s32  ; 4-byte Folded Reload
	s_waitcnt vmcnt(3)
	v_lshlrev_b16_e32 v1, 8, v1
	s_waitcnt vmcnt(1)
	v_or_b32_sdwa v1, v2, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
	...
	buffer_load_dword v5, off, s[0:3], s32 offset:12 ; 4-byte Folded Reload
	s_waitcnt vmcnt(0)
	v_lshlrev_b16_e32 v5, 8, v5
	v_or_b32_sdwa v5, v6, v5 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
	v_or_b32_sdwa v1, v1, v5 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
	global_store_dwordx4 v0, v[1:4], s[6:7] offset:112
	buffer_load_dword v5, off, s[0:3], s32 offset:20 ; 4-byte Folded Reload
	...
	v_or_b32_sdwa v3, v1, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
	buffer_load_dword v1, off, s[0:3], s32 offset:4 ; 4-byte Folded Reload
	v_accvgpr_read_b32 v2, a63              ;  Reload Reuse
	s_waitcnt vmcnt(0)
	v_lshlrev_b16_e32 v1, 8, v1
	v_or_b32_sdwa v1, v2, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
	buffer_load_dword v2, off, s[0:3], s32 offset:44 ; 4-byte Folded Reload
	s_waitcnt vmcnt(0)
	v_lshlrev_b16_e32 v2, 8, v2
	v_or_b32_sdwa v2, v5, v2 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
	v_or_b32_sdwa v2, v1, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
	...
	v_or_b32_sdwa v5, v6, v5 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:BYTE_0 src1_sel:DWORD
	v_or_b32_sdwa v1, v1, v5 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
	global_store_dwordx4 v0, v[1:4], s[6:7] offset:128
	s_nop 0
...
; MemoryBound: 0
	...
	.section	.AMDGPU.csdata,"",@progbits
	.type	__hip_cuid_a3b50dc6f0770396,@object ; @__hip_cuid_a3b50dc6f0770396
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_a3b50dc6f0770396
__hip_cuid_a3b50dc6f0770396:
	.byte	0                               ; 0x0
	.size	__hip_cuid_a3b50dc6f0770396, 1
	...
	.addrsig_sym mailbox
	.addrsig_sym __hip_cuid_a3b50dc6f0770396
	.amdgpu_metadata
---
amdhsa.kernels:  []
