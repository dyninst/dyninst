...
DYNC_EXPORT std::map<BPatch_point *, BPatch_snippet *> *createSnippet(
...
DYNC_EXPORT BPatch_snippet *createSnippet(const char *s,
                                          BPatch_addressSpace &addSpace);
DYNC_EXPORT BPatch_snippet *createSnippet(FILE *f,
                                          BPatch_addressSpace &addSpace);
DYNC_EXPORT BPatch_snippet *createSnippet(std::string str,
                                          BPatch_addressSpace &addSpace);
