...
// $Id: test1_6.C,v 1.1 2007/09/24 16:38:49 cooksey Exp $
/*
 * #Name: test1_6
...
class test1_6_Mutator : public TestMutator {
  virtual test_results_t preExecution();
};
extern "C" TEST_DLL_EXPORT TestMutator *test1_6_factory() {
...
// {
test_results_t test1_6_Mutator::preExecution() {
