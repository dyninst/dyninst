...
// $Id: test1_9.C,v 1.1 2007/09/24 16:39:04 cooksey Exp $
/*
 * #Name: test1_9
...
class test1_9_Mutator : public TestMutator {
  virtual test_results_t preExecution();
};
extern "C" TEST_DLL_EXPORT TestMutator *test1_9_factory() {
...
// {
test_results_t test1_9_Mutator::preExecution() {
