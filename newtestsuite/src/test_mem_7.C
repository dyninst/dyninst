...
// $Id: test_mem_7.C,v 1.1 2007/09/24 16:41:15 cooksey Exp $
/*
 * #Name: test6_7
...
class test_mem_7_Mutator : public TestMutator {
public:
  virtual test_results_t preExecution();
};
extern "C" TEST_DLL_EXPORT TestMutator *test_mem_7_factory() {
...
test_results_t test_mem_7_Mutator::preExecution() {
  int testnum = 7;
