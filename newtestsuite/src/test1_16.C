...
// $Id: test1_16.C,v 1.1 2007/09/24 16:36:48 cooksey Exp $
/*
 * #Name: test1_16
...
class test1_16_Mutator : public TestMutator {
...
// {
test_results_t test1_16_Mutator::preExecution() {
  ...
  BPatch_Vector<BPatch_function *> found_funcs;
    ...
    RETURNONNULL(insertSnippetAt(appThread, appImage, "test1_16_func2",
				 BPatch_entry, if16_2, 16, "if-else"));
    RETURNONNULL(insertSnippetAt(appThread, appImage, "test1_16_func3",
				 BPatch_entry, if16_3, 16, "if-else"));
    RETURNONNULL(insertSnippetAt(appThread, appImage, "test1_16_func4",
