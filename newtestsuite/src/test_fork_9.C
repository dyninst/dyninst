...
// $Id: test_fork_9.C,v 1.2 2008/05/08 20:55:11 cooksey Exp $
/*
 * #Name: test7_5
...
class test_fork_9_Mutator : public TestMutator {
private:
  BPatch *bpatch;
...
extern "C" TEST_DLL_EXPORT TestMutator *test_fork_9_factory() {
...
test_results_t test_fork_9_Mutator::execute() {
