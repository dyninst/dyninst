...
// $Id: test2_11.C,v 1.1 2007/09/24 16:39:13 cooksey Exp $
/*
 * #Name: test2_11
...
class test2_11_Mutator : public TestMutator {
  virtual test_results_t preExecution();
};
extern "C" TEST_DLL_EXPORT TestMutator *test2_11_factory() {
...
test_results_t test2_11_Mutator::preExecution() {
