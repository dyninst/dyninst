...
<<<<<<< HEAD:newtestsuite/src/specification/makemake.py
	platform = find_platform(os.environ.get('PLATFORM'))
...
=======
   ...
   for m in module_set:
      rest = """
>>>>>>> origin/HEAD:newtestsuite/src/specification/makemake.py
...
<<<<<<< HEAD:newtestsuite/src/specification/makemake.py
def print_special_object_rules(compiler, out, module):
	out.write("\n# Exceptional rules for mutatees compiled with %s for %s\n\n"
			  % (compiler, module))
...
<<<<<<< HEAD:newtestsuite/src/specification/makemake.py
	...
	for l in aux_comps:
		...
		if c not in comps:
			print_special_object_rules(c, out, module)
=======
   # Pattern rules for auxilliary compilers supported on this platform
   out.write("\n# Generic rules for this platform's auxilliary compilers\n\n")
   aux_comps = platform['auxilliary_compilers']
...
<<<<<<< HEAD:newtestsuite/src/specification/makemake.py
	...
	for c in comps:
		...
		print_special_object_rules(c, out, m)
...
def print_patterns_nt(c, out):
   ...
   for abi in platform['abis']:
      for o in compiler['optimization']:
         ...
         # WARNING:  not sure if the following specification of group_boilerplaces is correct at all...  
...
# TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO TODO 
   ...
   #commented out next line due to problems
