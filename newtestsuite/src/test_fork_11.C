...
// $Id: test_fork_11.C,v 1.3 2008/10/20 20:37:13 legendre Exp $
/*
 * #Name: test7_7
...
class test_fork_11_Mutator : public TestMutator {
private:
  BPatch *bpatch;
...
extern "C" TEST_DLL_EXPORT TestMutator *test_fork_11_factory() {
