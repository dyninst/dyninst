...
int main() {
  ...
  emitter->emitLoadConst(RegisterConstants::s0, (uint64_t)0x123456789, gen);
  ...
  emitter->emitLoadIndir(RegisterConstants::s4, RegisterConstants::s2, 1, gen);
  ...
  emitter->emitLoadRelative(RegisterConstants::s4, 0x1234, RegisterConstants::s2, 1, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<12>{{
  ...
  emitter->emitLoadRelative(RegisterConstants::s4, 0x1234, RegisterConstants::s2, 2, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<12>{{
  ...
  emitter->emitLoadRelative(RegisterConstants::s4, 0x1234, RegisterConstants::s2, 4, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<12>{{
  ...
  emitter->emitLoadRelative(RegisterConstants::s4, 0x1234, RegisterConstants::s2, 8, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<12>{{
  ...
  emitter->emitLoadRelative(RegisterConstants::s4, 0x1234, RegisterConstants::s2, 16, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<12>{{
  ...
  emitter->emitStoreIndir(RegisterConstants::s2, RegisterConstants::s4, 1, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<12>{{
  ...
  emitter->emitStoreRelative(RegisterConstants::s4, 0x1234, RegisterConstants::s2, 1, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<12>{{
  ...
  emitter->emitStoreRelative(RegisterConstants::s4, 0x1234, RegisterConstants::s2, 2, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<12>{{
  ...
  emitter->emitStoreRelative(RegisterConstants::s4, 0x1234, RegisterConstants::s2, 4, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<12>{{
  ...
  emitter->emitAddConstantToRegPair(RegisterConstants::s2, 0x1234, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<16>{{
  ...
  emitter->emitAtomicAdd(RegisterConstants::s2, RegisterConstants::s0, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<8>{{
  ...
  emitter->emitAtomicSub(RegisterConstants::s2, RegisterConstants::s0, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<8>{{
