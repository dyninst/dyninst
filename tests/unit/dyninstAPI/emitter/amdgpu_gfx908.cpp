...
int main() {
  ...
  emitter->emitMoveRegToReg(sgpr0, sgpr1, gen);
  ...
  emitter->emitLoadConst(sgpr0, (uint64_t)0x123456789, gen);
  ...
  emitter->emitLoadIndir(sgpr4, sgpr2, 1, gen);
  ...
  emitter->emitLoadRelative(sgpr4, 0x1234, sgpr2, 1, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<12>{{
  ...
  emitter->emitLoadRelative(sgpr4, 0x1234, sgpr2, 2, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<12>{{
  ...
  emitter->emitLoadRelative(sgpr4, 0x1234, sgpr2, 4, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<12>{{
  ...
  emitter->emitLoadRelative(sgpr4, 0x1234, sgpr2, 8, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<12>{{
  ...
  emitter->emitLoadRelative(sgpr4, 0x1234, sgpr2, 16, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<12>{{
  ...
  emitter->emitStoreIndir(sgpr2, sgpr4, 1, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<12>{{
  ...
  emitter->emitStoreRelative(sgpr4, 0x1234, sgpr2, 1, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<12>{{
  ...
  emitter->emitStoreRelative(sgpr4, 0x1234, sgpr2, 2, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<12>{{
  ...
  emitter->emitStoreRelative(sgpr4, 0x1234, sgpr2, 4, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<12>{{
  ...
  // scc = s1 < s2
  emitter->emitRelOp(lessOp, /*SCC_DUMMY=*/0, sgpr1, sgpr2, gen, 0);
  failed |= !verify_emitter(gen, emitter_buffer_t<4>{{
    0x01,0x02,0x04,0xbf                      // s_cmp_lt_i32 s1, s2
  }});

  // scc = s1 <= s2
  emitter->emitRelOp(leOp, /*SCC_DUMMY=*/0, sgpr1, sgpr2, gen, 0);
  failed |= !verify_emitter(gen, emitter_buffer_t<4>{{
    0x01,0x02,0x05,0xbf                      // s_cmp_le_i32 s1, s2
  }});

  // scc = s1 > 2
  emitter->emitRelOp(greaterOp, /*SCC_DUMMY=*/0, sgpr1, sgpr2, gen, 0);
  failed |= !verify_emitter(gen, emitter_buffer_t<4>{{
    0x01,0x02,0x02,0xbf                      // s_cmp_gt_i32 s1, s2
  }});

  // scc = s1 >= s2
  emitter->emitRelOp(geOp, /*SCC_DUMMY=*/0, sgpr1, sgpr2, gen, 0);
  failed |= !verify_emitter(gen, emitter_buffer_t<4>{{
    0x01,0x02,03,0xbf                        // s_cmp_ge_i32 s1, s2
  }});

  // scc = s1 == s2
  emitter->emitRelOp(eqOp, /*SCC_DUMMY=*/0, sgpr1, sgpr2, gen, 0);
  failed |= !verify_emitter(gen, emitter_buffer_t<4>{{
    0x01,0x02,0x00,0xbf                      // s_cmp_eq_i32 s1, s2
  }});

  // scc = s1 != s2
  emitter->emitRelOp(neOp, /*SCC_DUMMY=*/0, sgpr1, sgpr2, gen, 0);
  failed |= !verify_emitter(gen, emitter_buffer_t<4>{{
    0x01,0x02,0x01,0xbf                      // s_cmp_lg_i32 s1, s2
  }});

  // s3 = s1 + s2
  emitter->emitOp(plusOp, sgpr3, sgpr1, sgpr2, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<4>{{
    0x01,0x02,0x03,0x81                      // s_add_i32 s3, s1, s2
  }});

  // s3 = s1 - s2
  emitter->emitOp(minusOp, sgpr3, sgpr1, sgpr2, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<4>{{
    0x01,0x02,0x83,0x81                      // s_sub_i32 s3, s1, s2
  }});

  // s3 = s1 * s2
  emitter->emitOp(timesOp, sgpr3, sgpr1, sgpr2, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<4>{{
    0x01,0x02,0x03,0x92                      // s_mul_i32 s3, s1, s2
  }});

  // s3 = s1 | s2
  emitter->emitOp(orOp, sgpr3, sgpr1, sgpr2, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<4>{{
    0x01,0x02,0x03,0x87                      // s_or_b32 s3, s1, s2
  }});

  // s3 = s1 & s2
  emitter->emitOp(andOp, sgpr3, sgpr1, sgpr2, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<4>{{
    0x01,0x02,0x03,0x86                      // s_and_b32 s3, s1, s2
  }});

  // s3 = s1 ^ s2
  emitter->emitOp(xorOp, sgpr3, sgpr1, sgpr2, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<4>{{
  ...
  emitter->emitAddConstantToRegPair(sgpr2, 0x1234, gen);
  failed |= !verify_emitter(gen, emitter_buffer_t<16>{{
  ...
  // s0 = 0x1234
  emitter->emitMovLiteral(sgpr0, 0x1234, gen);
