...
std::vector<branch_test> make_tests(Dyninst::Architecture arch) {
  ...
  return {
    { // jmp 0x12
      {0xeb, 0x10},
      di::opcode_test(e_jmp, "jmp 0x12(%"+ip.name()+"),$0x12"),
      di::register_rw_test{
        reg_set{ip},
        reg_set{ip}
      },
    ...
    { // jmp 0x12345678
      ...
      di::opcode_test(e_jmp, "jmp 0x1234567d(%"+ip.name()+"),$0x1234567d"),
      di::register_rw_test{
        reg_set{ip},
        reg_set{ip}
      },
    ...
    { // jmp dword ptr [eax+0x12345678]
      ...
      di::opcode_test(e_jmp, "jmp 0x12345678(%"+eax.name()+")"),
      di::register_rw_test{
        reg_set{eax},
        reg_set{ip}
      },
    ...
    { // loop 0x12
      {0xe2, 0x10},
      di::opcode_test(e_loop, "loop $0x12"),
      di::register_rw_test{
        reg_set{ip, ecx},
        reg_set{ip, ecx}
      },
    ...
    { // loope 0x12
      {0xe1, 0x10},
      di::opcode_test(e_loope, "loope $0x12"),
      di::register_rw_test{
    ...
    { // loopne 0x12
      {0xe0, 0x10},
      di::opcode_test(e_loopne, "loopne $0x12"),
      di::register_rw_test{
        reg_set{ip, ecx, flags, zf},
        reg_set{ip, ecx}
      },
    ...
    { // jrcxz 0x7f   (aka jcxz/jecxz)
      {0xe3, 0x7d},
      di::opcode_test(e_jrcxz, is_64 ? "jrcxz $0x7f" : "jecxz $0x7f"),
      di::register_rw_test{
        reg_set{ip, ecx, },
        reg_set{ip}
      },
    ...
    { // jo 0x12345678
      ...
      di::opcode_test(e_jo, "jo $0x12345678"),
      di::register_rw_test{
        reg_set{flags, ip, of},
        reg_set{ip}
      },
    ...
    { // jno 0x12345678
      ...
      di::opcode_test(e_jno, "jno $0x12345678"),
      di::register_rw_test{
        reg_set{flags, ip, of},
        reg_set{ip}
      },
    ...
    { // jb 0x12345678   (aka jc/jnae)
      ...
      di::opcode_test(e_jb, "jb $0x12345678"),
      di::register_rw_test{
        reg_set{flags, ip, cf},
        reg_set{ip}
      },
    ...
    { // jae 0x12345678   (aka jnb/jnc)
      ...
      di::opcode_test(e_jae, "jae $0x12345678"),
      di::register_rw_test{
        reg_set{flags, ip, cf},
        reg_set{ip}
      },
    ...
    { // je 0x12345678   (aka jz)
      ...
      di::opcode_test(e_je, "je $0x12345678"),
      di::register_rw_test{
        reg_set{flags, ip, zf},
        reg_set{ip}
      },
    ...
    { // jne 0x12345678   (aka jnz)
      ...
      di::opcode_test(e_jne, "jne $0x12345678"),
      di::register_rw_test{
        reg_set{flags, ip, zf},
        reg_set{ip}
      },
    ...
    { // jbe 0x12345678   (aka jna)
      ...
      di::opcode_test(e_jbe, "jbe $0x12345678"),
      di::register_rw_test{
        reg_set{flags, ip, cf, zf},
        reg_set{ip}
      },
    ...
    { // ja 0x12345678   (aka jnbe)
      ...
      di::opcode_test(e_ja, "ja $0x12345678"),
      di::register_rw_test{
        reg_set{flags, ip, cf, zf},
        reg_set{ip}
      },
    ...
    { // js 0x12345678
      ...
      di::opcode_test(e_js, "js $0x12345678"),
      di::register_rw_test{
        reg_set{flags, ip, sf},
        reg_set{ip}
      },
    ...
    { // jns 0x12345678
      ...
      di::opcode_test(e_jns, "jns $0x12345678"),
      di::register_rw_test{
        reg_set{flags, ip, sf},
        reg_set{ip}
      },
    ...
    { // jp 0x12345678   (aka jpe)
      ...
      di::opcode_test(e_jp, "jp $0x12345678"),
      di::register_rw_test{
        reg_set{flags, ip, pf},
        reg_set{ip}
      },
    ...
    { // jnp 0x12345678   (aka jpo)
      ...
      di::opcode_test(e_jnp, "jnp $0x12345678"),
      di::register_rw_test{
        reg_set{flags, ip, pf},
        reg_set{ip}
      },
    ...
    { // jl 0x12345678   (aka jnge)
      ...
      di::opcode_test(e_jl, "jl $0x12345678"),
      di::register_rw_test{
        reg_set{flags, ip, of, sf},
        reg_set{ip}
      },
    ...
    { // jge 0x12345678   (aka jnl)
      ...
      di::opcode_test(e_jge, "jge $0x12345678"),
      di::register_rw_test{
        reg_set{flags, ip, of, sf},
        reg_set{ip}
      },
    ...
    { // jle 0x12345678   (aka jng)
      ...
      di::opcode_test(e_jle, "jle $0x12345678"),
      di::register_rw_test{
        reg_set{flags, ip, of, sf, zf},
        reg_set{ip}
      },
    ...
    { // jg 0x12345678   (aka jnle)
      ...
      di::opcode_test(e_jg, "jg $0x12345678"),
      di::register_rw_test{
        reg_set{flags, ip, of, sf, zf},
        reg_set{ip}
      },
...
std::vector<branch_test> make_tests32() {
  ...
  return {
    { // jmp 0x12345678
      ...
      di::opcode_test(e_jmp, "jmp 0x12345678(%"+ip.name()+"),$0x12345678"),
    ...
    { // jmp eax
      {0xff, 0xe0},
      di::opcode_test(e_jmp, "jmp %"+eax.name()+""),
    ...
    { // ljmp 0x5678:0x12345678
      ...
      di::opcode_test(e_ljmp, "ljmp $0x12345678,$0x5678"),
...
std::vector<branch_test> make_tests64() {
  ...
  // clang-format off
  return {
    { // REX.W jmp far [rax + 0x12345678]
      {0x48, 0xff, 0xa8, 0x78, 0x56, 0x34, 0x12},
      di::opcode_test(e_ljmp, "ljmp 0x12345678(%rax)"),
