...
std::vector<rv64a_tests> make_tests64() {
  ...
  return {
    ...
    { // amoadd.w s4, s5, (s6)
      {0x2f,0x2a,0x5b,0x01},
      di::opcode_test{riscv64_op_amoadd_w, riscv64_op_amoadd_w, "amoadd.w", "amoadd.w"},
    ...
    { // amoswap.w s7, s8, (s9)
      {0xaf,0xab,0x8c,0x09},
      di::opcode_test{riscv64_op_amoswap_w, riscv64_op_amoswap_w, "amoswap.w", "amoswap.w"},
    ...
    { // amoxor.w t3, t4, (t5)
      {0x2f,0x2e,0xdf,0x21},
      di::opcode_test{riscv64_op_amoxor_w, riscv64_op_amoxor_w, "amoxor.w", "amoxor.w"},
    ...
    { // amoand.w a0, a1, (a2)
      {0x2f,0x25,0xb6,0x60},
      di::opcode_test{riscv64_op_amoand_w, riscv64_op_amoand_w, "amoand.w", "amoand.w"},
    ...
    { // amoor.w a3, a4, (a5)
      {0xaf,0xa6,0xe7,0x40},
      di::opcode_test{riscv64_op_amoor_w, riscv64_op_amoor_w, "amoor.w", "amoor.w"},
    ...
    { // amomin.w a6, a7, (s10)
      {0x2f,0x28,0x1d,0x81},
      di::opcode_test{riscv64_op_amomin_w, riscv64_op_amomin_w, "amomin.w", "amomin.w"},
    ...
    { // amomax.w s11, ra, (sp)
      {0xaf,0x2d,0x11,0xa0},
      di::opcode_test{riscv64_op_amomax_w, riscv64_op_amomax_w, "amomax.w", "amomax.w"},
    ...
    { // amominu.w gp, tp, (t0)
      {0xaf,0xa1,0x42,0xc0},
      di::opcode_test{riscv64_op_amominu_w, riscv64_op_amominu_w, "amominu.w", "amominu.w"},
    ...
    { // amomaxu.w t1, t2, (t3)
      {0x2f,0x23,0x7e,0xe0},
      di::opcode_test{riscv64_op_amomaxu_w, riscv64_op_amomaxu_w, "amomaxu.w", "amomaxu.w"},
    ...
    { // amoadd.d s4, s5, (s6)
      {0x2f,0x3a,0x5b,0x01},
      di::opcode_test{riscv64_op_amoadd_d, riscv64_op_amoadd_d, "amoadd.d", "amoadd.d"},
      di::register_rw_test{ reg_set{s5, s6}, reg_set{s4} },
      di::mem_test{ reads_memory, writes_memory, di::register_rw_test{ reg_set{s6}, reg_set{s6} } }
    },
    { // amoswap.d s7, s8, (s9)
      {0xaf,0xbb,0x8c,0x09},
      di::opcode_test{riscv64_op_amoswap_d, riscv64_op_amoswap_d, "amoswap.d", "amoswap.d"},
      di::register_rw_test{ reg_set{s8, s9}, reg_set{s7} },
      di::mem_test{ reads_memory, writes_memory, di::register_rw_test{ reg_set{s9}, reg_set{s9} } }
    },
    { // amoxor.d t3, t4, (t5)
      {0x2f,0x3e,0xdf,0x21},
      di::opcode_test{riscv64_op_amoxor_d, riscv64_op_amoxor_d, "amoxor.d", "amoxor.d"},
      di::register_rw_test{ reg_set{t4, t5}, reg_set{t3} },
      di::mem_test{ reads_memory, writes_memory, di::register_rw_test{ reg_set{t5}, reg_set{t5} } }
    },
    { // amoand.d a0, a1, (a2)
      {0x2f,0x35,0xb6,0x60},
      di::opcode_test{riscv64_op_amoand_d, riscv64_op_amoand_d, "amoand.d", "amoand.d"},
      di::register_rw_test{ reg_set{a1, a2}, reg_set{a0} },
      di::mem_test{ reads_memory, writes_memory, di::register_rw_test{ reg_set{a2}, reg_set{a2} } }
    },
    { // amoor.d a3, a4, (a5)
      {0xaf,0xb6,0xe7,0x40},
      di::opcode_test{riscv64_op_amoor_d, riscv64_op_amoor_d, "amoor.d", "amoor.d"},
      di::register_rw_test{ reg_set{a4, a5}, reg_set{a3} },
      di::mem_test{ reads_memory, writes_memory, di::register_rw_test{ reg_set{a5}, reg_set{a5} } }
    },
    { // amomin.d a6, a7, (s10)
      {0x2f,0x38,0x1d,0x81},
      di::opcode_test{riscv64_op_amomin_d, riscv64_op_amomin_d, "amomin.d", "amomin.d"},
      di::register_rw_test{ reg_set{a7, s10}, reg_set{a6} },
      di::mem_test{ reads_memory, writes_memory, di::register_rw_test{ reg_set{s10}, reg_set{s10} } }
    },
    { // amomax.d s11, ra, (sp)
      {0xaf,0x3d,0x11,0xa0},
      di::opcode_test{riscv64_op_amomax_d, riscv64_op_amomax_d, "amomax.d", "amomax.d"},
      di::register_rw_test{ reg_set{ra, sp}, reg_set{s11} },
      di::mem_test{ reads_memory, writes_memory, di::register_rw_test{ reg_set{sp}, reg_set{sp} } }
    },
    { // amominu.d gp, tp, (t0)
      {0xaf,0xb1,0x42,0xc0},
      di::opcode_test{riscv64_op_amominu_d, riscv64_op_amominu_d, "amominu.d", "amominu.d"},
      di::register_rw_test{ reg_set{tp, t0}, reg_set{gp} },
      di::mem_test{ reads_memory, writes_memory, di::register_rw_test{ reg_set{t0}, reg_set{t0} } }
    },
    { // amomaxu.d t1, t2, (t3)
      {0x2f,0x33,0x7e,0xe0},
      di::opcode_test{riscv64_op_amomaxu_d, riscv64_op_amomaxu_d, "amomaxu.d", "amomaxu.d"},
      di::register_rw_test{ reg_set{t2, t3}, reg_set{t1} },
      di::mem_test{ reads_memory, writes_memory, di::register_rw_test{ reg_set{t3}, reg_set{t3} } }
    },
  };
