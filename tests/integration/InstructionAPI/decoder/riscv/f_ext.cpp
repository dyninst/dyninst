...
std::vector<rv64f_tests> make_tests64() {
  ...
  return {
    ...
    { // flw f0, 0(s1)
      {0x07,0xa0,0x04,0x00},
      di::opcode_test{riscv64_op_flw, riscv64_op_flw, "flw", "flw"},
    ...
    { // fsw f1, 4(s0)
      {0x27,0x22,0x14,0x00},
      di::opcode_test{riscv64_op_fsw, riscv64_op_fsw, "fsw", "fsw"},
    ...
    { // fmv.x.w a0, f2
      {0x53,0x05,0x01,0xe0},
      di::opcode_test{riscv64_op_fmv_x_w, riscv64_op_fmv_x_w, "fmv.x.w", "fmv.x.w"},
    ...
    { // fmv.w.x f3, a1
      {0xd3,0x81,0x05,0xf0},
      di::opcode_test{riscv64_op_fmv_w_x, riscv64_op_fmv_w_x, "fmv.w.x", "fmv.w.x"},
    ...
    { // fadd.s f4, f5, f6
      {0x53,0xf2,0x62,0x00},
      di::opcode_test{riscv64_op_fadd_s, riscv64_op_fadd_s, "fadd.s", "fadd.s"},
      di::register_rw_test{ reg_set{f5, f6}, reg_set{f4} },
      di::mem_test{}
    },
    { // fsub.s f7, f8, f9
      {0xd3,0x73,0x94,0x08},
      di::opcode_test{riscv64_op_fsub_s, riscv64_op_fsub_s, "fsub.s", "fsub.s"},
      di::register_rw_test{ reg_set{f8, f9}, reg_set{f7} },
      di::mem_test{}
    },
    { // fmul.s f28, f18, f19
      {0x53,0x7e,0x39,0x11},
      di::opcode_test{riscv64_op_fmul_s, riscv64_op_fmul_s, "fmul.s", "fmul.s"},
      di::register_rw_test{ reg_set{f18, f19}, reg_set{f28} },
      di::mem_test{}
    },
    { // fdiv.s f29, f20, f21
      {0xd3,0x7e,0x5a,0x19},
      di::opcode_test{riscv64_op_fdiv_s, riscv64_op_fdiv_s, "fdiv.s", "fdiv.s"},
      di::register_rw_test{ reg_set{f20, f21}, reg_set{f29} },
      di::mem_test{}
    },
    { // fsqrt.s f30, f22
      {0x53,0x7f,0x0b,0x58},
      di::opcode_test{riscv64_op_fsqrt_s, riscv64_op_fsqrt_s, "fsqrt.s", "fsqrt.s"},
    ...
    { // fsgnj.s f31, f0, f1
      {0xd3,0x0f,0x10,0x20},
      di::opcode_test{riscv64_op_fsgnj_s, riscv64_op_fsgnj_s, "fsgnj.s", "fsgnj.s"},
      di::register_rw_test{ reg_set{f0, f1}, reg_set{f31} },
      di::mem_test{}
    },
    { // fsgnjn.s f10, f11, f12
      {0x53,0x95,0xc5,0x20},
      di::opcode_test{riscv64_op_fsgnjn_s, riscv64_op_fsgnjn_s, "fsgnjn.s", "fsgnjn.s"},
      di::register_rw_test{ reg_set{f11, f12}, reg_set{f10} },
      di::mem_test{}
    },
    { // fsgnjx.s f13, f14, f15
      {0xd3,0x26,0xf7,0x20},
      di::opcode_test{riscv64_op_fsgnjx_s, riscv64_op_fsgnjx_s, "fsgnjx.s", "fsgnjx.s"},
    ...
    { // feq.s a2, f16, f17
      {0x53,0x26,0x18,0xa1},
      di::opcode_test{riscv64_op_feq_s, riscv64_op_feq_s, "feq.s", "feq.s"},
    ...
    { // flt.s a3, f0, f21
      {0xd3,0x16,0x50,0xa1},
      di::opcode_test{riscv64_op_flt_s, riscv64_op_flt_s, "flt.s", "flt.s"},
    ...
    { // fle.s a4, f2, f3
      {0x53,0x07,0x31,0xa0},
      di::opcode_test{riscv64_op_fle_s, riscv64_op_fle_s, "fle.s", "fle.s"},
    ...
    { // fcvt.s.w f0, a5
      {0x53,0xf0,0x07,0xd0},
      di::opcode_test{riscv64_op_fcvt_s_w, riscv64_op_fcvt_s_w, "fcvt.s.w", "fcvt.s.w"},
    ...
    { // fcvt.s.wu f1, a6
      {0xd3,0x70,0x18,0xd0},
      di::opcode_test{riscv64_op_fcvt_s_wu, riscv64_op_fcvt_s_wu, "fcvt.s.wu", "fcvt.s.wu"},
    ...
    { // fcvt.w.s a7, f4
      {0xd3,0x78,0x02,0xc0},
      di::opcode_test{riscv64_op_fcvt_w_s, riscv64_op_fcvt_w_s, "fcvt.w.s", "fcvt.w.s"},
    ...
    { // fcvt.wu.s s0, f5
      {0x53,0xf4,0x12,0xc0},
      di::opcode_test{riscv64_op_fcvt_wu_s, riscv64_op_fcvt_wu_s, "fcvt.wu.s", "fcvt.wu.s"},
    ...
    { // fclass.s a0, f6
      {0x53,0x15,0x03,0xe0},
      di::opcode_test{riscv64_op_fclass_s, riscv64_op_fclass_s, "fclass.s", "fclass.s"},
