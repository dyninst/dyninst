...
// $Id: test1_7.C,v 1.4 2006/10/11 21:53:14 cooksey Exp $
/*
 * #Name: test1_7
...
static int genRelTest(BPatch_image *appImage,BPatch_Vector<BPatch_snippet*> &vect7_1,
                BPatch_relOp op, int r1, int r2, const char *var1)
{
   ...
   BPatch_Vector<BPatch_function *> found_funcs;
	...
	logerror("Unable to find entry point to \"func7_1\".\n");
	return -1;
    }
...
static int mutatorTest(BPatch_thread *appThread, BPatch_image *appImage)
{
   ...
   BPatch_Vector<BPatch_function *> found_funcs;
    ...
    if (!point7_1 || ((*point7_1).size() == 0)) {
	logerror("Unable to find entry point to \"func7_2\".\n");
	return -1;
    }
...
// External Interface
extern "C" TEST_DLL_EXPORT int test1_7_mutatorMAIN(ParameterDict &param)
{
    BPatch *bpatch;
