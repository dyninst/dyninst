...
SymbolLookup*
Walker::createDefaultSymLookup(std::string exec_name)
{
...
bool
SwkSymtab::lookupAtAddr(Dyninst::Address, std::string&, void*&)
{
...
bool
SymDefaultLookup::lookupAtAddr(Dyninst::Address addr, std::string& out_name,
                               void*& out_value)
{
