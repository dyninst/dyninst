...
#if (defined(os_linux) || defined(os_freebsd)) && (defined(DYNINST_HOST_ARCH_X86) || defined(DYNINST_HOST_ARCH_X86_64) || defined(DYNINST_HOST_ARCH_AARCH64) || defined(arch_amdgpu) )
