...
class SW_EXPORT ProcessState {
 ...
 protected:
  ...
  ProcessState(Dyninst::PID pid_ = 0,
               std::string executable_path_ = std::string(""));
 ...
 public:
  ...
  virtual bool getRegValue(Dyninst::MachRegister reg, Dyninst::THR_ID thread,
