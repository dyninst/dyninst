...
public:
    Frame();
    Frame(Walker* walker);
    static Frame* newFrame(Dyninst::MachRegisterVal ra, Dyninst::MachRegisterVal sp,
...
typedef bool (*frame_cmp_t)(const Frame& a,
                            const Frame& b);  // Return true if a < b, by some comparison
SW_EXPORT bool
frame_addr_cmp(const Frame& a, const Frame& b);  // Default
SW_EXPORT bool
frame_lib_offset_cmp(const Frame& a, const Frame& b);
SW_EXPORT bool
frame_symname_cmp(const Frame& a, const Frame& b);
SW_EXPORT bool
frame_lineno_cmp(const Frame& a, const Frame& b);
