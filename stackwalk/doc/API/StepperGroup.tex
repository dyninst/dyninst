...
\begin{apient}
bool addStepper(FrameStepper* stepper, Address start, Address end);
\end{apient}
\apidesc{
...
\begin{apient}
void registerStepper(FrameStepper* stepper);
\end{apient}
...
void newLibraryNotification(LibAddrPair* libaddr, lib_change_t
change);
\end{apient}
