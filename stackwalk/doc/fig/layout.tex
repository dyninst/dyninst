...
\begin{tikzpicture}[
    ...
    % Right labels
    \node [code, right=3cm of dots,anchor=south] (mainFO) {main's\\ Frame Object};
    ...
    \node [code, below=2.5cm of mainFO] (fooFO) {foo's\\ Frame Object};
    ...
    \node [code, below=2.5cm of fooFO] (barFO) {bar's\\ Frame Object};
