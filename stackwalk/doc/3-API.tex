...
\end{apient}
\apidesc{
	A handle for identifying a thread. On Linux based platforms this is an integer referring to a TID (Thread Identifier). On Solaris and AIX the integer refers to a LWP (Light Weight Process). On Windows it is a HANDLE object.
}
...
\begin{apient}
int getLocalVariableValue(Dyninst::SymtabAPI::localVar *var,
