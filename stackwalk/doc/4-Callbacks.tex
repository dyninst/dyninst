...
callback classes described in Section~\ref{sec:callback-interface}. These implementations are used by a
...
\begin{apient}
bool pause(Dyninst::THR_ID tid = NULL_THR_ID);
\end{apient}
\apidesc{
...
\begin{apient}
bool resume(Dyninst::THR_ID tid = NULL_THR_ID);
\end{apient}
\apidesc{
...
\begin{apient}
bool detach(bool leave_stopped = false);
\end{apient}
\apidesc{
...
\subsubsection{Class FrameFuncHelper}
