...
/* $Id: RTheap-solaris.c,v 1.1 1999/06/17 06:19:47 csserra Exp $ */
...
#define HEAP_LO_ADDR ((caddr_t)0x00000000) /* avoid zero page */
#define HEAP_HI_ADDR ((caddr_t)0xefffffff) /* avoid stack and kernel */
