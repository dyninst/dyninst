...
/* $Id: RThwtimer-winnt.c,v 1.1 2001/02/01 01:04:58 schendel Exp $ */

/************************************************************************
 * RThwtimer-winnt.c: nt hardware level timer support functions
************************************************************************/
...
int isTSCAvail(void)  {
  __try {
    __asm {
;      mov ecx,13h
;      rdmsr            ; can be used to test that exception is caught
     rdtsc
    }
  }
