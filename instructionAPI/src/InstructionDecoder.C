...
{
INSTRUCTION_EXPORT
InstructionDecoder::InstructionDecoder(const unsigned char* buffer_, size_t size,
                                       Architecture arch)
: m_buf(buffer_, size)
{
...
INSTRUCTION_EXPORT
InstructionDecoder::InstructionDecoder(const void* buffer_, size_t size,
                                       Architecture arch)
...
INSTRUCTION_EXPORT Instruction
InstructionDecoder::decode(const unsigned char* b)
{
...
InstructionDecoder::doDelayedDecode(const Instruction* i)
{
