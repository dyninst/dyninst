...
INSTRUCTION_EXPORT InstructionDecoder::InstructionDecoder(
    const unsigned char* buffer, size_t size, Architecture arch)
    : m_buf(buffer, size) {
  m_Impl = InstructionDecoderImpl::makeDecoderImpl(arch);
  m_Impl->setMode(arch == Arch_x86_64);
}
INSTRUCTION_EXPORT InstructionDecoder::InstructionDecoder(const void* buffer,
                                                          size_t size,
                                                          Architecture arch)
...
INSTRUCTION_EXPORT InstructionDecoder::InstructionDecoder(
    const InstructionDecoder& o)
    : m_buf(o.m_buf), m_Impl(o.m_Impl) {}
INSTRUCTION_EXPORT InstructionDecoder::~InstructionDecoder() {}
...
INSTRUCTION_EXPORT void InstructionDecoder::doDelayedDecode(
    const Instruction* i) {
