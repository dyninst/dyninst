#define IS_ENC_SOP1(I) ((I & 0xFF800000) == 0xBE800000)
#define IS_ENC_SOPC(I) ((I & 0xFF800000) == 0xBF000000)
#define IS_ENC_SOPP(I) ((I & 0xFF800000) == 0xBF800000)
#define IS_ENC_SOPK(I) ((I & 0xF0000000) == 0xB0000000)
#define IS_ENC_SOP2(I) ((I & 0xC0000000) == 0x80000000)
#define IS_ENC_SMEM(I) ((I & 0xFC000000) == 0xC0000000)
#define IS_ENC_VOP1(I) ((I & 0xFE000000) == 0x7E000000)
#define IS_ENC_VOPC(I) ((I & 0xFE000000) == 0x7C000000)
#define IS_ENC_VOP2(I) ((I & 0x80000000) == 0x0)
#define IS_ENC_VINTRP(I) ((I & 0xFC000000) == 0xD4000000)
#define IS_ENC_VOP3P(I) ((I & 0xFF800000) == 0xD3800000)
#define IS_ENC_VOP3(I) ((I & 0xFC000000) == 0xD0000000)
#define IS_ENC_DS(I) ((I & 0xFC000000) == 0xD8000000)
#define IS_ENC_MUBUF(I) ((I & 0xFC000000) == 0xE0000000)
#define IS_ENC_MTBUF(I) ((I & 0xFC000000) == 0xE8000000)
#define IS_ENC_MIMG(I) ((I & 0xFC000000) == 0xF0000000)
#define IS_ENC_EXP(I) ((I & 0xFC000000) == 0xC4000000)
#define IS_ENC_FLAT(I) ((I & 0xFC000000) == 0xDC000000)
#define IS_VOP3_0_SDST_ENC_VOP3_1_(I) ((I & 0x0) == 0x0)
