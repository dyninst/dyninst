...
const operandFactory amdgpu_insn_entry::operandTable[] = {
    fn(NOTHING),    fn(setSMEM),
    fn(setLoad<1>),                            // s_load_dword
...
const amdgpu_insn_table amdgpu_insn_entry::sop1_insn_table = {
    ...
    { amdgpu_op_s_andn1_saveexec_b64, "s_andn1_saveexec_b64", 0,
      &operandTable[0] },                                                           // 51
    ...
    { amdgpu_op_s_bitreplicate_b64_b32, "s_bitreplicate_b64_b32", 0,
      &operandTable[0] },  // 55
...
const amdgpu_insn_table amdgpu_insn_entry::sopp_insn_table = {
    ...
    { amdgpu_op_s_cbranch_cdbgsys_or_user, "s_cbranch_cdbgsys_or_user", 0,
      &operandTable[0] },  // 25
    { amdgpu_op_s_cbranch_cdbgsys_and_user, "s_cbranch_cdbgsys_and_user", 2,
      &operandTable[70] },                                                        // 26
    ...
    { amdgpu_op_s_endpgm_ordered_ps_done, "s_endpgm_ordered_ps_done", 0,
      &operandTable[0] },  // 30
...
const amdgpu_insn_table amdgpu_insn_entry::smem_insn_table = {
    ...
    { amdgpu_op_s_scratch_load_dwordx2, "s_scratch_load_dwordx2", 0,
      &operandTable[0] },  // 6
    { amdgpu_op_s_scratch_load_dwordx4, "s_scratch_load_dwordx4", 0,
      &operandTable[0] },                                                            // 7
    { amdgpu_op_s_buffer_load_dword, "s_buffer_load_dword", 2, &operandTable[11] },  // 8
    { amdgpu_op_s_buffer_load_dwordx2, "s_buffer_load_dwordx2", 2,
      &operandTable[13] },  // 9
    { amdgpu_op_s_buffer_load_dwordx4, "s_buffer_load_dwordx4", 2,
      &operandTable[15] },  // 10
    { amdgpu_op_s_buffer_load_dwordx8, "s_buffer_load_dwordx8", 2,
      &operandTable[17] },  // 11
    { amdgpu_op_s_buffer_load_dwordx16, "s_buffer_load_dwordx16", 2,
      &operandTable[19] },                                                  // 12
    ...
    { amdgpu_op_s_scratch_store_dword, "s_scratch_store_dword", 0,
      &operandTable[0] },  // 21
    { amdgpu_op_s_scratch_store_dwordx2, "s_scratch_store_dwordx2", 0,
      &operandTable[0] },  // 22
    { amdgpu_op_s_scratch_store_dwordx4, "s_scratch_store_dwordx4", 0,
      &operandTable[0] },  // 23
    { amdgpu_op_s_buffer_store_dword, "s_buffer_store_dword", 0,
      &operandTable[0] },  // 24
    { amdgpu_op_s_buffer_store_dwordx2, "s_buffer_store_dwordx2", 0,
      &operandTable[0] },  // 25
    { amdgpu_op_s_buffer_store_dwordx4, "s_buffer_store_dwordx4", 0,
      &operandTable[0] },                                                     // 26
    ...
    { amdgpu_op_s_dcache_memrealtime, "s_dcache_memrealtime", 0,
      &operandTable[0] },                                                   // 37
...
const amdgpu_insn_table amdgpu_insn_entry::mtbuf_insn_table = {
    { amdgpu_op_tbuffer_load_format_x, "tbuffer_load_format_x", 2,
      &operandTable[37] },  // 0
    { amdgpu_op_tbuffer_load_format_xy, "tbuffer_load_format_xy", 2,
      &operandTable[39] },  // 1
    { amdgpu_op_tbuffer_load_format_xyz, "tbuffer_load_format_xyz", 2,
      &operandTable[41] },  // 2
    { amdgpu_op_tbuffer_load_format_xyzw, "tbuffer_load_format_xyzw", 2,
      &operandTable[43] },  // 3
    { amdgpu_op_tbuffer_store_format_x, "tbuffer_store_format_x", 2,
      &operandTable[45] },  // 4
    { amdgpu_op_tbuffer_store_format_xy, "tbuffer_store_format_xy", 2,
      &operandTable[47] },  // 5
    { amdgpu_op_tbuffer_store_format_xyz, "tbuffer_store_format_xyz", 2,
      &operandTable[49] },  // 6
    { amdgpu_op_tbuffer_store_format_xyzw, "tbuffer_store_format_xyzw", 2,
      &operandTable[51] },                              // 7
    { amdgpu_op_s_nop, "s_nop", 0, &operandTable[0] },  // 8
    { amdgpu_op_s_nop, "s_nop", 0, &operandTable[0] },  // 9
    { amdgpu_op_s_nop, "s_nop", 0, &operandTable[0] },  // 10
    ...
    { amdgpu_op_s_nop, "s_nop", 0, &operandTable[0] },  // 13
    { amdgpu_op_s_nop, "s_nop", 0, &operandTable[0] },  // 14
    { amdgpu_op_tbuffer_store_format_d16_xyzw, "tbuffer_store_format_d16_xyzw", 0,
      &operandTable[0] },  // 15
};                         // end tbuffer_store_format_d16_xyzw_insn_table

const amdgpu_insn_table amdgpu_insn_entry::mubuf_insn_table = {
    { amdgpu_op_buffer_load_format_x, "buffer_load_format_x", 2,
      &operandTable[21] },  // 0
    { amdgpu_op_buffer_load_format_xy, "buffer_load_format_xy", 2,
      &operandTable[23] },  // 1
    { amdgpu_op_buffer_load_format_xyz, "buffer_load_format_xyz", 2,
      &operandTable[25] },  // 2
    { amdgpu_op_buffer_load_format_xyzw, "buffer_load_format_xyzw", 2,
      &operandTable[27] },  // 3
    { amdgpu_op_buffer_store_format_x, "buffer_store_format_x", 2,
      &operandTable[29] },  // 4
    { amdgpu_op_buffer_store_format_xy, "buffer_store_format_xy", 2,
      &operandTable[31] },  // 5
    { amdgpu_op_buffer_store_format_xyz, "buffer_store_format_xyz", 2,
      &operandTable[33] },  // 6
    { amdgpu_op_buffer_store_format_xyzw, "buffer_store_format_xyzw", 2,
      &operandTable[35] },                                                          // 7
    ...
    { amdgpu_op_s_nop, "s_nop", 0, &operandTable[0] },                              // 106
    { amdgpu_op_s_nop, "s_nop", 0, &operandTable[0] },                              // 107
    { amdgpu_op_buffer_atomic_dec_x2, "buffer_atomic_dec_x2", 0,
      &operandTable[0] },  // 108
...
const amdgpu_insn_table amdgpu_insn_entry::vop3ab_insn_table = {
    ...
    { amdgpu_op_v_mul_legacy_f32_e64, "v_mul_legacy_f32_e64", 0,
      &operandTable[0] },                                                       // 260
    ...
    { amdgpu_op_v_mul_hi_i32_i24_e64, "v_mul_hi_i32_i24_e64", 0,
      &operandTable[0] },                                                       // 263
    { amdgpu_op_v_mul_u32_u24_e64, "v_mul_u32_u24_e64", 0, &operandTable[0] },  // 264
    { amdgpu_op_v_mul_hi_u32_u24_e64, "v_mul_hi_u32_u24_e64", 0,
      &operandTable[0] },                                                           // 265
    ...
    { amdgpu_op_v_subbrev_co_u32_e64, "v_subbrev_co_u32_e64", 0,
      &operandTable[0] },                                                       // 286
    ...
    { amdgpu_op_v_readfirstlane_b32_e64, "v_readfirstlane_b32_e64", 0,
      &operandTable[0] },                                                       // 322
    ...
    { amdgpu_op_v_cvt_rpi_i32_f32_e64, "v_cvt_rpi_i32_f32_e64", 0,
      &operandTable[0] },  // 332
    { amdgpu_op_v_cvt_flr_i32_f32_e64, "v_cvt_flr_i32_f32_e64", 0,
      &operandTable[0] },  // 333
    { amdgpu_op_v_cvt_off_f32_i4_e64, "v_cvt_off_f32_i4_e64", 0,
      &operandTable[0] },                                                     // 334
