...
public:
    ...
    InstructionDecoderImpl(Architecture a)
    : m_Arch(a)
    {}
...
protected:
    ...
    virtual Expression::Ptr makeTernaryExpression(Expression::Ptr cond,
                                                  Expression::Ptr first,
                                                  Expression::Ptr second,
                                                  Result_Type     resultType);
    // Instruction* makeInstruction(entryID opcode, const char* mnem, unsigned int
    // decodedSize,const unsigned char* raw);
