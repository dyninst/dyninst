...
namespace Dyninst { namespace InstructionAPI {
  ...
  Expression::Ptr InstructionDecoder_x86::makeSIBExpression(const InstructionDecoder::buffer& b) {
    ...
    return makeAddExpression(baseAST, makeMultiplyExpression(indexAST, scaleAST, registerType),
                             registerType);
  }
    ...
    switch(locs->modrm_mod) {
      case 0:
        ...
        if(locs->modrm_rm == modrm_use_sib)
          ...
          if(is64BitMode) {
            e = makeAddExpression(makeRegisterExpression(x86_64::rip), getModRMDisplacement(b), aw);
          } else {
  ...
  Expression::Ptr InstructionDecoder_x86::decodeImmediate(unsigned int opType,
                                                          const unsigned char* immStart,
                                                          bool isSigned) {
    ...
    switch(opType) {
      ...
      case op_d:
        return Immediate::makeImmediate(
            Result(isSigned ? s32 : u32, Dyninst::read_memory_as<dword_t>(immStart)));
      case op_w:
        return Immediate::makeImmediate(
            Result(isSigned ? s16 : u16, Dyninst::read_memory_as<word_t>(immStart)));
        break;
      case op_q:
        return Immediate::makeImmediate(
            Result(isSigned ? s64 : u64, Dyninst::read_memory_as<int64_t>(immStart)));
        break;
      case op_v:
      ...
      case op_p:
        ...
        if(!sizePrefixPresent) {
          return Immediate::makeImmediate(
              Result(isSigned ? s48 : u48, Dyninst::read_memory_as<int64_t>(immStart)));
        } else {
          return Immediate::makeImmediate(
              Result(isSigned ? s32 : u32, Dyninst::read_memory_as<dword_t>(immStart)));
        }
  ...
  Expression::Ptr
  InstructionDecoder_x86::getModRMDisplacement(const InstructionDecoder::buffer& b) {
    int disp_pos;
  ...
  static MachRegister IntelRegTable32[][8] = {
      ...
      {x86_64::rax, x86_64::rcx, x86_64::rdx, x86_64::rbx, x86_64::rsp, x86_64::rbp, x86_64::rsi,
       x86_64::rdi}, /* b_64bit */
      {x86::xmm0, x86::xmm1, x86::xmm2, x86::xmm3, x86::xmm4, x86::xmm5, x86::xmm6,
       x86::xmm7}, /* b_xmm_set0 */
      {x86_64::xmm8, x86_64::xmm9, x86_64::xmm10, x86_64::xmm11, x86_64::xmm12, x86_64::xmm13,
       x86_64::xmm14, x86_64::xmm15}, /* b_xmm_set1 */
      {x86_64::xmm16, x86_64::xmm17, x86_64::xmm18, x86_64::xmm19, x86_64::xmm20, x86_64::xmm21,
       x86_64::xmm22, x86_64::xmm23}, /* b_xmm_set2 */
      {x86_64::xmm24, x86_64::xmm25, x86_64::xmm26, x86_64::xmm27, x86_64::xmm28, x86_64::xmm29,
       x86_64::xmm30, x86_64::xmm31}, /* b_xmm_set3 */
      {x86_64::ymm0, x86_64::ymm1, x86_64::ymm2, x86_64::ymm3, x86_64::ymm4, x86_64::ymm5,
       x86_64::ymm6, x86_64::ymm7}, /* b_ymm_set0 */
      {x86_64::ymm8, x86_64::ymm9, x86_64::ymm10, x86_64::ymm11, x86_64::ymm12, x86_64::ymm13,
       x86_64::ymm14, x86_64::ymm15}, /* b_ymm_set1 */
      {x86_64::ymm16, x86_64::ymm17, x86_64::ymm18, x86_64::ymm19, x86_64::ymm20, x86_64::ymm21,
       x86_64::ymm22, x86_64::ymm23}, /* b_ymm_set2 */
      {x86_64::ymm24, x86_64::ymm25, x86_64::ymm26, x86_64::ymm27, x86_64::ymm28, x86_64::ymm29,
       x86_64::ymm30, x86_64::ymm31}, /* b_ymm_set3 */
      {x86_64::zmm0, x86_64::zmm1, x86_64::zmm2, x86_64::zmm3, x86_64::zmm4, x86_64::zmm5,
       x86_64::zmm6, x86_64::zmm7}, /* b_zmm_set0 */
      {x86_64::zmm8, x86_64::zmm9, x86_64::zmm10, x86_64::zmm11, x86_64::zmm12, x86_64::zmm13,
       x86_64::zmm14, x86_64::zmm15}, /* b_zmm_set1 */
      {x86_64::zmm16, x86_64::zmm17, x86_64::zmm18, x86_64::zmm19, x86_64::zmm20, x86_64::zmm21,
       x86_64::zmm22, x86_64::zmm23}, /* b_zmm_set2 */
      {x86_64::zmm24, x86_64::zmm25, x86_64::zmm26, x86_64::zmm27, x86_64::zmm28, x86_64::zmm29,
       x86_64::zmm30, x86_64::zmm31}, /* b_zmm_set3 */
      {x86_64::k0, x86_64::k1, x86_64::k2, x86_64::k3, x86_64::k4, x86_64::k5, x86_64::k6,
       x86_64::k7},
      ...
      {x86_64::r8, x86_64::r9, x86_64::r10, x86_64::r11, x86_64::r12, x86_64::r13, x86_64::r14,
       x86_64::r15},
      {x86_64::al, x86_64::cl, x86_64::dl, x86_64::bl, x86_64::spl, x86_64::bpl, x86_64::sil,
       x86_64::dil},
      {x86::st0, x86::st1, x86::st2, x86::st3, x86::st4, x86::st5, x86::st6, x86::st7}};

  static MachRegister IntelRegTable64[][8] = {
      {x86_64::al, x86_64::cl, x86_64::dl, x86_64::bl, x86_64::ah, x86_64::ch, x86_64::dh,
       x86_64::bh},
      {x86_64::ax, x86_64::cx, x86_64::dx, x86_64::bx, x86_64::sp, x86_64::bp, x86_64::si,
       x86_64::di},
      {x86_64::eax, x86_64::ecx, x86_64::edx, x86_64::ebx, x86_64::esp, x86_64::ebp, x86_64::esi,
       x86_64::edi},
      {x86_64::es, x86_64::cs, x86_64::ss, x86_64::ds, x86_64::fs, x86_64::gs, InvalidReg,
       InvalidReg},
      {x86_64::rax, x86_64::rcx, x86_64::rdx, x86_64::rbx, x86_64::rsp, x86_64::rbp, x86_64::rsi,
       x86_64::rdi},
      {x86_64::xmm0, x86_64::xmm1, x86_64::xmm2, x86_64::xmm3, x86_64::xmm4, x86_64::xmm5,
       x86_64::xmm6, x86_64::xmm7}, /* b_xmm_set0 */
      {x86_64::xmm8, x86_64::xmm9, x86_64::xmm10, x86_64::xmm11, x86_64::xmm12, x86_64::xmm13,
       x86_64::xmm14, x86_64::xmm15}, /* b_xmm_set1 */
      {x86_64::xmm16, x86_64::xmm17, x86_64::xmm18, x86_64::xmm19, x86_64::xmm20, x86_64::xmm21,
       x86_64::xmm22, x86_64::xmm23}, /* b_xmm_set2 */
      ...
      {x86_64::k0, x86_64::k1, x86_64::k2, x86_64::k3, x86_64::k4, x86_64::k5, x86_64::k6,
       x86_64::k7},
      {x86_64::mm0, x86_64::mm1, x86_64::mm2, x86_64::mm3, x86_64::mm4, x86_64::mm5, x86_64::mm6,
       x86_64::mm7},
      {x86_64::cr0, x86_64::cr1, x86_64::cr2, x86_64::cr3, x86_64::cr4, x86_64::cr5, x86_64::cr6,
       x86_64::cr7},
      {x86_64::dr0, x86_64::dr1, x86_64::dr2, x86_64::dr3, x86_64::dr4, x86_64::dr5, x86_64::dr6,
       x86_64::dr7},
      {x86_64::tr0, x86_64::tr1, x86_64::tr2, x86_64::tr3, x86_64::tr4, x86_64::tr5, x86_64::tr6,
       x86_64::tr7},
      {x86_64::r8, x86_64::r9, x86_64::r10, x86_64::r11, x86_64::r12, x86_64::r13, x86_64::r14,
       x86_64::r15},
      {x86_64::al, x86_64::cl, x86_64::dl, x86_64::bl, x86_64::spl, x86_64::bpl, x86_64::sil,
       x86_64::dil},
      {x86_64::st0, x86_64::st1, x86_64::st2, x86_64::st3, x86_64::st4, x86_64::st5, x86_64::st6,
       x86_64::st7},
      {x86_64::r8b, x86_64::r9b, x86_64::r10b, x86_64::r11b, x86_64::r12b, x86_64::r13b,
       x86_64::r14b, x86_64::r15b},
      {x86_64::r8w, x86_64::r9w, x86_64::r10w, x86_64::r11w, x86_64::r12w, x86_64::r13w,
       x86_64::r14w, x86_64::r15w},
      {x86_64::r8d, x86_64::r9d, x86_64::r10d, x86_64::r11d, x86_64::r12d, x86_64::r13d,
       x86_64::r14d, x86_64::r15d},
  };
  ...
  public:
    inline MachRegister operator()(Architecture arch, intelRegBanks bank, int index) {
...
#define AVX_TYPE_OKAY(type) ((type) >= AVX_XMM && (type) <= AVX_ZMM)
  ...
  bool decodeAVX(intelRegBanks& bank, int* bank_index, int regnum, AVX_Regtype type,
                 ia32_prefixes& pref, unsigned int admet, bool is64BitMode) {
    bool is64BitReg;
  ...
  bool InstructionDecoder_x86::decodeOneOperand(const InstructionDecoder::buffer& b,
                                                ...
                                                const Instruction* insn_to_complete, bool isRead,
    ...
    if(sizePrefixPresent && ((optype == op_v) || (optype == op_z)) && (operand.admet != am_J)) {
      optype = op_w;
    }
    ...
    switch(operand.admet) {
      ...
      case am_L:
        ...
        if(decodeAVX(bank, &bank_index,
                     (*(const uint8_t*)(b.start + locs->imm_position[imm_index++])) >> 4, avx_type,
  ...
  bool InstructionDecoder_x86::decodeOperands(const Instruction* insn_to_complete) {
    ...
    if(semantics >= s4OP) {
      ...
      } else if(!decodeOneOperand(b, {am_I, op_b}, /* This is always an IMM8 */
                                  imm_index, insn_to_complete, readsOperand(semantics, 3),
