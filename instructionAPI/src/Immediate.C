...
Immediate::Ptr Immediate::makeImmediate(const Result &val) {
  ...
  // std::map<Result, Immediate::Ptr>::const_iterator foundIt =
  // builtImmediates.find(val);

  // if(foundIt == builtImmediates.end())
  //{
  Immediate::Ptr ret =
      make_shared(singleton_object_pool<Immediate>::construct(val));
...
ArmConditionImmediate::ArmConditionImmediate(const Result &val)
    : Immediate(val) {
  m_condLookupMap =
      boost::assign::map_list_of(0, "eq")(1, "ne")(2, "cs")(3, "cc")(4, "mi")(
          5, "pl")(6, "vs")(7, "vc")(8, "hi")(9, "ls")(10, "ge")(11, "lt")(
          12, "gt")(13, "le")(14, "al")(15, "nv")
          .convert_to_container<std::map<unsigned int, std::string> >();
}

Immediate::Ptr ArmConditionImmediate::makeArmConditionImmediate(
    const Result &val) {
  Immediate::Ptr ret =
...
ArmPrfmTypeImmediate::ArmPrfmTypeImmediate(const Result &val) : Immediate(val) {
  m_prfmTypeLookupMap =
      boost::assign::map_list_of(0, "PLDL1KEEP")(1, "PLDL1STRM")(
          2, "PLDL2KEEP")(3, "PLDL2STRM")(4, "PLDL3KEEP")(5, "PLDL3STRM")(
          8, "PLIL1KEEP")(9, "PLIL1STRM")(10, "PLIL2KEEP")(11, "PLIL2STRM")(
          12, "PLIL3KEEP")(13, "PLIL3STRM")(16, "PSTL1KEEP")(17, "PSTL1STRM")(
          18, "PSTL2KEEP")(19, "PSTL2STRM")(20, "PSTL3KEEP")(21, "PSTL3STRM")
          .convert_to_container<std::map<unsigned int, std::string> >();
}

Immediate::Ptr ArmPrfmTypeImmediate::makeArmPrfmTypeImmediate(
    const Result &val) {
  Immediate::Ptr ret =
