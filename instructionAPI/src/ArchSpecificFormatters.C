...
std::string
x86Formatter::formatImmediate(std::string evalString)
{
    return "$0x" + evalString;
}
...
ArchSpecificFormatter::getFormatter(Architecture a)
{
    ...
    switch(a)
    {
        ...
        case Arch_aarch64:
            theFormatters[a] =
                boost::shared_ptr<ArchSpecificFormatter>(new ArmFormatter());
            break;
        case Arch_ppc32:
        case Arch_ppc64:
            theFormatters[a] =
                boost::shared_ptr<ArchSpecificFormatter>(new PPCFormatter());
            break;
        case Arch_x86:
        case Arch_x86_64:
        default:
            theFormatters[a] =
                boost::shared_ptr<ArchSpecificFormatter>(new x86Formatter());
            break;
    }
