...
void aarch64_insn_entry::buildInsnTable()
{
	...
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_bic_advsimd_imm, 	"bic",	list_of( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRa) )( fn(OPRb) )( fn(OPRc) )( fn(OPRcmode) )( fn(OPRcmode) )( fn(OPRcmode) )( fn(OPRd) )( fn(OPRe) )( fn(OPRf) )( fn(OPRg) )( fn(OPRh) )( fn(OPRRd) ), 788534272, 3220708352) );
	...
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_ld1_advsimd_mult, 	"ld1",	list_of( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRopcode) )( fn(OPRopcode) )( fn(OPRopcode) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnL) )( fn(OPRRtL) ), 205529088, 3221168128) );
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_ld1_advsimd_mult, 	"ld1",	list_of( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRRm) )( fn(OPRopcode) )( fn(OPRopcode) )( fn(OPRopcode) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnL) )( fn(OPRRtL) ), 213917696, 3219136512) );
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_ld1_advsimd_sngl, 	"ld1",	list_of( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRopcode) )( fn(OPRopcode) )( fn(OPRS<12 COMMA 12>) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnL) )( fn(OPRRtL) ), 222298112, 3221168128) );
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_ld1_advsimd_sngl, 	"ld1",	list_of( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRRm) )( fn(OPRopcode) )( fn(OPRopcode) )( fn(OPRS<12 COMMA 12>) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnL) )( fn(OPRRtL) ), 230686720, 3219136512) );
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_ld1r_advsimd, 	"ld1r",	list_of( fn(setRegWidth) )( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnL) )( fn(OPRRtL) ), 222347264, 3221221376) );
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_ld1r_advsimd, 	"ld1r",	list_of( fn(setRegWidth) )( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRRm) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnL) )( fn(OPRRtL) ), 230735872, 3219189760) );
	...
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_ld2_advsimd_sngl, 	"ld2",	list_of( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRopcode) )( fn(OPRopcode) )( fn(OPRS<12 COMMA 12>) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnL) )( fn(OPRRtL) ), 224395264, 3221168128) );
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_ld2_advsimd_sngl, 	"ld2",	list_of( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRRm) )( fn(OPRopcode) )( fn(OPRopcode) )( fn(OPRS<12 COMMA 12>) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnL) )( fn(OPRRtL) ), 232783872, 3219136512) );
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_ld2r_advsimd, 	"ld2r",	list_of( fn(setRegWidth) )( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnL) )( fn(OPRRtL) ), 224444416, 3221221376) );
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_ld2r_advsimd, 	"ld2r",	list_of( fn(setRegWidth) )( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRRm) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnL) )( fn(OPRRtL) ), 232833024, 3219189760) );
	...
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_ld3_advsimd_sngl, 	"ld3",	list_of( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRopcode) )( fn(OPRopcode) )( fn(OPRS<12 COMMA 12>) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnL) )( fn(OPRRtL) ), 222306304, 3221168128) );
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_ld3_advsimd_sngl, 	"ld3",	list_of( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRRm) )( fn(OPRopcode) )( fn(OPRopcode) )( fn(OPRS<12 COMMA 12>) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnL) )( fn(OPRRtL) ), 230694912, 3219136512) );
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_ld3r_advsimd, 	"ld3r",	list_of( fn(setRegWidth) )( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnL) )( fn(OPRRtL) ), 222355456, 3221221376) );
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_ld3r_advsimd, 	"ld3r",	list_of( fn(setRegWidth) )( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRRm) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnL) )( fn(OPRRtL) ), 230744064, 3219189760) );
	...
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_ld4_advsimd_sngl, 	"ld4",	list_of( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRopcode) )( fn(OPRopcode) )( fn(OPRS<12 COMMA 12>) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnL) )( fn(OPRRtL) ), 224403456, 3221168128) );
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_ld4_advsimd_sngl, 	"ld4",	list_of( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRRm) )( fn(OPRopcode) )( fn(OPRopcode) )( fn(OPRS<12 COMMA 12>) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnL) )( fn(OPRRtL) ), 232792064, 3219136512) );
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_ld4r_advsimd, 	"ld4r",	list_of( fn(setRegWidth) )( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnL) )( fn(OPRRtL) ), 224452608, 3221221376) );
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_ld4r_advsimd, 	"ld4r",	list_of( fn(setRegWidth) )( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRRm) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnL) )( fn(OPRRtL) ), 232841216, 3219189760) );
	...
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_orr_advsimd_imm, 	"orr",	list_of( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRa) )( fn(OPRb) )( fn(OPRc) )( fn(OPRcmode) )( fn(OPRcmode) )( fn(OPRcmode) )( fn(OPRd) )( fn(OPRe) )( fn(OPRf) )( fn(OPRg) )( fn(OPRh) )( fn(OPRRd) ), 251663360, 3220708352) );
	...
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_st1_advsimd_mult, 	"st1",	list_of( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRopcode) )( fn(OPRopcode) )( fn(OPRopcode) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnS) )( fn(OPRRtS) ), 201334784, 3221168128) );
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_st1_advsimd_mult, 	"st1",	list_of( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRRm) )( fn(OPRopcode) )( fn(OPRopcode) )( fn(OPRopcode) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnS) )( fn(OPRRtS) ), 209723392, 3219136512) );
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_st1_advsimd_sngl, 	"st1",	list_of( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRopcode) )( fn(OPRopcode) )( fn(OPRS<12 COMMA 12>) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnS) )( fn(OPRRtS) ), 218103808, 3221168128) );
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_st1_advsimd_sngl, 	"st1",	list_of( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRRm) )( fn(OPRopcode) )( fn(OPRopcode) )( fn(OPRS<12 COMMA 12>) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnS) )( fn(OPRRtS) ), 226492416, 3219136512) );
	...
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_st2_advsimd_sngl, 	"st2",	list_of( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRopcode) )( fn(OPRopcode) )( fn(OPRS<12 COMMA 12>) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnS) )( fn(OPRRtS) ), 220200960, 3221168128) );
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_st2_advsimd_sngl, 	"st2",	list_of( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRRm) )( fn(OPRopcode) )( fn(OPRopcode) )( fn(OPRS<12 COMMA 12>) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnS) )( fn(OPRRtS) ), 228589568, 3219136512) );
	...
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_st3_advsimd_sngl, 	"st3",	list_of( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRopcode) )( fn(OPRopcode) )( fn(OPRS<12 COMMA 12>) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnS) )( fn(OPRRtS) ), 218112000, 3221168128) );
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_st3_advsimd_sngl, 	"st3",	list_of( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRRm) )( fn(OPRopcode) )( fn(OPRopcode) )( fn(OPRS<12 COMMA 12>) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnS) )( fn(OPRRtS) ), 226500608, 3219136512) );
	...
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_st4_advsimd_sngl, 	"st4",	list_of( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRopcode) )( fn(OPRopcode) )( fn(OPRS<12 COMMA 12>) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnS) )( fn(OPRRtS) ), 220209152, 3221168128) );
	main_insn_table.push_back(aarch64_insn_entry(aarch64_op_st4_advsimd_sngl, 	"st4",	list_of( fn(setSIMDMode) )( fn(OPRQ) )( fn(OPRRm) )( fn(OPRopcode) )( fn(OPRopcode) )( fn(OPRS<12 COMMA 12>) )( fn(OPRsize<11 COMMA 10>) )( fn(OPRRnS) )( fn(OPRRtS) ), 228597760, 3219136512) );
...
void aarch64_mask_entry::buildDecoderTable()
{
	...
	main_decoder_table[0]=aarch64_mask_entry(0x18000000, map_list_of(0,1)(1,2)(2,3)(3,4), list_of(-1));
	main_decoder_table[1]=aarch64_mask_entry(0x0, branchMap(), list_of(0));
	main_decoder_table[2]=aarch64_mask_entry(0x7000000, map_list_of(0,5)(1,6)(2,7)(3,8)(4,9)(5,10)(6,11)(7,12), list_of(-1));
	main_decoder_table[5]=aarch64_mask_entry(0x20c00000, map_list_of(0,13)(1,14)(2,15)(3,16)(4,17)(5,18)(6,19)(7,20), list_of(-1));
	main_decoder_table[13]=aarch64_mask_entry(0x80208000, map_list_of(0,21)(1,22)(4,23)(5,24)(6,25)(7,26), list_of(-1));
	main_decoder_table[21]=aarch64_mask_entry(0x40007c00, map_list_of(31,27)(63,28), list_of(-1));
	main_decoder_table[27]=aarch64_mask_entry(0x0, branchMap(), list_of(614));
	main_decoder_table[28]=aarch64_mask_entry(0x0, branchMap(), list_of(615));
	main_decoder_table[22]=aarch64_mask_entry(0x40007c00, map_list_of(31,29)(63,30), list_of(-1));
	main_decoder_table[29]=aarch64_mask_entry(0x0, branchMap(), list_of(579));
	main_decoder_table[30]=aarch64_mask_entry(0x0, branchMap(), list_of(580));
	main_decoder_table[23]=aarch64_mask_entry(0x0, branchMap(), list_of(613));
	main_decoder_table[24]=aarch64_mask_entry(0x0, branchMap(), list_of(578));
	main_decoder_table[25]=aarch64_mask_entry(0x0, branchMap(), list_of(612));
	main_decoder_table[26]=aarch64_mask_entry(0x0, branchMap(), list_of(577));
	main_decoder_table[14]=aarch64_mask_entry(0x803f8000, map_list_of(62,31)(63,32)(190,33)(191,34)(254,35)(255,36), list_of(-1));
	main_decoder_table[31]=aarch64_mask_entry(0x40007c00, map_list_of(31,37)(63,38), list_of(-1));
	main_decoder_table[37]=aarch64_mask_entry(0x0, branchMap(), list_of(359));
	main_decoder_table[38]=aarch64_mask_entry(0x0, branchMap(), list_of(360));
	main_decoder_table[32]=aarch64_mask_entry(0x40007c00, map_list_of(31,39)(63,40), list_of(-1));
	main_decoder_table[39]=aarch64_mask_entry(0x0, branchMap(), list_of(300));
	main_decoder_table[40]=aarch64_mask_entry(0x0, branchMap(), list_of(301));
	main_decoder_table[33]=aarch64_mask_entry(0x0, branchMap(), list_of(358));
	main_decoder_table[34]=aarch64_mask_entry(0x0, branchMap(), list_of(299));
	main_decoder_table[35]=aarch64_mask_entry(0x0, branchMap(), list_of(357));
	main_decoder_table[36]=aarch64_mask_entry(0x0, branchMap(), list_of(298));
	main_decoder_table[15]=aarch64_mask_entry(0x803ffc00, map_list_of(2047,41)(6143,42), list_of(-1));
	main_decoder_table[41]=aarch64_mask_entry(0x40000000, map_list_of(0,43)(1,44), list_of(-1));
	main_decoder_table[43]=aarch64_mask_entry(0x0, branchMap(), list_of(575));
	main_decoder_table[44]=aarch64_mask_entry(0x0, branchMap(), list_of(576));
	main_decoder_table[42]=aarch64_mask_entry(0x0, branchMap(), list_of(574));
	main_decoder_table[16]=aarch64_mask_entry(0x803ffc00, map_list_of(2047,45)(6143,46), list_of(-1));
	main_decoder_table[45]=aarch64_mask_entry(0x40000000, map_list_of(0,47)(1,48), list_of(-1));
	main_decoder_table[47]=aarch64_mask_entry(0x0, branchMap(), list_of(296));
	main_decoder_table[48]=aarch64_mask_entry(0x0, branchMap(), list_of(297));
	main_decoder_table[46]=aarch64_mask_entry(0x0, branchMap(), list_of(295));
	main_decoder_table[17]=aarch64_mask_entry(0x0, branchMap(), list_of(582));
	main_decoder_table[18]=aarch64_mask_entry(0x0, branchMap(), list_of(303));
	main_decoder_table[19]=aarch64_mask_entry(0x0, branchMap(), list_of(586));
	main_decoder_table[20]=aarch64_mask_entry(0x40000000, map_list_of(0,49)(1,50), list_of(-1));
	main_decoder_table[49]=aarch64_mask_entry(0x0, branchMap(), list_of(307));
	main_decoder_table[50]=aarch64_mask_entry(0x0, branchMap(), list_of(310));
	main_decoder_table[6]=aarch64_mask_entry(0x60c00000, map_list_of(4,51)(5,52)(6,53)(7,54)(13,55)(15,56), list_of(-1));
	main_decoder_table[51]=aarch64_mask_entry(0x0, branchMap(), list_of(588));
	main_decoder_table[52]=aarch64_mask_entry(0x0, branchMap(), list_of(309));
	main_decoder_table[53]=aarch64_mask_entry(0x0, branchMap(), list_of(587));
	main_decoder_table[54]=aarch64_mask_entry(0x0, branchMap(), list_of(308));
	main_decoder_table[55]=aarch64_mask_entry(0x0, branchMap(), list_of(312));
	main_decoder_table[56]=aarch64_mask_entry(0x0, branchMap(), list_of(311));
	main_decoder_table[7]=aarch64_mask_entry(0x60200000, map_list_of(0,57)(1,58)(2,59)(3,60)(4,61)(5,62)(6,63)(7,64), list_of(-1));
	main_decoder_table[57]=aarch64_mask_entry(0x0, branchMap(), list_of(25));
	main_decoder_table[58]=aarch64_mask_entry(0x0, branchMap(), list_of(39));
	main_decoder_table[59]=aarch64_mask_entry(0x0, branchMap(), list_of(381)(410));
	main_decoder_table[60]=aarch64_mask_entry(0x0, branchMap(), list_of(395)(406));
	main_decoder_table[61]=aarch64_mask_entry(0x0, branchMap(), list_of(112));
	main_decoder_table[62]=aarch64_mask_entry(0x0, branchMap(), list_of(109));
	main_decoder_table[63]=aarch64_mask_entry(0x0, branchMap(), list_of(642)(27));
	main_decoder_table[64]=aarch64_mask_entry(0x0, branchMap(), list_of(40));
	main_decoder_table[8]=aarch64_mask_entry(0x60200000, map_list_of(0,65)(1,66)(2,67)(3,68)(4,69)(5,70)(6,71)(7,72), list_of(-1));
	main_decoder_table[65]=aarch64_mask_entry(0x0, branchMap(), list_of(7));
	main_decoder_table[66]=aarch64_mask_entry(0x0, branchMap(), list_of(5));
	main_decoder_table[67]=aarch64_mask_entry(0x0, branchMap(), list_of(83)(15));
	main_decoder_table[68]=aarch64_mask_entry(0xc00000, map_list_of(0,73), list_of(-1));
	main_decoder_table[73]=aarch64_mask_entry(0x0, branchMap(), list_of(81)(13));
	main_decoder_table[69]=aarch64_mask_entry(0x0, branchMap(), list_of(399)(618));
	main_decoder_table[70]=aarch64_mask_entry(0x0, branchMap(), list_of(616));
	main_decoder_table[71]=aarch64_mask_entry(0x0, branchMap(), list_of(86)(400)(624));
	main_decoder_table[72]=aarch64_mask_entry(0xc00000, map_list_of(0,74), list_of(-1));
	main_decoder_table[74]=aarch64_mask_entry(0x0, branchMap(), list_of(84)(622));
	main_decoder_table[9]=aarch64_mask_entry(0x20c00000, map_list_of(0,75)(1,76)(2,77)(3,78)(4,79)(5,80)(6,81)(7,82), list_of(-1));
	main_decoder_table[75]=aarch64_mask_entry(0x803f2000, map_list_of(0,83)(1,84), list_of(-1));
	main_decoder_table[83]=aarch64_mask_entry(0xd000, map_list_of(0,85)(2,86)(4,87), list_of(-1));
	main_decoder_table[85]=aarch64_mask_entry(0x0, branchMap(), list_of(570));
	main_decoder_table[86]=aarch64_mask_entry(0x0, branchMap(), list_of(566));
	main_decoder_table[87]=aarch64_mask_entry(0x0, branchMap(), list_of(562));
	main_decoder_table[84]=aarch64_mask_entry(0x0, branchMap(), list_of(558));
	main_decoder_table[76]=aarch64_mask_entry(0x803f2000, map_list_of(0,88)(1,89), list_of(-1));
	main_decoder_table[88]=aarch64_mask_entry(0xd000, map_list_of(0,90)(2,91)(4,92), list_of(-1));
	main_decoder_table[90]=aarch64_mask_entry(0x0, branchMap(), list_of(289));
	main_decoder_table[91]=aarch64_mask_entry(0x0, branchMap(), list_of(283));
	main_decoder_table[92]=aarch64_mask_entry(0x0, branchMap(), list_of(277));
	main_decoder_table[89]=aarch64_mask_entry(0x0, branchMap(), list_of(271));
	main_decoder_table[77]=aarch64_mask_entry(0x80202000, map_list_of(0,93)(1,94), list_of(-1));
	main_decoder_table[93]=aarch64_mask_entry(0xd000, map_list_of(0,95)(2,96)(4,97), list_of(-1));
	main_decoder_table[95]=aarch64_mask_entry(0x0, branchMap(), list_of(571));
	main_decoder_table[96]=aarch64_mask_entry(0x0, branchMap(), list_of(567));
	main_decoder_table[97]=aarch64_mask_entry(0x0, branchMap(), list_of(563));
	main_decoder_table[94]=aarch64_mask_entry(0x0, branchMap(), list_of(559));
	main_decoder_table[78]=aarch64_mask_entry(0x80202000, map_list_of(0,98)(1,99), list_of(-1));
	main_decoder_table[98]=aarch64_mask_entry(0xd000, map_list_of(0,100)(2,101)(4,102), list_of(-1));
	main_decoder_table[100]=aarch64_mask_entry(0x0, branchMap(), list_of(290));
	main_decoder_table[101]=aarch64_mask_entry(0x0, branchMap(), list_of(284));
	main_decoder_table[102]=aarch64_mask_entry(0x0, branchMap(), list_of(278));
	main_decoder_table[99]=aarch64_mask_entry(0x0, branchMap(), list_of(272));
	main_decoder_table[79]=aarch64_mask_entry(0x0, branchMap(), list_of(581));
	main_decoder_table[80]=aarch64_mask_entry(0x0, branchMap(), list_of(302));
	main_decoder_table[81]=aarch64_mask_entry(0x0, branchMap(), list_of(583));
	main_decoder_table[82]=aarch64_mask_entry(0x0, branchMap(), list_of(304));
	main_decoder_table[10]=aarch64_mask_entry(0x20c00000, map_list_of(0,103)(1,104)(2,105)(3,106)(4,107)(5,108)(6,109)(7,110), list_of(-1));
	main_decoder_table[103]=aarch64_mask_entry(0x803f2000, map_list_of(0,111)(1,112)(64,113)(65,114), list_of(-1));
	main_decoder_table[111]=aarch64_mask_entry(0x0, branchMap(), list_of(560));
	main_decoder_table[112]=aarch64_mask_entry(0x0, branchMap(), list_of(568));
	main_decoder_table[113]=aarch64_mask_entry(0x0, branchMap(), list_of(564));
	main_decoder_table[114]=aarch64_mask_entry(0x0, branchMap(), list_of(572));
	main_decoder_table[104]=aarch64_mask_entry(0x803f2000, map_list_of(0,115)(1,116)(64,117)(65,118), list_of(-1));
	main_decoder_table[115]=aarch64_mask_entry(0x0, branchMap(), list_of(275)(273));
	main_decoder_table[116]=aarch64_mask_entry(0x0, branchMap(), list_of(287)(285));
	main_decoder_table[117]=aarch64_mask_entry(0x0, branchMap(), list_of(281)(279));
	main_decoder_table[118]=aarch64_mask_entry(0x0, branchMap(), list_of(293)(291));
	main_decoder_table[105]=aarch64_mask_entry(0x80202000, map_list_of(0,119)(1,120)(2,121)(3,122), list_of(-1));
	main_decoder_table[119]=aarch64_mask_entry(0x0, branchMap(), list_of(561));
	main_decoder_table[120]=aarch64_mask_entry(0x0, branchMap(), list_of(569));
	main_decoder_table[121]=aarch64_mask_entry(0x0, branchMap(), list_of(565));
	main_decoder_table[122]=aarch64_mask_entry(0x0, branchMap(), list_of(573));
	main_decoder_table[106]=aarch64_mask_entry(0x80202000, map_list_of(0,123)(1,124)(2,125)(3,126), list_of(-1));
	main_decoder_table[123]=aarch64_mask_entry(0x0, branchMap(), list_of(276)(274));
	main_decoder_table[124]=aarch64_mask_entry(0x0, branchMap(), list_of(288)(286));
	main_decoder_table[125]=aarch64_mask_entry(0x0, branchMap(), list_of(282)(280));
	main_decoder_table[126]=aarch64_mask_entry(0x0, branchMap(), list_of(294)(292));
	main_decoder_table[107]=aarch64_mask_entry(0x0, branchMap(), list_of(585));
	main_decoder_table[108]=aarch64_mask_entry(0x0, branchMap(), list_of(306));
	main_decoder_table[109]=aarch64_mask_entry(0x0, branchMap(), list_of(584));
	main_decoder_table[110]=aarch64_mask_entry(0x0, branchMap(), list_of(305));
	main_decoder_table[11]=aarch64_mask_entry(0xa0208400, map_list_of(0,127)(1,128)(4,129)(5,130)(6,131)(7,132)(8,133)(9,134)(12,135)(13,136)(14,137)(15,138), list_of(-1));
	main_decoder_table[127]=aarch64_mask_entry(0x1800, map_list_of(0,139)(1,140)(2,141)(3,142), list_of(-1));
	main_decoder_table[139]=aarch64_mask_entry(0x0, branchMap(), list_of(634));
	main_decoder_table[140]=aarch64_mask_entry(0x6000, map_list_of(1,143)(3,144), list_of(-1));
	main_decoder_table[143]=aarch64_mask_entry(0x0, branchMap(), list_of(639));
	main_decoder_table[144]=aarch64_mask_entry(0x0, branchMap(), list_of(640));
	main_decoder_table[141]=aarch64_mask_entry(0x0, branchMap(), list_of(636));
	main_decoder_table[142]=aarch64_mask_entry(0x6000, map_list_of(0,145)(1,146)(2,147)(3,148), list_of(-1));
	main_decoder_table[145]=aarch64_mask_entry(0x0, branchMap(), list_of(721));
	main_decoder_table[146]=aarch64_mask_entry(0x0, branchMap(), list_of(727));
	main_decoder_table[147]=aarch64_mask_entry(0x0, branchMap(), list_of(722));
	main_decoder_table[148]=aarch64_mask_entry(0x0, branchMap(), list_of(728));
	main_decoder_table[128]=aarch64_mask_entry(0xc07800, map_list_of(0,149)(1,150)(3,151)(5,152)(7,153), list_of(-1));
	main_decoder_table[149]=aarch64_mask_entry(0x0, branchMap(), list_of(107));
	main_decoder_table[150]=aarch64_mask_entry(0x0, branchMap(), list_of(108));
	main_decoder_table[151]=aarch64_mask_entry(0x40000000, map_list_of(1,154), list_of(-1));
	main_decoder_table[154]=aarch64_mask_entry(0x0, branchMap(), list_of(269)(376));
	main_decoder_table[152]=aarch64_mask_entry(0x0, branchMap(), list_of(486));
	main_decoder_table[153]=aarch64_mask_entry(0x0, branchMap(), list_of(382)(676));
	main_decoder_table[129]=aarch64_mask_entry(0x7800, map_list_of(0,155)(1,156)(2,157)(3,158)(4,159)(5,160)(6,161)(7,162)(8,163)(9,164)(10,165)(11,166)(12,167)(13,168)(14,169)(15,170), list_of(-1));
	main_decoder_table[155]=aarch64_mask_entry(0x0, branchMap(), list_of(437));
	main_decoder_table[156]=aarch64_mask_entry(0x0, branchMap(), list_of(426));
	main_decoder_table[157]=aarch64_mask_entry(0x0, branchMap(), list_of(440));
	main_decoder_table[158]=aarch64_mask_entry(0x0, branchMap(), list_of(422));
	main_decoder_table[159]=aarch64_mask_entry(0x0, branchMap(), list_of(556));
	main_decoder_table[160]=aarch64_mask_entry(0x1f0000, map_list_of(0,171)(1,172), list_of(-1));
	main_decoder_table[171]=aarch64_mask_entry(0x0, branchMap(), list_of(438));
	main_decoder_table[172]=aarch64_mask_entry(0x0, branchMap(), list_of(725));
	main_decoder_table[161]=aarch64_mask_entry(0x0, branchMap(), list_of(557));
	main_decoder_table[162]=aarch64_mask_entry(0x1f0000, map_list_of(0,173)(16,174), list_of(-1));
	main_decoder_table[173]=aarch64_mask_entry(0x0, branchMap(), list_of(626));
	main_decoder_table[174]=aarch64_mask_entry(0x0, branchMap(), list_of(439));
	main_decoder_table[163]=aarch64_mask_entry(0x0, branchMap(), list_of(10));
	main_decoder_table[164]=aarch64_mask_entry(0x1f0000, map_list_of(0,175)(1,176)(8,177), list_of(-1));
	main_decoder_table[175]=aarch64_mask_entry(0x0, branchMap(), list_of(57));
	main_decoder_table[176]=aarch64_mask_entry(0x0, branchMap(), list_of(537));
	main_decoder_table[177]=aarch64_mask_entry(0x0, branchMap(), list_of(20));
	main_decoder_table[165]=aarch64_mask_entry(0x0, branchMap(), list_of(433));
	main_decoder_table[166]=aarch64_mask_entry(0x1f0000, map_list_of(0,178)(8,179), list_of(-1));
	main_decoder_table[178]=aarch64_mask_entry(0x0, branchMap(), list_of(90));
	main_decoder_table[179]=aarch64_mask_entry(0x0, branchMap(), list_of(19));
	main_decoder_table[167]=aarch64_mask_entry(0x0, branchMap(), list_of(621));
	main_decoder_table[168]=aarch64_mask_entry(0x1f0000, map_list_of(0,180)(1,181)(8,182), list_of(-1));
	main_decoder_table[180]=aarch64_mask_entry(0x0, branchMap(), list_of(436));
	main_decoder_table[181]=aarch64_mask_entry(0x0, branchMap(), list_of(163));
	main_decoder_table[182]=aarch64_mask_entry(0x0, branchMap(), list_of(22));
	main_decoder_table[169]=aarch64_mask_entry(0x0, branchMap(), list_of(435));
	main_decoder_table[170]=aarch64_mask_entry(0x1f0000, map_list_of(0,183)(1,184)(8,185), list_of(-1));
	main_decoder_table[183]=aarch64_mask_entry(0x0, branchMap(), list_of(493));
	main_decoder_table[184]=aarch64_mask_entry(0x0, branchMap(), list_of(156));
	main_decoder_table[185]=aarch64_mask_entry(0x0, branchMap(), list_of(21));
	main_decoder_table[130]=aarch64_mask_entry(0x7800, map_list_of(0,186)(1,187)(2,188)(3,189)(4,190)(5,191)(6,192)(7,193)(8,194)(9,195)(10,196)(11,197)(12,198)(13,199)(14,200)(15,201), list_of(-1));
	main_decoder_table[186]=aarch64_mask_entry(0x0, branchMap(), list_of(465));
	main_decoder_table[187]=aarch64_mask_entry(0x0, branchMap(), list_of(495));
	main_decoder_table[188]=aarch64_mask_entry(0x0, branchMap(), list_of(540));
	main_decoder_table[189]=aarch64_mask_entry(0xc00000, map_list_of(0,202)(1,203)(2,204)(3,205), list_of(-1));
	main_decoder_table[202]=aarch64_mask_entry(0x0, branchMap(), list_of(23));
	main_decoder_table[203]=aarch64_mask_entry(0x0, branchMap(), list_of(38));
	main_decoder_table[204]=aarch64_mask_entry(0x0, branchMap(), list_of(379)(408));
	main_decoder_table[205]=aarch64_mask_entry(0x0, branchMap(), list_of(405));
	main_decoder_table[190]=aarch64_mask_entry(0x0, branchMap(), list_of(470));
	main_decoder_table[191]=aarch64_mask_entry(0x0, branchMap(), list_of(535));
	main_decoder_table[192]=aarch64_mask_entry(0x0, branchMap(), list_of(70));
	main_decoder_table[193]=aarch64_mask_entry(0x0, branchMap(), list_of(66));
	main_decoder_table[194]=aarch64_mask_entry(0x0, branchMap(), list_of(550));
	main_decoder_table[195]=aarch64_mask_entry(0x0, branchMap(), list_of(527));
	main_decoder_table[196]=aarch64_mask_entry(0x0, branchMap(), list_of(544));
	main_decoder_table[197]=aarch64_mask_entry(0x0, branchMap(), list_of(519));
	main_decoder_table[198]=aarch64_mask_entry(0x0, branchMap(), list_of(474));
	main_decoder_table[199]=aarch64_mask_entry(0x0, branchMap(), list_of(478));
	main_decoder_table[200]=aarch64_mask_entry(0x0, branchMap(), list_of(434));
	main_decoder_table[201]=aarch64_mask_entry(0x0, branchMap(), list_of(432));
	main_decoder_table[131]=aarch64_mask_entry(0x7800, map_list_of(0,206)(1,207)(2,208)(3,209)(4,210)(5,211)(6,212)(7,213)(8,214)(9,215)(10,216)(11,217)(12,218)(13,219)(15,220), list_of(-1));
	main_decoder_table[206]=aarch64_mask_entry(0x0, branchMap(), list_of(482));
	main_decoder_table[207]=aarch64_mask_entry(0x1f0000, map_list_of(0,221)(1,222), list_of(-1));
	main_decoder_table[221]=aarch64_mask_entry(0x0, branchMap(), list_of(72));
	main_decoder_table[222]=aarch64_mask_entry(0x800000, map_list_of(0,223)(1,224), list_of(-1));
	main_decoder_table[223]=aarch64_mask_entry(0x0, branchMap(), list_of(248));
	main_decoder_table[224]=aarch64_mask_entry(0x0, branchMap(), list_of(250));
	main_decoder_table[208]=aarch64_mask_entry(0x0, branchMap(), list_of(499));
	main_decoder_table[209]=aarch64_mask_entry(0x1f0000, map_list_of(0,225)(1,226), list_of(-1));
	main_decoder_table[225]=aarch64_mask_entry(0x0, branchMap(), list_of(64));
	main_decoder_table[226]=aarch64_mask_entry(0x800000, map_list_of(0,227)(1,228), list_of(-1));
	main_decoder_table[227]=aarch64_mask_entry(0x0, branchMap(), list_of(246));
	main_decoder_table[228]=aarch64_mask_entry(0x0, branchMap(), list_of(254));
	main_decoder_table[210]=aarch64_mask_entry(0x0, branchMap(), list_of(484));
	main_decoder_table[211]=aarch64_mask_entry(0x1f0000, map_list_of(0,229)(1,230)(16,231)(17,232), list_of(-1));
	main_decoder_table[229]=aarch64_mask_entry(0x0, branchMap(), list_of(80));
	main_decoder_table[230]=aarch64_mask_entry(0x800000, map_list_of(0,233)(1,234), list_of(-1));
	main_decoder_table[233]=aarch64_mask_entry(0x0, branchMap(), list_of(165));
	main_decoder_table[234]=aarch64_mask_entry(0x0, branchMap(), list_of(171));
	main_decoder_table[231]=aarch64_mask_entry(0x0, branchMap(), list_of(476));
	main_decoder_table[232]=aarch64_mask_entry(0x0, branchMap(), list_of(480));
	main_decoder_table[212]=aarch64_mask_entry(0x0, branchMap(), list_of(503));
	main_decoder_table[213]=aarch64_mask_entry(0x1f0000, map_list_of(0,235)(1,236)(17,237), list_of(-1));
	main_decoder_table[235]=aarch64_mask_entry(0x0, branchMap(), list_of(2));
	main_decoder_table[236]=aarch64_mask_entry(0x800000, map_list_of(0,238)(1,239), list_of(-1));
	main_decoder_table[238]=aarch64_mask_entry(0x0, branchMap(), list_of(158));
	main_decoder_table[239]=aarch64_mask_entry(0x0, branchMap(), list_of(181));
	main_decoder_table[237]=aarch64_mask_entry(0x0, branchMap(), list_of(16));
	main_decoder_table[214]=aarch64_mask_entry(0x0, branchMap(), list_of(490));
	main_decoder_table[215]=aarch64_mask_entry(0x9f0000, map_list_of(1,240)(32,241)(33,242), list_of(-1));
	main_decoder_table[240]=aarch64_mask_entry(0x0, branchMap(), list_of(151));
	main_decoder_table[241]=aarch64_mask_entry(0x0, branchMap(), list_of(141));
	main_decoder_table[242]=aarch64_mask_entry(0x0, branchMap(), list_of(698));
	main_decoder_table[216]=aarch64_mask_entry(0x0, branchMap(), list_of(511));
	main_decoder_table[217]=aarch64_mask_entry(0x9f0000, map_list_of(1,243)(32,244)(33,245), list_of(-1));
	main_decoder_table[243]=aarch64_mask_entry(0x0, branchMap(), list_of(449));
	main_decoder_table[244]=aarch64_mask_entry(0x0, branchMap(), list_of(133));
	main_decoder_table[245]=aarch64_mask_entry(0x0, branchMap(), list_of(238));
	main_decoder_table[218]=aarch64_mask_entry(0x0, branchMap(), list_of(412));
	main_decoder_table[219]=aarch64_mask_entry(0x0, branchMap(), list_of(145));
	main_decoder_table[220]=aarch64_mask_entry(0x0, branchMap(), list_of(118));
	main_decoder_table[132]=aarch64_mask_entry(0x7800, map_list_of(0,246)(1,247)(2,248)(3,249)(4,250)(5,251)(6,252)(7,253)(8,254)(9,255)(10,256)(11,257)(12,258)(14,259)(15,260), list_of(-1));
	main_decoder_table[246]=aarch64_mask_entry(0x0, branchMap(), list_of(9));
	main_decoder_table[247]=aarch64_mask_entry(0x0, branchMap(), list_of(88));
	main_decoder_table[248]=aarch64_mask_entry(0x0, branchMap(), list_of(369));
	main_decoder_table[249]=aarch64_mask_entry(0x0, branchMap(), list_of(392));
	main_decoder_table[250]=aarch64_mask_entry(0x0, branchMap(), list_of(475));
	main_decoder_table[251]=aarch64_mask_entry(0x0, branchMap(), list_of(479));
	main_decoder_table[252]=aarch64_mask_entry(0x0, branchMap(), list_of(507));
	main_decoder_table[253]=aarch64_mask_entry(0x0, branchMap(), list_of(12));
	main_decoder_table[254]=aarch64_mask_entry(0x800000, map_list_of(0,261)(1,262), list_of(-1));
	main_decoder_table[261]=aarch64_mask_entry(0x0, branchMap(), list_of(195));
	main_decoder_table[262]=aarch64_mask_entry(0x0, branchMap(), list_of(205));
	main_decoder_table[255]=aarch64_mask_entry(0x800000, map_list_of(0,263)(1,264), list_of(-1));
	main_decoder_table[263]=aarch64_mask_entry(0x0, branchMap(), list_of(215));
	main_decoder_table[264]=aarch64_mask_entry(0x0, branchMap(), list_of(218));
	main_decoder_table[256]=aarch64_mask_entry(0x800000, map_list_of(0,265)(1,266), list_of(-1));
	main_decoder_table[265]=aarch64_mask_entry(0x0, branchMap(), list_of(124));
	main_decoder_table[266]=aarch64_mask_entry(0x0, branchMap(), list_of(262));
	main_decoder_table[257]=aarch64_mask_entry(0x0, branchMap(), list_of(231));
	main_decoder_table[258]=aarch64_mask_entry(0x0, branchMap(), list_of(131));
	main_decoder_table[259]=aarch64_mask_entry(0x800000, map_list_of(0,267)(1,268), list_of(-1));
	main_decoder_table[267]=aarch64_mask_entry(0x0, branchMap(), list_of(193));
	main_decoder_table[268]=aarch64_mask_entry(0x0, branchMap(), list_of(203));
	main_decoder_table[260]=aarch64_mask_entry(0x800000, map_list_of(0,269)(1,270), list_of(-1));
	main_decoder_table[269]=aarch64_mask_entry(0x0, branchMap(), list_of(240));
	main_decoder_table[270]=aarch64_mask_entry(0x0, branchMap(), list_of(259));
	main_decoder_table[133]=aarch64_mask_entry(0x0, branchMap(), list_of(114));
	main_decoder_table[134]=aarch64_mask_entry(0x40c00000, map_list_of(4,271), list_of(-1));
	main_decoder_table[271]=aarch64_mask_entry(0x0, branchMap(), list_of(268)(375));
	main_decoder_table[135]=aarch64_mask_entry(0x7800, map_list_of(0,272)(1,273)(2,274)(4,275)(5,276)(6,277)(7,278)(8,279)(9,280)(10,281)(11,282)(12,283)(13,284)(14,285)(15,286), list_of(-1));
	main_decoder_table[272]=aarch64_mask_entry(0x0, branchMap(), list_of(648));
	main_decoder_table[273]=aarch64_mask_entry(0x0, branchMap(), list_of(424));
	main_decoder_table[274]=aarch64_mask_entry(0x0, branchMap(), list_of(651));
	main_decoder_table[275]=aarch64_mask_entry(0x0, branchMap(), list_of(716));
	main_decoder_table[276]=aarch64_mask_entry(0x1f0000, map_list_of(0,287)(1,288), list_of(-1));
	main_decoder_table[287]=aarch64_mask_entry(0x0, branchMap(), list_of(649));
	main_decoder_table[288]=aarch64_mask_entry(0x0, branchMap(), list_of(539));
	main_decoder_table[277]=aarch64_mask_entry(0x0, branchMap(), list_of(717));
	main_decoder_table[278]=aarch64_mask_entry(0x1f0000, map_list_of(0,289)(1,290)(16,291), list_of(-1));
	main_decoder_table[289]=aarch64_mask_entry(0x0, branchMap(), list_of(713));
	main_decoder_table[290]=aarch64_mask_entry(0x0, branchMap(), list_of(468));
	main_decoder_table[291]=aarch64_mask_entry(0x0, branchMap(), list_of(650));
	main_decoder_table[279]=aarch64_mask_entry(0x0, branchMap(), list_of(417));
	main_decoder_table[280]=aarch64_mask_entry(0x1f0000, map_list_of(0,292)(1,293), list_of(-1));
	main_decoder_table[292]=aarch64_mask_entry(0x0, branchMap(), list_of(59));
	main_decoder_table[293]=aarch64_mask_entry(0x0, branchMap(), list_of(697));
	main_decoder_table[281]=aarch64_mask_entry(0x0, branchMap(), list_of(644));
	main_decoder_table[282]=aarch64_mask_entry(0xdf0000, map_list_of(0,294)(32,295), list_of(-1));
	main_decoder_table[294]=aarch64_mask_entry(0x0, branchMap(), list_of(394)(404));
	main_decoder_table[295]=aarch64_mask_entry(0x0, branchMap(), list_of(418));
	main_decoder_table[283]=aarch64_mask_entry(0x0, branchMap(), list_of(431));
	main_decoder_table[284]=aarch64_mask_entry(0x1f0000, map_list_of(0,296)(1,297), list_of(-1));
	main_decoder_table[296]=aarch64_mask_entry(0x0, branchMap(), list_of(647));
	main_decoder_table[297]=aarch64_mask_entry(0x0, branchMap(), list_of(177));
	main_decoder_table[285]=aarch64_mask_entry(0x0, branchMap(), list_of(646));
	main_decoder_table[286]=aarch64_mask_entry(0x0, branchMap(), list_of(513));
	main_decoder_table[136]=aarch64_mask_entry(0x7800, map_list_of(0,298)(1,299)(2,300)(3,301)(4,302)(5,303)(6,304)(7,305)(8,306)(9,307)(10,308)(11,309)(12,310)(13,311)(14,312)(15,313), list_of(-1));
	main_decoder_table[298]=aarch64_mask_entry(0x0, branchMap(), list_of(662));
	main_decoder_table[299]=aarch64_mask_entry(0x0, branchMap(), list_of(683));
	main_decoder_table[300]=aarch64_mask_entry(0x0, branchMap(), list_of(699));
	main_decoder_table[301]=aarch64_mask_entry(0xc00000, map_list_of(0,314)(1,315)(2,316)(3,317), list_of(-1));
	main_decoder_table[314]=aarch64_mask_entry(0x0, branchMap(), list_of(110));
	main_decoder_table[315]=aarch64_mask_entry(0x0, branchMap(), list_of(47));
	main_decoder_table[316]=aarch64_mask_entry(0x0, branchMap(), list_of(42));
	main_decoder_table[317]=aarch64_mask_entry(0x0, branchMap(), list_of(41));
	main_decoder_table[302]=aarch64_mask_entry(0x0, branchMap(), list_of(663));
	main_decoder_table[303]=aarch64_mask_entry(0x0, branchMap(), list_of(695));
	main_decoder_table[304]=aarch64_mask_entry(0x0, branchMap(), list_of(74));
	main_decoder_table[305]=aarch64_mask_entry(0x0, branchMap(), list_of(76));
	main_decoder_table[306]=aarch64_mask_entry(0x0, branchMap(), list_of(708));
	main_decoder_table[307]=aarch64_mask_entry(0x0, branchMap(), list_of(691));
	main_decoder_table[308]=aarch64_mask_entry(0x0, branchMap(), list_of(701));
	main_decoder_table[309]=aarch64_mask_entry(0x0, branchMap(), list_of(685));
	main_decoder_table[310]=aarch64_mask_entry(0x0, branchMap(), list_of(665));
	main_decoder_table[311]=aarch64_mask_entry(0x0, branchMap(), list_of(668));
	main_decoder_table[312]=aarch64_mask_entry(0x0, branchMap(), list_of(645));
	main_decoder_table[313]=aarch64_mask_entry(0x0, branchMap(), list_of(643));
	main_decoder_table[137]=aarch64_mask_entry(0x7800, map_list_of(0,318)(1,319)(3,320)(4,321)(5,322)(7,323)(8,324)(9,325)(11,326)(15,327), list_of(-1));
	main_decoder_table[318]=aarch64_mask_entry(0x0, branchMap(), list_of(672));
	main_decoder_table[319]=aarch64_mask_entry(0x1f0000, map_list_of(0,328)(1,329), list_of(-1));
	main_decoder_table[328]=aarch64_mask_entry(0x0, branchMap(), list_of(68));
	main_decoder_table[329]=aarch64_mask_entry(0x0, branchMap(), list_of(242));
	main_decoder_table[320]=aarch64_mask_entry(0x1f0000, map_list_of(0,330)(1,331), list_of(-1));
	main_decoder_table[330]=aarch64_mask_entry(0x0, branchMap(), list_of(78));
	main_decoder_table[331]=aarch64_mask_entry(0x800000, map_list_of(0,332)(1,333), list_of(-1));
	main_decoder_table[332]=aarch64_mask_entry(0x0, branchMap(), list_of(252));
	main_decoder_table[333]=aarch64_mask_entry(0x0, branchMap(), list_of(244));
	main_decoder_table[321]=aarch64_mask_entry(0x0, branchMap(), list_of(674));
	main_decoder_table[322]=aarch64_mask_entry(0x1f0000, map_list_of(1,334)(16,335)(17,336), list_of(-1));
	main_decoder_table[334]=aarch64_mask_entry(0x800000, map_list_of(0,337)(1,338), list_of(-1));
	main_decoder_table[337]=aarch64_mask_entry(0x0, branchMap(), list_of(168));
	main_decoder_table[338]=aarch64_mask_entry(0x0, branchMap(), list_of(174));
	main_decoder_table[335]=aarch64_mask_entry(0x0, branchMap(), list_of(667));
	main_decoder_table[336]=aarch64_mask_entry(0x0, branchMap(), list_of(670));
	main_decoder_table[323]=aarch64_mask_entry(0x1f0000, map_list_of(0,339)(1,340), list_of(-1));
	main_decoder_table[339]=aarch64_mask_entry(0x0, branchMap(), list_of(398));
	main_decoder_table[340]=aarch64_mask_entry(0x800000, map_list_of(0,341)(1,342), list_of(-1));
	main_decoder_table[341]=aarch64_mask_entry(0x0, branchMap(), list_of(161));
	main_decoder_table[342]=aarch64_mask_entry(0x0, branchMap(), list_of(187));
	main_decoder_table[324]=aarch64_mask_entry(0x0, branchMap(), list_of(680));
	main_decoder_table[325]=aarch64_mask_entry(0x9f0000, map_list_of(1,343)(16,344)(32,345)(33,346)(48,347), list_of(-1));
	main_decoder_table[343]=aarch64_mask_entry(0x0, branchMap(), list_of(154));
	main_decoder_table[344]=aarch64_mask_entry(0x0, branchMap(), list_of(199));
	main_decoder_table[345]=aarch64_mask_entry(0x0, branchMap(), list_of(137));
	main_decoder_table[346]=aarch64_mask_entry(0x0, branchMap(), list_of(704));
	main_decoder_table[347]=aarch64_mask_entry(0x0, branchMap(), list_of(209));
	main_decoder_table[326]=aarch64_mask_entry(0x9f0000, map_list_of(1,348)(32,349)(33,350), list_of(-1));
	main_decoder_table[348]=aarch64_mask_entry(0x0, branchMap(), list_of(658));
	main_decoder_table[349]=aarch64_mask_entry(0x0, branchMap(), list_of(143));
	main_decoder_table[350]=aarch64_mask_entry(0x0, branchMap(), list_of(257));
	main_decoder_table[327]=aarch64_mask_entry(0x9f0000, map_list_of(16,351)(32,352)(33,353)(48,354), list_of(-1));
	main_decoder_table[351]=aarch64_mask_entry(0x0, branchMap(), list_of(202));
	main_decoder_table[352]=aarch64_mask_entry(0x0, branchMap(), list_of(232));
	main_decoder_table[353]=aarch64_mask_entry(0x0, branchMap(), list_of(260));
	main_decoder_table[354]=aarch64_mask_entry(0x0, branchMap(), list_of(212));
	main_decoder_table[138]=aarch64_mask_entry(0x7800, map_list_of(0,355)(1,356)(2,357)(3,358)(4,359)(5,360)(6,361)(8,362)(10,363)(11,364)(12,365)(13,366)(14,367)(15,368), list_of(-1));
	main_decoder_table[355]=aarch64_mask_entry(0x0, branchMap(), list_of(620));
	main_decoder_table[356]=aarch64_mask_entry(0x0, branchMap(), list_of(62));
	main_decoder_table[357]=aarch64_mask_entry(0x0, branchMap(), list_of(371));
	main_decoder_table[358]=aarch64_mask_entry(0x0, branchMap(), list_of(411));
	main_decoder_table[359]=aarch64_mask_entry(0x0, branchMap(), list_of(666));
	main_decoder_table[360]=aarch64_mask_entry(0x0, branchMap(), list_of(669));
	main_decoder_table[361]=aarch64_mask_entry(0x0, branchMap(), list_of(517));
	main_decoder_table[362]=aarch64_mask_entry(0x800000, map_list_of(0,369)(1,370), list_of(-1));
	main_decoder_table[369]=aarch64_mask_entry(0x0, branchMap(), list_of(198));
	main_decoder_table[370]=aarch64_mask_entry(0x0, branchMap(), list_of(208));
	main_decoder_table[363]=aarch64_mask_entry(0x800000, map_list_of(0,371)(1,372), list_of(-1));
	main_decoder_table[371]=aarch64_mask_entry(0x0, branchMap(), list_of(127));
	main_decoder_table[372]=aarch64_mask_entry(0x0, branchMap(), list_of(117));
	main_decoder_table[364]=aarch64_mask_entry(0x0, branchMap(), list_of(226));
	main_decoder_table[365]=aarch64_mask_entry(0x800000, map_list_of(0,373)(1,374), list_of(-1));
	main_decoder_table[373]=aarch64_mask_entry(0x0, branchMap(), list_of(135));
	main_decoder_table[374]=aarch64_mask_entry(0x0, branchMap(), list_of(139));
	main_decoder_table[366]=aarch64_mask_entry(0x800000, map_list_of(0,375)(1,376), list_of(-1));
	main_decoder_table[375]=aarch64_mask_entry(0x0, branchMap(), list_of(121));
	main_decoder_table[376]=aarch64_mask_entry(0x0, branchMap(), list_of(123));
	main_decoder_table[367]=aarch64_mask_entry(0x800000, map_list_of(0,377)(1,378), list_of(-1));
	main_decoder_table[377]=aarch64_mask_entry(0x0, branchMap(), list_of(201));
	main_decoder_table[378]=aarch64_mask_entry(0x0, branchMap(), list_of(211));
	main_decoder_table[368]=aarch64_mask_entry(0x0, branchMap(), list_of(190));
	main_decoder_table[12]=aarch64_mask_entry(0x80000400, map_list_of(0,379)(1,380), list_of(-1));
	main_decoder_table[379]=aarch64_mask_entry(0x2000f000, map_list_of(1,381)(2,382)(3,383)(5,384)(6,385)(7,386)(8,387)(9,388)(10,389)(11,390)(12,391)(13,392)(16,393)(18,394)(20,395)(22,396)(25,397)(26,398), list_of(-1));
	main_decoder_table[381]=aarch64_mask_entry(0x0, branchMap(), list_of(214));
	main_decoder_table[382]=aarch64_mask_entry(0x0, branchMap(), list_of(481));
	main_decoder_table[383]=aarch64_mask_entry(0x0, branchMap(), list_of(497));
	main_decoder_table[384]=aarch64_mask_entry(0x0, branchMap(), list_of(217));
	main_decoder_table[385]=aarch64_mask_entry(0x0, branchMap(), list_of(483));
	main_decoder_table[386]=aarch64_mask_entry(0x0, branchMap(), list_of(501));
	main_decoder_table[387]=aarch64_mask_entry(0x0, branchMap(), list_of(391));
	main_decoder_table[388]=aarch64_mask_entry(0x0, branchMap(), list_of(225));
	main_decoder_table[389]=aarch64_mask_entry(0x0, branchMap(), list_of(489));
	main_decoder_table[390]=aarch64_mask_entry(0x0, branchMap(), list_of(509));
	main_decoder_table[391]=aarch64_mask_entry(0x0, branchMap(), list_of(505));
	main_decoder_table[392]=aarch64_mask_entry(0x0, branchMap(), list_of(515));
	main_decoder_table[393]=aarch64_mask_entry(0x0, branchMap(), list_of(368));
	main_decoder_table[394]=aarch64_mask_entry(0x0, branchMap(), list_of(671));
	main_decoder_table[395]=aarch64_mask_entry(0x0, branchMap(), list_of(370));
	main_decoder_table[396]=aarch64_mask_entry(0x0, branchMap(), list_of(673));
	main_decoder_table[397]=aarch64_mask_entry(0x0, branchMap(), list_of(229));
	main_decoder_table[398]=aarch64_mask_entry(0x0, branchMap(), list_of(679));
	main_decoder_table[380]=aarch64_mask_entry(0x800800, map_list_of(0,399)(1,400), list_of(-1));
	main_decoder_table[399]=aarch64_mask_entry(0x0, branchMap(), list_of(219)(630)(720)(37)(407)(396)(447)(467)(469)(472)(525)(529)(531)(533)(542)(546)(548)(551)(553)(555)(656)(689)(693)(703)(706)(709)(711)(715)(383));
	main_decoder_table[400]=aarch64_mask_entry(0x2000f000, map_list_of(8,401)(9,402)(15,403)(24,404)(25,405)(31,406), list_of(-1));
	main_decoder_table[401]=aarch64_mask_entry(0x0, branchMap(), list_of(430));
	main_decoder_table[402]=aarch64_mask_entry(0x0, branchMap(), list_of(521));
	main_decoder_table[403]=aarch64_mask_entry(0x0, branchMap(), list_of(179));
	main_decoder_table[404]=aarch64_mask_entry(0x0, branchMap(), list_of(523));
	main_decoder_table[405]=aarch64_mask_entry(0x0, branchMap(), list_of(687));
	main_decoder_table[406]=aarch64_mask_entry(0x0, branchMap(), list_of(185));
	main_decoder_table[3]=aarch64_mask_entry(0x4000000, map_list_of(0,407)(1,408), list_of(-1));
	main_decoder_table[407]=aarch64_mask_entry(0x3000000, map_list_of(0,409)(1,410)(2,411)(3,412), list_of(-1));
	main_decoder_table[409]=aarch64_mask_entry(0x80000000, map_list_of(0,413)(1,414), list_of(-1));
	main_decoder_table[413]=aarch64_mask_entry(0x0, branchMap(), list_of(17));
	main_decoder_table[414]=aarch64_mask_entry(0x0, branchMap(), list_of(18));
	main_decoder_table[410]=aarch64_mask_entry(0x60000000, map_list_of(0,415)(1,416)(2,417)(3,418), list_of(-1));
	main_decoder_table[415]=aarch64_mask_entry(0x0, branchMap(), list_of(373)(6));
	main_decoder_table[416]=aarch64_mask_entry(0x0, branchMap(), list_of(82)(14));
	main_decoder_table[417]=aarch64_mask_entry(0x0, branchMap(), list_of(617));
	main_decoder_table[418]=aarch64_mask_entry(0x0, branchMap(), list_of(85)(623));
	main_decoder_table[411]=aarch64_mask_entry(0x60800000, map_list_of(0,419)(1,420)(2,421)(4,422)(5,423)(6,424)(7,425), list_of(-1));
	main_decoder_table[419]=aarch64_mask_entry(0x0, branchMap(), list_of(24));
	main_decoder_table[420]=aarch64_mask_entry(0x0, branchMap(), list_of(377)(385));
	main_decoder_table[421]=aarch64_mask_entry(0x0, branchMap(), list_of(380)(409));
	main_decoder_table[422]=aarch64_mask_entry(0x0, branchMap(), list_of(111));
	main_decoder_table[423]=aarch64_mask_entry(0x0, branchMap(), list_of(378)(386));
	main_decoder_table[424]=aarch64_mask_entry(0x0, branchMap(), list_of(641)(26));
	main_decoder_table[425]=aarch64_mask_entry(0x0, branchMap(), list_of(384));
	main_decoder_table[412]=aarch64_mask_entry(0x60800000, map_list_of(0,426)(1,427)(2,428)(4,429), list_of(-1));
	main_decoder_table[426]=aarch64_mask_entry(0x0, branchMap(), list_of(631)(628)(629)(29)(443)(444)(445));
	main_decoder_table[427]=aarch64_mask_entry(0x200000, map_list_of(0,430), list_of(-1));
	main_decoder_table[430]=aarch64_mask_entry(0x0, branchMap(), list_of(115)(427));
	main_decoder_table[428]=aarch64_mask_entry(0x0, branchMap(), list_of(34)(35)(36));
	main_decoder_table[429]=aarch64_mask_entry(0x0, branchMap(), list_of(718)(719)(365)(362)(652)(653)(654));
	main_decoder_table[408]=aarch64_mask_entry(0x60000000, map_list_of(0,431)(1,432)(2,433), list_of(-1));
	main_decoder_table[431]=aarch64_mask_entry(0x80000000, map_list_of(0,434)(1,435), list_of(-1));
	main_decoder_table[434]=aarch64_mask_entry(0x0, branchMap(), list_of(33));
	main_decoder_table[435]=aarch64_mask_entry(0x0, branchMap(), list_of(43));
	main_decoder_table[432]=aarch64_mask_entry(0x3000000, map_list_of(0,436)(1,437)(2,438)(3,439), list_of(-1));
	main_decoder_table[436]=aarch64_mask_entry(0x0, branchMap(), list_of(49));
	main_decoder_table[437]=aarch64_mask_entry(0x0, branchMap(), list_of(48));
	main_decoder_table[438]=aarch64_mask_entry(0x0, branchMap(), list_of(637));
	main_decoder_table[439]=aarch64_mask_entry(0x0, branchMap(), list_of(635));
	main_decoder_table[433]=aarch64_mask_entry(0x83000000, map_list_of(0,440)(4,441)(5,442)(6,443), list_of(-1));
	main_decoder_table[440]=aarch64_mask_entry(0x0, branchMap(), list_of(32));
	main_decoder_table[441]=aarch64_mask_entry(0xe0001f, map_list_of(1,444)(2,445)(3,446)(32,447)(64,448)(161,449)(162,450)(163,451), list_of(-1));
	main_decoder_table[444]=aarch64_mask_entry(0x0, branchMap(), list_of(627));
	main_decoder_table[445]=aarch64_mask_entry(0x0, branchMap(), list_of(266));
	main_decoder_table[446]=aarch64_mask_entry(0x0, branchMap(), list_of(477));
	main_decoder_table[447]=aarch64_mask_entry(0x0, branchMap(), list_of(46));
	main_decoder_table[448]=aarch64_mask_entry(0x0, branchMap(), list_of(265));
	main_decoder_table[449]=aarch64_mask_entry(0x0, branchMap(), list_of(100));
	main_decoder_table[450]=aarch64_mask_entry(0x0, branchMap(), list_of(101));
	main_decoder_table[451]=aarch64_mask_entry(0x0, branchMap(), list_of(102));
	main_decoder_table[442]=aarch64_mask_entry(0xf00000, map_list_of(0,452)(1,453)(2,454)(3,455), list_of(-1));
	main_decoder_table[452]=aarch64_mask_entry(0x80000, map_list_of(0,456)(1,457), list_of(-1));
	main_decoder_table[456]=aarch64_mask_entry(0xf01f, map_list_of(95,458)(127,459)(159,460), list_of(-1));
	main_decoder_table[458]=aarch64_mask_entry(0x70000, map_list_of(3,461), list_of(-1));
	main_decoder_table[461]=aarch64_mask_entry(0x0, branchMap(), list_of(403)(453)(454)(723)(724)(726)(264));
	main_decoder_table[459]=aarch64_mask_entry(0x700e0, map_list_of(26,462)(28,463)(29,464)(30,465), list_of(-1));
	main_decoder_table[462]=aarch64_mask_entry(0x0, branchMap(), list_of(56));
	main_decoder_table[463]=aarch64_mask_entry(0x0, branchMap(), list_of(105));
	main_decoder_table[464]=aarch64_mask_entry(0x0, branchMap(), list_of(103));
	main_decoder_table[465]=aarch64_mask_entry(0x0, branchMap(), list_of(270));
	main_decoder_table[460]=aarch64_mask_entry(0x0, branchMap(), list_of(388));
	main_decoder_table[457]=aarch64_mask_entry(0x0, branchMap(), list_of(31)(99)(267)(638)(632));
	main_decoder_table[453]=aarch64_mask_entry(0x0, branchMap(), list_of(389));
	main_decoder_table[454]=aarch64_mask_entry(0x0, branchMap(), list_of(633));
	main_decoder_table[455]=aarch64_mask_entry(0x0, branchMap(), list_of(387));
	main_decoder_table[443]=aarch64_mask_entry(0xfffc1f, map_list_of(63488,466)(129024,467)(194560,468)(325632,469)(391168,470), list_of(-1));
	main_decoder_table[466]=aarch64_mask_entry(0x0, branchMap(), list_of(45));
	main_decoder_table[467]=aarch64_mask_entry(0x0, branchMap(), list_of(44));
	main_decoder_table[468]=aarch64_mask_entry(0x0, branchMap(), list_of(420));
	main_decoder_table[469]=aarch64_mask_entry(0x0, branchMap(), list_of(113));
	main_decoder_table[470]=aarch64_mask_entry(0x0, branchMap(), list_of(104));
	main_decoder_table[4]=aarch64_mask_entry(0x27000000, map_list_of(0,471)(2,472)(3,473)(4,474)(6,475)(7,476)(8,477)(9,478)(10,479)(12,480)(13,481)(14,482)(15,483), list_of(-1));
	main_decoder_table[471]=aarch64_mask_entry(0x80000000, map_list_of(0,484)(1,485), list_of(-1));
	main_decoder_table[484]=aarch64_mask_entry(0x0, branchMap(), list_of(320));
	main_decoder_table[485]=aarch64_mask_entry(0x40000000, map_list_of(0,486)(1,487), list_of(-1));
	main_decoder_table[486]=aarch64_mask_entry(0x0, branchMap(), list_of(342));
	main_decoder_table[487]=aarch64_mask_entry(0x0, branchMap(), list_of(414));
	main_decoder_table[472]=aarch64_mask_entry(0x40e00000, map_list_of(0,488)(4,489)(6,490)(8,491)(12,492)(14,493), list_of(-1));
	main_decoder_table[488]=aarch64_mask_entry(0x0, branchMap(), list_of(3));
	main_decoder_table[489]=aarch64_mask_entry(0xc00, map_list_of(0,494)(1,495), list_of(-1));
	main_decoder_table[494]=aarch64_mask_entry(0x0, branchMap(), list_of(93));
	main_decoder_table[495]=aarch64_mask_entry(0x0, branchMap(), list_of(94)(54)(96));
	main_decoder_table[490]=aarch64_mask_entry(0xf000, map_list_of(0,496)(2,497)(4,498)(5,499), list_of(-1));
	main_decoder_table[496]=aarch64_mask_entry(0xc00, map_list_of(2,500)(3,501), list_of(-1));
	main_decoder_table[500]=aarch64_mask_entry(0x0, branchMap(), list_of(661));
	main_decoder_table[501]=aarch64_mask_entry(0x0, branchMap(), list_of(452));
	main_decoder_table[497]=aarch64_mask_entry(0xc00, map_list_of(0,502)(1,503)(2,504)(3,505), list_of(-1));
	main_decoder_table[502]=aarch64_mask_entry(0x0, branchMap(), list_of(361)(363));
	main_decoder_table[503]=aarch64_mask_entry(0x0, branchMap(), list_of(364)(366));
	main_decoder_table[504]=aarch64_mask_entry(0x0, branchMap(), list_of(28)(30));
	main_decoder_table[505]=aarch64_mask_entry(0x0, branchMap(), list_of(428)(429));
	main_decoder_table[498]=aarch64_mask_entry(0x0, branchMap(), list_of(91));
	main_decoder_table[499]=aarch64_mask_entry(0x0, branchMap(), list_of(92));
	main_decoder_table[491]=aarch64_mask_entry(0xfc00, map_list_of(0,506), list_of(-1));
	main_decoder_table[506]=aarch64_mask_entry(0x0, branchMap(), list_of(401)(441));
	main_decoder_table[492]=aarch64_mask_entry(0xc00, map_list_of(0,507)(1,508), list_of(-1));
	main_decoder_table[507]=aarch64_mask_entry(0x0, branchMap(), list_of(95)(55)(97));
	main_decoder_table[508]=aarch64_mask_entry(0x0, branchMap(), list_of(89)(98));
	main_decoder_table[493]=aarch64_mask_entry(0x1ff800, map_list_of(0,509)(1,510)(2,511), list_of(-1));
	main_decoder_table[509]=aarch64_mask_entry(0x400, map_list_of(0,512)(1,513), list_of(-1));
	main_decoder_table[512]=aarch64_mask_entry(0x0, branchMap(), list_of(419));
	main_decoder_table[513]=aarch64_mask_entry(0x0, branchMap(), list_of(423));
	main_decoder_table[510]=aarch64_mask_entry(0x0, branchMap(), list_of(425)(421));
	main_decoder_table[511]=aarch64_mask_entry(0x400, map_list_of(0,514)(1,515), list_of(-1));
	main_decoder_table[514]=aarch64_mask_entry(0x0, branchMap(), list_of(60));
	main_decoder_table[515]=aarch64_mask_entry(0x0, branchMap(), list_of(58));
	main_decoder_table[473]=aarch64_mask_entry(0x40e08000, map_list_of(0,516)(1,517)(2,518)(3,519)(4,520)(10,521)(11,522)(12,523), list_of(-1));
	main_decoder_table[516]=aarch64_mask_entry(0x0, branchMap(), list_of(393)(367));
	main_decoder_table[517]=aarch64_mask_entry(0x0, branchMap(), list_of(372)(390));
	main_decoder_table[518]=aarch64_mask_entry(0x80000000, map_list_of(1,524), list_of(-1));
	main_decoder_table[524]=aarch64_mask_entry(0x0, branchMap(), list_of(491)(473));
	main_decoder_table[519]=aarch64_mask_entry(0x80000000, map_list_of(1,525), list_of(-1));
	main_decoder_table[525]=aarch64_mask_entry(0x0, branchMap(), list_of(485)(487));
	main_decoder_table[520]=aarch64_mask_entry(0x0, branchMap(), list_of(488));
	main_decoder_table[521]=aarch64_mask_entry(0x80000000, map_list_of(1,526), list_of(-1));
	main_decoder_table[526]=aarch64_mask_entry(0x0, branchMap(), list_of(681)(664));
	main_decoder_table[522]=aarch64_mask_entry(0x80000000, map_list_of(1,527), list_of(-1));
	main_decoder_table[527]=aarch64_mask_entry(0x0, branchMap(), list_of(675)(677));
	main_decoder_table[523]=aarch64_mask_entry(0x0, branchMap(), list_of(678));
	main_decoder_table[474]=aarch64_mask_entry(0x0, branchMap(), list_of(319));
	main_decoder_table[475]=aarch64_mask_entry(0x40200000, map_list_of(0,528)(1,529)(2,530)(3,531), list_of(-1));
	main_decoder_table[528]=aarch64_mask_entry(0x9f0000, map_list_of(2,532)(3,533)(24,534)(25,535), list_of(-1));
	main_decoder_table[532]=aarch64_mask_entry(0x0, branchMap(), list_of(450));
	main_decoder_table[533]=aarch64_mask_entry(0x0, branchMap(), list_of(659));
	main_decoder_table[534]=aarch64_mask_entry(0x0, branchMap(), list_of(182));
	main_decoder_table[535]=aarch64_mask_entry(0x0, branchMap(), list_of(188));
	main_decoder_table[529]=aarch64_mask_entry(0xc00, map_list_of(0,536)(1,537)(2,538)(3,539), list_of(-1));
	main_decoder_table[536]=aarch64_mask_entry(0x1000, map_list_of(0,540)(1,541), list_of(-1));
	main_decoder_table[540]=aarch64_mask_entry(0x6000, map_list_of(0,542)(1,543)(2,544), list_of(-1));
	main_decoder_table[542]=aarch64_mask_entry(0x168000, map_list_of(0,545)(2,546)(4,547)(6,548)(8,549), list_of(-1));
	main_decoder_table[545]=aarch64_mask_entry(0x890000, map_list_of(0,550)(1,551)(2,552)(3,553), list_of(-1));
	main_decoder_table[550]=aarch64_mask_entry(0x0, branchMap(), list_of(166));
	main_decoder_table[551]=aarch64_mask_entry(0x0, branchMap(), list_of(169));
	main_decoder_table[552]=aarch64_mask_entry(0x0, branchMap(), list_of(172));
	main_decoder_table[553]=aarch64_mask_entry(0x0, branchMap(), list_of(175));
	main_decoder_table[546]=aarch64_mask_entry(0x890000, map_list_of(0,554)(1,555), list_of(-1));
	main_decoder_table[554]=aarch64_mask_entry(0x0, branchMap(), list_of(451));
	main_decoder_table[555]=aarch64_mask_entry(0x0, branchMap(), list_of(660));
	main_decoder_table[547]=aarch64_mask_entry(0x890000, map_list_of(0,556)(1,557), list_of(-1));
	main_decoder_table[556]=aarch64_mask_entry(0x0, branchMap(), list_of(152));
	main_decoder_table[557]=aarch64_mask_entry(0x0, branchMap(), list_of(155));
	main_decoder_table[548]=aarch64_mask_entry(0x0, branchMap(), list_of(221));
	main_decoder_table[549]=aarch64_mask_entry(0x890000, map_list_of(0,558)(1,559)(2,560)(3,561), list_of(-1));
	main_decoder_table[558]=aarch64_mask_entry(0x0, branchMap(), list_of(159));
	main_decoder_table[559]=aarch64_mask_entry(0x0, branchMap(), list_of(162));
	main_decoder_table[560]=aarch64_mask_entry(0x0, branchMap(), list_of(183));
	main_decoder_table[561]=aarch64_mask_entry(0x0, branchMap(), list_of(189));
	main_decoder_table[543]=aarch64_mask_entry(0x80808017, map_list_of(0,562)(8,563), list_of(-1));
	main_decoder_table[562]=aarch64_mask_entry(0x0, branchMap(), list_of(146));
	main_decoder_table[563]=aarch64_mask_entry(0x0, branchMap(), list_of(147));
	main_decoder_table[544]=aarch64_mask_entry(0x801e0000, map_list_of(0,564)(1,565)(2,566)(3,567), list_of(-1));
	main_decoder_table[564]=aarch64_mask_entry(0x818000, map_list_of(0,568)(1,569)(2,570)(3,571), list_of(-1));
	main_decoder_table[568]=aarch64_mask_entry(0x0, branchMap(), list_of(220));
	main_decoder_table[569]=aarch64_mask_entry(0x0, branchMap(), list_of(119));
	main_decoder_table[570]=aarch64_mask_entry(0x0, branchMap(), list_of(233));
	main_decoder_table[571]=aarch64_mask_entry(0x0, branchMap(), list_of(261));
	main_decoder_table[565]=aarch64_mask_entry(0x0, branchMap(), list_of(149));
	main_decoder_table[566]=aarch64_mask_entry(0x818000, map_list_of(0,572)(1,573)(2,574)(3,575), list_of(-1));
	main_decoder_table[572]=aarch64_mask_entry(0x0, branchMap(), list_of(249));
	main_decoder_table[573]=aarch64_mask_entry(0x0, branchMap(), list_of(251));
	main_decoder_table[574]=aarch64_mask_entry(0x0, branchMap(), list_of(247));
	main_decoder_table[575]=aarch64_mask_entry(0x0, branchMap(), list_of(255));
	main_decoder_table[567]=aarch64_mask_entry(0x818000, map_list_of(0,576)(2,577)(3,578), list_of(-1));
	main_decoder_table[576]=aarch64_mask_entry(0x0, branchMap(), list_of(243));
	main_decoder_table[577]=aarch64_mask_entry(0x0, branchMap(), list_of(253));
	main_decoder_table[578]=aarch64_mask_entry(0x0, branchMap(), list_of(245));
	main_decoder_table[541]=aarch64_mask_entry(0x0, branchMap(), list_of(222));
	main_decoder_table[537]=aarch64_mask_entry(0x80800010, map_list_of(0,579)(1,580), list_of(-1));
	main_decoder_table[579]=aarch64_mask_entry(0x0, branchMap(), list_of(128));
	main_decoder_table[580]=aarch64_mask_entry(0x0, branchMap(), list_of(129));
	main_decoder_table[538]=aarch64_mask_entry(0x8080f000, map_list_of(0,581)(1,582)(2,583)(3,584)(4,585)(5,586)(6,587)(7,588)(8,589), list_of(-1));
	main_decoder_table[581]=aarch64_mask_entry(0x0, branchMap(), list_of(227));
	main_decoder_table[582]=aarch64_mask_entry(0x0, branchMap(), list_of(191));
	main_decoder_table[583]=aarch64_mask_entry(0x0, branchMap(), list_of(125));
	main_decoder_table[584]=aarch64_mask_entry(0x0, branchMap(), list_of(263));
	main_decoder_table[585]=aarch64_mask_entry(0x0, branchMap(), list_of(194));
	main_decoder_table[586]=aarch64_mask_entry(0x0, branchMap(), list_of(204));
	main_decoder_table[587]=aarch64_mask_entry(0x0, branchMap(), list_of(196));
	main_decoder_table[588]=aarch64_mask_entry(0x0, branchMap(), list_of(206));
	main_decoder_table[589]=aarch64_mask_entry(0x0, branchMap(), list_of(236));
	main_decoder_table[539]=aarch64_mask_entry(0x0, branchMap(), list_of(148));
	main_decoder_table[530]=aarch64_mask_entry(0x80c0fc00, map_list_of(0,590)(1,591)(4,592)(8,593)(12,594)(16,595)(20,596)(24,597), list_of(-1));
	main_decoder_table[590]=aarch64_mask_entry(0x0, branchMap(), list_of(455));
	main_decoder_table[591]=aarch64_mask_entry(0x0, branchMap(), list_of(106)(374));
	main_decoder_table[592]=aarch64_mask_entry(0x0, branchMap(), list_of(458));
	main_decoder_table[593]=aarch64_mask_entry(0x0, branchMap(), list_of(457));
	main_decoder_table[594]=aarch64_mask_entry(0x0, branchMap(), list_of(459));
	main_decoder_table[595]=aarch64_mask_entry(0x0, branchMap(), list_of(462));
	main_decoder_table[596]=aarch64_mask_entry(0x0, branchMap(), list_of(461));
	main_decoder_table[597]=aarch64_mask_entry(0x0, branchMap(), list_of(464));
	main_decoder_table[531]=aarch64_mask_entry(0x8000fc00, map_list_of(2,598)(3,599)(6,600)(10,601)(11,602)(13,603)(14,604)(15,605)(17,606)(18,607)(19,608)(21,609)(23,610)(30,611)(33,612)(34,613)(35,614)(36,615)(38,616)(42,617)(44,618)(45,619)(46,620)(50,621)(52,622)(54,623)(55,624)(57,625)(58,626)(62,627)(63,628), list_of(-1));
	main_decoder_table[598]=aarch64_mask_entry(0x0, branchMap(), list_of(456));
	main_decoder_table[599]=aarch64_mask_entry(0x0, branchMap(), list_of(494));
	main_decoder_table[600]=aarch64_mask_entry(0x0, branchMap(), list_of(460));
	main_decoder_table[601]=aarch64_mask_entry(0x0, branchMap(), list_of(463));
	main_decoder_table[602]=aarch64_mask_entry(0x0, branchMap(), list_of(534));
	main_decoder_table[603]=aarch64_mask_entry(0x0, branchMap(), list_of(69));
	main_decoder_table[604]=aarch64_mask_entry(0x0, branchMap(), list_of(625));
	main_decoder_table[605]=aarch64_mask_entry(0x0, branchMap(), list_of(65));
	main_decoder_table[606]=aarch64_mask_entry(0x0, branchMap(), list_of(549));
	main_decoder_table[607]=aarch64_mask_entry(0x0, branchMap(), list_of(536));
	main_decoder_table[608]=aarch64_mask_entry(0x0, branchMap(), list_of(526));
	main_decoder_table[609]=aarch64_mask_entry(0x0, branchMap(), list_of(543));
	main_decoder_table[610]=aarch64_mask_entry(0x0, branchMap(), list_of(518));
	main_decoder_table[611]=aarch64_mask_entry(0x0, branchMap(), list_of(492));
	main_decoder_table[612]=aarch64_mask_entry(0x0, branchMap(), list_of(8));
	main_decoder_table[613]=aarch64_mask_entry(0x0, branchMap(), list_of(71));
	main_decoder_table[614]=aarch64_mask_entry(0x0, branchMap(), list_of(87));
	main_decoder_table[615]=aarch64_mask_entry(0x0, branchMap(), list_of(498));
	main_decoder_table[616]=aarch64_mask_entry(0x0, branchMap(), list_of(63));
	main_decoder_table[617]=aarch64_mask_entry(0x1f0000, map_list_of(0,629)(1,630), list_of(-1));
	main_decoder_table[629]=aarch64_mask_entry(0x0, branchMap(), list_of(79));
	main_decoder_table[630]=aarch64_mask_entry(0x800000, map_list_of(0,631)(1,632), list_of(-1));
	main_decoder_table[631]=aarch64_mask_entry(0x0, branchMap(), list_of(164));
	main_decoder_table[632]=aarch64_mask_entry(0x0, branchMap(), list_of(170));
	main_decoder_table[618]=aarch64_mask_entry(0x0, branchMap(), list_of(502));
	main_decoder_table[619]=aarch64_mask_entry(0x0, branchMap(), list_of(506));
	main_decoder_table[620]=aarch64_mask_entry(0x1f0000, map_list_of(0,633)(1,634)(17,635), list_of(-1));
	main_decoder_table[633]=aarch64_mask_entry(0x0, branchMap(), list_of(1));
	main_decoder_table[634]=aarch64_mask_entry(0x800000, map_list_of(0,636)(1,637), list_of(-1));
	main_decoder_table[636]=aarch64_mask_entry(0x0, branchMap(), list_of(157));
	main_decoder_table[637]=aarch64_mask_entry(0x0, branchMap(), list_of(180));
	main_decoder_table[635]=aarch64_mask_entry(0x0, branchMap(), list_of(11));
	main_decoder_table[621]=aarch64_mask_entry(0x9f0000, map_list_of(1,638)(32,639), list_of(-1));
	main_decoder_table[638]=aarch64_mask_entry(0x0, branchMap(), list_of(150));
	main_decoder_table[639]=aarch64_mask_entry(0x0, branchMap(), list_of(140));
	main_decoder_table[622]=aarch64_mask_entry(0x0, branchMap(), list_of(510));
	main_decoder_table[623]=aarch64_mask_entry(0x9f0000, map_list_of(1,640)(32,641)(33,642), list_of(-1));
	main_decoder_table[640]=aarch64_mask_entry(0x0, branchMap(), list_of(448));
	main_decoder_table[641]=aarch64_mask_entry(0x0, branchMap(), list_of(132));
	main_decoder_table[642]=aarch64_mask_entry(0x0, branchMap(), list_of(237));
	main_decoder_table[624]=aarch64_mask_entry(0x0, branchMap(), list_of(230));
	main_decoder_table[625]=aarch64_mask_entry(0x0, branchMap(), list_of(130));
	main_decoder_table[626]=aarch64_mask_entry(0x0, branchMap(), list_of(144));
	main_decoder_table[627]=aarch64_mask_entry(0x0, branchMap(), list_of(241));
	main_decoder_table[628]=aarch64_mask_entry(0x800000, map_list_of(0,643)(1,644), list_of(-1));
	main_decoder_table[643]=aarch64_mask_entry(0x0, branchMap(), list_of(239));
	main_decoder_table[644]=aarch64_mask_entry(0x0, branchMap(), list_of(258));
	main_decoder_table[476]=aarch64_mask_entry(0xc0008000, map_list_of(0,645)(1,646)(2,647)(3,648), list_of(-1));
	main_decoder_table[645]=aarch64_mask_entry(0xa00000, map_list_of(0,649)(1,650), list_of(-1));
	main_decoder_table[649]=aarch64_mask_entry(0x0, branchMap(), list_of(192));
	main_decoder_table[650]=aarch64_mask_entry(0x0, branchMap(), list_of(234));
	main_decoder_table[646]=aarch64_mask_entry(0xa00000, map_list_of(0,651)(1,652), list_of(-1));
	main_decoder_table[651]=aarch64_mask_entry(0x0, branchMap(), list_of(223));
	main_decoder_table[652]=aarch64_mask_entry(0x0, branchMap(), list_of(235));
	main_decoder_table[647]=aarch64_mask_entry(0x7400, map_list_of(1,653)(2,654)(3,655)(5,656)(6,657)(7,658)(10,659)(11,660)(14,661)(15,662), list_of(-1));
	main_decoder_table[653]=aarch64_mask_entry(0x0, branchMap(), list_of(552));
	main_decoder_table[654]=aarch64_mask_entry(0x0, branchMap(), list_of(213));
	main_decoder_table[655]=aarch64_mask_entry(0x0, branchMap(), list_of(554));
	main_decoder_table[656]=aarch64_mask_entry(0x0, branchMap(), list_of(545));
	main_decoder_table[657]=aarch64_mask_entry(0x0, branchMap(), list_of(496));
	main_decoder_table[658]=aarch64_mask_entry(0x0, branchMap(), list_of(547));
	main_decoder_table[659]=aarch64_mask_entry(0x0, branchMap(), list_of(216));
	main_decoder_table[660]=aarch64_mask_entry(0x0, branchMap(), list_of(466));
	main_decoder_table[661]=aarch64_mask_entry(0x0, branchMap(), list_of(500));
	main_decoder_table[662]=aarch64_mask_entry(0x0, branchMap(), list_of(524));
	main_decoder_table[648]=aarch64_mask_entry(0x7400, map_list_of(2,663)(3,664)(6,665)(8,666)(10,667)(13,668)(15,669), list_of(-1));
	main_decoder_table[663]=aarch64_mask_entry(0x0, branchMap(), list_of(224));
	main_decoder_table[664]=aarch64_mask_entry(0x800800, map_list_of(0,670)(1,671), list_of(-1));
	main_decoder_table[670]=aarch64_mask_entry(0x0, branchMap(), list_of(530));
	main_decoder_table[671]=aarch64_mask_entry(0x0, branchMap(), list_of(520));
	main_decoder_table[665]=aarch64_mask_entry(0x0, branchMap(), list_of(508));
	main_decoder_table[666]=aarch64_mask_entry(0x0, branchMap(), list_of(504));
	main_decoder_table[667]=aarch64_mask_entry(0x0, branchMap(), list_of(514));
	main_decoder_table[668]=aarch64_mask_entry(0x0, branchMap(), list_of(446));
	main_decoder_table[669]=aarch64_mask_entry(0x0, branchMap(), list_of(178));
	main_decoder_table[477]=aarch64_mask_entry(0x80a00c00, map_list_of(0,672)(1,673)(2,674)(3,675)(6,676)(8,677)(9,678)(10,679)(11,680)(14,681)(16,682)(17,683)(18,684)(19,685)(22,686)(24,687)(25,688)(26,689)(27,690)(30,691), list_of(-1));
	main_decoder_table[672]=aarch64_mask_entry(0x40400000, map_list_of(0,692)(1,693)(2,694)(3,695), list_of(-1));
	main_decoder_table[692]=aarch64_mask_entry(0x0, branchMap(), list_of(610));
	main_decoder_table[693]=aarch64_mask_entry(0x0, branchMap(), list_of(352));
	main_decoder_table[694]=aarch64_mask_entry(0x0, branchMap(), list_of(611));
	main_decoder_table[695]=aarch64_mask_entry(0x0, branchMap(), list_of(353));
	main_decoder_table[673]=aarch64_mask_entry(0x40400000, map_list_of(0,696)(1,697)(2,698)(3,699), list_of(-1));
	main_decoder_table[696]=aarch64_mask_entry(0x0, branchMap(), list_of(597));
	main_decoder_table[697]=aarch64_mask_entry(0x0, branchMap(), list_of(323));
	main_decoder_table[698]=aarch64_mask_entry(0x0, branchMap(), list_of(601));
	main_decoder_table[699]=aarch64_mask_entry(0x0, branchMap(), list_of(327));
	main_decoder_table[674]=aarch64_mask_entry(0x40400000, map_list_of(0,700)(1,701)(2,702)(3,703), list_of(-1));
	main_decoder_table[700]=aarch64_mask_entry(0x0, branchMap(), list_of(606));
	main_decoder_table[701]=aarch64_mask_entry(0x0, branchMap(), list_of(345));
	main_decoder_table[702]=aarch64_mask_entry(0x0, branchMap(), list_of(607));
	main_decoder_table[703]=aarch64_mask_entry(0x0, branchMap(), list_of(346));
	main_decoder_table[675]=aarch64_mask_entry(0x40400000, map_list_of(0,704)(1,705)(2,706)(3,707), list_of(-1));
	main_decoder_table[704]=aarch64_mask_entry(0x0, branchMap(), list_of(598));
	main_decoder_table[705]=aarch64_mask_entry(0x0, branchMap(), list_of(324));
	main_decoder_table[706]=aarch64_mask_entry(0x0, branchMap(), list_of(602));
	main_decoder_table[707]=aarch64_mask_entry(0x0, branchMap(), list_of(328));
	main_decoder_table[676]=aarch64_mask_entry(0x40400000, map_list_of(0,708)(1,709)(2,710)(3,711), list_of(-1));
	main_decoder_table[708]=aarch64_mask_entry(0x0, branchMap(), list_of(600));
	main_decoder_table[709]=aarch64_mask_entry(0x0, branchMap(), list_of(326));
	main_decoder_table[710]=aarch64_mask_entry(0x0, branchMap(), list_of(604));
	main_decoder_table[711]=aarch64_mask_entry(0x0, branchMap(), list_of(330));
	main_decoder_table[677]=aarch64_mask_entry(0x40000000, map_list_of(0,712)(1,713), list_of(-1));
	main_decoder_table[712]=aarch64_mask_entry(0x0, branchMap(), list_of(354));
	main_decoder_table[713]=aarch64_mask_entry(0x0, branchMap(), list_of(355));
	main_decoder_table[678]=aarch64_mask_entry(0x40000000, map_list_of(0,714)(1,715), list_of(-1));
	main_decoder_table[714]=aarch64_mask_entry(0x0, branchMap(), list_of(331));
	main_decoder_table[715]=aarch64_mask_entry(0x0, branchMap(), list_of(335));
	main_decoder_table[679]=aarch64_mask_entry(0x40000000, map_list_of(0,716)(1,717), list_of(-1));
	main_decoder_table[716]=aarch64_mask_entry(0x0, branchMap(), list_of(347));
	main_decoder_table[717]=aarch64_mask_entry(0x0, branchMap(), list_of(348));
	main_decoder_table[680]=aarch64_mask_entry(0x40000000, map_list_of(0,718)(1,719), list_of(-1));
	main_decoder_table[718]=aarch64_mask_entry(0x0, branchMap(), list_of(332));
	main_decoder_table[719]=aarch64_mask_entry(0x0, branchMap(), list_of(336));
	main_decoder_table[681]=aarch64_mask_entry(0x40000000, map_list_of(0,720)(1,721), list_of(-1));
	main_decoder_table[720]=aarch64_mask_entry(0x0, branchMap(), list_of(334));
	main_decoder_table[721]=aarch64_mask_entry(0x0, branchMap(), list_of(338));
	main_decoder_table[682]=aarch64_mask_entry(0x400000, map_list_of(0,722)(1,723), list_of(-1));
	main_decoder_table[722]=aarch64_mask_entry(0x0, branchMap(), list_of(609));
	main_decoder_table[723]=aarch64_mask_entry(0x0, branchMap(), list_of(351));
	main_decoder_table[683]=aarch64_mask_entry(0x400000, map_list_of(0,724)(1,725), list_of(-1));
	main_decoder_table[724]=aarch64_mask_entry(0x0, branchMap(), list_of(592));
	main_decoder_table[725]=aarch64_mask_entry(0x0, branchMap(), list_of(316));
	main_decoder_table[684]=aarch64_mask_entry(0x400000, map_list_of(0,726)(1,727), list_of(-1));
	main_decoder_table[726]=aarch64_mask_entry(0x0, branchMap(), list_of(605));
	main_decoder_table[727]=aarch64_mask_entry(0x0, branchMap(), list_of(344));
	main_decoder_table[685]=aarch64_mask_entry(0x400000, map_list_of(0,728)(1,729), list_of(-1));
	main_decoder_table[728]=aarch64_mask_entry(0x0, branchMap(), list_of(593));
	main_decoder_table[729]=aarch64_mask_entry(0x0, branchMap(), list_of(317));
	main_decoder_table[686]=aarch64_mask_entry(0x400000, map_list_of(0,730)(1,731), list_of(-1));
	main_decoder_table[730]=aarch64_mask_entry(0x0, branchMap(), list_of(596));
	main_decoder_table[731]=aarch64_mask_entry(0x0, branchMap(), list_of(322));
	main_decoder_table[687]=aarch64_mask_entry(0x40400000, map_list_of(0,732)(2,733), list_of(-1));
	main_decoder_table[732]=aarch64_mask_entry(0x0, branchMap(), list_of(356));
	main_decoder_table[733]=aarch64_mask_entry(0x0, branchMap(), list_of(416));
	main_decoder_table[688]=aarch64_mask_entry(0x0, branchMap(), list_of(339));
	main_decoder_table[689]=aarch64_mask_entry(0x0, branchMap(), list_of(349));
	main_decoder_table[690]=aarch64_mask_entry(0x0, branchMap(), list_of(340));
	main_decoder_table[691]=aarch64_mask_entry(0x40400000, map_list_of(0,734)(2,735), list_of(-1));
	main_decoder_table[734]=aarch64_mask_entry(0x0, branchMap(), list_of(343));
	main_decoder_table[735]=aarch64_mask_entry(0x0, branchMap(), list_of(415));
	main_decoder_table[478]=aarch64_mask_entry(0x80800000, map_list_of(0,736)(1,737)(2,738)(3,739), list_of(-1));
	main_decoder_table[736]=aarch64_mask_entry(0x40400000, map_list_of(0,740)(1,741)(2,742)(3,743), list_of(-1));
	main_decoder_table[740]=aarch64_mask_entry(0x0, branchMap(), list_of(599));
	main_decoder_table[741]=aarch64_mask_entry(0x0, branchMap(), list_of(325));
	main_decoder_table[742]=aarch64_mask_entry(0x0, branchMap(), list_of(603));
	main_decoder_table[743]=aarch64_mask_entry(0x0, branchMap(), list_of(329));
	main_decoder_table[737]=aarch64_mask_entry(0x40000000, map_list_of(0,744)(1,745), list_of(-1));
	main_decoder_table[744]=aarch64_mask_entry(0x0, branchMap(), list_of(333));
	main_decoder_table[745]=aarch64_mask_entry(0x0, branchMap(), list_of(337));
	main_decoder_table[738]=aarch64_mask_entry(0x400000, map_list_of(0,746)(1,747), list_of(-1));
	main_decoder_table[746]=aarch64_mask_entry(0x0, branchMap(), list_of(594));
	main_decoder_table[747]=aarch64_mask_entry(0x0, branchMap(), list_of(318));
	main_decoder_table[739]=aarch64_mask_entry(0x40400000, map_list_of(0,748)(2,749), list_of(-1));
	main_decoder_table[748]=aarch64_mask_entry(0x0, branchMap(), list_of(341));
	main_decoder_table[749]=aarch64_mask_entry(0x0, branchMap(), list_of(413));
	main_decoder_table[479]=aarch64_mask_entry(0x40e00c00, map_list_of(0,750)(8,751)(10,752)(32,753)(40,754)(42,755), list_of(-1));
	main_decoder_table[750]=aarch64_mask_entry(0x0, branchMap(), list_of(4));
	main_decoder_table[751]=aarch64_mask_entry(0x0, branchMap(), list_of(51));
	main_decoder_table[752]=aarch64_mask_entry(0x0, branchMap(), list_of(50));
	main_decoder_table[753]=aarch64_mask_entry(0xf000, map_list_of(0,756), list_of(-1));
	main_decoder_table[756]=aarch64_mask_entry(0x0, branchMap(), list_of(402)(442));
	main_decoder_table[754]=aarch64_mask_entry(0x0, branchMap(), list_of(53));
	main_decoder_table[755]=aarch64_mask_entry(0x0, branchMap(), list_of(52));
	main_decoder_table[480]=aarch64_mask_entry(0x600c00, map_list_of(0,757)(1,758)(3,759)(6,760)(8,761)(9,762)(11,763)(14,764), list_of(-1));
	main_decoder_table[757]=aarch64_mask_entry(0x0, branchMap(), list_of(608));
	main_decoder_table[758]=aarch64_mask_entry(0x0, branchMap(), list_of(589));
	main_decoder_table[759]=aarch64_mask_entry(0x0, branchMap(), list_of(590));
	main_decoder_table[760]=aarch64_mask_entry(0x0, branchMap(), list_of(595));
	main_decoder_table[761]=aarch64_mask_entry(0x0, branchMap(), list_of(350));
	main_decoder_table[762]=aarch64_mask_entry(0x0, branchMap(), list_of(313));
	main_decoder_table[763]=aarch64_mask_entry(0x0, branchMap(), list_of(314));
	main_decoder_table[764]=aarch64_mask_entry(0x0, branchMap(), list_of(321));
	main_decoder_table[481]=aarch64_mask_entry(0x400000, map_list_of(0,765)(1,766), list_of(-1));
	main_decoder_table[765]=aarch64_mask_entry(0x0, branchMap(), list_of(591));
	main_decoder_table[766]=aarch64_mask_entry(0x0, branchMap(), list_of(315));
	main_decoder_table[482]=aarch64_mask_entry(0xc020fc00, map_list_of(195,767)(202,768)(203,769)(205,770)(206,771)(207,772)(209,773)(210,774)(211,775)(213,776)(215,777)(218,778)(222,779)(225,780)(226,781)(227,782)(230,783)(234,784)(237,785)(238,786)(242,787)(245,788)(246,789)(249,790)(251,791)(254,792), list_of(-1));
	main_decoder_table[767]=aarch64_mask_entry(0x0, branchMap(), list_of(682));
	main_decoder_table[768]=aarch64_mask_entry(0x0, branchMap(), list_of(538));
	main_decoder_table[769]=aarch64_mask_entry(0x0, branchMap(), list_of(694));
	main_decoder_table[770]=aarch64_mask_entry(0x0, branchMap(), list_of(73));
	main_decoder_table[771]=aarch64_mask_entry(0x0, branchMap(), list_of(712));
	main_decoder_table[772]=aarch64_mask_entry(0x0, branchMap(), list_of(75));
	main_decoder_table[773]=aarch64_mask_entry(0x0, branchMap(), list_of(707));
	main_decoder_table[774]=aarch64_mask_entry(0x0, branchMap(), list_of(696));
	main_decoder_table[775]=aarch64_mask_entry(0x0, branchMap(), list_of(690));
	main_decoder_table[776]=aarch64_mask_entry(0x0, branchMap(), list_of(700));
	main_decoder_table[777]=aarch64_mask_entry(0x0, branchMap(), list_of(684));
	main_decoder_table[778]=aarch64_mask_entry(0x0, branchMap(), list_of(176));
	main_decoder_table[779]=aarch64_mask_entry(0x0, branchMap(), list_of(512));
	main_decoder_table[780]=aarch64_mask_entry(0x0, branchMap(), list_of(619));
	main_decoder_table[781]=aarch64_mask_entry(0x0, branchMap(), list_of(67));
	main_decoder_table[782]=aarch64_mask_entry(0x0, branchMap(), list_of(61));
	main_decoder_table[783]=aarch64_mask_entry(0x0, branchMap(), list_of(77));
	main_decoder_table[784]=aarch64_mask_entry(0x9f0000, map_list_of(1,793)(33,794), list_of(-1));
	main_decoder_table[793]=aarch64_mask_entry(0x0, branchMap(), list_of(167));
	main_decoder_table[794]=aarch64_mask_entry(0x0, branchMap(), list_of(173));
	main_decoder_table[785]=aarch64_mask_entry(0x0, branchMap(), list_of(516));
	main_decoder_table[786]=aarch64_mask_entry(0x1f0000, map_list_of(0,795)(1,796), list_of(-1));
	main_decoder_table[795]=aarch64_mask_entry(0x0, branchMap(), list_of(397));
	main_decoder_table[796]=aarch64_mask_entry(0x800000, map_list_of(0,797)(1,798), list_of(-1));
	main_decoder_table[797]=aarch64_mask_entry(0x0, branchMap(), list_of(160));
	main_decoder_table[798]=aarch64_mask_entry(0x0, branchMap(), list_of(186));
	main_decoder_table[787]=aarch64_mask_entry(0x9f0000, map_list_of(1,799)(16,800)(32,801)(48,802), list_of(-1));
	main_decoder_table[799]=aarch64_mask_entry(0x0, branchMap(), list_of(153));
	main_decoder_table[800]=aarch64_mask_entry(0x0, branchMap(), list_of(197));
	main_decoder_table[801]=aarch64_mask_entry(0x0, branchMap(), list_of(136));
	main_decoder_table[802]=aarch64_mask_entry(0x0, branchMap(), list_of(207));
	main_decoder_table[788]=aarch64_mask_entry(0x0, branchMap(), list_of(116));
	main_decoder_table[789]=aarch64_mask_entry(0x9f0000, map_list_of(1,803)(16,804)(32,805)(33,806), list_of(-1));
	main_decoder_table[803]=aarch64_mask_entry(0x0, branchMap(), list_of(657));
	main_decoder_table[804]=aarch64_mask_entry(0x0, branchMap(), list_of(126));
	main_decoder_table[805]=aarch64_mask_entry(0x0, branchMap(), list_of(142));
	main_decoder_table[806]=aarch64_mask_entry(0x0, branchMap(), list_of(256));
	main_decoder_table[790]=aarch64_mask_entry(0x800000, map_list_of(0,807)(1,808), list_of(-1));
	main_decoder_table[807]=aarch64_mask_entry(0x0, branchMap(), list_of(134));
	main_decoder_table[808]=aarch64_mask_entry(0x0, branchMap(), list_of(138));
	main_decoder_table[791]=aarch64_mask_entry(0x800000, map_list_of(0,809)(1,810), list_of(-1));
	main_decoder_table[809]=aarch64_mask_entry(0x0, branchMap(), list_of(120));
	main_decoder_table[810]=aarch64_mask_entry(0x0, branchMap(), list_of(122));
	main_decoder_table[792]=aarch64_mask_entry(0x9f0000, map_list_of(16,811)(48,812), list_of(-1));
	main_decoder_table[811]=aarch64_mask_entry(0x0, branchMap(), list_of(200));
	main_decoder_table[812]=aarch64_mask_entry(0x0, branchMap(), list_of(210));
	main_decoder_table[483]=aarch64_mask_entry(0xc080f400, map_list_of(65,813)(67,814)(69,815)(71,816)(73,817)(75,818)(77,819)(79,820)(81,821)(83,822)(93,823)(95,824)(114,825), list_of(-1));
	main_decoder_table[813]=aarch64_mask_entry(0x0, branchMap(), list_of(710));
	main_decoder_table[814]=aarch64_mask_entry(0x0, branchMap(), list_of(714));
	main_decoder_table[815]=aarch64_mask_entry(0x0, branchMap(), list_of(702));
	main_decoder_table[816]=aarch64_mask_entry(0x0, branchMap(), list_of(705));
	main_decoder_table[817]=aarch64_mask_entry(0x0, branchMap(), list_of(541));
	main_decoder_table[818]=aarch64_mask_entry(0x0, branchMap(), list_of(471));
	main_decoder_table[819]=aarch64_mask_entry(0x0, branchMap(), list_of(528));
	main_decoder_table[820]=aarch64_mask_entry(0x0, branchMap(), list_of(688));
	main_decoder_table[821]=aarch64_mask_entry(0x800, map_list_of(0,826)(1,827), list_of(-1));
	main_decoder_table[826]=aarch64_mask_entry(0x0, branchMap(), list_of(532));
	main_decoder_table[827]=aarch64_mask_entry(0x0, branchMap(), list_of(522));
	main_decoder_table[822]=aarch64_mask_entry(0x800, map_list_of(0,828)(1,829), list_of(-1));
	main_decoder_table[828]=aarch64_mask_entry(0x0, branchMap(), list_of(692));
	main_decoder_table[829]=aarch64_mask_entry(0x0, branchMap(), list_of(686));
	main_decoder_table[823]=aarch64_mask_entry(0x0, branchMap(), list_of(655));
	main_decoder_table[824]=aarch64_mask_entry(0x0, branchMap(), list_of(184));
	main_decoder_table[825]=aarch64_mask_entry(0x0, branchMap(), list_of(228));
...
void InstructionDecoder_aarch64::buildSysRegMap()
{
	...
	sysRegMap[0xDE83] = aarch64::tpidrr0_el0;
	sysRegMap[0x9820] = aarch64::dbgdtr_el0;
	sysRegMap[0x9828] = aarch64::dbggtrrx_el0;
	sysRegMap[0x9828] = aarch64::dbggtrtx_el0;
	...
	sysRegMap[0xDF00] = aarch64::cntfr0_el0;
