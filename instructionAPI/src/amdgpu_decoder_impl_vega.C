...
InstructionDecoder_amdgpu_vega::decodeSOP2()
{
    ...
    this->insn_in_progress =
        makeInstruction(insn_entry.op, insn_entry.mnemonic, insn_size_ + immLen,
...
void
InstructionDecoder_amdgpu_vega::mainDecode(InstructionDecoder::buffer& b)
{
...
void
InstructionDecoder_amdgpu_vega::mainDecodeOpcode(InstructionDecoder::buffer& b)
{
    if(IS_SOP2(insn_long))
    {
        unsigned                 insn_size_ = 4;
        const amdgpu_insn_entry& insn_entry =
            amdgpu_insn_entry::sop2_insn_table[longfield<23, 29>(insn_long)];
        setUseImm<0, 7, 255>(b, 4);
        setUseImm<8, 15, 255>(b, 4);
        this->insn_in_progress =
            makeInstruction(insn_entry.op, insn_entry.mnemonic, insn_size_ + immLen,
    ...
    else if(IS_SOP1(insn_long))
    {
        unsigned                 insn_size_ = 4;
        const amdgpu_insn_entry& insn_entry =
            amdgpu_insn_entry::sop1_insn_table[longfield<8, 15>(insn_long)];
        setUseImm<0, 7, 255>(b, 4);
        this->insn_in_progress =
            makeInstruction(insn_entry.op, insn_entry.mnemonic, insn_size_ + immLen,
                            reinterpret_cast<unsigned char*>(&insn));
    ...
    else if(IS_SOPK(insn_long))
    {
        unsigned                 insn_size_ = 4;
        const amdgpu_insn_entry& insn_entry =
            amdgpu_insn_entry::sopk_insn_table[longfield<23, 27>(insn_long)];
        this->insn_in_progress =
            makeInstruction(insn_entry.op, insn_entry.mnemonic, insn_size_ + immLen,
                            reinterpret_cast<unsigned char*>(&insn));
        instr_family = SOPK;
    ...
    else if(IS_SOPC(insn_long))
    {
        unsigned                 insn_size_ = 4;
        const amdgpu_insn_entry& insn_entry =
            amdgpu_insn_entry::sopc_insn_table[longfield<16, 22>(insn_long)];
        this->insn_in_progress =
            makeInstruction(insn_entry.op, insn_entry.mnemonic, insn_size_ + immLen,
                            reinterpret_cast<unsigned char*>(&insn));
        instr_family = SOPC;
    ...
    else if(IS_SOPP(insn_long))
    {
        unsigned                 insn_size_ = 4;
        const amdgpu_insn_entry& insn_entry =
            amdgpu_insn_entry::sopp_insn_table[longfield<16, 22>(insn_long)];
        this->insn_in_progress =
            makeInstruction(insn_entry.op, insn_entry.mnemonic, insn_size_ + immLen,
                            reinterpret_cast<unsigned char*>(&insn));
        instr_family = SOPP;
    ...
    else if(IS_SMEM(insn_long))
    {
        unsigned                 insn_size_ = 8;
        const amdgpu_insn_entry& insn_entry =
            amdgpu_insn_entry::smem_insn_table[longfield<18, 25>(insn_long)];
        this->insn_in_progress =
            makeInstruction(insn_entry.op, insn_entry.mnemonic, insn_size_ + immLen,
                            reinterpret_cast<unsigned char*>(&insn));
        instr_family = SMEM;
    ...
    else if(IS_VOP2(insn_long))
    {
        unsigned                 insn_size_ = 4;
        const amdgpu_insn_entry& insn_entry =
            amdgpu_insn_entry::vop2_insn_table[longfield<25, 30>(insn_long)];
        setUseImm<0, 8, 249>(b, 4);
        setUseImm<0, 8, 250>(b, 4);
        setUseImm<0, 8, 255>(b, 4);
        this->insn_in_progress =
    ...
    else if(IS_VOP1(insn_long))
    {
        unsigned                 insn_size_ = 4;
        const amdgpu_insn_entry& insn_entry =
            amdgpu_insn_entry::vop1_insn_table[longfield<9, 16>(insn_long)];
        setUseImm<0, 8, 249>(b, 4);
        setUseImm<0, 8, 250>(b, 4);
        setUseImm<0, 8, 255>(b, 4);
        this->insn_in_progress =
    ...
    else if(IS_VOPC(insn_long))
    {
        unsigned                 insn_size_ = 4;
        const amdgpu_insn_entry& insn_entry =
            amdgpu_insn_entry::vopc_insn_table[longfield<17, 24>(insn_long)];
        setUseImm<0, 8, 255>(b, 4);
        this->insn_in_progress =
            makeInstruction(insn_entry.op, insn_entry.mnemonic, insn_size_ + immLen,
                            reinterpret_cast<unsigned char*>(&insn));
    ...
    else if(IS_VINTRP(insn_long))
    {
        unsigned                 insn_size_ = 4;
        const amdgpu_insn_entry& insn_entry =
            amdgpu_insn_entry::vintrp_insn_table[longfield<16, 17>(insn_long)];
        this->insn_in_progress =
            makeInstruction(insn_entry.op, insn_entry.mnemonic, insn_size_ + immLen,
                            reinterpret_cast<unsigned char*>(&insn));
        instr_family = VINTRP;
    ...
    else if(IS_DS(insn_long))
    {
        unsigned                 insn_size_ = 8;
        const amdgpu_insn_entry& insn_entry =
            amdgpu_insn_entry::ds_insn_table[longfield<17, 24>(insn_long)];
        this->insn_in_progress =
            makeInstruction(insn_entry.op, insn_entry.mnemonic, insn_size_ + immLen,
                            reinterpret_cast<unsigned char*>(&insn));
        instr_family = DS;
    ...
    else if(IS_MTBUF(insn_long))
    {
        unsigned                 insn_size_ = 8;
        const amdgpu_insn_entry& insn_entry =
            amdgpu_insn_entry::mtbuf_insn_table[longfield<15, 18>(insn_long)];
        this->insn_in_progress =
            makeInstruction(insn_entry.op, insn_entry.mnemonic, insn_size_ + immLen,
                            reinterpret_cast<unsigned char*>(&insn));
        instr_family = MTBUF;
    ...
    else if(IS_MUBUF(insn_long))
    {
        unsigned                 insn_size_ = 8;
        const amdgpu_insn_entry& insn_entry =
            amdgpu_insn_entry::mubuf_insn_table[longfield<18, 24>(insn_long)];
        this->insn_in_progress =
            makeInstruction(insn_entry.op, insn_entry.mnemonic, insn_size_ + immLen,
                            reinterpret_cast<unsigned char*>(&insn));
        instr_family = MUBUF;
    ...
    else if(IS_VOP3AB(insn_long))
    {
        unsigned                 insn_size_ = 8;
        const amdgpu_insn_entry& insn_entry =
            amdgpu_insn_entry::vop3ab_insn_table[longfield<16, 25>(insn_long)];
        this->insn_in_progress =
            makeInstruction(insn_entry.op, insn_entry.mnemonic, insn_size_ + immLen,
                            reinterpret_cast<unsigned char*>(&insn));
        instr_family = VOP3AB;
    ...
    else if(IS_VOP3P(insn_long))
    {
        unsigned                 insn_size_ = 8;
        const amdgpu_insn_entry& insn_entry =
            amdgpu_insn_entry::vop3p_insn_table[longfield<11, 13>(insn_long)];
        this->insn_in_progress =
            makeInstruction(insn_entry.op, insn_entry.mnemonic, insn_size_ + immLen,
                            reinterpret_cast<unsigned char*>(&insn));
        instr_family = VOP3P;
    ...
    else if(IS_FLAT(insn_long))
    {
        unsigned                 insn_size_ = 8;
        const amdgpu_insn_entry& insn_entry =
            amdgpu_insn_entry::flat_insn_table[longfield<18, 24>(insn_long)];
        this->insn_in_progress =
            makeInstruction(insn_entry.op, insn_entry.mnemonic, insn_size_ + immLen,
                            reinterpret_cast<unsigned char*>(&insn));
        instr_family = FLAT;
