...
#define IS_INSN_LDST_UNSCALED(I)                                                                   \
  (field<27, 29>(I) == 0x07 && field<24, 25>(I) == 0 && field<21, 21>(I) == 0 &&                   \
   field<10, 11>(I) == 0x00)
#define IS_INSN_LDST_POST(I)                                                                       \
  (field<27, 29>(I) == 0x07 && field<24, 25>(I) == 0 && field<21, 21>(I) == 0 &&                   \
   field<10, 11>(I) == 0x01)
#define IS_INSN_LDST_UNPRIV(I)                                                                     \
  (field<27, 29>(I) == 0x07 && field<24, 25>(I) == 0 && field<21, 21>(I) == 0 &&                   \
   field<10, 11>(I) == 0x02)
#define IS_INSN_LDST_PRE(I)                                                                        \
  (field<27, 29>(I) == 0x07 && field<24, 25>(I) == 0 && field<21, 21>(I) == 0 &&                   \
   field<10, 11>(I) == 0x03)
#define IS_INSN_LDST_REG(I)                                                                        \
  (field<27, 29>(I) == 0x07 && field<24, 25>(I) == 0 && field<21, 21>(I) == 1 &&                   \
   field<10, 11>(I) == 0x02)
#define IS_INSN_LDST_UIMM(I) (field<27, 29>(I) == 0x07 && field<24, 25>(I) == 1)

#define IS_INSN_LDST_SIMD_MULT(I)                                                                  \
  (field<31, 31>(I) == 0x00 && field<23, 29>(I) == 0x18 && field<16, 21>(I) == 0)
#define IS_INSN_LDST_SIMD_MULT_POST(I)                                                             \
  (field<31, 31>(I) == 0x00 && field<23, 29>(I) == 0x19 && field<21, 21>(I) == 0)
#define IS_INSN_LDST_SIMD_SING(I)                                                                  \
  (field<31, 31>(I) == 0x00 && field<23, 29>(I) == 0x1a && field<16, 20>(I) == 0)
...
#define IS_INSN_FP_COMPARE(I)                                                                      \
  (field<24, 28>(I) == 0x1E && field<21, 21>(I) == 0x1 && field<10, 13>(I) == 0x8)
#define IS_INSN_FP_CONV_FIX(I) (field<24, 28>(I) == 0x1E && field<21, 21>(I) == 0x0)
#define IS_INSN_FP_CONV_INT(I)                                                                     \
  (field<24, 28>(I) == 0x1E && field<21, 21>(I) == 0x1 && field<10, 15>(I) == 0x0)
#define IS_SOURCE_GP(I)                                                                            \
  (field<16, 18>(I) == 0x2 || field<16, 18>(I) == 0x3 || field<16, 18>(I) == 0x7)
#define IS_INSN_FP_DATAPROC_ONESRC(I)                                                              \
  (field<24, 28>(I) == 0x1E && field<21, 21>(I) == 0x1 && field<10, 14>(I) == 0x10)
...
#define IS_INSN_BRANCHING(I)                                                                       \
  (IS_INSN_B_COND(I) || IS_INSN_B_UNCOND(I) || IS_INSN_B_UNCOND_REG(I) || IS_INSN_B_TEST(I) ||     \
   IS_INSN_B_COMPARE(I))

#define IS_INSN_SIMD_3SAME(I)                                                                      \
  (field<31, 31>(I) == 0x0 && field<24, 28>(I) == 0xE && field<21, 21>(I) == 0x1 &&                \
   field<10, 10>(I) == 0x1)
#define IS_INSN_SIMD_3DIFF(I)                                                                      \
  (field<31, 31>(I) == 0x0 && field<24, 28>(I) == 0xe && field<21, 21>(I) == 0x1 &&                \
   field<10, 11>(I) == 0x0)
#define IS_INSN_SIMD_2REG_MISC(I)                                                                  \
  (field<31, 31>(I) == 0x0 && field<24, 28>(I) == 0xe && field<17, 21>(I) == 0x10 &&               \
   field<10, 11>(I) == 0x2)
#define IS_INSN_SIMD_ACROSS(I)                                                                     \
  (field<31, 31>(I) == 0x0 && field<24, 28>(I) == 0xe && field<17, 21>(I) == 0x18 &&               \
   field<10, 11>(I) == 0x2)
#define IS_INSN_SIMD_COPY(I)                                                                       \
  (field<31, 31>(I) == 0x0 && field<21, 28>(I) == 0x70 && field<15, 15>(I) == 0x0 &&               \
   field<10, 10>(I) == 0x1)
#define IS_INSN_SIMD_VEC_INDEX(I)                                                                  \
  (field<31, 31>(I) == 0x0 && field<24, 28>(I) == 0xf && field<10, 10>(I) == 0x0)
#define IS_INSN_SIMD_MOD_IMM(I)                                                                    \
  (field<31, 31>(I) == 0x0 && field<19, 28>(I) == 0x1e0 && field<10, 10>(I) == 0x1)
#define IS_INSN_SIMD_SHIFT_IMM(I)                                                                  \
  (field<31, 31>(I) == 0x0 && field<23, 28>(I) == 0x1e && field<19, 22>(I) != 0x0 &&               \
   field<10, 10>(I) == 0x1)
#define IS_INSN_SIMD_TAB_LOOKUP(I)                                                                 \
  (field<31, 31>(I) == 0x0 && field<24, 29>(I) == 0xe && field<21, 21>(I) == 0x0 &&                \
   field<15, 15>(I) == 0x0 && field<10, 11>(I) == 0x0)
#define IS_INSN_SIMD_EXTR(I)                                                                       \
  (field<31, 31>(I) == 0x0 && field<24, 29>(I) == 0x2e && field<21, 21>(I) == 0x0 &&               \
   field<15, 15>(I) == 0x0 && field<10, 10>(I) == 0x0)
#define IS_INSN_SCALAR_3SAME(I)                                                                    \
  (field<30, 31>(I) == 0x1 && field<24, 28>(I) == 0x1e && field<21, 21>(I) == 0x1 &&               \
   field<10, 10>(I) == 0x1)
#define IS_INSN_SCALAR_3DIFF(I)                                                                    \
  (field<30, 31>(I) == 0x1 && field<24, 28>(I) == 0x1e && field<21, 21>(I) == 0x1 &&               \
   field<10, 11>(I) == 0x0)
#define IS_INSN_SCALAR_2REG_MISC(I)                                                                \
  (field<30, 31>(I) == 0x1 && field<24, 28>(I) == 0x1e && field<17, 21>(I) == 0x10 &&              \
   field<10, 11>(I) == 0x2)
#define IS_INSN_SCALAR_PAIR(I)                                                                     \
  (field<30, 31>(I) == 0x1 && field<24, 28>(I) == 0x1e && field<17, 21>(I) == 0x18 &&              \
   field<10, 11>(I) == 0x2)
#define IS_INSN_SCALAR_COPY(I)                                                                     \
  (field<30, 31>(I) == 0x1 && field<21, 28>(I) == 0xf0 && field<15, 15>(I) == 0x0 &&               \
   field<10, 10>(I) == 0x1)
#define IS_INSN_SCALAR_INDEX(I)                                                                    \
  (field<30, 31>(I) == 0x1 && field<24, 28>(I) == 0x1f && field<10, 10>(I) == 0x0)
#define IS_INSN_SCALAR_SHIFT_IMM(I)                                                                \
  (field<30, 31>(I) == 0x1 && field<23, 28>(I) == 0x3e && field<10, 10>(I) == 0x1)

#define IS_INSN_CRYPT_3REG_SHA(I)                                                                  \
  (field<24, 31>(I) == 0x5E && field<21, 21>(I) == 0 && field<15, 15>(I) == 0 &&                   \
   field<10, 11>(I) == 0)
#define IS_INSN_CRYPT_2REG_SHA(I)                                                                  \
  (field<24, 31>(I) == 0x5E && field<17, 21>(I) == 0x14 && field<10, 11>(I) == 0x2)
...
namespace Dyninst { namespace InstructionAPI {
  ...
  InstructionDecoder_aarch64::InstructionDecoder_aarch64(Architecture a)
      : InstructionDecoderImpl(a), isPstateRead(false), isPstateWritten(false), isFPInsn(false),
        isSIMDInsn(false), skipRn(false), skipRm(false), is64Bit(true), isValid(true), insn(0),
        hasHw(false), hasShift(false), hasOption(false), hasN(false), immr(0), immrLen(0),
        sField(0), nField(0), nLen(0), immlo(0), immloLen(0), _szField(-1), size(-1), cmode(0),
        op(0), simdAlphabetImm(0), _Q(1) {}
...
*/
  ...
  template <unsigned int endBit, unsigned int startBit> void InstructionDecoder_aarch64::OPRtype() {
  ...
  MachRegister InstructionDecoder_aarch64::makeAarch64RegID(MachRegister base,
  ...
  template <unsigned int endBit, unsigned int startBit> void InstructionDecoder_aarch64::OPRsize() {
    ...
    if((insnID == aarch64_op_pmull_advsimd && (size == 0x1 || size == 0x2)) ||
       ...
       ((insnID == aarch64_op_sqdmull_advsimd_vec || insnID == aarch64_op_sqdmlal_advsimd_vec ||
  ...
  Expression::Ptr InstructionDecoder_aarch64::makeRdExpr() {
    ...
    if(isSIMDInsn) {
      ...
      if(encoding == 31)
        reg =
            ((IS_INSN_ADDSUB_IMM(insn) || IS_INSN_ADDSUB_EXT(insn) || IS_INSN_LOGICAL_IMM(insn)) &&
             !isPstateWritten)
  ...
  void InstructionDecoder_aarch64::OPRRd() {
    ...
    if(((IS_INSN_SIMD_VEC_INDEX(insn) || IS_INSN_SCALAR_INDEX(insn)) && !(cmode_ & 0x8)) ||
       (IS_INSN_SIMD_MOD_IMM(insn) && (((cmode_ & 0x8) && !(cmode_ & 0x4) && (cmode_ & 0x1)) ||
  ...
  Expression::Ptr InstructionDecoder_aarch64::makeRnExpr() {
    ...
    if(isSIMDInsn && !IS_INSN_LDST(insn)) {
      if(IS_INSN_SIMD_COPY(insn)) {
        ...
        // the below two conditions can easily be combined into one, but would be difficult to
        // understand
        if(field<13, 13>(insn) == 0x1)
          reg = _Q == 0x1 ? aarch64::hq0 : aarch64::d0;
        else
  ...
  void InstructionDecoder_aarch64::getMemRefIndex_SizeSizelen(unsigned int& size_,
  ...
  void InstructionDecoder_aarch64::getMemRefIndexPrePost_ImmImmlen(unsigned int& immVal,
                                                                   unsigned int& immLen) {
  ...
  Expression::Ptr InstructionDecoder_aarch64::makeMemRefIndexUImm() {
    ...
    Expression::Ptr offset =
        Immediate::makeImmediate(Result(u64, unsign_extend64(immLen + size_, immVal << size_)));
...
*/
  ...
  */
  ...
  immVal))); return makeDereferenceExpression(makeAddExpression(makeRnExpr(), offset, u64) , u64);
  }
  */
...
*/
  ...
  Expression::Ptr InstructionDecoder_aarch64::makeRmExpr() {
    ...
    if(isSIMDInsn) {
      ...
      reg = (is64Bit && !use32for64bit) ? ((encoding == 31) ? aarch64::xzr : aarch64::x0)
                                        : ((encoding == 31) ? aarch64::wzr : aarch64::w0);
      if(encoding != 31)
        reg = makeAarch64RegID(reg, encoding);
    }
  ...
  template <unsigned int endBit, unsigned int startBit> void InstructionDecoder_aarch64::OPRN() {
    hasN = true;
  ...
  void InstructionDecoder_aarch64::setRegWidth() {
    ...
    if(IS_INSN_LDST(insn)) {
      if(IS_INSN_LDST_UIMM(insn) || IS_INSN_LDST_UNSCALED(insn) || IS_INSN_LDST_UNPRIV(insn) ||
         IS_INSN_LDST_POST(insn) || IS_INSN_LDST_PRE(insn) || IS_INSN_LDST_REG(insn)) {
        if(opc1 == 0) {
  ...
  void InstructionDecoder_aarch64::OPRRt() {
    ...
    if(IS_INSN_BRANCHING(insn)) {
      ...
      if((encoding & 0x1E) == 0x6 || (encoding & 0x1E) == 0xE || (encoding & 0x1E) == 0x16 ||
         (encoding & 0x18) == 0x18)
  ...
  template <unsigned int endBit, unsigned int startBit> void InstructionDecoder_aarch64::OPRS() {
  ...
  template <unsigned int endBit, unsigned int startBit> void InstructionDecoder_aarch64::OPRsz() {
  ...
  bool InstructionDecoder_aarch64::isSinglePrec() {
    if(isFPInsn && !isSIMDInsn) {
      ...
      // return false even if type has an invalid value, it won't matter because isValid is set to
      // false and thus the instruction will be marked invalid
  ...
  Expression::Ptr InstructionDecoder_aarch64::makeFallThroughExpr() {
    return makeAddExpression(makePCExpr(),
  ...
  template <typename T>
  Expression::Ptr InstructionDecoder_aarch64::makeLogicalImm(int immr_, int imms, int immsLen,
                                                             Result_Type rT) {
    ...
    } else if(hasN) // logical (immediate), bitfield, extract
    {
      ...
      if(IS_INSN_ADDSUB_EXT(insn)) // add-sub extended
      {
        ...
        isValid = false;
              ...
              !IS_INSN_B_UNCOND_REG(insn)) { // unconditional branch (immediate), test and branch,
    ...
    } else if(IS_INSN_PCREL_ADDR(insn)) // pc-relative addressing
    {
      ...
      if(IS_INSN_SIMD_EXTR(insn)) {
        ...
        // immb
          ...
          // manner. unfortunately, determining whether the instruction will do a left or right
          // shift cannot be determined in any way other than checking the instruction's opcode
          if(insnID == aarch64_op_shl_advsimd || insnID == aarch64_op_sqshl_advsimd_imm ||
             insnID == aarch64_op_sshll_advsimd || insnID == aarch64_op_sli_advsimd ||
             insnID == aarch64_op_sqshlu_advsimd || insnID == aarch64_op_uqshl_advsimd_imm ||
...
#include "aarch64_opcode_tables.C"
  ...
  bool InstructionDecoder_aarch64::pre_process_checks(const aarch64_insn_entry& entry) {
    ...
    vector<entryID> simdCompareRegInsns = {aarch64_op_cmeq_advsimd_reg, aarch64_op_cmge_advsimd_reg,
                                           ...
                                           aarch64_op_cmhs_advsimd,     aarch64_op_cmtst_advsimd},
    ...
    vector<entryID> fpCompareRegInsns = {aarch64_op_fcmeq_advsimd_reg, aarch64_op_fcmge_advsimd_reg,
                                         aarch64_op_fcmgt_advsimd_reg},
                    fpCompareZeroInsns = {aarch64_op_fcmeq_advsimd_zero,
                                          aarch64_op_fcmge_advsimd_zero,
                                          aarch64_op_fcmgt_advsimd_zero, aarch64_op_fcmle_advsimd,
