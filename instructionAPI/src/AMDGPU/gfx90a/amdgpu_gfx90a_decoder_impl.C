...
void InstructionDecoder_amdgpu_gfx90a::decodeENC_SOP1(){
	...
	assert(isArrayIndexValid(amdgpu_gfx90a_insn_entry::ENC_SOP1_insn_table, layout.OP) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx90a::decodeENC_SOPC(){
	...
	assert(isArrayIndexValid(amdgpu_gfx90a_insn_entry::ENC_SOPC_insn_table, layout.OP) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx90a::decodeENC_SOPP(){
	...
	assert(isArrayIndexValid(amdgpu_gfx90a_insn_entry::ENC_SOPP_insn_table, layout.OP) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx90a::decodeENC_SOPK(){
	...
	layout.SDST = longfield<16,22>(insn_long);
	layout.SIMM16 = longfield<0,15>(insn_long);
	assert(isArrayIndexValid(amdgpu_gfx90a_insn_entry::ENC_SOPK_insn_table, layout.OP) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx90a::decodeENC_SOP2(){
	...
	layout.SSRC0 = longfield<0,7>(insn_long);
	layout.SSRC1 = longfield<8,15>(insn_long);
	assert(isArrayIndexValid(amdgpu_gfx90a_insn_entry::ENC_SOP2_insn_table, layout.OP) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx90a::decodeENC_SMEM(){
	...
	assert(isArrayIndexValid(amdgpu_gfx90a_insn_entry::ENC_SMEM_insn_table, layout.OP) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx90a::decodeENC_VOP1(){
	...
	assert(isArrayIndexValid(amdgpu_gfx90a_insn_entry::ENC_VOP1_insn_table, layout.OP) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx90a::decodeENC_VOPC(){
	...
	assert(isArrayIndexValid(amdgpu_gfx90a_insn_entry::ENC_VOPC_insn_table, layout.OP) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx90a::decodeENC_VOP2(){
	...
	layout.VDST = longfield<17,24>(insn_long);
	layout.VSRC1 = longfield<9,16>(insn_long);
	assert(isArrayIndexValid(amdgpu_gfx90a_insn_entry::ENC_VOP2_insn_table, layout.OP) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx90a::decodeENC_VINTRP(){
	...
	assert(isArrayIndexValid(amdgpu_gfx90a_insn_entry::ENC_VINTRP_insn_table, layout.OP) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx90a::decodeENC_VOP3P(){
	...
	assert(isArrayIndexValid(amdgpu_gfx90a_insn_entry::ENC_VOP3P_insn_table, layout.OP) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx90a::decodeENC_VOP3(){
	...
	layout.SRC2 = longfield<50,58>(insn_long);
	layout.VDST = longfield<0,7>(insn_long);
	assert(isArrayIndexValid(amdgpu_gfx90a_insn_entry::ENC_VOP3_insn_table, layout.OP) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx90a::decodeENC_DS(){
	...
	assert(isArrayIndexValid(amdgpu_gfx90a_insn_entry::ENC_DS_insn_table, layout.OP) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx90a::decodeENC_MUBUF(){
	...
	assert(isArrayIndexValid(amdgpu_gfx90a_insn_entry::ENC_MUBUF_insn_table, layout.OP) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx90a::decodeENC_MTBUF(){
	...
	layout.VADDR = longfield<32,39>(insn_long);
	layout.VDATA = longfield<40,47>(insn_long);
	assert(isArrayIndexValid(amdgpu_gfx90a_insn_entry::ENC_MTBUF_insn_table, layout.OP) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx90a::decodeENC_MIMG(){
	...
	layout.VADDR = longfield<32,39>(insn_long);
	layout.VDATA = longfield<40,47>(insn_long);
	assert(isArrayIndexValid(amdgpu_gfx90a_insn_entry::ENC_MIMG_insn_table, layout.OP) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx90a::decodeENC_FLAT(){
	...
	layout.SLC = longfield<17,17>(insn_long);
	layout.VDST = longfield<56,63>(insn_long);
	assert(isArrayIndexValid(amdgpu_gfx90a_insn_entry::ENC_FLAT_insn_table, layout.OP) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx90a::decodeENC_FLAT_GLBL(){
	...
	layout.SLC = longfield<17,17>(insn_long);
	layout.VDST = longfield<56,63>(insn_long);
	assert(isArrayIndexValid(amdgpu_gfx90a_insn_entry::ENC_FLAT_GLBL_insn_table, layout.OP) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx90a::decodeENC_FLAT_SCRATCH(){
	...
	layout.SLC = longfield<17,17>(insn_long);
	layout.VDST = longfield<56,63>(insn_long);
	assert(isArrayIndexValid(amdgpu_gfx90a_insn_entry::ENC_FLAT_SCRATCH_insn_table, layout.OP) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx90a::decodeSOPK_INST_LITERAL_(){
	...
	assert(isArrayIndexValid(amdgpu_gfx90a_insn_entry::SOPK_INST_LITERAL__insn_table, layout.OP) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx90a::decodeENC_VOP2_LITERAL(){
	...
	layout.VDST = longfield<17,24>(insn_long);
	layout.VSRC1 = longfield<9,16>(insn_long);
	assert(isArrayIndexValid(amdgpu_gfx90a_insn_entry::ENC_VOP2_LITERAL_insn_table, layout.OP) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx90a::decodeENC_VOP3B(){
	...
	layout.SRC2 = longfield<50,58>(insn_long);
	layout.VDST = longfield<0,7>(insn_long);
	assert(isArrayIndexValid(amdgpu_gfx90a_insn_entry::ENC_VOP3B_insn_table, layout.OP) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx90a::decodeENC_VOP3P_MFMA(){
	...
	layout.SRC2 = longfield<50,58>(insn_long);
	layout.VDST = longfield<0,7>(insn_long);
	assert(isArrayIndexValid(amdgpu_gfx90a_insn_entry::ENC_VOP3P_MFMA_insn_table, layout.OP) && "Opcode over or underflow");
