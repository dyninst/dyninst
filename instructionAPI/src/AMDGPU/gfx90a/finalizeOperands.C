...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR),true,false);
break;
case 64:case 65:case 66:case 67:case 68:case 69:case 70:case 71:case 72:case 73:case 74:case 75:case 77:case 82:case 83:case 92:
//DS_ADD_U64,DS_SUB_U64,DS_RSUB_U64,DS_INC_U64,DS_DEC_U64,DS_MIN_I64,DS_MAX_I64,DS_MIN_U64,DS_MAX_U64,DS_AND_B64,DS_OR_B64,DS_XOR_B64,DS_WRITE_B64,DS_MIN_F64,DS_MAX_F64,DS_ADD_F64
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR),true,false);
...
break;
case 96:case 97:case 98:case 99:case 100:case 101:case 102:case 103:case 104:case 105:case 106:case 107:case 109:case 114:case 115:case 124:case 126:
//DS_ADD_RTN_U64,DS_SUB_RTN_U64,DS_RSUB_RTN_U64,DS_INC_RTN_U64,DS_DEC_RTN_U64,DS_MIN_RTN_I64,DS_MAX_RTN_I64,DS_MIN_RTN_U64,DS_MAX_RTN_U64,DS_AND_RTN_B64,DS_OR_RTN_B64,DS_XOR_RTN_B64,DS_WRXCHG_RTN_B64,DS_MIN_RTN_F64,DS_MAX_RTN_F64,DS_ADD_RTN_F64,DS_CONDXCHG32_RTN_B64
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST+0,2),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST+1,0),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0+0,2),true,false);
...
//FLAT_ATOMIC_CMPSWAP,FLAT_ATOMIC_ADD_F64,FLAT_ATOMIC_MIN_F64,FLAT_ATOMIC_MAX_F64,FLAT_ATOMIC_SWAP_X2,FLAT_ATOMIC_ADD_X2,FLAT_ATOMIC_SUB_X2,FLAT_ATOMIC_SMIN_X2,FLAT_ATOMIC_UMIN_X2,FLAT_ATOMIC_SMAX_X2,FLAT_ATOMIC_UMAX_X2,FLAT_ATOMIC_AND_X2,FLAT_ATOMIC_OR_X2,FLAT_ATOMIC_XOR_X2,FLAT_ATOMIC_INC_X2,FLAT_ATOMIC_DEC_X2
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST+0,2),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST+1,0),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR+0,2),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR+1,0),true,false);
...
break;
case 65:case 79:case 80:case 81:case 96:case 98:case 99:case 100:case 101:case 102:case 103:case 104:case 105:case 106:case 107:case 108:
//GLOBAL_ATOMIC_CMPSWAP,GLOBAL_ATOMIC_ADD_F64,GLOBAL_ATOMIC_MIN_F64,GLOBAL_ATOMIC_MAX_F64,GLOBAL_ATOMIC_SWAP_X2,GLOBAL_ATOMIC_ADD_X2,GLOBAL_ATOMIC_SUB_X2,GLOBAL_ATOMIC_SMIN_X2,GLOBAL_ATOMIC_UMIN_X2,GLOBAL_ATOMIC_SMAX_X2,GLOBAL_ATOMIC_UMAX_X2,GLOBAL_ATOMIC_AND_X2,GLOBAL_ATOMIC_OR_X2,GLOBAL_ATOMIC_XOR_X2,GLOBAL_ATOMIC_INC_X2,GLOBAL_ATOMIC_DEC_X2
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST+0,2),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST+1,0),false,true);
if(layout.SADDR == 0x7f){
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,2),true,false);
...
insn_in_progress->appendOperand(makeRegisterExpression(amdgpu_gfx90a::vmcnt,0,36),true,true,true);
break;
case 40:case 41:case 62:case 63:
//BUFFER_WBL2,BUFFER_INVL2,BUFFER_WBINVL1,BUFFER_WBINVL1_VOL
insn_in_progress->appendOperand(makeRegisterExpression(amdgpu_gfx90a::vmcnt,0,36),true,true,true);
break;
case 61:
...
switch(layout.OP){
case 0:case 9:case 14:case 32:case 33:case 34:case 35:case 38:case 39:case 40:case 41:case 42:case 43:case 48:
//V_PK_MAD_I16,V_PK_MAD_U16,V_PK_FMA_F16,V_MAD_MIX_F32,V_MAD_MIXLO_F16,V_MAD_MIXHI_F16,V_DOT2_F32_F16,V_DOT2_I32_I16,V_DOT2_U32_U16,V_DOT4_I32_I8,V_DOT4_U32_U8,V_DOT8_I32_I4,V_DOT8_U32_U4,V_PK_FMA_F32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC2),true,false);
break;
case 1:case 2:case 3:case 7:case 8:case 10:case 11:case 12:case 13:case 15:case 16:case 17:case 18:case 49:case 50:
//V_PK_MUL_LO_U16,V_PK_ADD_I16,V_PK_SUB_I16,V_PK_MAX_I16,V_PK_MIN_I16,V_PK_ADD_U16,V_PK_SUB_U16,V_PK_MAX_U16,V_PK_MIN_U16,V_PK_ADD_F16,V_PK_MUL_F16,V_PK_MIN_F16,V_PK_MAX_F16,V_PK_MUL_F32,V_PK_ADD_F32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2),true,false);
break;
}
}
