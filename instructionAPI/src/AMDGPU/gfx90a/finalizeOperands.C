    ...
    namespace InstructionAPI {
        ...
        void InstructionDecoder_amdgpu_gfx90a::finalizeENC_SOPPOperands(){
            ...
            switch (layout.OP) {
                ...
                if (vmcnt != 0x3f) {insn_in_progress->appendOperand( makeRegisterExpression(amdgpu_gfx90a::vmcnt, 0 ,32),false,true);insn_in_progress->appendOperand( Immediate::makeImmediate(Result(u32,vmcnt)),false,false);}
                if (expcnt != 0x7) {insn_in_progress->appendOperand( makeRegisterExpression(amdgpu_gfx90a::expcnt, 0 ,32),false,true);insn_in_progress->appendOperand( Immediate::makeImmediate(Result(u32,expcnt)),false,false);}
                if (lgkmcnt != 0xf) {insn_in_progress->appendOperand( makeRegisterExpression(amdgpu_gfx90a::lgkmcnt, 0 ,32),false,true);insn_in_progress->appendOperand( Immediate::makeImmediate(Result(u32,lgkmcnt)),false,false);}
                }
                break;
                case 16:case 17:
        ...
        void InstructionDecoder_amdgpu_gfx90a::finalizeENC_VOP3P_MFMAOperands(){
            ...
            switch (layout.OP) {
                ...
                break;
                case 72:case 99:
                //V_MFMA_F32_32X32X4F16,V_MFMA_F32_32X32X4BF16_1K
                appendOPR_VGPR_OR_ACCVGPR(layout.VDST,false,true,32);
                appendOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,true,false,2);
                appendOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,true,false,2);
                appendOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,true,false,32);
                break;
                case 73:case 76:case 100:case 102:
                //V_MFMA_F32_16X16X4F16,V_MFMA_F32_32X32X8F16,V_MFMA_F32_16X16X4BF16_1K,V_MFMA_F32_32X32X8BF16_1K
                appendOPR_VGPR_OR_ACCVGPR(layout.VDST,false,true,16);
                appendOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,true,false,2);
                appendOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,true,false,2);
                appendOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,true,false,16);
                break;
                case 74:case 77:case 101:case 103:
                //V_MFMA_F32_4X4X4F16,V_MFMA_F32_16X16X16F16,V_MFMA_F32_4X4X4BF16_1K,V_MFMA_F32_16X16X16BF16_1K
                appendOPR_VGPR_OR_ACCVGPR(layout.VDST,false,true,4);
                appendOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,true,false,2);
                appendOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,true,false,2);
                appendOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,true,false,4);
