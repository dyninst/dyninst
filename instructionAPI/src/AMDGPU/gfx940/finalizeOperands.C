    ...
    namespace InstructionAPI {
        ...
        void InstructionDecoder_amdgpu_gfx940::finalizeENC_SOPPOperands(){
            ...
            switch (layout.OP) {
                ...
                if (vmcnt != 0x3f) {insn_in_progress->appendOperand( makeRegisterExpression(amdgpu_gfx940::vmcnt, 0 ,32),false,true);insn_in_progress->appendOperand( Immediate::makeImmediate(Result(u32,vmcnt)),false,false);}
                if (expcnt != 0x7) {insn_in_progress->appendOperand( makeRegisterExpression(amdgpu_gfx940::expcnt, 0 ,32),false,true);insn_in_progress->appendOperand( Immediate::makeImmediate(Result(u32,expcnt)),false,false);}
                if (lgkmcnt != 0xf) {insn_in_progress->appendOperand( makeRegisterExpression(amdgpu_gfx940::lgkmcnt, 0 ,32),false,true);insn_in_progress->appendOperand( Immediate::makeImmediate(Result(u32,lgkmcnt)),false,false);}
                }
                break;
                case 16:case 17:
        ...
        void InstructionDecoder_amdgpu_gfx940::finalizeENC_VOP3P_MFMAOperands(){
            ...
            switch (layout.OP) {
                ...
                appendOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,true,false,32);
                break;
                case 98:case 106:case 120:case 121:case 122:case 123:
                //V_SMFMAC_F32_16X16X32_F16,V_SMFMAC_I32_16X16X64_I8,V_SMFMAC_F32_16X16X64_BF8_BF8,V_SMFMAC_F32_16X16X64_BF8_FP8,V_SMFMAC_F32_16X16X64_FP8_BF8,V_SMFMAC_F32_16X16X64_FP8_FP8
                appendOPR_VGPR_OR_ACCVGPR(layout.VDST,true,true,4);
                appendOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,true,false,2);
                appendOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,true,false,4);
                appendOPR_SRC_VGPR(layout.SRC2,true,false);
                break;
                case 100:case 102:
                //V_SMFMAC_F32_32X32X16_F16,V_SMFMAC_F32_16X16X32_BF16
                appendOPR_VGPR_OR_ACCVGPR(layout.VDST,true,true,16);
                appendOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,true,false,2);
                appendOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,true,false,2);
                appendOPR_SRC_VGPR(layout.SRC2,true,false,16);
                break;
                case 104:
                //V_SMFMAC_F32_32X32X16_BF16
                appendOPR_VGPR_OR_ACCVGPR(layout.VDST,true,true,32);
                appendOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,true,false);
                appendOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,true,false);
                appendOPR_SRC_VGPR(layout.SRC2,true,false,32);
                break;
                case 108:
