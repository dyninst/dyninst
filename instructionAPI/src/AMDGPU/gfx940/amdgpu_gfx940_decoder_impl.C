...
namespace Dyninst {
    namespace InstructionAPI {
        ...
        void InstructionDecoder_amdgpu_gfx940::decodeENC_VINTRP(){
            ...
            const amdgpu_gfx940_insn_entry &insn_entry = ENC_VINTRP_insn_table[layout.OP];
            this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
        ...
        void InstructionDecoder_amdgpu_gfx940::decodeENC_MIMG(){
            ...
            const amdgpu_gfx940_insn_entry &insn_entry = ENC_MIMG_insn_table[layout.OP];
            this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
        ...
        void InstructionDecoder_amdgpu_gfx940::mainDecodeOpcode(){
            if(IS_ENC_SOP1(insn_long)){
                ...
                assert(  op_value < sizeof(ENC_SOP1_insn_table) / sizeof(ENC_SOP1_insn_table[0]) && "Opcode over or underflow");
                ...
                assert(  op_value < sizeof(ENC_SOPC_insn_table) / sizeof(ENC_SOPC_insn_table[0]) && "Opcode over or underflow");
                ...
                insn_size = 4;
                uint32_t op_value = longfield<16,22>(insn_long);
                assert(  op_value < sizeof(ENC_SOPP_insn_table) / sizeof(ENC_SOPP_insn_table[0]) && "Opcode over or underflow");
                ...
                assert(  op_value < sizeof(ENC_SOPK_insn_table) / sizeof(ENC_SOPK_insn_table[0]) && "Opcode over or underflow");
                ...
                assert(  op_value < sizeof(ENC_SOP2_insn_table) / sizeof(ENC_SOP2_insn_table[0]) && "Opcode over or underflow");
                ...
                assert(  op_value < sizeof(ENC_SMEM_insn_table) / sizeof(ENC_SMEM_insn_table[0]) && "Opcode over or underflow");
                ...
                assert(  op_value < sizeof(ENC_VOP1_insn_table) / sizeof(ENC_VOP1_insn_table[0]) && "Opcode over or underflow");
                ...
                assert(  op_value < sizeof(ENC_VOPC_insn_table) / sizeof(ENC_VOPC_insn_table[0]) && "Opcode over or underflow");
                ...
                assert(  op_value < sizeof(ENC_VOP2_insn_table) / sizeof(ENC_VOP2_insn_table[0]) && "Opcode over or underflow");
                ...
                assert(  op_value < sizeof(ENC_VINTRP_insn_table) / sizeof(ENC_VINTRP_insn_table[0]) && "Opcode over or underflow");
                const amdgpu_gfx940_insn_entry &insn_entry = ENC_VINTRP_insn_table[op];
                this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
                ...
                insn_size = 8;
                uint32_t op_value = longfield<16,22>(insn_long);
                assert(  op_value < sizeof(ENC_VOP3P_insn_table) / sizeof(ENC_VOP3P_insn_table[0]) && "Opcode over or underflow");
                ...
                assert(  op_value < sizeof(ENC_VOP3_insn_table) / sizeof(ENC_VOP3_insn_table[0]) && "Opcode over or underflow");
                ...
                insn_size = 8;
                uint32_t op_value = longfield<17,24>(insn_long);
                assert(  op_value < sizeof(ENC_DS_insn_table) / sizeof(ENC_DS_insn_table[0]) && "Opcode over or underflow");
                ...
                assert(  op_value < sizeof(ENC_MUBUF_insn_table) / sizeof(ENC_MUBUF_insn_table[0]) && "Opcode over or underflow");
                ...
                assert(  op_value < sizeof(ENC_MTBUF_insn_table) / sizeof(ENC_MTBUF_insn_table[0]) && "Opcode over or underflow");
                ...
                insn_size = 8;
                uint32_t op_value = longfield<18,24>(insn_long);
                assert(  op_value < sizeof(ENC_MIMG_insn_table) / sizeof(ENC_MIMG_insn_table[0]) && "Opcode over or underflow");
                const amdgpu_gfx940_insn_entry &insn_entry = ENC_MIMG_insn_table[op];
                this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
                ...
                insn_size = 8;
                uint32_t op_value = longfield<18,24>(insn_long);
                assert(  op_value < sizeof(ENC_FLAT_insn_table) / sizeof(ENC_FLAT_insn_table[0]) && "Opcode over or underflow");
                ...
                insn_size = 8;
                uint32_t op_value = longfield<18,24>(insn_long);
                assert(  op_value < sizeof(ENC_FLAT_GLBL_insn_table) / sizeof(ENC_FLAT_GLBL_insn_table[0]) && "Opcode over or underflow");
                ...
                insn_size = 8;
                uint32_t op_value = longfield<18,24>(insn_long);
                assert(  op_value < sizeof(ENC_FLAT_SCRATCH_insn_table) / sizeof(ENC_FLAT_SCRATCH_insn_table[0]) && "Opcode over or underflow");
                ...
                insn_size = 8;
                uint32_t op_value = longfield<23,27>(insn_long);
                assert(  op_value < sizeof(SOPK_INST_LITERAL__insn_table) / sizeof(SOPK_INST_LITERAL__insn_table[0]) && "Opcode over or underflow");
                const amdgpu_gfx940_insn_entry &insn_entry = SOPK_INST_LITERAL__insn_table[op];
                this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
                ...
                insn_size = 8;
                uint32_t op_value = longfield<25,30>(insn_long);
                assert(  op_value < sizeof(ENC_VOP2_LITERAL_insn_table) / sizeof(ENC_VOP2_LITERAL_insn_table[0]) && "Opcode over or underflow");
                const amdgpu_gfx940_insn_entry &insn_entry = ENC_VOP2_LITERAL_insn_table[op];
                this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
                ...
                insn_size = 8;
                uint32_t op_value = longfield<16,25>(insn_long);
                assert(  op_value < sizeof(ENC_VOP3B_insn_table) / sizeof(ENC_VOP3B_insn_table[0]) && "Opcode over or underflow");
                const amdgpu_gfx940_insn_entry &insn_entry = ENC_VOP3B_insn_table[op];
                this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
                ...
                insn_size = 8;
                uint32_t op_value = longfield<16,22>(insn_long);
                assert(  op_value < sizeof(ENC_VOP3P_MFMA_insn_table) / sizeof(ENC_VOP3P_MFMA_insn_table[0]) && "Opcode over or underflow");
                const amdgpu_gfx940_insn_entry &insn_entry = ENC_VOP3P_MFMA_insn_table[op];
                this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
