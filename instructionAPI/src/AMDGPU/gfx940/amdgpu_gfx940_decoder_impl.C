...
bool InstructionDecoder_amdgpu_gfx940::IS_ENC_VINTRP(uint64_t I){
	switch( I & 0xfc000000 ){
	default:
		return false;
	}
...
bool InstructionDecoder_amdgpu_gfx940::IS_ENC_MIMG(uint64_t I){
	switch( I & 0xfc000000 ){
	default:
		return false;
	}
...
bool InstructionDecoder_amdgpu_gfx940::IS_SOPK_INST_LITERAL_(uint64_t I){
	switch( I & 0xff800000 ){
	case 0xba000000:
		return true;
	default:
...
bool InstructionDecoder_amdgpu_gfx940::IS_ENC_VOP2_LITERAL(uint64_t I){
	switch( I & 0xfe000000 ){
...
bool InstructionDecoder_amdgpu_gfx940::IS_ENC_VOP3B(uint64_t I){
	switch( I & 0xffff0000 ){
...
bool InstructionDecoder_amdgpu_gfx940::IS_ENC_VOP3P_MFMA(uint64_t I){
	switch( I & 0xffff0000 ){
...
void InstructionDecoder_amdgpu_gfx940::decodeENC_SOP1(){
	...
	assert(isArrayIndexValid(amdgpu_gfx940_insn_entry::ENC_SOP1_insn_table, layout.OP) && "Opcode over or underflow");
	const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_SOP1_insn_table[layout.OP];
...
void InstructionDecoder_amdgpu_gfx940::decodeENC_SOPC(){
	...
	assert(isArrayIndexValid(amdgpu_gfx940_insn_entry::ENC_SOPC_insn_table, layout.OP) && "Opcode over or underflow");
	const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_SOPC_insn_table[layout.OP];
	this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
...
void InstructionDecoder_amdgpu_gfx940::decodeENC_SOPP(){
	...
	assert(isArrayIndexValid(amdgpu_gfx940_insn_entry::ENC_SOPP_insn_table, layout.OP) && "Opcode over or underflow");
	const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_SOPP_insn_table[layout.OP];
	this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
...
void InstructionDecoder_amdgpu_gfx940::decodeENC_SOPK(){
	...
	layout.SDST = longfield<16,22>(insn_long);
	layout.SIMM16 = longfield<0,15>(insn_long);
	assert(isArrayIndexValid(amdgpu_gfx940_insn_entry::ENC_SOPK_insn_table, layout.OP) && "Opcode over or underflow");
	const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_SOPK_insn_table[layout.OP];
	this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
...
void InstructionDecoder_amdgpu_gfx940::decodeENC_SOP2(){
	...
	layout.SSRC0 = longfield<0,7>(insn_long);
	layout.SSRC1 = longfield<8,15>(insn_long);
	assert(isArrayIndexValid(amdgpu_gfx940_insn_entry::ENC_SOP2_insn_table, layout.OP) && "Opcode over or underflow");
	const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_SOP2_insn_table[layout.OP];
	this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
...
void InstructionDecoder_amdgpu_gfx940::decodeENC_SMEM(){
	...
	assert(isArrayIndexValid(amdgpu_gfx940_insn_entry::ENC_SMEM_insn_table, layout.OP) && "Opcode over or underflow");
	const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_SMEM_insn_table[layout.OP];
	this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
...
void InstructionDecoder_amdgpu_gfx940::decodeENC_VOP1(){
	...
	assert(isArrayIndexValid(amdgpu_gfx940_insn_entry::ENC_VOP1_insn_table, layout.OP) && "Opcode over or underflow");
	const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_VOP1_insn_table[layout.OP];
	this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
...
void InstructionDecoder_amdgpu_gfx940::decodeENC_VOPC(){
	...
	assert(isArrayIndexValid(amdgpu_gfx940_insn_entry::ENC_VOPC_insn_table, layout.OP) && "Opcode over or underflow");
	const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_VOPC_insn_table[layout.OP];
	this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
...
void InstructionDecoder_amdgpu_gfx940::decodeENC_VOP2(){
	...
	layout.VDST = longfield<17,24>(insn_long);
	layout.VSRC1 = longfield<9,16>(insn_long);
	assert(isArrayIndexValid(amdgpu_gfx940_insn_entry::ENC_VOP2_insn_table, layout.OP) && "Opcode over or underflow");
	const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_VOP2_insn_table[layout.OP];
	this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
	finalizeENC_VOP2Operands();
	this->insn_in_progress->updateSize(insn_size + immLen);
	this->insn_in_progress->updateMnemonic(std::string(insn_entry.mnemonic) + extension);
}
void InstructionDecoder_amdgpu_gfx940::decodeENC_VINTRP(){
	insn_size = 4;
	...
	assert(isArrayIndexValid(amdgpu_gfx940_insn_entry::ENC_VINTRP_insn_table, layout.OP) && "Opcode over or underflow");
	const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_VINTRP_insn_table[layout.OP];
	this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
...
void InstructionDecoder_amdgpu_gfx940::decodeENC_VOP3P(){
	...
	assert(isArrayIndexValid(amdgpu_gfx940_insn_entry::ENC_VOP3P_insn_table, layout.OP) && "Opcode over or underflow");
	const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_VOP3P_insn_table[layout.OP];
	this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
...
void InstructionDecoder_amdgpu_gfx940::decodeENC_VOP3(){
	...
	layout.SRC2 = longfield<50,58>(insn_long);
	layout.VDST = longfield<0,7>(insn_long);
	assert(isArrayIndexValid(amdgpu_gfx940_insn_entry::ENC_VOP3_insn_table, layout.OP) && "Opcode over or underflow");
	const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_VOP3_insn_table[layout.OP];
	this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
...
void InstructionDecoder_amdgpu_gfx940::decodeENC_DS(){
	...
	assert(isArrayIndexValid(amdgpu_gfx940_insn_entry::ENC_DS_insn_table, layout.OP) && "Opcode over or underflow");
	const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_DS_insn_table[layout.OP];
	this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
...
void InstructionDecoder_amdgpu_gfx940::decodeENC_MUBUF(){
	...
	assert(isArrayIndexValid(amdgpu_gfx940_insn_entry::ENC_MUBUF_insn_table, layout.OP) && "Opcode over or underflow");
	const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_MUBUF_insn_table[layout.OP];
	this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
...
void InstructionDecoder_amdgpu_gfx940::decodeENC_MTBUF(){
	...
	layout.VADDR = longfield<32,39>(insn_long);
	layout.VDATA = longfield<40,47>(insn_long);
	assert(isArrayIndexValid(amdgpu_gfx940_insn_entry::ENC_MTBUF_insn_table, layout.OP) && "Opcode over or underflow");
	const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_MTBUF_insn_table[layout.OP];
	this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
	finalizeENC_MTBUFOperands();
	this->insn_in_progress->updateSize(insn_size + immLen);
	this->insn_in_progress->updateMnemonic(std::string(insn_entry.mnemonic) + extension);
}
void InstructionDecoder_amdgpu_gfx940::decodeENC_MIMG(){
	insn_size = 8;
	...
	layout.VADDR = longfield<32,39>(insn_long);
	layout.VDATA = longfield<40,47>(insn_long);
	assert(isArrayIndexValid(amdgpu_gfx940_insn_entry::ENC_MIMG_insn_table, layout.OP) && "Opcode over or underflow");
	const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_MIMG_insn_table[layout.OP];
	this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
...
void InstructionDecoder_amdgpu_gfx940::decodeENC_FLAT(){
	...
	layout.VDST = longfield<56,63>(insn_long);
	assert(isArrayIndexValid(amdgpu_gfx940_insn_entry::ENC_FLAT_insn_table, layout.OP) && "Opcode over or underflow");
	const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_FLAT_insn_table[layout.OP];
	this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
...
void InstructionDecoder_amdgpu_gfx940::decodeENC_FLAT_GLBL(){
	...
	layout.SVE = longfield<13,13>(insn_long);
	layout.VDST = longfield<56,63>(insn_long);
	assert(isArrayIndexValid(amdgpu_gfx940_insn_entry::ENC_FLAT_GLBL_insn_table, layout.OP) && "Opcode over or underflow");
	const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_FLAT_GLBL_insn_table[layout.OP];
	this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
...
void InstructionDecoder_amdgpu_gfx940::decodeENC_FLAT_SCRATCH(){
	...
	layout.SVE = longfield<13,13>(insn_long);
	layout.VDST = longfield<56,63>(insn_long);
	assert(isArrayIndexValid(amdgpu_gfx940_insn_entry::ENC_FLAT_SCRATCH_insn_table, layout.OP) && "Opcode over or underflow");
	const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_FLAT_SCRATCH_insn_table[layout.OP];
	this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
	finalizeENC_FLAT_SCRATCHOperands();
	this->insn_in_progress->updateSize(insn_size + immLen);
	this->insn_in_progress->updateMnemonic(std::string(insn_entry.mnemonic) + extension);
}
void InstructionDecoder_amdgpu_gfx940::decodeSOPK_INST_LITERAL_(){
	insn_size = 8;
	...
	assert(isArrayIndexValid(amdgpu_gfx940_insn_entry::SOPK_INST_LITERAL__insn_table, layout.OP) && "Opcode over or underflow");
	const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::SOPK_INST_LITERAL__insn_table[layout.OP];
	this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
	finalizeSOPK_INST_LITERAL_Operands();
	this->insn_in_progress->updateSize(insn_size + immLen);
	this->insn_in_progress->updateMnemonic(std::string(insn_entry.mnemonic) + extension);
}
void InstructionDecoder_amdgpu_gfx940::decodeENC_VOP2_LITERAL(){
	insn_size = 8;
	...
	layout.VDST = longfield<17,24>(insn_long);
	layout.VSRC1 = longfield<9,16>(insn_long);
	assert(isArrayIndexValid(amdgpu_gfx940_insn_entry::ENC_VOP2_LITERAL_insn_table, layout.OP) && "Opcode over or underflow");
	const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_VOP2_LITERAL_insn_table[layout.OP];
	this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
	finalizeENC_VOP2_LITERALOperands();
	this->insn_in_progress->updateSize(insn_size + immLen);
	this->insn_in_progress->updateMnemonic(std::string(insn_entry.mnemonic) + extension);
}
void InstructionDecoder_amdgpu_gfx940::decodeENC_VOP3B(){
	insn_size = 8;
	...
	layout.SRC2 = longfield<50,58>(insn_long);
	layout.VDST = longfield<0,7>(insn_long);
	assert(isArrayIndexValid(amdgpu_gfx940_insn_entry::ENC_VOP3B_insn_table, layout.OP) && "Opcode over or underflow");
	const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_VOP3B_insn_table[layout.OP];
	this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
	finalizeENC_VOP3BOperands();
	this->insn_in_progress->updateSize(insn_size + immLen);
	this->insn_in_progress->updateMnemonic(std::string(insn_entry.mnemonic) + extension);
}
void InstructionDecoder_amdgpu_gfx940::decodeENC_VOP3P_MFMA(){
	insn_size = 8;
	...
	layout.SRC2 = longfield<50,58>(insn_long);
	layout.VDST = longfield<0,7>(insn_long);
	assert(isArrayIndexValid(amdgpu_gfx940_insn_entry::ENC_VOP3P_MFMA_insn_table, layout.OP) && "Opcode over or underflow");
	const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_VOP3P_MFMA_insn_table[layout.OP];
	this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
...
void InstructionDecoder_amdgpu_gfx940::mainDecodeOpcode(){
	if(IS_ENC_SOP1(insn_long)){
		...
		assert(  op_value < sizeof(amdgpu_gfx940_insn_entry::ENC_SOP1_insn_table) / sizeof(amdgpu_gfx940_insn_entry::ENC_SOP1_insn_table[0]) && "Opcode over or underflow");
		const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_SOP1_insn_table[op];
		this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
		...
		assert(  op_value < sizeof(amdgpu_gfx940_insn_entry::ENC_SOPC_insn_table) / sizeof(amdgpu_gfx940_insn_entry::ENC_SOPC_insn_table[0]) && "Opcode over or underflow");
		const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_SOPC_insn_table[op];
		this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
		...
		insn_size = 4;
		uint32_t op_value = longfield<16,22>(insn_long);
		assert(  op_value < sizeof(amdgpu_gfx940_insn_entry::ENC_SOPP_insn_table) / sizeof(amdgpu_gfx940_insn_entry::ENC_SOPP_insn_table[0]) && "Opcode over or underflow");
		const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_SOPP_insn_table[op];
		this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
		...
		assert(  op_value < sizeof(amdgpu_gfx940_insn_entry::ENC_SOPK_insn_table) / sizeof(amdgpu_gfx940_insn_entry::ENC_SOPK_insn_table[0]) && "Opcode over or underflow");
		const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_SOPK_insn_table[op];
		this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
		...
		assert(  op_value < sizeof(amdgpu_gfx940_insn_entry::ENC_SOP2_insn_table) / sizeof(amdgpu_gfx940_insn_entry::ENC_SOP2_insn_table[0]) && "Opcode over or underflow");
		const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_SOP2_insn_table[op];
		this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
		...
		assert(  op_value < sizeof(amdgpu_gfx940_insn_entry::ENC_SMEM_insn_table) / sizeof(amdgpu_gfx940_insn_entry::ENC_SMEM_insn_table[0]) && "Opcode over or underflow");
		const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_SMEM_insn_table[op];
		this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
		...
		assert(  op_value < sizeof(amdgpu_gfx940_insn_entry::ENC_VOP1_insn_table) / sizeof(amdgpu_gfx940_insn_entry::ENC_VOP1_insn_table[0]) && "Opcode over or underflow");
		const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_VOP1_insn_table[op];
		this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
		...
		assert(  op_value < sizeof(amdgpu_gfx940_insn_entry::ENC_VOPC_insn_table) / sizeof(amdgpu_gfx940_insn_entry::ENC_VOPC_insn_table[0]) && "Opcode over or underflow");
		const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_VOPC_insn_table[op];
		this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
		...
		assert(  op_value < sizeof(amdgpu_gfx940_insn_entry::ENC_VOP2_insn_table) / sizeof(amdgpu_gfx940_insn_entry::ENC_VOP2_insn_table[0]) && "Opcode over or underflow");
		const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_VOP2_insn_table[op];
		this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
		...
		assert(  op_value < sizeof(amdgpu_gfx940_insn_entry::ENC_VINTRP_insn_table) / sizeof(amdgpu_gfx940_insn_entry::ENC_VINTRP_insn_table[0]) && "Opcode over or underflow");
		const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_VINTRP_insn_table[op];
		this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
		...
		insn_size = 8;
		uint32_t op_value = longfield<16,22>(insn_long);
		assert(  op_value < sizeof(amdgpu_gfx940_insn_entry::ENC_VOP3P_insn_table) / sizeof(amdgpu_gfx940_insn_entry::ENC_VOP3P_insn_table[0]) && "Opcode over or underflow");
		const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_VOP3P_insn_table[op];
		this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
		...
		assert(  op_value < sizeof(amdgpu_gfx940_insn_entry::ENC_VOP3_insn_table) / sizeof(amdgpu_gfx940_insn_entry::ENC_VOP3_insn_table[0]) && "Opcode over or underflow");
		const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_VOP3_insn_table[op];
		this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
		...
		insn_size = 8;
		uint32_t op_value = longfield<17,24>(insn_long);
		assert(  op_value < sizeof(amdgpu_gfx940_insn_entry::ENC_DS_insn_table) / sizeof(amdgpu_gfx940_insn_entry::ENC_DS_insn_table[0]) && "Opcode over or underflow");
		const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_DS_insn_table[op];
		this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
		instr_family = ENC_DS;
	}
		...
		assert(  op_value < sizeof(amdgpu_gfx940_insn_entry::ENC_MUBUF_insn_table) / sizeof(amdgpu_gfx940_insn_entry::ENC_MUBUF_insn_table[0]) && "Opcode over or underflow");
		const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_MUBUF_insn_table[op];
		this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
		...
		assert(  op_value < sizeof(amdgpu_gfx940_insn_entry::ENC_MTBUF_insn_table) / sizeof(amdgpu_gfx940_insn_entry::ENC_MTBUF_insn_table[0]) && "Opcode over or underflow");
		const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_MTBUF_insn_table[op];
		this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
		...
		insn_size = 8;
		uint32_t op_value = longfield<18,24>(insn_long);
		assert(  op_value < sizeof(amdgpu_gfx940_insn_entry::ENC_MIMG_insn_table) / sizeof(amdgpu_gfx940_insn_entry::ENC_MIMG_insn_table[0]) && "Opcode over or underflow");
		const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_MIMG_insn_table[op];
		this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
		...
		insn_size = 8;
		uint32_t op_value = longfield<18,24>(insn_long);
		assert(  op_value < sizeof(amdgpu_gfx940_insn_entry::ENC_FLAT_insn_table) / sizeof(amdgpu_gfx940_insn_entry::ENC_FLAT_insn_table[0]) && "Opcode over or underflow");
		const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_FLAT_insn_table[op];
		this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
		...
		insn_size = 8;
		uint32_t op_value = longfield<18,24>(insn_long);
		assert(  op_value < sizeof(amdgpu_gfx940_insn_entry::ENC_FLAT_GLBL_insn_table) / sizeof(amdgpu_gfx940_insn_entry::ENC_FLAT_GLBL_insn_table[0]) && "Opcode over or underflow");
		const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_FLAT_GLBL_insn_table[op];
		this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
		...
		insn_size = 8;
		uint32_t op_value = longfield<18,24>(insn_long);
		assert(  op_value < sizeof(amdgpu_gfx940_insn_entry::ENC_FLAT_SCRATCH_insn_table) / sizeof(amdgpu_gfx940_insn_entry::ENC_FLAT_SCRATCH_insn_table[0]) && "Opcode over or underflow");
		const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_FLAT_SCRATCH_insn_table[op];
		this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
		...
		insn_size = 8;
		uint32_t op_value = longfield<23,27>(insn_long);
		assert(  op_value < sizeof(amdgpu_gfx940_insn_entry::SOPK_INST_LITERAL__insn_table) / sizeof(amdgpu_gfx940_insn_entry::SOPK_INST_LITERAL__insn_table[0]) && "Opcode over or underflow");
		const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::SOPK_INST_LITERAL__insn_table[op];
		this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
		...
		insn_size = 8;
		uint32_t op_value = longfield<25,30>(insn_long);
		assert(  op_value < sizeof(amdgpu_gfx940_insn_entry::ENC_VOP2_LITERAL_insn_table) / sizeof(amdgpu_gfx940_insn_entry::ENC_VOP2_LITERAL_insn_table[0]) && "Opcode over or underflow");
		const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_VOP2_LITERAL_insn_table[op];
		this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
		...
		insn_size = 8;
		uint32_t op_value = longfield<16,25>(insn_long);
		assert(  op_value < sizeof(amdgpu_gfx940_insn_entry::ENC_VOP3B_insn_table) / sizeof(amdgpu_gfx940_insn_entry::ENC_VOP3B_insn_table[0]) && "Opcode over or underflow");
		const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_VOP3B_insn_table[op];
		this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
		...
		insn_size = 8;
		uint32_t op_value = longfield<16,22>(insn_long);
		assert(  op_value < sizeof(amdgpu_gfx940_insn_entry::ENC_VOP3P_MFMA_insn_table) / sizeof(amdgpu_gfx940_insn_entry::ENC_VOP3P_MFMA_insn_table[0]) && "Opcode over or underflow");
		const amdgpu_gfx940_insn_entry &insn_entry = amdgpu_gfx940_insn_entry::ENC_VOP3P_MFMA_insn_table[op];
		this->insn_in_progress = makeInstruction(insn_entry.op,insn_entry.mnemonic,insn_size+immLen,reinterpret_cast<unsigned char *>(&insn));
