...
#define insn_printf(format, ...) \
        ...
        class InstructionDecoder_amdgpu_gfx940 : public InstructionDecoderImpl {
            ...
            static bool IS_SOP1_INST_LITERAL(uint64_t I);
            static bool IS_SOP2_INST_LITERAL(uint64_t I);
            static bool IS_SOPC_INST_LITERAL(uint64_t I);
            static bool IS_SOPK_INST_LITERAL(uint64_t I);
            static bool IS_VOP1_INST_LITERAL(uint64_t I);
            static bool IS_VOP1_VOP_DPP(uint64_t I);
            static bool IS_VOP1_VOP_SDWA(uint64_t I);
            static bool IS_VOP2_INST_LITERAL(uint64_t I);
            static bool IS_VOP2_VOP_DPP(uint64_t I);
            static bool IS_VOP2_VOP_SDWA(uint64_t I);
            static bool IS_VOP2_VOP_SDWA_SDST_ENC(uint64_t I);
            static bool IS_VOP3_SDST_ENC(uint64_t I);
            static bool IS_VOP3P_MFMA(uint64_t I);
            static bool IS_VOPC_INST_LITERAL(uint64_t I);
            static bool IS_VOPC_VOP_SDWA_SDST_ENC(uint64_t I);
            bool COND_ENC_SOP1_default(uint64_t I);
            bool COND_ENC_SOPC_default(uint64_t I);
            bool COND_ENC_SOP2_default(uint64_t I);
            bool COND_ENC_VOP1_default(uint64_t I);
            bool COND_ENC_VOPC_default(uint64_t I);
            bool COND_ENC_VOP2_default(uint64_t I);
            bool COND_SOP1_INST_LITERAL_has_lit_0(uint64_t I);
            bool COND_SOP2_INST_LITERAL_has_lit_0(uint64_t I);
            bool COND_SOP2_INST_LITERAL_has_lit_1(uint64_t I);
            bool COND_SOP2_INST_LITERAL_has_lit_0_has_lit_1(uint64_t I);
            bool COND_SOPC_INST_LITERAL_has_lit_0(uint64_t I);
            bool COND_SOPC_INST_LITERAL_has_lit_1(uint64_t I);
            bool COND_SOPC_INST_LITERAL_has_lit_0_has_lit_1(uint64_t I);
            bool COND_VOP1_INST_LITERAL_has_lit(uint64_t I);
            bool COND_VOP1_VOP_DPP_has_dpp(uint64_t I);
            bool COND_VOP1_VOP_SDWA_has_sdwa(uint64_t I);
            bool COND_VOP2_INST_LITERAL_has_lit(uint64_t I);
            bool COND_VOP2_INST_LITERAL_default(uint64_t I);
            bool COND_VOP2_VOP_DPP_has_dpp(uint64_t I);
            bool COND_VOP2_VOP_SDWA_has_sdwa(uint64_t I);
            bool COND_VOP2_VOP_SDWA_SDST_ENC_has_sdwa(uint64_t I);
            bool COND_VOPC_INST_LITERAL_has_lit(uint64_t I);
            bool COND_VOPC_VOP_SDWA_SDST_ENC_has_sdwa(uint64_t I);
            enum InstructionFamily
            {
                ...
                ENC_FLAT_GLBL = 17,
                ENC_FLAT_SCRATCH = 18,
                SOP1_INST_LITERAL = 19,
                SOP2_INST_LITERAL = 20,
                SOPC_INST_LITERAL = 21,
                SOPK_INST_LITERAL = 22,
                VOP1_INST_LITERAL = 23,
                VOP1_VOP_DPP = 24,
                VOP1_VOP_SDWA = 25,
                VOP2_INST_LITERAL = 26,
                VOP2_VOP_DPP = 27,
                VOP2_VOP_SDWA = 28,
                VOP2_VOP_SDWA_SDST_ENC = 29,
                VOP3_SDST_ENC = 30,
                VOP3P_MFMA = 31,
                VOPC_INST_LITERAL = 32,
                VOPC_VOP_SDWA_SDST_ENC = 33,
            };
            ...
            struct layout_SOP1_INST_LITERAL {
                uint16_t ENCODING : 9;
                uint32_t LITERAL : 32;
                uint8_t OP : 8;
                uint8_t SDST : 7;
            ...
            struct layout_SOP2_INST_LITERAL {
                uint8_t ENCODING : 2;
                uint32_t LITERAL : 32;
                uint8_t OP : 7;
                uint8_t SDST : 7;
            ...
            struct layout_SOPC_INST_LITERAL {
                uint16_t ENCODING : 9;
                uint32_t LITERAL : 32;
                uint8_t OP : 7;
                uint8_t SSRC0 : 8;
            ...
            struct layout_SOPK_INST_LITERAL {
                uint8_t ENCODING : 4;
                uint32_t LITERAL : 32;
                uint8_t OP : 5;
                uint8_t SDST : 7;
            ...
            struct layout_VOP1_INST_LITERAL {
                uint8_t ENCODING : 7;
                uint32_t LITERAL : 32;
                uint8_t OP : 8;
                uint16_t SRC0 : 9;
            ...
            struct layout_VOP1_VOP_DPP {
                uint8_t BANK_MASK : 4;
                uint8_t BOUND_CTRL : 1;
                uint16_t DPP_CTRL : 9;
                uint8_t ENCODING : 7;
                uint8_t OP : 8;
                uint8_t ROW_MASK : 4;
            ...
            struct layout_VOP1_VOP_SDWA {
                uint8_t CLAMP : 1;
                uint8_t DST_SEL : 3;
                uint8_t DST_UNUSED : 2;
                uint8_t ENCODING : 7;
                uint8_t OMOD : 2;
                uint8_t OP : 8;
                uint8_t S0 : 1;
            ...
            struct layout_VOP2_INST_LITERAL {
                uint8_t ENCODING : 1;
                uint32_t LITERAL : 32;
                uint8_t OP : 6;
                uint16_t SRC0 : 9;
            ...
            struct layout_VOP2_VOP_SDWA_SDST_ENC {
                uint8_t ENCODING : 1;
                uint8_t OP : 6;
                uint8_t S0 : 1;
                uint8_t S1 : 1;
            ...
            struct layout_VOPC_INST_LITERAL {
                uint8_t ENCODING : 7;
                uint32_t LITERAL : 32;
                uint8_t OP : 8;
                uint16_t SRC0 : 9;
            ...
            struct layout_VOPC_VOP_SDWA_SDST_ENC {
                uint8_t ENCODING : 7;
                uint8_t OP : 8;
                uint8_t S0 : 1;
                uint8_t S1 : 1;
            ...
            union insn_layout{
                ...
                layout_SOP1_INST_LITERAL SOP1_INST_LITERAL;
                layout_SOP2_INST_LITERAL SOP2_INST_LITERAL;
                layout_SOPC_INST_LITERAL SOPC_INST_LITERAL;
                layout_SOPK_INST_LITERAL SOPK_INST_LITERAL;
                layout_VOP1_INST_LITERAL VOP1_INST_LITERAL;
                layout_VOP1_VOP_DPP VOP1_VOP_DPP;
                layout_VOP1_VOP_SDWA VOP1_VOP_SDWA;
                layout_VOP2_INST_LITERAL VOP2_INST_LITERAL;
                layout_VOP2_VOP_DPP VOP2_VOP_DPP;
                layout_VOP2_VOP_SDWA VOP2_VOP_SDWA;
                layout_VOP2_VOP_SDWA_SDST_ENC VOP2_VOP_SDWA_SDST_ENC;
                layout_VOP3_SDST_ENC VOP3_SDST_ENC;
                layout_VOP3P_MFMA VOP3P_MFMA;
                layout_VOPC_INST_LITERAL VOPC_INST_LITERAL;
                layout_VOPC_VOP_SDWA_SDST_ENC VOPC_VOP_SDWA_SDST_ENC;
            }insn_layout;
            void decodeENC_SOP1();
            ...
            void decodeSOP1_INST_LITERAL();
            void finalizeSOP1_INST_LITERALOperands();
            void decodeSOP2_INST_LITERAL();
            void finalizeSOP2_INST_LITERALOperands();
            void decodeSOPC_INST_LITERAL();
            void finalizeSOPC_INST_LITERALOperands();
            void decodeSOPK_INST_LITERAL();
            void finalizeSOPK_INST_LITERALOperands();
            void decodeVOP1_INST_LITERAL();
            void finalizeVOP1_INST_LITERALOperands();
            void decodeVOP1_VOP_DPP();
            void finalizeVOP1_VOP_DPPOperands();
            void decodeVOP1_VOP_SDWA();
            void finalizeVOP1_VOP_SDWAOperands();
            void decodeVOP2_INST_LITERAL();
            void finalizeVOP2_INST_LITERALOperands();
            void decodeVOP2_VOP_DPP();
            void finalizeVOP2_VOP_DPPOperands();
            void decodeVOP2_VOP_SDWA();
            void finalizeVOP2_VOP_SDWAOperands();
            void decodeVOP2_VOP_SDWA_SDST_ENC();
            void finalizeVOP2_VOP_SDWA_SDST_ENCOperands();
            void decodeVOP3_SDST_ENC();
            void finalizeVOP3_SDST_ENCOperands();
            void decodeVOP3P_MFMA();
            void finalizeVOP3P_MFMAOperands();
            void decodeVOPC_INST_LITERAL();
            ...
            Expression::Ptr decodeOPR_GPUMEM(uint64_t input, uint32_t output_vec_len = 1 );
            ...
            void appendOPR_GPUMEM(uint64_t input, bool isRead, bool isWritten, uint32_t _num_elements = 1, bool isImplicit = false);
            ...
            const amdgpu_gfx940_insn_entry ENC_DS_insn_table[256] =
            {
                ...
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 22
                {amdgpu_gfx940_op_DS_PK_ADD_F16,"DS_PK_ADD_F16"}, // 23
                {amdgpu_gfx940_op_DS_PK_ADD_BF16,"DS_PK_ADD_BF16"}, // 24
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 25
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 26
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 27
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 28
                ...
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 93
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 94
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 95
                ...
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 116
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 117
                ...
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 121
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 122
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 123
                {amdgpu_gfx940_op_DS_ADD_RTN_F64,"DS_ADD_RTN_F64"}, // 124
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 125
                {amdgpu_gfx940_op_DS_CONDXCHG32_RTN_B64,"DS_CONDXCHG32_RTN_B64"}, // 126
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 127
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 128
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 129
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 130
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 131
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 132
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 133
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 134
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 135
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 136
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 137
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 138
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 139
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 140
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 141
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 142
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 143
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 144
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 145
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 146
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 147
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 148
                {amdgpu_gfx940_op_INVALID,"INVALID"}, //
            const amdgpu_gfx940_insn_entry SOPC_INST_LITERAL_insn_table[20] =
            {
                {amdgpu_gfx940_op_S_CMP_EQ_I32,"S_CMP_EQ_I32"}, // 0
                {amdgpu_gfx940_op_S_CMP_LG_I32,"S_CMP_LG_I32"}, // 1
                {amdgpu_gfx940_op_S_CMP_GT_I32,"S_CMP_GT_I32"}, // 2
            ...
            const amdgpu_gfx940_insn_entry SOPK_INST_LITERAL_insn_table[21] =
            {
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 0
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 1
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 2
                ...
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 14
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 15
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 16
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 17
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 18
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 19
                {amdgpu_gfx940_op_S_SETREG_IMM32_B32,"S_SETREG_IMM32_B32"}, // 20
            ...
            const amdgpu_gfx940_insn_entry VOP1_INST_LITERAL_insn_table[88] =
            {
                {amdgpu_gfx940_op_V_NOP,"V_NOP"}, // 0
                {amdgpu_gfx940_op_V_MOV_B32,"V_MOV_B32"}, // 1
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 2
            ...
            const amdgpu_gfx940_insn_entry VOP1_VOP_DPP_insn_table[88] =
            {
                {amdgpu_gfx940_op_V_NOP,"V_NOP"}, // 0
                {amdgpu_gfx940_op_V_MOV_B32,"V_MOV_B32"}, // 1
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 2
                ...
                {amdgpu_gfx940_op_V_RCP_IFLAG_F32,"V_RCP_IFLAG_F32"}, // 35
                {amdgpu_gfx940_op_V_RSQ_F32,"V_RSQ_F32"}, // 36
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 37
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 38
                {amdgpu_gfx940_op_V_SQRT_F32,"V_SQRT_F32"}, // 39
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 40
                {amdgpu_gfx940_op_V_SIN_F32,"V_SIN_F32"}, // 41
            ...
            const amdgpu_gfx940_insn_entry VOP1_VOP_SDWA_insn_table[88] =
            {
                {amdgpu_gfx940_op_V_NOP,"V_NOP"}, // 0
                {amdgpu_gfx940_op_V_MOV_B32,"V_MOV_B32"}, // 1
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 2
                ...
                {amdgpu_gfx940_op_V_CVT_F32_UBYTE2,"V_CVT_F32_UBYTE2"}, // 19
                {amdgpu_gfx940_op_V_CVT_F32_UBYTE3,"V_CVT_F32_UBYTE3"}, // 20
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 21
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 22
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 23
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 24
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 25
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 26
                {amdgpu_gfx940_op_V_FRACT_F32,"V_FRACT_F32"}, // 27
                {amdgpu_gfx940_op_V_TRUNC_F32,"V_TRUNC_F32"}, // 28
            ...
            const amdgpu_gfx940_insn_entry ENC_VOP3_insn_table[678] =
            {
                ...
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 278
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 279
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 280
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 281
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 282
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 283
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 284
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 285
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 286
                ...
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 292
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 293
                ...
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 318
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 319
                ...
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 329
                ...
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 374
                ...
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 408
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 409
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 410
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 411
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 412
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 413
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 414
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 415
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 416
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 417
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 418
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 419
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 420
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 421
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 422
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 423
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 424
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 425
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 426
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 427
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 428
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 429
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 430
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 431
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 432
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 433
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 434
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 435
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 436
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 437
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 438
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 439
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 440
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 441
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 442
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 443
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 444
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 445
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 446
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 447
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 448
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 449
                ...
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 480
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 481
                ...
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 488
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 489
                ...
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 521
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 522
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 523
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 524
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 525
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 526
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 527
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 528
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 529
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 530
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 531
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 532
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 533
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 534
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 535
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 536
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 537
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 538
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 539
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 540
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 541
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 542
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 543
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 544
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 545
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 546
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 547
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 548
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 549
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 550
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 551
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 552
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 553
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 554
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 555
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 556
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 557
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 558
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 559
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 560
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 561
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 562
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 563
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 564
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 565
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 566
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 567
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 568
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 569
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 570
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 571
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 572
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 573
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 574
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 575
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 576
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 577
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 578
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 579
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 580
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 581
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 582
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 583
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 584
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 585
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 586
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 587
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 588
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 589
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 590
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 591
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 592
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 593
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 594
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 595
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 596
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 597
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 598
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 599
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 600
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 601
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 602
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 603
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 604
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 605
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 606
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 607
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 608
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 609
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 610
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 611
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 612
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 613
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 614
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 615
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 616
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 617
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 618
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 619
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 620
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 621
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 622
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 623
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 624
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 625
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 626
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 627
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 628
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 629
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 630
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 631
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 632
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 633
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 634
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 635
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 636
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 637
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 638
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 639
                ...
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 654
                ...
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 667
            ...
            const amdgpu_gfx940_insn_entry ENC_VOP2_insn_table[62] =
            {
                ...
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 36
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 37
            ...
            const amdgpu_gfx940_insn_entry VOP2_INST_LITERAL_insn_table[62] =
            {
                {amdgpu_gfx940_op_V_CNDMASK_B32,"V_CNDMASK_B32"}, // 0
                {amdgpu_gfx940_op_V_ADD_F32,"V_ADD_F32"}, // 1
                {amdgpu_gfx940_op_V_SUB_F32,"V_SUB_F32"}, // 2
            ...
            const amdgpu_gfx940_insn_entry VOP2_VOP_DPP_insn_table[62] =
            {
                {amdgpu_gfx940_op_V_CNDMASK_B32,"V_CNDMASK_B32"}, // 0
                {amdgpu_gfx940_op_V_ADD_F32,"V_ADD_F32"}, // 1
                {amdgpu_gfx940_op_V_SUB_F32,"V_SUB_F32"}, // 2
            ...
            const amdgpu_gfx940_insn_entry VOP2_VOP_SDWA_insn_table[62] =
            {
                {amdgpu_gfx940_op_V_CNDMASK_B32,"V_CNDMASK_B32"}, // 0
                {amdgpu_gfx940_op_V_ADD_F32,"V_ADD_F32"}, // 1
                {amdgpu_gfx940_op_V_SUB_F32,"V_SUB_F32"}, // 2
                ...
                {amdgpu_gfx940_op_V_SUBREV_F16,"V_SUBREV_F16"}, // 33
                {amdgpu_gfx940_op_V_MUL_F16,"V_MUL_F16"}, // 34
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 35
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 36
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 37
                {amdgpu_gfx940_op_V_ADD_U16,"V_ADD_U16"}, // 38
                {amdgpu_gfx940_op_V_SUB_U16,"V_SUB_U16"}, // 39
            ...
            const amdgpu_gfx940_insn_entry VOP2_VOP_SDWA_SDST_ENC_insn_table[31] =
            {
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 0
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 1
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 2
            ...
            const amdgpu_gfx940_insn_entry VOP3_SDST_ENC_insn_table[490] =
            {
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 0
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 1
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 2
                ...
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 30
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 31
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 32
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 33
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 34
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 35
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 36
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 37
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 38
                ...
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 62
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 63
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 64
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 65
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 66
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 67
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 68
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 69
                {amdgpu_gfx940_op_INVALID,"INVALID"}, // 70
                {amdgpu_gfx940_op_INVALID,"INVALID"}, //