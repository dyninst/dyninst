...
Expression::Ptr decodeOPR_PARAM(uint64_t input, uint32_t _num_elements = 1 );
...
Expression::Ptr decodeOPR_SRC_ACCVGPR_OR_CONST(uint64_t input, uint32_t _num_elements = 1 );
...
Expression::Ptr decodeOPR_TGT(uint64_t input, uint32_t _num_elements = 1 );
