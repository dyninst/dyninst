...
void InstructionDecoder_amdgpu_gfx908::decodeENC_SOP1(){
	...
	assert( layout.OP >= 0 && layout.OP < sizeof(amdgpu_gfx908_insn_entry::ENC_SOP1_insn_table) / sizeof(amdgpu_gfx908_insn_entry::ENC_SOP1_insn_table[0]) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx908::decodeENC_SOPC(){
	...
	assert( layout.OP >= 0 && layout.OP < sizeof(amdgpu_gfx908_insn_entry::ENC_SOPC_insn_table) / sizeof(amdgpu_gfx908_insn_entry::ENC_SOPC_insn_table[0]) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx908::decodeENC_SOPP(){
	...
	assert( layout.OP >= 0 && layout.OP < sizeof(amdgpu_gfx908_insn_entry::ENC_SOPP_insn_table) / sizeof(amdgpu_gfx908_insn_entry::ENC_SOPP_insn_table[0]) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx908::decodeENC_SOPK(){
	...
	layout.SDST = longfield<16,22>(insn_long);
	layout.SIMM16 = longfield<0,15>(insn_long);
	assert( layout.OP >= 0 && layout.OP < sizeof(amdgpu_gfx908_insn_entry::ENC_SOPK_insn_table) / sizeof(amdgpu_gfx908_insn_entry::ENC_SOPK_insn_table[0]) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx908::decodeENC_SOP2(){
	...
	layout.SSRC0 = longfield<0,7>(insn_long);
	layout.SSRC1 = longfield<8,15>(insn_long);
	assert( layout.OP >= 0 && layout.OP < sizeof(amdgpu_gfx908_insn_entry::ENC_SOP2_insn_table) / sizeof(amdgpu_gfx908_insn_entry::ENC_SOP2_insn_table[0]) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx908::decodeENC_SMEM(){
	...
	assert( layout.OP >= 0 && layout.OP < sizeof(amdgpu_gfx908_insn_entry::ENC_SMEM_insn_table) / sizeof(amdgpu_gfx908_insn_entry::ENC_SMEM_insn_table[0]) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx908::decodeENC_VOP1(){
	...
	assert( layout.OP >= 0 && layout.OP < sizeof(amdgpu_gfx908_insn_entry::ENC_VOP1_insn_table) / sizeof(amdgpu_gfx908_insn_entry::ENC_VOP1_insn_table[0]) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx908::decodeENC_VOPC(){
	...
	assert( layout.OP >= 0 && layout.OP <= (sizeof(amdgpu_gfx908_insn_entry::ENC_VOPC_insn_table) / sizeof(amdgpu_gfx908_insn_entry::ENC_VOPC_insn_table[0]) - 1) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx908::decodeENC_VOP2(){
	...
	layout.VDST = longfield<17,24>(insn_long);
	layout.VSRC1 = longfield<9,16>(insn_long);
	assert( layout.OP >= 0 && layout.OP < sizeof(amdgpu_gfx908_insn_entry::ENC_VOP2_insn_table) / sizeof(amdgpu_gfx908_insn_entry::ENC_VOP2_insn_table[0]) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx908::decodeENC_VINTRP(){
	...
	assert( layout.OP >= 0 && layout.OP < sizeof(amdgpu_gfx908_insn_entry::ENC_VINTRP_insn_table) / sizeof(amdgpu_gfx908_insn_entry::ENC_VINTRP_insn_table[0]) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx908::decodeENC_VOP3P(){
	...
	assert( layout.OP >= 0 && layout.OP < sizeof(amdgpu_gfx908_insn_entry::ENC_VOP3P_insn_table) / sizeof(amdgpu_gfx908_insn_entry::ENC_VOP3P_insn_table[0]) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx908::decodeENC_VOP3(){
	...
	layout.SRC2 = longfield<50,58>(insn_long);
	layout.VDST = longfield<0,7>(insn_long);
	assert( layout.OP >= 0 && layout.OP < sizeof(amdgpu_gfx908_insn_entry::ENC_VOP3_insn_table) / sizeof(amdgpu_gfx908_insn_entry::ENC_VOP3_insn_table[0]) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx908::decodeENC_DS(){
	...
	assert( layout.OP >= 0 && layout.OP <= (sizeof(amdgpu_gfx908_insn_entry::ENC_DS_insn_table) / sizeof(amdgpu_gfx908_insn_entry::ENC_DS_insn_table[0]) - 1) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx908::decodeENC_MUBUF(){
	...
	assert( layout.OP >= 0 && layout.OP < sizeof(amdgpu_gfx908_insn_entry::ENC_MUBUF_insn_table) / sizeof(amdgpu_gfx908_insn_entry::ENC_MUBUF_insn_table[0]) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx908::decodeENC_MTBUF(){
	...
	layout.VADDR = longfield<32,39>(insn_long);
	layout.VDATA = longfield<40,47>(insn_long);
	assert( layout.OP >= 0 && layout.OP < sizeof(amdgpu_gfx908_insn_entry::ENC_MTBUF_insn_table) / sizeof(amdgpu_gfx908_insn_entry::ENC_MTBUF_insn_table[0]) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx908::decodeENC_MIMG(){
	...
	layout.VADDR = longfield<32,39>(insn_long);
	layout.VDATA = longfield<40,47>(insn_long);
	assert( layout.OP >= 0 && layout.OP < sizeof(amdgpu_gfx908_insn_entry::ENC_MIMG_insn_table) / sizeof(amdgpu_gfx908_insn_entry::ENC_MIMG_insn_table[0]) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx908::decodeENC_FLAT(){
	...
	layout.SLC = longfield<17,17>(insn_long);
	layout.VDST = longfield<56,63>(insn_long);
	assert( layout.OP >= 0 && layout.OP < sizeof(amdgpu_gfx908_insn_entry::ENC_FLAT_insn_table) / sizeof(amdgpu_gfx908_insn_entry::ENC_FLAT_insn_table[0]) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx908::decodeENC_FLAT_GLBL(){
	...
	layout.SLC = longfield<17,17>(insn_long);
	layout.VDST = longfield<56,63>(insn_long);
	assert( layout.OP >= 0 && layout.OP < sizeof(amdgpu_gfx908_insn_entry::ENC_FLAT_GLBL_insn_table) / sizeof(amdgpu_gfx908_insn_entry::ENC_FLAT_GLBL_insn_table[0]) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx908::decodeENC_FLAT_SCRATCH(){
	...
	layout.SLC = longfield<17,17>(insn_long);
	layout.VDST = longfield<56,63>(insn_long);
	assert( layout.OP >= 0 && layout.OP < sizeof(amdgpu_gfx908_insn_entry::ENC_FLAT_SCRATCH_insn_table) / sizeof(amdgpu_gfx908_insn_entry::ENC_FLAT_SCRATCH_insn_table[0]) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx908::decodeSOPK_INST_LITERAL_(){
	...
	assert( layout.OP >= 0 && layout.OP < sizeof(amdgpu_gfx908_insn_entry::SOPK_INST_LITERAL__insn_table) / sizeof(amdgpu_gfx908_insn_entry::SOPK_INST_LITERAL__insn_table[0]) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx908::decodeENC_VOP2_LITERAL(){
	...
	layout.VDST = longfield<17,24>(insn_long);
	layout.VSRC1 = longfield<9,16>(insn_long);
	assert( layout.OP >= 0 && layout.OP < sizeof(amdgpu_gfx908_insn_entry::ENC_VOP2_LITERAL_insn_table) / sizeof(amdgpu_gfx908_insn_entry::ENC_VOP2_LITERAL_insn_table[0]) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx908::decodeENC_VOP3B(){
	...
	layout.SRC2 = longfield<50,58>(insn_long);
	layout.VDST = longfield<0,7>(insn_long);
	assert( layout.OP >= 0 && layout.OP < sizeof(amdgpu_gfx908_insn_entry::ENC_VOP3B_insn_table) / sizeof(amdgpu_gfx908_insn_entry::ENC_VOP3B_insn_table[0]) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx908::decodeENC_VOP3P_MFMA(){
	...
	layout.SRC2 = longfield<50,58>(insn_long);
	layout.VDST = longfield<0,7>(insn_long);
	assert( layout.OP >= 0 && layout.OP < sizeof(amdgpu_gfx908_insn_entry::ENC_VOP3P_MFMA_insn_table) / sizeof(amdgpu_gfx908_insn_entry::ENC_VOP3P_MFMA_insn_table[0]) && "Opcode over or underflow");
