...
void InstructionDecoder_amdgpu_gfx908::decodeENC_VOPC(){
	...
	assert( layout.OP >= 0 && layout.OP < sizeof(amdgpu_gfx908_insn_entry::ENC_VOPC_insn_table) / sizeof(amdgpu_gfx908_insn_entry::ENC_VOPC_insn_table[0]) && "Opcode over or underflow");
...
void InstructionDecoder_amdgpu_gfx908::decodeENC_DS(){
	...
	assert( layout.OP >= 0 && layout.OP < sizeof(amdgpu_gfx908_insn_entry::ENC_DS_insn_table) / sizeof(amdgpu_gfx908_insn_entry::ENC_DS_insn_table[0]) && "Opcode over or underflow");
