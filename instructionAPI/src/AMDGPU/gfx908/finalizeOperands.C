...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.DATA0),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124),true,false);
break;
...
//DS_WRITE_B96
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.DATA0+0,3),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.DATA0+1,0),true,false);
...
//DS_WRITE_B128
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.DATA0+0,4),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.DATA0+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.DATA0+2,0),true,false);
...
insn_in_progress->appendOperand(decodeOPR_FLAT_SCRATCH(0),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124),true,false);
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDATA+0,4),false,true);
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+0,4),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+2,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+3,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+0,8),true,false);
...
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+4,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+5,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+6,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+7,0),true,false);
insn_in_progress->appendOperand(makeRegisterExpression(amdgpu_gfx908::vmcnt,0,36),true,true,true);
break;
case 8:case 9:case 10:case 11:
//IMAGE_STORE,IMAGE_STORE_MIP,IMAGE_STORE_PCK,IMAGE_STORE_MIP_PCK
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDATA+0,4),true,false);
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDATA+2,0),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDATA+3,0),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+0,8),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+2,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+3,0),true,false);
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDATA+0,4),true,true);
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDATA+2,0),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDATA+3,0),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+0,3),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+2,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+0,8),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+1,0),true,false);
...
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+6,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+7,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SSAMP+0,4),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SSAMP+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SSAMP+2,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SSAMP+3,0),true,false);
insn_in_progress->appendOperand(makeRegisterExpression(amdgpu_gfx908::vmcnt,0,36),true,true,true);
break;
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDATA+2,0),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDATA+3,0),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+0,9),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+2,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+3,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+4,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+5,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+6,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+7,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+8,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+0,8),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+2,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+3,0),true,false);
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDATA+2,0),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDATA+3,0),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+0,10),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+2,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+3,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+4,0),true,false);
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+7,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+8,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+9,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+0,8),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+2,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+3,0),true,false);
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDATA+2,0),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDATA+3,0),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+0,5),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+2,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+3,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+4,0),true,false);
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDATA+2,0),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDATA+3,0),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+0,11),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+2,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+3,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+4,0),true,false);
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+8,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+9,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+10,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+0,8),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+2,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+3,0),true,false);
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDATA+2,0),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDATA+3,0),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+0,6),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+2,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+3,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+4,0),true,false);
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDATA+2,0),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDATA+3,0),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+0,12),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+2,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+3,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+4,0),true,false);
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+9,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+10,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+11,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+0,8),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+2,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC+3,0),true,false);
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDATA+2,0),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDATA+3,0),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+0,7),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+2,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+3,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+4,0),true,false);
...
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+0,2),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+1,0),true,false);
processOPR_SMEM_OFFSET(layout);
insn_in_progress->appendOperand(makeRegisterExpression(amdgpu_gfx908::lgkmcnt,0,16),true,true,true);
break;
case 1:case 6:
//S_LOAD_DWORDX2,S_SCRATCH_LOAD_DWORDX2
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+0,2),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+1,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+0,2),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+1,0),true,false);
processOPR_SMEM_OFFSET(layout);
insn_in_progress->appendOperand(makeRegisterExpression(amdgpu_gfx908::lgkmcnt,0,16),true,true,true);
...
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+0,4),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+1,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+2,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+3,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+0,2),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+1,0),true,false);
processOPR_SMEM_OFFSET(layout);
insn_in_progress->appendOperand(makeRegisterExpression(amdgpu_gfx908::lgkmcnt,0,16),true,true,true);
...
case 3:
//S_LOAD_DWORDX8
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+0,8),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+1,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+2,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+3,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+4,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+5,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+6,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+7,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+0,2),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+1,0),true,false);
processOPR_SMEM_OFFSET(layout);
insn_in_progress->appendOperand(makeRegisterExpression(amdgpu_gfx908::lgkmcnt,0,16),true,true,true);
...
case 4:
//S_LOAD_DWORDX16
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+0,16),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+1,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+2,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+3,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+4,0),false,true);
...
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+6,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+7,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+8,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+9,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+10,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+11,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+12,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+13,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+14,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+15,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+0,2),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+1,0),true,false);
processOPR_SMEM_OFFSET(layout);
insn_in_progress->appendOperand(makeRegisterExpression(amdgpu_gfx908::lgkmcnt,0,16),true,true,true);
...
//S_BUFFER_LOAD_DWORD
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+0,4),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+2,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+3,0),true,false);
processOPR_SMEM_OFFSET(layout);
insn_in_progress->appendOperand(makeRegisterExpression(amdgpu_gfx908::lgkmcnt,0,16),true,true,true);
break;
case 9:
...
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+0,2),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+1,0),true,false);
processOPR_SMEM_OFFSET(layout);
insn_in_progress->appendOperand(makeRegisterExpression(amdgpu_gfx908::lgkmcnt,0,16),true,true,true);
...
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+0,2),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+0,2),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+1,0),true,false);
processOPR_SMEM_OFFSET(layout);
insn_in_progress->appendOperand(makeRegisterExpression(amdgpu_gfx908::lgkmcnt,0,16),true,true,true);
...
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+0,4),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+2,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+3,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+0,2),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+1,0),true,false);
processOPR_SMEM_OFFSET(layout);
insn_in_progress->appendOperand(makeRegisterExpression(amdgpu_gfx908::lgkmcnt,0,16),true,true,true);
...
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA),true,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+0,4),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+2,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+3,0),true,false);
...
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+0,2),true,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+1,0),true,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+0,4),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+2,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+3,0),true,false);
...
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+0,4),true,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+1,0),true,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+2,0),true,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA+3,0),true,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+0,4),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+2,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE+3,0),true,false);
...
switch(layout.OP){
case 0:case 8:case 14:case 16:case 18:case 20:case 22:case 23:
//S_MOV_B32,S_BREV_B32,S_FF0_I32_B32,S_FF1_I32_B32,S_FLBIT_I32_B32,S_FLBIT_I32,S_SEXT_I32_I8,S_SEXT_I32_I16
insn_in_progress->appendOperand(decodeOPR_SDST(layout.SDST),false,true);
insn_in_progress->appendOperand(decodeOPR_SSRC(layout.SSRC0),true,false);
break;
case 1:case 9:
//S_MOV_B64,S_BREV_B64
insn_in_progress->appendOperand(decodeOPR_SDST(layout.SDST+0,2),false,true);
insn_in_progress->appendOperand(decodeOPR_SDST(layout.SDST+1,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SSRC(layout.SSRC0+0,2),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC(layout.SSRC0+1,0),true,false);
break;
case 2:
//S_CMOV_B32
insn_in_progress->appendOperand(decodeOPR_SDST(layout.SDST),true,true);
insn_in_progress->appendOperand(decodeOPR_SSRC(layout.SSRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_SPECIAL_SCC(253),true,false);
break;
case 3:
//S_CMOV_B64
insn_in_progress->appendOperand(decodeOPR_SDST(layout.SDST+0,2),true,true);
insn_in_progress->appendOperand(decodeOPR_SDST(layout.SDST+1,0),true,true);
insn_in_progress->appendOperand(decodeOPR_SSRC(layout.SSRC0+0,2),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC(layout.SSRC0+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_SPECIAL_SCC(253),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_SDST(layout.SDST),false,true);
insn_in_progress->appendOperand(decodeOPR_SSRC(layout.SSRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_SPECIAL_SCC(253),false,true);
break;
...
insn_in_progress->appendOperand(decodeOPR_SDST(layout.SDST+0,2),false,true);
insn_in_progress->appendOperand(decodeOPR_SDST(layout.SDST+1,0),false,true);
insn_in_progress->appendOperand(decodeOPR_PC(0),true,false);
break;
case 29:
//S_SETPC_B64
setBranch();
setModifyPC();
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SSRC0+0,2),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SSRC0+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_PC(0),false,true);
break;
case 30:
//S_SWAPPC_B64
setBranch();
...
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDST+0,2),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDST+1,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SSRC(layout.SSRC0+0,2),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC(layout.SSRC0+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_EXEC(126),false,true);
insn_in_progress->appendOperand(decodeOPR_SSRC_SPECIAL_SCC(253),false,true);
insn_in_progress->appendOperand(decodeOPR_SDST_EXEC(126),true,false);
break;
case 42:
//S_MOVRELS_B32
insn_in_progress->appendOperand(decodeOPR_SDST(layout.SDST),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SSRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124),true,false);
break;
case 43:
//S_MOVRELS_B64
...
case 44:
//S_MOVRELD_B32
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDST),false,true);
insn_in_progress->appendOperand(decodeOPR_SSRC(layout.SSRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124),true,false);
break;
case 45:
...
//S_SET_GPR_IDX_IDX
insn_in_progress->appendOperand(decodeOPR_SSRC(layout.SSRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124),false,true);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124),true,false);
break;
case 55:
...
insn_in_progress->appendOperand(decodeOPR_SDST(layout.SDST),false,true);
insn_in_progress->appendOperand(decodeOPR_SSRC(layout.SSRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC(layout.SSRC1),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_SPECIAL_SCC(253),false,true);
break;
case 4:case 5:
...
insn_in_progress->appendOperand(decodeOPR_SSRC(layout.SSRC0+0,2),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC(layout.SSRC0+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC(layout.SSRC1+0,2),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC(layout.SSRC1+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_SPECIAL_SCC(253),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_SSRC_SPECIAL_SCC(253),false,true);
break;
case 34:case 36:case 44:case 45:case 50:case 51:case 52:
//S_BFM_B32,S_MUL_I32,S_MUL_HI_U32,S_MUL_HI_I32,S_PACK_LL_B32_B16,S_PACK_LH_B32_B16,S_PACK_HH_B32_B16
insn_in_progress->appendOperand(decodeOPR_SDST(layout.SDST),false,true);
insn_in_progress->appendOperand(decodeOPR_SSRC(layout.SSRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC(layout.SSRC1),true,false);
break;
...
case 41:
//S_CBRANCH_G_FORK
insn_in_progress->appendOperand(decodeOPR_SSRC_NOLIT(layout.SSRC0+0,2),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_NOLIT(layout.SSRC0+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_NOLIT(layout.SSRC1+0,2),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_NOLIT(layout.SSRC1+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_PC(0),false,true);
break;
case 43:
//S_RFE_RESTORE_B64
...
insn_in_progress->appendOperand(decodeOPR_SDST(layout.SDST),true,false);
insn_in_progress->appendOperand(decodeOPR_SIMM16(layout.SIMM16),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_SPECIAL_SCC(253),false,true);
break;
case 14:
...
case 16:
//S_CBRANCH_I_FORK
insn_in_progress->appendOperand(decodeOPR_SDST(layout.SDST+0,2),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST(layout.SDST+1,0),true,false);
...
makeBranchTarget(isCall,isConditional,layout.SIMM16);
insn_in_progress->appendOperand(decodeOPR_LABEL(layout.SIMM16),true,false);
insn_in_progress->appendOperand(decodeOPR_VCC(0),true,false);
break;
case 8:case 9:
...
//V_INTERP_P1_F32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VSRC),true,false);
insn_in_progress->appendOperand(decodeOPR_ATTR(layout.ATTR),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124),true,false);
break;
case 1:
//V_INTERP_P2_F32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST),true,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VSRC),true,false);
insn_in_progress->appendOperand(decodeOPR_ATTR(layout.ATTR),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124),true,false);
break;
...
//V_INTERP_MOV_F32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST),false,true);
insn_in_progress->appendOperand(decodeOPR_PARAM(layout.VSRC),true,false);
insn_in_progress->appendOperand(decodeOPR_ATTR(layout.ATTR),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124),true,false);
break;
}
...
//V_INTERP_P1_F32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR(layout.SRC1),true,false);
insn_in_progress->appendOperand(decodeOPR_ATTR(layout.SRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124),true,false);
break;
case 625:
//V_INTERP_P2_F32
...
//V_INTERP_MOV_F32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST),false,true);
insn_in_progress->appendOperand(decodeOPR_PARAM(layout.SRC1),true,false);
insn_in_progress->appendOperand(decodeOPR_ATTR(layout.SRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124),true,false);
break;
case 320:case 373:
//V_NOP,V_CLREXCP
break;
case 321:case 325:case 326:case 327:case 328:case 330:case 331:case 332:case 333:case 334:case 337:case 338:case 339:case 340:case 347:case 348:case 349:case 350:case 351:case 352:case 353:case 354:case 355:case 356:case 359:case 361:case 362:case 363:case 364:case 365:case 366:case 367:case 371:case 372:case 375:case 377:case 378:case 379:case 380:case 381:case 382:case 383:case 384:case 385:case 386:case 387:case 388:case 389:case 390:case 391:case 392:case 393:case 394:case 395:case 396:case 397:case 398:case 399:
//V_MOV_B32,V_CVT_F32_I32,V_CVT_F32_U32,V_CVT_U32_F32,V_CVT_I32_F32,V_CVT_F16_F32,V_CVT_F32_F16,V_CVT_RPI_I32_F32,V_CVT_FLR_I32_F32,V_CVT_OFF_F32_I4,V_CVT_F32_UBYTE0,V_CVT_F32_UBYTE1,V_CVT_F32_UBYTE2,V_CVT_F32_UBYTE3,V_FRACT_F32,V_TRUNC_F32,V_CEIL_F32,V_RNDNE_F32,V_FLOOR_F32,V_EXP_F32,V_LOG_F32,V_RCP_F32,V_RCP_IFLAG_F32,V_RSQ_F32,V_SQRT_F32,V_SIN_F32,V_COS_F32,V_NOT_B32,V_BFREV_B32,V_FFBH_U32,V_FFBL_B32,V_FFBH_I32,V_FREXP_EXP_I32_F32,V_FREXP_MANT_F32,V_SCREEN_PARTITION_4SE_B32,V_CVT_F16_U16,V_CVT_F16_I16,V_CVT_U16_F16,V_CVT_I16_F16,V_RCP_F16,V_SQRT_F16,V_RSQ_F16,V_LOG_F16,V_EXP_F16,V_FREXP_MANT_F16,V_FREXP_EXP_I16_F16,V_FLOOR_F16,V_CEIL_F16,V_TRUNC_F16,V_RNDNE_F16,V_FRACT_F16,V_SIN_F16,V_COS_F16,V_EXP_LEGACY_F32,V_LOG_LEGACY_F32,V_CVT_NORM_I16_F16,V_CVT_NORM_U16_F16,V_SAT_PK_U8_I16
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0),true,false);
break;
case 322:
//V_READFIRSTLANE_B32
insn_in_progress->appendOperand(decodeOPR_SREG_NOVCC(layout.VDST),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_LDS(layout.SRC0),true,false);
break;
case 323:case 335:case 341:case 368:
//V_CVT_I32_F64,V_CVT_F32_F64,V_CVT_U32_F64,V_FREXP_EXP_I32_F64
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0+0,2),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0+1,0),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1),true,false);
break;
case 272:case 273:case 274:case 289:case 296:case 298:case 299:case 300:case 310:
//V_LSHRREV_B32,V_ASHRREV_I32,V_LSHLREV_B32,V_SUBREV_F16,V_SUBREV_U16,V_LSHLREV_B16,V_LSHRREV_B16,V_ASHRREV_I16,V_SUBREV_U32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1),true,false);
break;
case 278:case 291:case 311:case 312:case 313:case 314:case 315:case 316:case 496:
//V_MAC_F32,V_MAC_F16,V_DOT2C_F32_F16,V_DOT2C_I32_I16,V_DOT4C_I32_I8,V_DOT8C_I32_I4,V_FMAC_F32,V_PK_FMAC_F16,V_CVT_PKACCUM_U8_F32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST),true,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0+0,2),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1+0,2),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC2+0,2),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC2+1,0),true,false);
break;
case 482:
//V_DIV_FMAS_F32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST),false,true);
...
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR(layout.SRC2+0,4),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR(layout.SRC2+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR(layout.SRC2+2,0),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR(layout.SRC2+3,0),true,false);
break;
case 628:
//V_INTERP_P1LL_F16
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST),false,true);
...
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR(layout.SRC1),true,false);
insn_in_progress->appendOperand(decodeOPR_ATTR(layout.SRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR(layout.SRC2),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_SREG_NOVCC(layout.VDST),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_LDS(layout.SRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_LANESEL(layout.SRC1),true,false);
break;
case 650:
//V_WRITELANE_B32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST),true,true);
insn_in_progress->appendOperand(decodeOPR_SSRC_NOLIT(layout.SRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_LANESEL(layout.SRC1),true,false);
break;
...
//V_CVT_I32_F64,V_CVT_F32_F64,V_CVT_U32_F64,V_FREXP_EXP_I32_F64
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC(layout.SRC0+0,2),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC(layout.SRC0+1,0),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC(layout.SRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VSRC1),true,false);
insn_in_progress->appendOperand(decodeOPR_VCC(0,64),true,false);
break;
case 1:case 2:case 3:case 4:case 5:case 6:case 7:case 8:case 9:case 10:case 11:case 12:case 13:case 14:case 15:case 19:case 20:case 21:case 31:case 32:case 34:case 38:case 39:case 41:case 45:case 46:case 47:case 48:case 49:case 50:case 51:case 52:case 53:case 61:
//V_ADD_F32,V_SUB_F32,V_SUBREV_F32,V_MUL_LEGACY_F32,V_MUL_F32,V_MUL_I32_I24,V_MUL_HI_I32_I24,V_MUL_U32_U24,V_MUL_HI_U32_U24,V_MIN_F32,V_MAX_F32,V_MIN_I32,V_MAX_I32,V_MIN_U32,V_MAX_U32,V_AND_B32,V_OR_B32,V_XOR_B32,V_ADD_F16,V_SUB_F16,V_MUL_F16,V_ADD_U16,V_SUB_U16,V_MUL_LO_U16,V_MAX_F16,V_MIN_F16,V_MAX_U16,V_MAX_I16,V_MIN_U16,V_MIN_I16,V_LDEXP_F16,V_ADD_U32,V_SUB_U32,V_XNOR_B32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC(layout.SRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VSRC1),true,false);
break;
case 16:case 17:case 18:case 33:case 40:case 42:case 43:case 44:case 54:
//V_LSHRREV_B32,V_ASHRREV_I32,V_LSHLREV_B32,V_SUBREV_F16,V_SUBREV_U16,V_LSHLREV_B16,V_LSHRREV_B16,V_ASHRREV_I16,V_SUBREV_U32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLDS(layout.SRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VSRC1),true,false);
break;
case 22:case 35:case 55:case 56:case 57:case 58:case 59:case 60:
//V_MAC_F32,V_MAC_F16,V_DOT2C_F32_F16,V_DOT2C_I32_I16,V_DOT4C_I32_I8,V_DOT8C_I32_I4,V_FMAC_F32,V_PK_FMAC_F16
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST),true,true);
insn_in_progress->appendOperand(decodeOPR_SRC(layout.SRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VSRC1),true,false);
break;
...
//V_DIV_SCALE_F32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST),false,true);
insn_in_progress->appendOperand(decodeOPR_VCC(layout.SDST+0,2),false,true);
insn_in_progress->appendOperand(decodeOPR_VCC(layout.SDST+1,0),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC2),true,false);
break;
...
switch(layout.OP){
case 0:case 9:case 14:case 32:case 33:case 34:case 35:case 38:case 39:case 40:case 41:case 42:case 43:
//V_PK_MAD_I16,V_PK_MAD_U16,V_PK_FMA_F16,V_MAD_MIX_F32,V_MAD_MIXLO_F16,V_MAD_MIXHI_F16,V_DOT2_F32_F16,V_DOT2_I32_I16,V_DOT2_U32_U16,V_DOT4_I32_I8,V_DOT4_U32_U8,V_DOT8_I32_I4,V_DOT8_U32_U4
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC2),true,false);
...
//V_ACCVGPR_READ
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_ACCVGPR(layout.SRC0),true,false);
break;
case 89:
//V_ACCVGPR_WRITE
insn_in_progress->appendOperand(decodeOPR_ACCVGPR(layout.VDST),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0),true,false);
break;
}
}
...
insn_in_progress->appendOperand(decodeOPR_ACCVGPR(layout.VDST),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_ACCVGPR_OR_CONST(layout.SRC2),true,false);
break;
}
}
...
insn_in_progress->appendOperand(decodeOPR_SRC(layout.SRC0+0,2),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC(layout.SRC0+1,0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VSRC1+0,2),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VSRC1+1,0),true,false);
break;
case 112:case 113:case 114:case 115:case 116:case 117:case 118:case 119:case 120:case 121:case 122:case 123:case 124:case 125:case 126:case 127:case 240:case 241:case 242:case 243:case 244:case 245:case 246:case 247:case 248:case 249:case 250:case 251:case 252:case 253:case 254:case 255:
//V_CMPX_F_F64,V_CMPX_LT_F64,V_CMPX_EQ_F64,V_CMPX_LE_F64,V_CMPX_GT_F64,V_CMPX_LG_F64,V_CMPX_GE_F64,V_CMPX_O_F64,V_CMPX_U_F64,V_CMPX_NGE_F64,V_CMPX_NLG_F64,V_CMPX_NGT_F64,V_CMPX_NLE_F64,V_CMPX_NEQ_F64,V_CMPX_NLT_F64,V_CMPX_TRU_F64,V_CMPX_F_I64,V_CMPX_LT_I64,V_CMPX_EQ_I64,V_CMPX_LE_I64,V_CMPX_GT_I64,V_CMPX_NE_I64,V_CMPX_GE_I64,V_CMPX_T_I64,V_CMPX_F_U64,V_CMPX_LT_U64,V_CMPX_EQ_U64,V_CMPX_LE_U64,V_CMPX_GT_U64,V_CMPX_NE_U64,V_CMPX_GE_U64,V_CMPX_T_U64
insn_in_progress->appendOperand(decodeOPR_VCC(0,64),false,true);
