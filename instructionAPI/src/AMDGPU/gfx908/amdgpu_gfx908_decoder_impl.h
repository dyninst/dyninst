...
typedef void (InstructionDecoder_amdgpu_gfx908::*func_ptr)(void);
func_ptr decode_lookup_table [24] = {
	(&InstructionDecoder_amdgpu_gfx908::decodeENC_SOP1),
	(&InstructionDecoder_amdgpu_gfx908::decodeENC_SOPC),
	(&InstructionDecoder_amdgpu_gfx908::decodeENC_SOPP),
	(&InstructionDecoder_amdgpu_gfx908::decodeENC_SOPK),
	(&InstructionDecoder_amdgpu_gfx908::decodeENC_SOP2),
	(&InstructionDecoder_amdgpu_gfx908::decodeENC_SMEM),
	(&InstructionDecoder_amdgpu_gfx908::decodeENC_VOP1),
	(&InstructionDecoder_amdgpu_gfx908::decodeENC_VOPC),
	(&InstructionDecoder_amdgpu_gfx908::decodeENC_VOP2),
	(&InstructionDecoder_amdgpu_gfx908::decodeENC_VINTRP),
	(&InstructionDecoder_amdgpu_gfx908::decodeENC_VOP3P),
	(&InstructionDecoder_amdgpu_gfx908::decodeENC_VOP3),
	(&InstructionDecoder_amdgpu_gfx908::decodeENC_DS),
	(&InstructionDecoder_amdgpu_gfx908::decodeENC_MUBUF),
	(&InstructionDecoder_amdgpu_gfx908::decodeENC_MTBUF),
	(&InstructionDecoder_amdgpu_gfx908::decodeENC_MIMG),
	(&InstructionDecoder_amdgpu_gfx908::decodeENC_EXP),
	(&InstructionDecoder_amdgpu_gfx908::decodeENC_FLAT),
	(&InstructionDecoder_amdgpu_gfx908::decodeENC_FLAT_GLBL),
	(&InstructionDecoder_amdgpu_gfx908::decodeENC_FLAT_SCRATCH),
	(&InstructionDecoder_amdgpu_gfx908::decodeSOPK_INST_LITERAL_),
	(&InstructionDecoder_amdgpu_gfx908::decodeENC_VOP2_LITERAL),
	(&InstructionDecoder_amdgpu_gfx908::decodeENC_VOP3B),
	(&InstructionDecoder_amdgpu_gfx908::decodeENC_VOP3P_MFMA),
};
