...
Expression::Ptr decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(uint64_t input, uint32_t opr_size );
...
Expression::Ptr decodeOPR_VGPR_OR_ACCVGPR(uint64_t input, uint32_t opr_size );
