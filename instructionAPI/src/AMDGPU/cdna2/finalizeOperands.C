...
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC),true,false);
...
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE),true,false);
insn_in_progress->appendOperand(decodeOPR_SMEM_OFFSET(layout.SOFFSET),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_SSRC_NOLIT(layout.SSRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_NOLIT(layout.SSRC1),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRC2),true,false);
break;
case 257:// V_ADD_F32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0),true,false);
...
insn_in_progress->appendOperand(decodeOPR_SREG(layout.VDST),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1),true,false);
break;
case 17:// V_CMPX_CLASS_F32
insn_in_progress->appendOperand(decodeOPR_SDST(layout.VDST),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST),false,true);
insn_in_progress->appendOperand(decodeOPR_VCC(0),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC(layout.SRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VSRC1),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST),false,true);
insn_in_progress->appendOperand(decodeOPR_VCC(layout.SDST),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC2),true,false);
break;
