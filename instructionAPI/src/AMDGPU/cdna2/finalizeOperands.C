...
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST+1,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA1,32),true,false);
break;
...
case 64:// DS_ADD_U64
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0+0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0+1,32),true,false);
break;
case 65:// DS_SUB_U64
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0+0,32),true,false);
...
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0+0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0+1,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA1+0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA1+1,32),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST+0,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST+1,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST+2,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST+3,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0+0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0+1,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA1+0,32),true,false);
...
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0+0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0+1,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0+2,32),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0+1,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0+2,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0+3,32),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR+0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR+1,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA+0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA+1,32),true,false);
insn_in_progress->appendOperand(decodeOPR_FLAT_SCRATCH(0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124,32),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA+0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA+1,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA+2,32),true,false);
insn_in_progress->appendOperand(decodeOPR_FLAT_SCRATCH(0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124,32),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA+1,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA+2,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA+3,32),true,false);
insn_in_progress->appendOperand(decodeOPR_FLAT_SCRATCH(0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124,32),true,false);
break;
...
switch(layout.OP){
case 0:// IMAGE_LOAD
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDATA+0,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDATA+1,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDATA+2,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDATA+3,32),false,true);
...
break;
case 8:// IMAGE_STORE
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDATA+0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDATA+1,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDATA+2,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDATA+3,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+1,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+2,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+3,32),true,false);
...
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDATA+0,32),true,true);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDATA+1,32),true,true);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDATA+2,32),true,true);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDATA+3,32),true,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+1,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+2,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR+3,32),true,false);
...
void InstructionDecoder_amdgpu_cdna2::finalizeSOPK_INST_LITERAL_Operands(){
...
break;
case 260:// V_FMAC_F64
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST+0,32),true,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST+1,32),true,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0+0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0+1,32),true,false);
...
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,32),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,32),true,false);
break;
case 99:// V_MFMA_F32_32X32X4BF16_1K
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,32),true,false);
break;
case 100:// V_MFMA_F32_16X16X4BF16_1K
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,32),true,false);
break;
case 101:// V_MFMA_F32_4X4X4BF16_1K
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,32),true,false);
