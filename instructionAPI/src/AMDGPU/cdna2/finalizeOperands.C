...
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0,32),true,false);
break;
case 1:// DS_SUB_U32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0,32),true,false);
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA1,32),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0,32),true,false);
break;
case 23:// DS_PK_ADD_F16
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0,32),true,false);
break;
case 24:// DS_PK_ADD_BF16
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0,32),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0,32),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,64),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA1,32),true,false);
break;
...
case 64:// DS_ADD_U64
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0,64),true,false);
break;
case 65:// DS_SUB_U64
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0,64),true,false);
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA1,64),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,128),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA1,64),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124,32),true,false);
break;
case 183:// DS_PK_ADD_RTN_F16
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0,32),true,false);
break;
case 184:// DS_PK_ADD_RTN_BF16
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0,32),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0,96),true,false);
break;
case 223:// DS_WRITE_B128
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA0,128),true,false);
break;
case 254:// DS_READ_B96
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,96),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,32),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,64),true,false);
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA,32),true,false);
insn_in_progress->appendOperand(decodeOPR_FLAT_SCRATCH(0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124,32),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA,64),true,false);
insn_in_progress->appendOperand(decodeOPR_FLAT_SCRATCH(0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124,32),true,false);
break;
case 30:// FLAT_STORE_DWORDX3
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA,96),true,false);
insn_in_progress->appendOperand(decodeOPR_FLAT_SCRATCH(0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124,32),true,false);
break;
case 31:// FLAT_STORE_DWORDX4
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA,128),true,false);
insn_in_progress->appendOperand(decodeOPR_FLAT_SCRATCH(0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124,32),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124,32),true,false);
break;
case 78:// FLAT_ATOMIC_PK_ADD_F16
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA,32),true,false);
insn_in_progress->appendOperand(decodeOPR_FLAT_SCRATCH(0,64),true,false);
...
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124,32),true,false);
break;
case 82:// FLAT_ATOMIC_PK_ADD_BF16
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA,32),true,false);
insn_in_progress->appendOperand(decodeOPR_FLAT_SCRATCH(0,64),true,false);
...
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124,32),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124,32),true,false);
break;
case 38:// GLOBAL_LOAD_LDS_UBYTE
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124,32),true,false);
break;
case 39:// GLOBAL_LOAD_LDS_SBYTE
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124,32),true,false);
break;
case 40:// GLOBAL_LOAD_LDS_USHORT
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124,32),true,false);
break;
case 41:// GLOBAL_LOAD_LDS_SSHORT
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124,32),true,false);
break;
case 42:// GLOBAL_LOAD_LDS_DWORD
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124,32),true,false);
...
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124,32),true,false);
break;
case 82:// GLOBAL_ATOMIC_PK_ADD_BF16
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.DATA,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SADDR,64),true,false);
...
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124,32),true,false);
break;
case 38:// SCRATCH_LOAD_LDS_UBYTE
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_FLAT_SCRATCH(0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124,32),true,false);
break;
case 39:// SCRATCH_LOAD_LDS_SBYTE
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_FLAT_SCRATCH(0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124,32),true,false);
break;
case 40:// SCRATCH_LOAD_LDS_USHORT
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_FLAT_SCRATCH(0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124,32),true,false);
break;
case 41:// SCRATCH_LOAD_LDS_SSHORT
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_FLAT_SCRATCH(0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_M0(124,32),true,false);
break;
case 42:// SCRATCH_LOAD_LDS_DWORD
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.ADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SADDR,32),true,false);
insn_in_progress->appendOperand(decodeOPR_FLAT_SCRATCH(0,64),true,false);
...
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDATA,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_NOLIT(layout.SOFFSET,32),true,false);
break;
case 1:// TBUFFER_LOAD_FORMAT_XY
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDATA,64),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_NOLIT(layout.SOFFSET,32),true,false);
break;
case 2:// TBUFFER_LOAD_FORMAT_XYZ
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDATA,96),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_NOLIT(layout.SOFFSET,32),true,false);
break;
case 3:// TBUFFER_LOAD_FORMAT_XYZW
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDATA,128),false,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_NOLIT(layout.SOFFSET,32),true,false);
break;
case 4:// TBUFFER_STORE_FORMAT_X
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDATA,32),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_NOLIT(layout.SOFFSET,32),true,false);
break;
case 5:// TBUFFER_STORE_FORMAT_XY
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDATA,64),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_NOLIT(layout.SOFFSET,32),true,false);
break;
case 6:// TBUFFER_STORE_FORMAT_XYZ
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDATA,96),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_NOLIT(layout.SOFFSET,32),true,false);
break;
case 7:// TBUFFER_STORE_FORMAT_XYZW
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDATA,128),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_NOLIT(layout.SOFFSET,32),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDATA,32),true,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_NOLIT(layout.SOFFSET,32),true,false);
break;
case 65:// BUFFER_ATOMIC_CMPSWAP
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDATA,64),true,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_NOLIT(layout.SOFFSET,32),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_SSRC_NOLIT(layout.SOFFSET,32),true,false);
break;
case 79:// BUFFER_ATOMIC_ADD_F64
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDATA,64),true,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_NOLIT(layout.SOFFSET,32),true,false);
break;
case 80:// BUFFER_ATOMIC_MIN_F64
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDATA,64),true,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_NOLIT(layout.SOFFSET,32),true,false);
break;
case 81:// BUFFER_ATOMIC_MAX_F64
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDATA,64),true,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_NOLIT(layout.SOFFSET,32),true,false);
...
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDATA,128),true,true);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VADDR,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRSRC,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_NOLIT(layout.SOFFSET,32),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SMEM_OFFSET(layout.SOFFSET,32),true,false);
break;
case 1:// S_LOAD_DWORDX2
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA,64),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SMEM_OFFSET(layout.SOFFSET,32),true,false);
break;
case 2:// S_LOAD_DWORDX4
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA,128),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SMEM_OFFSET(layout.SOFFSET,32),true,false);
break;
case 3:// S_LOAD_DWORDX8
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA,256),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SMEM_OFFSET(layout.SOFFSET,32),true,false);
break;
case 4:// S_LOAD_DWORDX16
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA,512),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SMEM_OFFSET(layout.SOFFSET,32),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA,32),false,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SMEM_OFFSET(layout.SOFFSET,32),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SMEM_OFFSET(layout.SOFFSET,32),true,false);
break;
case 18:// S_STORE_DWORDX4
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SMEM_OFFSET(layout.SOFFSET,32),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA,64),true,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SMEM_OFFSET(layout.SOFFSET,32),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDATA,128),true,true);
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SBASE,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SMEM_OFFSET(layout.SOFFSET,32),true,false);
break;
...
break;
case 1:// S_MOV_B64
insn_in_progress->appendOperand(decodeOPR_SDST(layout.SDST,64),false,true);
insn_in_progress->appendOperand(decodeOPR_SSRC(layout.SSRC0,64),true,false);
break;
case 2:// S_CMOV_B32
...
break;
case 3:// S_CMOV_B64
insn_in_progress->appendOperand(decodeOPR_SDST(layout.SDST,64),true,true);
insn_in_progress->appendOperand(decodeOPR_SSRC(layout.SSRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_SPECIAL_SCC(253,1),true,false);
break;
case 4:// S_NOT_B32
...
break;
case 29:// S_SETPC_B64
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SSRC0,64),true,false);
...
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SDST,64),false,true);
insn_in_progress->appendOperand(decodeOPR_SSRC(layout.SSRC0,64),true,false);
...
insn_in_progress->appendOperand(decodeOPR_SDST(layout.SDST,64),false,true);
insn_in_progress->appendOperand(decodeOPR_SSRC(layout.SSRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC(layout.SSRC1,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_SPECIAL_SCC(253,1),true,false);
break;
case 12:// S_AND_B32
insn_in_progress->appendOperand(decodeOPR_SDST(layout.SDST,32),false,true);
...
insn_in_progress->appendOperand(decodeOPR_SSRC_NOLIT(layout.SSRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SSRC_NOLIT(layout.SSRC1,64),true,false);
insn_in_progress->appendOperand(decodeOPR_PC(0,64),false,true);
break;
...
insn_in_progress->appendOperand(decodeOPR_SDST(layout.SDST,64),true,false);
...
break;
case 31:// S_SET_VALU_COEXEC_MODE
insn_in_progress->appendOperand(decodeOPR_SIMM16(layout.SIMM16),true,false);
break;
}
}
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC(layout.SRC0,64),true,false);
break;
case 4:// V_CVT_F64_I32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST,64),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC(layout.SRC0,32),true,false);
break;
...
break;
case 84:// V_CVT_F32_FP8
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC(layout.SRC0,8),true,false);
break;
case 85:// V_CVT_F32_BF8
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC(layout.SRC0,8),true,false);
break;
case 86:// V_CVT_PK_F32_FP8
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST,64),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC(layout.SRC0,32),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0,64),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_SRC_ACCVGPR(layout.SRC0,32),true,false);
break;
case 404:// V_CVT_F32_FP8
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0,8),true,false);
break;
case 405:// V_CVT_F32_BF8
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0,8),true,false);
break;
case 406:// V_CVT_PK_F32_FP8
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST,64),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0,32),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_SREG(layout.SRC2,64),true,false);
break;
case 257:// V_ADD_F32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0,32),true,false);
...
break;
case 260:// V_FMAC_F64
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST,64),true,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1,64),true,false);
break;
case 261:// V_MUL_F32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0,32),true,false);
...
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC2,64),true,false);
break;
case 461:// V_LERP_U8
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0,32),true,false);
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST,128),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR(layout.SRC2,128),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1,16),true,false);
break;
case 673:// V_MUL_LEGACY_F32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1,32),true,false);
break;
case 674:// V_CVT_PK_FP8_F32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST,32),true,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1,32),true,false);
break;
case 675:// V_CVT_PK_BF8_F32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST,32),true,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1,32),true,false);
break;
case 676:// V_CVT_SR_FP8_F32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST,32),true,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1,32),true,false);
break;
case 677:// V_CVT_SR_BF8_F32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST,8),true,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1,32),true,false);
break;
case 16:// V_CMP_CLASS_F32
insn_in_progress->appendOperand(decodeOPR_SREG(layout.VDST,64),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1,32),true,false);
break;
case 17:// V_CMPX_CLASS_F32
insn_in_progress->appendOperand(decodeOPR_SDST(layout.VDST,64),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SDST_EXEC(126,64),false,true);
break;
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST,64),true,true);
insn_in_progress->appendOperand(decodeOPR_SRC(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VSRC1,64),true,false);
break;
case 5:// V_MUL_F32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC(layout.SRC0,32),true,false);
...
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST,32),false,true);
insn_in_progress->appendOperand(decodeOPR_VCC(layout.SDST,64),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC2,32),true,false);
break;
...
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC2,64),true,false);
break;
case 49:// V_PK_MUL_F32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST,64),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1,64),true,false);
break;
case 50:// V_PK_ADD_F32
insn_in_progress->appendOperand(decodeOPR_VGPR(layout.VDST,64),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_NOLIT(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_SIMPLE(layout.SRC1,64),true,false);
break;
...
switch(layout.OP){
case 62:// V_MFMA_F32_16X16X8_XF32
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,128),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,128),true,false);
break;
case 63:// V_MFMA_F32_32X32X4_XF32
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,512),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,512),true,false);
break;
case 64:// V_MFMA_F32_32X32X1_2B_F32
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,1024),false,true);
...
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,1024),true,false);
break;
case 65:// V_MFMA_F32_16X16X1_4B_F32
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,512),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,512),true,false);
break;
case 66:// V_MFMA_F32_4X4X1_16B_F32
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,128),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,128),true,false);
break;
case 68:// V_MFMA_F32_32X32X2_F32
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,512),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,512),true,false);
break;
case 69:// V_MFMA_F32_16X16X4_F32
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,128),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,128),true,false);
break;
case 72:// V_MFMA_F32_32X32X4_2B_F16
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,1024),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,1024),true,false);
break;
case 73:// V_MFMA_F32_16X16X4_4B_F16
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,512),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,512),true,false);
break;
case 74:// V_MFMA_F32_4X4X4_16B_F16
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,128),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,128),true,false);
break;
case 76:// V_MFMA_F32_32X32X8_F16
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,512),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,512),true,false);
break;
case 77:// V_MFMA_F32_16X16X16_F16
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,128),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,128),true,false);
break;
case 80:// V_MFMA_I32_32X32X4_2B_I8
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,1024),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,1024),true,false);
break;
case 81:// V_MFMA_I32_16X16X4_4B_I8
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,512),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,512),true,false);
break;
case 82:// V_MFMA_I32_4X4X4_16B_I8
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,128),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,32),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,128),true,false);
break;
case 86:// V_MFMA_I32_32X32X16_I8
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,512),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,512),true,false);
break;
case 87:// V_MFMA_I32_16X16X32_I8
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,128),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,128),true,false);
break;
case 93:// V_MFMA_F32_32X32X4_2B_BF16
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,1024),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,1024),true,false);
break;
case 94:// V_MFMA_F32_16X16X4_4B_BF16
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,512),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,512),true,false);
break;
case 95:// V_MFMA_F32_4X4X4_16B_BF16
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,128),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,128),true,false);
break;
case 96:// V_MFMA_F32_32X32X8_BF16
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,512),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,512),true,false);
break;
case 97:// V_MFMA_F32_16X16X16_BF16
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,128),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,128),true,false);
break;
case 98:// V_SMFMAC_F32_16X16X32_F16
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,128),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR(layout.SRC2,32),true,false);
break;
case 100:// V_SMFMAC_F32_32X32X16_F16
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,512),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR(layout.SRC2,32),true,false);
break;
case 102:// V_SMFMAC_F32_16X16X32_BF16
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,128),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR(layout.SRC2,32),true,false);
break;
case 104:// V_SMFMAC_F32_32X32X16_BF16
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,512),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR(layout.SRC2,32),true,false);
break;
case 106:// V_SMFMAC_I32_16X16X64_I8
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,128),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR(layout.SRC2,32),true,false);
break;
case 108:// V_SMFMAC_I32_32X32X32_I8
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,512),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR(layout.SRC2,32),true,false);
...
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,256),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,256),true,false);
break;
case 111:// V_MFMA_F64_4X4X4_4B_F64
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,64),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,64),true,false);
break;
case 112:// V_MFMA_F32_16X16X32_BF8_BF8
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,128),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,128),true,false);
break;
case 113:// V_MFMA_F32_16X16X32_BF8_FP8
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,128),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,128),true,false);
break;
case 114:// V_MFMA_F32_16X16X32_FP8_BF8
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,128),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,128),true,false);
...
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,128),true,false);
break;
case 116:// V_MFMA_F32_32X32X16_BF8_BF8
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,512),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,512),true,false);
break;
case 117:// V_MFMA_F32_32X32X16_BF8_FP8
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,512),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,512),true,false);
break;
case 118:// V_MFMA_F32_32X32X16_FP8_BF8
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,512),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,512),true,false);
...
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR_OR_CONST(layout.SRC2,512),true,false);
break;
case 120:// V_SMFMAC_F32_16X16X64_BF8_BF8
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,128),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR(layout.SRC2,32),true,false);
break;
case 121:// V_SMFMAC_F32_16X16X64_BF8_FP8
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,128),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR(layout.SRC2,32),true,false);
break;
case 122:// V_SMFMAC_F32_16X16X64_FP8_BF8
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,128),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR(layout.SRC2,32),true,false);
break;
case 123:// V_SMFMAC_F32_16X16X64_FP8_FP8
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,128),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR(layout.SRC2,32),true,false);
break;
case 124:// V_SMFMAC_F32_32X32X32_BF8_BF8
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,512),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR(layout.SRC2,32),true,false);
break;
case 125:// V_SMFMAC_F32_32X32X32_BF8_FP8
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,512),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR(layout.SRC2,32),true,false);
break;
case 126:// V_SMFMAC_F32_32X32X32_FP8_BF8
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,512),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR(layout.SRC2,32),true,false);
break;
case 127:// V_SMFMAC_F32_32X32X32_FP8_FP8
insn_in_progress->appendOperand(decodeOPR_VGPR_OR_ACCVGPR(layout.VDST,512),false,true);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC0,64),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR_OR_ACCVGPR(layout.SRC1,128),true,false);
insn_in_progress->appendOperand(decodeOPR_SRC_VGPR(layout.SRC2,32),true,false);
