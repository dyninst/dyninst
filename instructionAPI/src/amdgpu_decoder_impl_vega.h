...
func_ptr decode_lookup_table[16] = { (&InstructionDecoder_amdgpu_vega::decodeSOP2),
...
#define IS_SOP2(I)                                                                       \
    ((longfield<30, 31>(I) == 0x2) && (longfield<28, 29>(I) != 0x3) &&                   \
     (longfield<23, 29>(I) != 0x3d) && (longfield<23, 29>(I) != 0x3e) &&                 \
     (longfield<23, 29>(I) != 0x3f))
#define IS_SOP1(I) ((longfield<23, 31>(I) == 0x17d))
#define IS_SOPK(I)                                                                       \
    ((longfield<30, 31>(I) == 0x2) && (longfield<28, 31>(I) == 0xb) &&                   \
     (longfield<23, 27>(I) != 0x1d) && (longfield<23, 27>(I) != 0x1e) &&                 \
     (longfield<23, 27>(I) != 0x1f))
#define IS_SOPC(I) ((longfield<23, 31>(I) == 0x17e))
#define IS_SOPP(I) ((longfield<23, 31>(I) == 0x17f))
#define IS_SMEM(I) ((longfield<26, 31>(I) == 0x30))
#define IS_VOP2(I)                                                                       \
    ((longfield<31, 31>(I) == 0x0) && (longfield<25, 30>(I) != 0x3e) &&                  \
     (longfield<25, 30>(I) != 0x3f))
