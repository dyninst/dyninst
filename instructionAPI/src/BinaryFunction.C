...
namespace Dyninst
{
  namespace InstructionAPI
  {
    ...
    Result doSubtraction(Result arg1, Result arg2, Result_Type ResultT)
    {
      switch(ResultT)
      {
		  case s8:
    ...
    Result doBitwiseXor(Result arg1, Result arg2, Result_Type ResultT)
    {
      switch(ResultT)
      {
		  case s8:
    ...
    Result operator-(const Result& arg1, const Result& arg2)
    {
        ...
        return doSubtraction(arg1, arg2, ResultT);
    }
	...
	Result operator^(const Result& arg1, const Result& arg2)
	{
		...
		return doBitwiseXor(arg1, arg2, ResultT);
	}
    ...
    bool BinaryFunction::isSubtraction() const
    {
        return dynamic_cast<subResult*>(m_funcPtr.get()) != NULL;
    }
    ...
    bool BinaryFunction::isBitwiseXor() const
    {
        return dynamic_cast<bitwiseXorResult*>(m_funcPtr.get()) != NULL;
    }
  };
};
