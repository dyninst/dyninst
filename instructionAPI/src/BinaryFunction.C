  ...
  switch (ResultT) {
    ...
    case sp_float:
      return Result(ResultT,
                    arg1.convert<Result_type2type<sp_float>::type>() +
                        arg2.convert<Result_type2type<sp_float>::type>());
    case dp_float:
      return Result(ResultT,
                    arg1.convert<Result_type2type<dp_float>::type>() +
                        arg2.convert<Result_type2type<dp_float>::type>());
    case bit_flag:
      return Result(ResultT,
                    arg1.convert<Result_type2type<bit_flag>::type>() +
...
Result doLeftShift(Result arg1, Result arg2, Result_Type ResultT) {
  ...
  switch (ResultT) {
    ...
    /*case sp_float:
                  return Result(ResultT,
    arg1.convert<Result_type2type<sp_float>::type >() * arg2.convert<
