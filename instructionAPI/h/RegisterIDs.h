...
enum IA32Regs : unsigned int
{
    ...
    r_DummyFPR = 130,
    r_Reserved,
    // and we have a dummy register to make liveness consistent since floating point saves
    // are all/none at present
    r_rAX = 140,
    r_rBX,
    r_rCX,
    r_rDX,
