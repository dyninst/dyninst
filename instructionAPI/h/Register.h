...
public:
    ...
    /// \param children Since a %RegisterAST has no children, the \c children parameter is
    ...
    /// The \c format method on a %RegisterAST object returns the name associated with its
    /// ID.
    ...
    /// We define a partial ordering on registers by their register number so that they
...
{
public:
    MaskRegisterAST(MachRegister r)
    : RegisterAST(r)
    {}
