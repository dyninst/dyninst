...
class Visitor {
  ...
  /// (%BinaryFunction, %Immediate, %RegisterAST, and %Dereference).  Any state
  /// that
  /// the %Visitor needs to preserve between nodes must be kept within the
  /// class.
  /// %Visitors are invoked by calling %Expression::apply(%Visitor* v); the
  /// %visit method
