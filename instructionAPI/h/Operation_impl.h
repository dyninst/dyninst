...
public:
    INSTRUCTION_EXPORT Operation_impl(NS_x86::ia32_entry*    e,
                                      NS_x86::ia32_prefixes* p    = NULL,
                                      ia32_locations*        l    = NULL,
    ...
    /// operands, but written anyway)
    INSTRUCTION_EXPORT const registerSet& implicitWrites();
    /// Returns the mnemonic for the operation.  Like \c instruction::format, this is
    /// exposed for debugging and will be replaced with stream operators in the public
    /// interface.
    INSTRUCTION_EXPORT std::string format() const;
    /// Returns the entry ID corresponding to this operation.  Entry IDs are enumerated
    /// values that correspond to assembly mnemonics.
...
struct Operation : public Operation_impl
{
    ...
    {}
    Operation(NS_x86::ia32_entry* e, NS_x86::ia32_prefixes* p = NULL,
              ia32_locations* l = NULL, Architecture arch = Arch_none)
    : Operation_impl(e, p, l, arch)
    {}
    Operation()
    : Operation_impl()
    {}
