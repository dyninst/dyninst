...
public:
    ...
    /// By definition, a %TernaryAST has three children, the condition, the first and the
    /// second child. and should all be added to the \param children.
    //
    ...
    /// The \c format method on a %TernaryAST object returns the name associated with its
    /// ID.
