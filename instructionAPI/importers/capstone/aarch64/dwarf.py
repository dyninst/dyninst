...
mapping = [
    {
        "number": [i for i in range(31)],
        "name": "x",
        "desc": "64-bit general-purpose registers",
    },
    ...
    {
        "number": invalid(34),
        "desc": "RA_SIGN_STATE Return address signed state pseudo-register (beta)",
    },
    {
        "number": 35,
        "name": "tpidrro_el0",
        "desc": "EL0 Read-Only Software Thread ID register",
    },
    {
        "number": 36,
        "name": "tpidr_el0",
        "desc": "EL0 Read/Write Software Thread ID register",
    },
    ...
    {"number": reserved(40, 45)},
    {
        "number": 46,
        "name": "vg",
        "desc": "64-bit SVE vector granule pseudo-register (beta state)",
    },
    {"number": 47, "name": "ffr", "desc": "VG × 8-bit SVE first fault register"},
    {
        "number": [i for i in range(48, 64)],
        "name": "p",
        "desc": "VG × 8-bit SVE predicate registers",
    },
    {
        "number": [i for i in range(64, 96)],
        "name": "q",
        "desc": "128-bit FP/Advanced SIMD registers",
    },
    {
        "number": [i for i in range(96, 128)],
        "name": "z",
        "desc": "VG × 64-bit SVE vector registers (beta state)",
    },
]
