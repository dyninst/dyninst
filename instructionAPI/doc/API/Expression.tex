...
Permissible leaf nodes of a \code{Expression} tree are RegisterAST and Immediate
...
\begin{apient}
const Result & eval() const [virtual]
\end{apient}
\apidesc{
...
\begin{apient}
bool bind(Expression * expr, const Result & value) [virtual]
\end{apient}
\apidesc{
...
\begin{apient}
virtual void apply(Visitor *) [virtual]
\end{apient}
\apidesc{
...
\begin{apient}
virtual void getChildren(std::vector<Expression::Ptr> & children) const [pure
virtual]
\end{apient}
\apidesc{
