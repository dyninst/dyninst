...
\begin{DoxyParams}{Parameters}
\item[{\em memAccessors}]If this is a memory read operand, insert the \code{ExpressionPtr} representing the address being read into \code{memAccessors}. \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em memAccessors}]If this is a memory write operand, insert the \code{ExpressionPtr} representing the address being written into \code{memAccessors}. \end{DoxyParams}
