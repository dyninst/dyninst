...
A Result may be constructed from a type without providing a value. This constructor creates a Result of type \code{t} with undefined contents. \index{Dyninst::InstructionAPI::Result@{Dyninst::InstructionAPI::Result}!Result@{Result}}
\index{Result@{Result}!Dyninst::InstructionAPI::Result@{Dyninst::InstructionAPI::Result}}
\paragraph[{Result}]{\setlength{\rightskip}{0pt plus 5cm}{\textbf Result} (
\begin{DoxyParamCaption}
\item[{Result\_\-Type}]{ t, }
