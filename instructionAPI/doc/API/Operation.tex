...
\begin{apient}
const Operation::registerSet& implicitReads();
\end{apient}
\apidesc{
...
\begin{apient}
const Operation::registerSet& implicitWrites();
\end{apient}
\apidesc{
...
\begin{apient}
const Operation::VCSet& getImplicitMemReads();
\end{apient}
\apidesc{
...
\begin{apient}
const Operation::VCSet& getImplicitMemWrites();
\end{apient}
\apidesc{
