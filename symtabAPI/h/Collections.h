...
class SYMTAB_EXPORT localVarCollection
    : public AnnotationContainer<localVar *> {
 ...
 public:
  ...
  Serializable *ac_serialize_impl(SerializerBase *,
    ...
    : public Serializable  //, public AnnotatableSparse
{
  ...
  // static dyn_hash_map<int, std::vector<std::pair<dataClass, Type **> > >
  // deferred_lookups;
