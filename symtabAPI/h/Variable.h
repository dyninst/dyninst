...
class SYMTAB_EXPORT Variable : public Aggregate,
                               public Serializable,
 ...
 public:
  ...
  Serializable *serialize_impl(SerializerBase *sb, const char *tag = "Variable")
...
class SYMTAB_EXPORT localVar : public Serializable, public AnnotatableSparse {
 ...
 public:
  localVar() : type_(NULL), lineNum_(-1), func_(NULL), locsExpanded_(false) {}
  //  Internal use only
  localVar(std::string name, Type *typ, std::string fileName, int lineNum,
 ...
 public:
  ...
  Serializable *serialize_impl(SerializerBase *, const char * = "localVar")
      THROW_SPEC(SerializerError);
};
}
}
