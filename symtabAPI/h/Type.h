...
class Type : public Serializable, public AnnotatableSparse  {
   ...
   void serialize(SerializerBase *, const char *) THROW_SPEC(SerializerError) {}

   SYMTAB_EXPORT void serialize_type(SerializerBase *, 
...
class fieldListType : public Type, public fieldListInterface {
 ...
 public:
   ...
   SYMTAB_EXPORT void serialize_fieldlist(Dyninst::SerializerBase *, const char * = "fieldListType") THROW_SPEC (SerializerError);
...
class rangedType : public Type, public rangedInterface {
 ...
 protected:
   ...
   SYMTAB_EXPORT void serialize_ranged(SerializerBase *, const char * = "rangedType") THROW_SPEC (SerializerError);
 public:
...
class derivedType : public Type, public derivedInterface {
 ...
 public:
   ...
   SYMTAB_EXPORT void serialize_derived(SerializerBase *, const char * = "derivedType") THROW_SPEC(SerializerError);
};
...
class typeEnum : public Type {
 ...
 public:
   ...
   SYMTAB_EXPORT void serialize(SerializerBase *, 
		   const char * = "typeEnum") THROW_SPEC(SerializerError);
};
...
class typeFunction : public Type {
 ...
 public:
   ...
   SYMTAB_EXPORT bool isCompatible(Type *otype);
   SYMTAB_EXPORT void serialize(SerializerBase *, 
		   const char * = "typeFunction") THROW_SPEC(SerializerError);
};
...
class typeScalar : public Type {
 ...
 public:
   ...
   SYMTAB_EXPORT bool isCompatible(Type *otype);
   SYMTAB_EXPORT void serialize(SerializerBase *, 
		   const char * = "typeScalar") THROW_SPEC(SerializerError);
};
...
class typeCommon : public fieldListType {
 ...
 public:
   ...
   SYMTAB_EXPORT void serialize(SerializerBase *, 
		   const char * = "typeCommon") THROW_SPEC(SerializerError);
};
...
#endif
   SYMTAB_EXPORT void serialize(SerializerBase *, 
		   const char * = "CBlock") THROW_SPEC(SerializerError);
};
...
class typeStruct : public fieldListType {
 ...
 public:
   ...
   SYMTAB_EXPORT bool isCompatible(Type *otype);
   SYMTAB_EXPORT void serialize(SerializerBase *, 
		   const char * = "typeStruct") THROW_SPEC(SerializerError);
};
...
class typeUnion : public fieldListType {
 ...
 public:
   ...
   SYMTAB_EXPORT bool isCompatible(Type *otype);
   SYMTAB_EXPORT void serialize(SerializerBase *, 
		   const char * = "typeUnion") THROW_SPEC(SerializerError);
};
...
class typePointer : public derivedType {
 ...
 public:
   ...
   SYMTAB_EXPORT void serialize(SerializerBase *, 
		   const char * = "typePtr") THROW_SPEC(SerializerError);
};
...
class typeTypedef: public derivedType {
 ...
 public:
   ...
   SYMTAB_EXPORT void serialize(SerializerBase *, 
		   const char * = "typeTypedef") THROW_SPEC(SerializerError);
};
...
class typeRef : public derivedType {
 ...
 public:
   ...
   SYMTAB_EXPORT bool operator==(const Type &otype) const;
   SYMTAB_EXPORT void serialize(SerializerBase *, 
		   const char * = "typeRef") THROW_SPEC(SerializerError);
};
...
class typeSubrange : public rangedType {
 ...
 public:
   ...
   SYMTAB_EXPORT bool isCompatible(Type *otype);
   SYMTAB_EXPORT void serialize(SerializerBase *, 
		   const char * = "typeSubrange") THROW_SPEC(SerializerError);
};
...
class typeArray : public rangedType {
 ...
 public:
   ...
   SYMTAB_EXPORT void fixupUnknowns(Module *);
   SYMTAB_EXPORT void serialize(SerializerBase *, 
		   const char * = "typeArray") THROW_SPEC(SerializerError);
};
