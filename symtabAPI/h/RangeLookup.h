...
struct SYMTAB_EXPORT AddressRange : std::pair<Offset, Offset> {
  ...
  AddressRange merge(const AddressRange& other) {
    return AddressRange(std::min(first, other.first),
...
struct RangeLookupTypes {
  ...
  typedef typename boost::multi_index::composite_key<
      ...
      upper_bound_key;
  typedef typename boost::multi_index::composite_key<
      Value, boost::multi_index::const_mem_fun<Value, unsigned int,
                                               &Value::getFileIndex>,
  ...
  typedef typename boost::multi_index_container<
      ...
      boost::multi_index::indexed_by<
          boost::multi_index::ordered_unique<
              boost::multi_index::tag<typename Value::addr_range>,
              addr_range_key>,
          boost::multi_index::ordered_non_unique<
              boost::multi_index::tag<typename Value::upper_bound>,
              upper_bound_key>,
          boost::multi_index::ordered_non_unique<
              boost::multi_index::tag<typename Value::line_info>,
              line_info_key> > >
      type;
  typedef
      typename boost::multi_index::index<type, typename Value::addr_range>::type
          addr_range_index;
  typedef typename boost::multi_index::index<
      type, typename Value::upper_bound>::type upper_bound_index;
  typedef
      typename boost::multi_index::index<type, typename Value::line_info>::type
          line_info_index;
