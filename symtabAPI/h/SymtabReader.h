...
// dyn_util/h)
// to read symbols rather than a straight dependency on SymtabAPI.  A component
// can
// either define its own SymReader (as ProcControlAPI does) or it can use
// SymtabAPI as
// its symbol reader.  These SymtabReader and SymtabReaderFactory implement the
// SymReader
