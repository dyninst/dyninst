...
\begin{titlepage}
\beginpgfgraphicnamed{symtabapi}
...
%    };
    ...
    \node [anchor=west,font=\sffamily] (title1) at ($(origin)+(0.75in,-3.0in)$)
        {\fontsize{48}{56}\selectfont SymtabAPI};
...
%    };
    ...
    \node [anchor=west,font=\sffamily] (rel2) at ($(rel1.west)+(0in,-32pt)$)
        {\fontsize{24}{32}\selectfont Sep 2012};
...
\input{symtabapi_1to5}
%\input{symtabapi_6_1_1to2}
%\input{symtabapi_6_1_3to8}
%\input{symtabapi_6_2}
%\input{symtabapi_6_3to4}
%\input{symtabapi_7}
