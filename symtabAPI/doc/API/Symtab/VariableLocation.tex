...
A VariableLocation is valid within the address range represented by \code{lowPC} and \code{hiPC}. If these are 0 and (Address) -1, respectively, the VariableLocation is always valid. 
