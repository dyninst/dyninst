...
RT\_RELR & Relative relocation section \\
...
\begin{apient}
bool setRegionNumber(unsigned index);
\end{apient}
\apidesc{
...
\subsection{Class relocationEntry}
This class represents a single object relocation.
