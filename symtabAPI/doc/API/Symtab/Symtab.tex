...
\begin{apient}
static Symtab *findOpenSymtab(std::string name);
\end{apient}
...
\begin{apient}
const std::vector<Symbol *> *findSymbolByOffset(Offset offset);
\end{apient}
...
\begin{apient}
bool addLibraryPrereq(std::string lib);
\end{apient}
\apidesc{
