...
\end{apient}
\apidesc{
Construct an enumerated type over \code{underlying\_type}. Given an \code{ID}, that identifier is
used; otherwise one is assigned.
}
...
\begin{apient}
dyn_c_vector<Field *> *getComponents() const;
\end{apient}
\apidesc{
