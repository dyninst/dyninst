...
name for the type. For example, in the example above \code{structType1}
represents the name for the \code{structType} object.
}

\begin{apient}
bool setName(std::string zname);
\end{apient}
\apidesc{
...
\begin{apient}
bool addConstant(const std::string &constname,
                 int value);
\end{apient}
\apidesc{
...
\begin{apient}
static typeFunction *create(std::string &name,
                            Type *retType,
...
\begin{apient}
std::vector< Type *> &getParams() const;
\end{apient}
\apidesc{
...
\begin{apient}
static typeUnion *create(std::string &name,
                         std::vector<std::pair<std::string, Type *>*> &flds,
                         Symtab *obj = NULL);
\end{apient}
\apidesc{
...
\begin{apient}
bool getComponents(std::vector<Field *> *vars);
\end{apient}
\apidesc{
...
\begin{apient}
bool getFunctions(std::vector<Symbol *> *funcs);
\end{apient}
\apidesc{
...
\begin{apient}
static typePointer *create(std::string &name,
                           Type *ptr,
                           Symtab *obj = NULL);
static typePointer *create(std::string &name,
                           Type *ptr,
...
\begin{apient}
static typeTypedef *create(std::string &name,
                           Type *ptr,
                           Symtab *obj = NULL);
\end{apient}
\apidesc{
...
\begin{apient}
static typeRef *create(std::string &name,
                       Type *ptr,
                       Symtab * obj = NULL);
\end{apient}
\apidesc{
...
\begin{apient}
static typeSubrange *create(std::string &name,
                            int size,
                            int low,
                            int hi,
                            symtab *obj = NULL);
...
\begin{apient}
static typeArray *create(std::string &name,
                         Type *type,
                         int low,
                         int hi,
                         Symtab *obj = NULL);
