...
Returns true if the file is parsed without an error, else returns false. The
error is set to Object\_Parsing. printSymtabError() should be called to get more error details.
}
...
false. The error is set to Object\_Parsing. printSymtabError() should
...
typedef enum{
    ...
    lang_GnuCPlusPlus,
    lang_Fortran,
    lang_Fortran\_with\_pretty\_debug,
    lang_CMFortran 
}supportedLanguages
\end{apient}
\apidesc{
