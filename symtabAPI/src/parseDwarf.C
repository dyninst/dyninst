...
int dwarf_get_fde_info_for_cfa_reg3(
    ...
    Dwarf_Signed * /*register*/, Dwarf_Signed * /*offset_or_block_len*/,
    Dwarf_Ptr * /*block_ptr */, Dwarf_Addr * /*row_pc_out*/,
    Dwarf_Error * /*error*/) {
...
bool Object::getRegValueAtFrame(Address pc, Dyninst::MachRegister reg,
  ...
  dwarf->frame_dbg();
  result = dwarf->frameParser()->getRegValueAtFrame(pc, reg, reg_result, reader,
                                                    frame_error);
