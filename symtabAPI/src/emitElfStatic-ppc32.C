...
bool emitElfStatic::archSpecificRelocation(Symtab *, Symtab *, char *targetData,
...
Offset emitElfStatic::layoutNewDtorRegion(LinkMap &lmap) {
  ...
  for (auto reg_it = lmap.newDtorRegions.begin();
...
bool emitElfStatic::isGOTRegion(Region *) { return false; }
...
Offset emitElfStatic::getGOTSize(Symtab *, LinkMap &, Offset &) { return 0; }
...
bool emitElfStatic::updateTOC(Symtab *, LinkMap &, Offset) { return true; }
