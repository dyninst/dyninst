...
int
parsing_printf(const char* format, ...)
{
    if(!sym_debug_parsing)
        return 0;
    if(NULL == format)
        return -1;
...
int
create_printf(const char* format, ...)
{
    if(!sym_debug_create)
        return 0;
    if(NULL == format)
...
int
aggregate_printf(const char* format, ...)
{
    if(!sym_debug_parsing)
        return 0;
    if(NULL == format)
...
int
object_printf(const char* format, ...)
{
    if(!sym_debug_object)
        return 0;
    if(NULL == format)
...
int
types_printf(const char* format, ...)
{
    if(!sym_debug_types)
        return 0;
    if(NULL == format)
...
int
rewrite_printf(const char* format, ...)
{
    init_debug_symtabAPI();
