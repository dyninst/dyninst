...
bool emitElfStatic::archSpecificRelocation(Symtab *, Symtab *, char *,
                                           relocationEntry &, Offset, Offset,
                                           Offset, LinkMap &, string &) {
...
#ifdef OLD_VERSION
void emitElfStatic::buildGOT(LinkMap &) { assert(!EMIT_STATIC_ASSERT); }
#endif
