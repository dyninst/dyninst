...
public:
    ...
    {
        if(addr > text_addr_ + baseaddr && addr < text_addr_ + baseaddr + text_size_)
        {
            return true;
        }
        return false;
...
private:
    ...
    bool loaded_elf(Offset&, Offset&, Elf_X_Shdr*&, Elf_X_Shdr*&, Elf_X_Shdr*&,
                    ...
                    Elf_X_Shdr*& symtab_shndx_scnp, bool a_out = false);
...
private:
    ...
    bool get_relocation_entries(Elf_X_Shdr*& rel_plt_scnp, Elf_X_Shdr*& dynsym_scnp,
    ...
    // existing symbols
    bool parse_all_relocations(Elf_X_Shdr*, Elf_X_Shdr*, Elf_X_Shdr*, Elf_X_Shdr*);

    void parseDynamic(Elf_X_Shdr*& dyn_scnp, Elf_X_Shdr*& dynsym_scnp,
                      Elf_X_Shdr*& dynstr_scnp);

    bool parse_symbols(Elf_X_Data& symdata, Elf_X_Data& strdata, Elf_X_Shdr* bssscnp,
                       Elf_X_Shdr* symscnp, Elf_X_Shdr* symtab_shndx_scnp,
    ...
    bool find_catch_blocks(Elf_X_Shdr* eh_frame, Elf_X_Shdr* except_scn, Address textaddr,
