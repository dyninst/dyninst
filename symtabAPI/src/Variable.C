...
SYMTABEXPORT bool Variable::addMangledName(string name, bool isPrimary) 
{
...
SYMTABEXPORT bool Variable::addPrettyName(string name, bool isPrimary) 
{
    // Check to see if we're duplicating
...
SYMTABEXPORT bool Variable::addTypedName(string name, bool isPrimary) 
{
    // Check to see if we're duplicating
